import { bG as defineComponent, bJ as ref, iv as reactive, bM as computed, fK as watch, bK as onMounted, bL as onBeforeUnmount, bP as openBlock, bX as createElementBlock, fH as createBaseVNode, it as renderSlot, bS as createTextVNode, fL as createCommentVNode, bY as Fragment, bZ as renderList, bT as toDisplayString, bH as useI18n, iw as toRef, bU as unref, ia as _export_sfc, iV as getDefaultExportFromCjs, bI as inject, bO as resolveDirective, bV as createVNode, bR as withCtx, bW as withDirectives, fG as normalizeClass, i8 as pushScopeId, i9 as popScopeId, i7 as vShow, iz as Transition, mC as provide, iP as useWizardStore, iG as LayerType, mD as onErrorCaptured, mE as WizardStep, fO as GlobalEvents, kV as LayerState, bN as resolveComponent, bQ as createBlock, ip as withModifiers, mA as nextTick } from './main-a010f0a1.js';
import { r as require$$0 } from './vue.esm-bundler-5e0400b4.js';
...
const Nt = { class: "vacp-range-input-group" }, Vt = ["for"], At = { class: "vacp-range-input-label-text vacp-range-input-label-text--hue" }, Ht = ["id", "value"], Et = ["for"], Lt = { class: "vacp-range-input-label-text vacp-range-input-label-text--alpha" }, Pt = ["id", "value"], Ot = /* @__PURE__ */ createBaseVNode("span", { class: "vacp-visually-hidden" }, "Copy color", -1), St = /* @__PURE__ */ createBaseVNode("svg", {
  class: "vacp-icon",
...
], -1), Rt = { class: "vacp-color-inputs" }, jt = { class: "vacp-color-input-group" }, Wt = ["for"], Dt = /* @__PURE__ */ createBaseVNode("span", { class: "vacp-color-input-label-text" }, " Hex ", -1), zt = ["id", "value"], Kt = ["id", "for", "onInput"], Yt = { class: "vacp-color-input-label-text" }, Bt = ["id", "value", "onInput"], Ut = /* @__PURE__ */ createBaseVNode("span", { class: "vacp-visually-hidden" }, "Switch format", -1), qt = /* @__PURE__ */ createBaseVNode("svg", {
  class: "vacp-icon",
  "aria-hidden": "true",
  xmlns: "http://www.w3.org/2000/svg",
  width: "16",
  ...
  emits: ["color-change"],
  setup(t, { emit: e }) {
    const s = ["hex", "hsl", "hsv", "hwb", "rgb"], o = t, u = e, f = ref(null), v = ref(null), p = ref(null);
    let d = !1;
    const c = ref(o.visibleFormats.includes(o.defaultFormat) ? o.defaultFormat : o.visibleFormats[0]), l = reactive({
      hex: "#ffffffff",
    ...
    watch(() => o.color, z), onMounted(function() {
    ...
    return (n, r) => (openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", Nt, [
        createBaseVNode("label", {
          ...
          createBaseVNode("span", At, [
            renderSlot(n.$slots, "hue-range-input-label", {}, () => [
              createTextVNode("Hue")
            ])
          ]),
      ...
      createBaseVNode("button", {
        ...
        renderSlot(n.$slots, "copy-button", {}, () => [
          Ot,
          St
        ])
      ]),
      createBaseVNode("div", Rt, [
        createBaseVNode("div", jt, [
          c.value === "hex" ? (openBlock(), createElementBlock("label", {
            key: 0,
          ...
          ], 8, Wt)) : (openBlock(!0), createElementBlock(Fragment, { key: 1 }, renderList(nt.value, (a) => (openBlock(), createElementBlock("label", {
            ...
            createBaseVNode("span", Yt, toDisplayString(a.toUpperCase()), 1),
            createBaseVNode("input", {
        ...
        n.visibleFormats.length > 1 ? (openBlock(), createElementBlock("button", {
          key: 0,
          class: "vacp-format-switch-button",
          type: "button",
          onClick: st
        }, [
          renderSlot(n.$slots, "format-switch-button", {}, () => [
            Ut,
            qt
          ])
...
const formFooter_vue_vue_type_style_index_0_scoped_0c230106_lang = '';

const WizardFormFooter = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-0c230106"]]);
...
const _withScopeId$2 = (n) => (pushScopeId("data-v-3a5f87df"), n = n(), popScopeId(), n);
...
const _hoisted_5$2 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("div", { class: "upload-mask absolute inset-0 flex border-dashed border-2 border-gray-400 pointer-events-none justify-center" }, [
  /* @__PURE__ */ createBaseVNode("svg", {
    ...
    /* @__PURE__ */ createBaseVNode("path", { d: "M29,58A29,29,0,1,0,0,29,29,29,0,0,0,29,58ZM29,4A25,25,0,1,1,4,29,25,25,0,0,1,29,4Z" }),
    /* @__PURE__ */ createBaseVNode("polygon", { points: "27 22 27 44.4 31 44.4 31 22 41.7 31.1 44.3 28.1 29 15 13.7 28.1 16.3 31.1 27 22" })
  ])
], -1));
const _hoisted_6$2 = { class: "text-gray-500 text-xs mb-1" };
const _hoisted_7$2 = { key: 1 };
const _hoisted_8$2 = { class: "text-base font-bold" };
const _hoisted_9$2 = {
  class: "mb-0.5",
  "data-type": "url"
};
const _hoisted_10$1 = ["value", "aria-label"];
const _hoisted_11 = {
  key: 0,
  class: "text-red-900 text-xs"
};
const _hoisted_12 = { key: 2 };
const _hoisted_13 = { class: "text-base font-bold" };
const _hoisted_14 = {
...
const _hoisted_18 = ["size", "value", "aria-label"];
...
const _hoisted_24 = { class: "text-base font-bold" };
const _hoisted_25 = { key: 4 };
const _hoisted_26 = { class: "text-base font-bold" };
const _hoisted_27 = { class: "relative mb-0.5" };
const _hoisted_28 = ["value", "aria-label"];
const _hoisted_29 = {
  key: 0,
  class: "text-red-900 text-xs"
};
  ...
  setup(__props, { emit }) {
    ...
    if (props.defaultOption && props.modelValue === "" && props.options.length) {
      ...
      if (props.name === "latField") {
        ...
        const latCandidate = props.options.find(
          (option) => latNames.test(option.label)
        );
        defaultValue = latCandidate?.value || defaultValue;
      } else if (props.name === "longField") {
        const longNames = new RegExp(/^(x|long.*)$/i);
        const longCandidate = props.options.find(
          (option) => longNames.test(option.label)
        );
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        __props.type === "file" ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
          ...
          createBaseVNode("div", _hoisted_6$2, toDisplayString(__props.help), 1)
        ])) : __props.type === "url" ? (openBlock(), createElementBlock("div", _hoisted_7$2, [
          createBaseVNode("label", _hoisted_8$2, toDisplayString(__props.label), 1),
          ...
          urlError.value ? (openBlock(), createElementBlock("div", _hoisted_11, toDisplayString(__props.modelValue ? __props.validationMessages?.invalid : __props.validationMessages?.required), 1)) : createCommentVNode("", true)
        ])) : __props.type === "select" ? (openBlock(), createElementBlock("div", _hoisted_12, [
          createBaseVNode("label", _hoisted_13, toDisplayString(__props.label), 1),
          createBaseVNode("div", _hoisted_14, [
            __props.multiple ? (openBlock(), createElementBlock("div", _hoisted_15, [
              createBaseVNode("div", {
                ref_key: "treeWrapper",
                ref: treeWrapper
              }, [
              ...
              __props.validation && sublayersError.value ? (openBlock(), createElementBlock("div", _hoisted_16, toDisplayString(__props.validationMessages?.required), 1)) : createCommentVNode("", true)
              ...
              __props.validation && __props.formatError ? (openBlock(), createElementBlock("div", _hoisted_20, toDisplayString(__props.validationMessages?.invalid), 1)) : createCommentVNode("", true),
              __props.validation && __props.failureError ? (openBlock(), createElementBlock("div", _hoisted_21, toDisplayString(__props.validationMessages?.failure), 1)) : createCommentVNode("", true)
            ]))
          ])
        ])) : __props.type === "checkbox" ? (openBlock(), createElementBlock("div", _hoisted_22, [
          createBaseVNode("input", {
          ...
          createBaseVNode("label", _hoisted_24, toDisplayString(__props.label), 1)
        ])) : (openBlock(), createElementBlock("div", _hoisted_25, [
          createBaseVNode("label", _hoisted_26, toDisplayString(__props.label), 1),
          ...
          __props.validation && !__props.modelValue ? (openBlock(), createElementBlock("div", _hoisted_29, toDisplayString(__props.validationMessages?.required), 1)) : createCommentVNode("", true)
        ]))
      ], 512);
    };
  }
...
const formInput_vue_vue_type_style_index_0_scoped_3a5f87df_lang = '';

const WizardInput = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-3a5f87df"]]);

const _withScopeId$1 = (n) => (pushScopeId("data-v-61104803"), n = n(), popScopeId(), n);
...
const _hoisted_4$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  height: "100%",
  width: "100%",
  ...
  /* @__PURE__ */ createBaseVNode("g", { id: "check_circle" }, [
    /* @__PURE__ */ createBaseVNode("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" })
  ])
], -1));
const _hoisted_5$1 = [
  _hoisted_4$1
];
const _hoisted_6$1 = { class: "flex flex-col overflow-hidden" };
const _hoisted_7$1 = { class: "pl-12 flex items-center text-md" };
const _hoisted_8$1 = { class: "pl-12 text-xs transition-opacity duration-1000 ease-out" };
const _hoisted_9$1 = { class: "pl-36" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          }, toDisplayString(index.value + 1), 3)) : (openBlock(), createElementBlock("div", _hoisted_3$1, _hoisted_5$1)),
          createBaseVNode("div", _hoisted_6$1, [
            createBaseVNode("div", _hoisted_7$1, toDisplayString(__props.title), 1),
...
const stepperItem_vue_vue_type_style_index_0_scoped_61104803_lang = '';

const StepperItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-61104803"]]);
...
const _withScopeId = (n) => (pushScopeId("data-v-d8382d08"), n = n(), popScopeId(), n);
const _hoisted_1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "block text-center mb-10" }, "or", -1));
const _hoisted_2 = {
  key: 0,
...
const _hoisted_4 = { class: "px-5 text-xs" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const onSelectContinue = async (event) => {
      ...
      displayFormat.value = isFileLayer() ? fileTypeOptions.find(
        (element) => element.value === typeSelection.value
      )?.label : serviceTypeOptions.find(
        (element) => element.value === typeSelection.value
      )?.label;
      try {
        layerInfo.value = isFileLayer() ? await layerSource.value.fetchFileInfo(
          url.value,
          typeSelection.value,
          fileData.value
    ...
    const updateNested = (isNested) => {
      ...
      if (typeSelection.value === LayerType.MAPIMAGE) {
        ...
        if (wizardStore.nested)
          populateNested(layerInfo, previouslySelected);
        else
          populateFlat(layerInfo, previouslySelected);
        ...
        const previouslySelected = new Set(
          (layerInfo.value?.config?.sublayers ?? []).map((sl) => sl.id)
        );
        if (wizardStore.nested)
          populateNestedWMS(layerInfo, previouslySelected);
        else
          populateFlatWMS(layerInfo, previouslySelected);
      }
    ...
    const populateNested = (layerInfo2, previouslySelected) => {
      ...
      const addSelectedValues = (parentId) => {
        if (!allChildrenSelected(parentId)) {
          ...
          selectedValues.value.push(parentId);
      };
      for (const parentId of parentChildMap.keys())
        addSelectedValues(parentId);
      for (const rawLayer of layerInfo2.value.layersRaw) {
    ...
    const populateNestedWMS = (layerInfo2, previouslySelected) => {
      const allDescendantsSelected = (layer) => {
        ...
        return layer.layers.every(
          (child) => allDescendantsSelected(child)
        );
      };
      const addSelectedLayerNames = (layer) => {
        if (allDescendantsSelected(layer))
          ...
          layer.layers.forEach(addSelectedLayerNames);
      };
      const topLayer = layerInfo2.value.layersRaw[0];
      if (topLayer && topLayer.layers) {
        topLayer.layers.forEach(
          (parentLayer) => addSelectedLayerNames(parentLayer)
        );
      }
      selectedValues.value = Array.from(new Set(selectedValues.value));
    };
    const populateFlat = (layerInfo2, previouslySelected) => {
      const lowestChildren = (parentId) => {
        const children = layerInfo2.value.layersRaw.filter(
          (rl) => rl.parentLayerId === parentId
        );
        if (children.length > 0) {
          for (const child of children) {
            if (previouslySelected.has(child.id))
              ...
              lowestChildren(child.id);
          }
        } else
          selectedValues.value.push(parentId);
      };
      for (const rawLayer of layerInfo2.value.layersRaw)
        if (previouslySelected.has(rawLayer.id))
          lowestChildren(rawLayer.id);
      selectedValues.value = Array.from(new Set(selectedValues.value));
    };
        ...
        content: withCtx(() => [
              ...
              createVNode(StepperItem, {
                ...
                default: withCtx(() => [
                  createBaseVNode("form", {
                    ...
                    IsCorsRequired.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
                      _hoisted_3,
                      createBaseVNode("span", _hoisted_4, toDisplayString(unref(t)("wizard.format.info.cors")), 1)
                    ...
                    createVNode(WizardInput, {
                      ...
                      "validation-messages": {
                        ...
                        )}.${IsCorsRequired.value ? " " + unref(t)("wizard.format.warn.cors") + "." : ""}${" " + unref(t)("wizard.format.warn.vpn") + "."}`
                      },
              ...
              createVNode(StepperItem, {
                ...
                default: withCtx(() => [
                  createBaseVNode("form", {
                    ...
                    layerInfo.value?.configOptions.includes(
                      `tooltipField`
                    ...
                    layerInfo.value?.configOptions.includes(`sublayers`) ? (openBlock(), createElementBlock("div", _hoisted_5, [
                      createVNode(WizardInput, {
                        type: "checkbox",
                        name: "nested",
                    ...
                    }, toDisplayString(unref(t)("wizard.configure.colour.hex")), 9, _hoisted_6),
                    layerInfo.value?.configOptions.includes("colour") ? (openBlock(), createElementBlock("label", _hoisted_7, toDisplayString(unref(t)("wizard.configure.colour.label")), 1)) : createCommentVNode("", true),
                    layerInfo.value?.configOptions.includes("colour") ? (openBlock(), createBlock(unref(Xt), {
                      key: 7,
                      "alpha-channel": "hide",
                      "visible-formats": ["hex"],
                      "default-format": "hex",
                      ...
                      "hue-range-input-label": withCtx(() => [
                        createBaseVNode("span", _hoisted_8, toDisplayString(unref(t)("wizard.configure.colour.hue")), 1)
                      ]),
                      "copy-button": withCtx(() => [
                        createBaseVNode("span", _hoisted_9, toDisplayString(unref(t)("wizard.configure.colour.copy")), 1),
                        _hoisted_10
                      ]),
                      _: 1
          ...
          layerReady.value ? (openBlock(), createElementBlock("div", {
            ...
            class: normalizeClass([
              ...
              layerUploaded.value ? "bg-green-100 !border-green-900" : "bg-red-100 !border-red-900"
            ])
...
const screen_vue_vue_type_style_index_0_scoped_d8382d08_lang = '';

const WizardScreenV = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d8382d08"]]);
