import { bB as FixtureInstance, nP as useDetailsStore, nQ as ReactiveIdentifyFactory, bG as defineComponent, bJ as ref, bK as onMounted, bP as openBlock, bX as createElementBlock, fH as createBaseVNode, bY as Fragment, bZ as renderList, fG as normalizeClass, iM as normalizeStyle, fL as createCommentVNode, bT as toDisplayString, i8 as pushScopeId, i9 as popScopeId, ia as _export_sfc, bM as computed, bO as resolveDirective, bW as withDirectives, bV as createVNode, ip as withModifiers, lC as useLayerStore, fJ as onBeforeMount, fK as watch, bL as onBeforeUnmount, bQ as createBlock, bH as useI18n, bI as inject, nR as linkifyHtml, bU as unref, kN as resolveDynamicComponent, iG as LayerType, nS as GeometryType, fO as GlobalEvents, bS as createTextVNode, bN as resolveComponent, bR as withCtx, he as markRaw, hf as useAppbarStore } from './main-a010f0a1.js';
import { H as HilightMode } from './hilight-defs-7930cd91.js';
import { T as ToggleSwitchControl } from './toggle-switch-control-d33b47a9.js';
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-8627eab6"), n = n(), popScopeId(), n);
const _hoisted_1$7 = {
  key: 0,
  class: "relative"
};
          ...
          stack.value.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_2$6, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(stack.value.slice(0, 3).reverse(), (item, idx) => {
              return openBlock(), createElementBlock("div", {
                ...
                }, null, 8, _hoisted_3$3)) : stack.value[idx].imgUrl ? (openBlock(), createElementBlock("img", {
                  key: 1,
                  class: "symbologyIcon w-28 h-28",
...
const symbologyStack_vue_vue_type_style_index_0_scoped_8627eab6_lang = '';

const SymbologyStack = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-8627eab6"]]);
...
const _hoisted_8$1 = ["content", "innerHTML"];
...
const _withScopeId = (n) => (pushScopeId("data-v-4df2db6a"), n = n(), popScopeId(), n);
const _hoisted_1$1 = {
  key: 0,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getLayerIdentifyItems = () => {
      const results = props.results.find((layerResult) => {
    ...
    const updateHighlight = () => {
      ...
      if (hilightToggle.value && isLayerResultLoaded && resultItems.length > 0 && canHighlight.value) {
        if (showList.value) {
    ...
    return (_ctx, _cache) => {
      ...
      return isLayerResultLoaded.value && activeGreedy.value === 0 ? (openBlock(), createElementBlock("div", {
        ...
        layerExists.value && getLayerIdentifyItems().length > 1 && !showList.value ? (openBlock(), createElementBlock("div", _hoisted_4, [
          createBaseVNode("div", _hoisted_5, [
            ...
            createBaseVNode("div", _hoisted_7, [
              ...
              withDirectives((openBlock(), createElementBlock("button", {
                ...
                disabled: currentIdx.value === getLayerIdentifyItems().length - 1
        ...
        layerExists.value ? (openBlock(), createElementBlock("div", _hoisted_15, [
          getLayerIdentifyItems().length > 0 ? (openBlock(), createElementBlock("div", _hoisted_16, [
            showList.value ? withDirectives((openBlock(), createElementBlock("div", _hoisted_17, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(getLayerIdentifyItems(), (item, idx) => {
                return withDirectives((openBlock(), createElementBlock("button", {
          ...
          ])) : (openBlock(), createElementBlock("div", _hoisted_19, toDisplayString(unref(t)("details.layers.results.empty.currentLayer")), 1))
...
const resultList_vue_vue_type_style_index_0_scoped_4df2db6a_lang = '';

const ResultList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4df2db6a"]]);
            ...
            createBaseVNode("div", _hoisted_2, [
              !noResults.value ? (openBlock(), createBlock(ResultList, {
                ...
                class: normalizeClass([
                  "text-center",
                  { "ml-42": layerResults.value.length > 1 }
                ])
...
const detailsScreen_vue_vue_type_style_index_0_scoped_4aff5458_lang = '';

const DetailsScreenV = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4aff5458"]]);
