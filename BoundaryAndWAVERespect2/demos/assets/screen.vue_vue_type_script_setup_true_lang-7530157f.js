import { bG as defineComponent, bH as useI18n, fE as usePanelStore, fF as useExportStore, bM as computed, bN as resolveComponent, bO as resolveDirective, bW as withDirectives, bP as openBlock, bQ as createBlock, bR as withCtx, bX as createElementBlock, bZ as renderList, fG as normalizeClass, fH as createBaseVNode, bT as toDisplayString, bU as unref, bY as Fragment, bI as inject, bJ as ref, fI as debounce, fJ as onBeforeMount, fK as watch, bK as onMounted, bL as onBeforeUnmount, bS as createTextVNode, fL as createCommentVNode, fM as getCurrentInstance } from './main-a010f0a1.js';

const _hoisted_1$1 = /* @__PURE__ */ createBaseVNode("div", { class: "flex items-center text-gray-400 w-full h-full hover:text-black p-4 sm:p-8" }, [
...
const _hoisted_2$1 = ["onClick", "aria-label"];
const _hoisted_3$1 = { class: "md-icon-small inline" };
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("g", null, [
...
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("div", { class: "overflow-hidden border border-gray-200" }, [
  /* @__PURE__ */ createBaseVNode("canvas", { class: "export-canvas !w-[100%]" })
], -1);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const watchers = ref([]);
    const el = computed(() => getCurrentInstance()?.proxy?.$el);
