import { bG as defineComponent, bH as useI18n, bI as inject, bM as computed, bN as resolveComponent, bP as openBlock, bQ as createBlock, bR as withCtx, fH as createBaseVNode, fG as normalizeClass, bU as unref, fL as createCommentVNode, ia as _export_sfc, bX as createElementBlock, mw as detectOverflow, bJ as ref, bK as onMounted, bL as onBeforeUnmount, bO as resolveDirective, bW as withDirectives, i7 as vShow, it as renderSlot, mx as createPopper, i8 as pushScopeId, i9 as popScopeId, my as useNotificationStore, bT as toDisplayString, fE as usePanelStore, hf as useAppbarStore, fJ as onBeforeMount, mz as onUpdated, mA as nextTick, bY as Fragment, bZ as renderList, kN as resolveDynamicComponent, bV as createVNode, mB as AboutRampDropdown, fM as getCurrentInstance, bB as FixtureInstance, fO as GlobalEvents } from './main-a010f0a1.js';
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-de544fde"), n = n(), popScopeId(), n);
...
const moreButton_vue_vue_type_style_index_0_scoped_de544fde_lang = '';

const MoreButton = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-de544fde"]]);

const _withScopeId = (n) => (pushScopeId("data-v-830e6165"), n = n(), popScopeId(), n);
const _hoisted_1$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(temporaryItems.value?.filter(
          (t2) => overflowFlags.value[`${t2}-temp`] !== true
        ), (item) => {
        ...
        withDirectives(createVNode(MoreButton, { id: "more" }, {
          default: withCtx(() => [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(temporaryItems.value?.filter(
              (t2) => overflowFlags.value[`${t2}-temp`]
            ), (item) => {
              return openBlock(), createBlock(_sfc_main$4, {
                panelId: item,
                minimize: true,
