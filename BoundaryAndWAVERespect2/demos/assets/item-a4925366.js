import { bG as defineComponent, bH as useI18n, bJ as ref, bK as onMounted, bO as resolveDirective, bP as openBlock, bX as createElementBlock, bW as withDirectives, fH as createBaseVNode, bU as unref, ip as withModifiers, iq as withKeys, fG as normalizeClass, iF as LegendItem, iE as LayerItem, lA as CoreFilter, bI as inject, fE as usePanelStore, bM as computed, lB as LayerControl, kU as toRaw, bN as resolveComponent, bV as createVNode, bR as withCtx, bS as createTextVNode, bT as toDisplayString, fO as GlobalEvents, i8 as pushScopeId, i9 as popScopeId, ia as _export_sfc, bY as Fragment, bZ as renderList, iM as normalizeStyle, fL as createCommentVNode, lC as useLayerStore, fK as watch, lD as LegendType, lE as LegendControl, bQ as createBlock, iD as SectionItem, lF as InfoType, kN as resolveDynamicComponent, lG as to, lH as createStaticVNode } from './main-a010f0a1.js';
...
const _withScopeId$2 = (n) => (pushScopeId("data-v-46ecfef6"), n = n(), popScopeId(), n);
const _hoisted_1$2 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createBaseVNode("div", { class: "flex p-4 justify-center items-center" }, [
...
const legendOptions_vue_vue_type_style_index_0_scoped_46ecfef6_lang = '';

const LegendOptions = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-46ecfef6"]]);
...
const SymbologyStack = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7bc13719"]]);

const _withScopeId = (n) => (pushScopeId("data-v-d86f40b5"), n = n(), popScopeId(), n);
...
const _hoisted_5 = /* @__PURE__ */ createStaticVNode('<path d="M0 0h24v24H0V0z" fill="none" data-v-d86f40b5></path><path d="M0 0h24v24H0V0z" fill="none" data-v-d86f40b5></path><circle cx="15.5" cy="9.5" r="1.5" data-v-d86f40b5></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-d86f40b5></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-d86f40b5></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-d86f40b5></circle><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-2.5c2.33 0 4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2s-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5z" data-v-d86f40b5></path>', 7);
const _hoisted_12 = [
  _hoisted_5
];
const _hoisted_13 = {
...
const _hoisted_14 = /* @__PURE__ */ createStaticVNode('<path d="M0 0h24v24H0V0z" fill="none" data-v-d86f40b5></path><path d="M0 0h24v24H0V0z" fill="none" data-v-d86f40b5></path><circle cx="15.5" cy="9.5" r="1.5" data-v-d86f40b5></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-d86f40b5></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-d86f40b5></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-d86f40b5></circle><path d="M 20,12C 20,7.6 16.4,4 12,4C 7.6,4 4,7.6 4,12C 4,16.4 7.6,20 12,20C 16.4,20 20,16.4 20,12 Z M 22,12C 22,17.5 17.5,22 12,22C 6.5,22 2,17.5 2,12C 2,6.5 6.5,2.00001 12,2.00001C 17.5,2.00001 22,6.5 22,12 Z M 15.5,8C 16.3,8 17,8.7 17,9.5C 17,10.3 16.3,11 15.5,11C 14.7,11 14,10.3 14,9.5C 14,8.7 14.7,8 15.5,8 Z M 10,9.5C 10,10.3 9.3,11 8.5,11C 7.7,11 7,10.3 7,9.5C 7,8.7 7.7,8 8.5,8C 9.3,8 10,8.7 10,9.5 Z M 12,14C 13.7524,14 15.2943,14.7212 16.1871,15.8129L 14.7697,17.2302C 14.3175,16.5078 13.2477,16 12,16C 10.7523,16 9.68254,16.5078 9.23024,17.2302L 7.81291,15.8129C 8.7057,14.7212 10.2476,14 12,14 Z" data-v-d86f40b5></path>', 7);
const _hoisted_21 = [
  _hoisted_14
];
...
const _hoisted_34 = ["content", "onClick", "aria-label"];
const _hoisted_35 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "flex p-8" }, [
  /* @__PURE__ */ createBaseVNode("svg", {
...
const _hoisted_38 = ["content", "onClick", "aria-label"];
const _hoisted_39 = { class: "flex p-8" };
const _hoisted_40 = {
  key: 0,
...
const _hoisted_44 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("path", { d: "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z" }, null, -1));
const _hoisted_45 = [
  _hoisted_44
];
const _hoisted_46 = ["content"];
const _hoisted_47 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
...
const _hoisted_49 = ["content"];
const _hoisted_50 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  height: "18",
...
const _hoisted_53 = ["content"];
const _hoisted_54 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
  class: "m-auto",
  xmlns: "http://www.w3.org/2000/svg",
  height: "18",
  viewBox: "0 0 24 24",
...
const _hoisted_57 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "progress-line" }, null, -1));
const _hoisted_58 = [
  _hoisted_57
];
const _hoisted_59 = {
...
const _hoisted_72 = { class: "flex-1 ml-15" };
const _hoisted_73 = { key: 1 };
const _hoisted_74 = { class: "flex p-5 ml-48" };
const _hoisted_75 = {
  key: 0,
  class: "relative animate-spin spinner h-20 w-20 mr-10 pt-2"
};
const _hoisted_76 = { class: "flex-1 text-gray-500" };
const _hoisted_77 = {
  key: 1,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const reloadIfReady = () => {
      ...
      if (props.legendItem._loadCancelled) {
        const readyWatcher = setInterval(() => {
          if (props.legendItem.layer) {
            Promise.allSettled([
              props.legendItem.layer.loadPromise
            ]).then(() => {
    ...
    const reloadLayer = () => {
      setTimeout(() => {
        props.legendItem._loadCancelled = false;
        if (props.legendItem.layer !== void 0) {
          toRaw(props.legendItem.layer).reload();
        } else {
          const layerConfig = props.legendItem.layerIdx === void 0 || props.legendItem.layerIdx === -1 ? layerConfigs.value.find(
            (lc) => lc.id === props.legendItem.layerId
          ) : layerConfigs.value.find(
            (lc) => lc.id === props.legendItem.parentLayerId
          );
    ...
    const cancelOrRemoveLayer = () => {
      ...
      if (layerItem.type === LegendType.Error) {
        ...
        props.legendItem._loadCancelled = true;
        const cancelWatcher = setInterval(() => {
          const parentLayer = iApi.geo.layer.allLayers().find(
            (l) => l.id === layerItem.parentLayerId || l.id === layerItem.layerId
          );
          if (parentLayer) {
            clearInterval(cancelWatcher);
            const layerItemToCancel = iApi.fixture.get("legend")?.getLayerItem(parentLayer);
            if (layerItemToCancel) {
              layerItemToCancel.error();
              layerItemToCancel._loadCancelled = true;
            }
            parentLayer.sublayers?.forEach((sl) => {
              const sublayerItemToCancel = iApi.fixture.get("legend")?.getLayerItem(sl);
      ...
      return !__props.legendItem.hidden ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1, [
          withDirectives((openBlock(), createElementBlock("div", {
            ...
            ]) : __props.legendItem instanceof unref(SectionItem) ? (openBlock(), createElementBlock("div", _hoisted_27, [
              __props.legendItem.infoType === unref(InfoType).Title && __props.legendItem.content ? (openBlock(), createElementBlock("h3", _hoisted_28, toDisplayString(__props.legendItem.content), 1)) : __props.legendItem.infoType === unref(InfoType).Title ? (openBlock(), createElementBlock("h3", _hoisted_29, toDisplayString(__props.legendItem.name), 1)) : __props.legendItem.infoType === unref(InfoType).Text ? (openBlock(), createElementBlock("p", _hoisted_30, toDisplayString(__props.legendItem.content), 1)) : __props.legendItem.infoType === unref(InfoType).Image ? (openBlock(), createElementBlock("img", {
                key: 3,
                src: __props.legendItem.content,
                alt: "InfoType image not found :("
              }, null, 8, _hoisted_31)) : __props.legendItem.infoType === unref(InfoType).Markdown ? (openBlock(), createElementBlock("div", {
                key: 4,
                class: "ramp-markdown",
                innerHTML: markdownToHtml(__props.legendItem.content)
              }, null, 8, _hoisted_32)) : (openBlock(), createBlock(resolveDynamicComponent(`${__props.legendItem.uid}-info-section`), { key: 5 }))
            ])) : createCommentVNode("", true),
            __props.legendItem.type === unref(LegendType).Error ? (openBlock(), createElementBlock("div", _hoisted_33, [
              withDirectives((openBlock(), createElementBlock("button", {
                type: "button",
                ...
                onClick: withModifiers(reloadIfReady, ["stop"]),
                "aria-label": unref(t)("legend.layer.controls.reload")
            ...
            __props.legendItem.type !== unref(LegendType).Item && __props.legendItem instanceof unref(LayerItem) ? (openBlock(), createElementBlock("div", _hoisted_37, [
              withDirectives((openBlock(), createElementBlock("button", {
                type: "button",
                class: "text-gray-500 hover:text-black",
                ...
                createBaseVNode("div", _hoisted_39, [
                  __props.legendItem.type === unref(LegendType).Placeholder ? (openBlock(), createElementBlock("svg", _hoisted_40, _hoisted_42)) : (openBlock(), createElementBlock("svg", _hoisted_43, _hoisted_45))
                ])
              ], 40, _hoisted_38)), [
                [_directive_tippy, {
                  placement: "top-start"
            ...
            __props.legendItem.type === unref(LegendType).Item && __props.legendItem instanceof unref(LayerItem) && !__props.legendItem.layer?.mapLayer ? withDirectives((openBlock(), createElementBlock("div", {
              ...
              "focus-icon": ""
            }, _hoisted_51, 40, _hoisted_49)), [
              [_directive_tippy, {
                placement: "top-end"
              }]
            ]) : createCommentVNode("", true),
            __props.legendItem.type === unref(LegendType).Item && __props.legendItem instanceof unref(LayerItem) && __props.legendItem.layerOffscale ? (openBlock(), createElementBlock("div", _hoisted_52, [
              withDirectives((openBlock(), createElementBlock("button", {
                type: "button",
                class: "p-4",
          ...
          __props.legendItem.type === unref(LegendType).Placeholder || __props.legendItem instanceof unref(LayerItem) && __props.legendItem.layerRedrawing && __props.legendItem.visibility ? (openBlock(), createElementBlock("div", _hoisted_56, _hoisted_58)) : createCommentVNode("", true)
        ]),
        __props.legendItem instanceof unref(LayerItem) && __props.legendItem.symbologyExpanded ? withDirectives((openBlock(), createElementBlock("div", _hoisted_59, [
          symbologyStack.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_60, [
            __props.legendItem instanceof unref(LayerItem) && __props.legendItem.description ? (openBlock(), createElementBlock("p", _hoisted_61, toDisplayString(__props.legendItem.description), 1)) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(symbologyStack.value, (item) => {
              return openBlock(), createElementBlock("div", {
                class: "m-5",
                key: item.uid
              }, [
                item.imgUrl && __props.legendItem.symbologyRenderStyle === "images" || !item.imgUrl && layerType.value === "ogc-wms" ? (openBlock(), createElementBlock("div", _hoisted_62, [
                  item.imgUrl ? (openBlock(), createElementBlock("div", _hoisted_63, [
                    createBaseVNode("img", {
                      class: "max-w-full",
                      src: item.imgUrl
                    }, null, 8, _hoisted_64)
                  ...
                  }, null, 8, _hoisted_65)) : createCommentVNode("", true),
                  item.label ? withDirectives((openBlock(), createElementBlock("div", _hoisted_66, [
                  ...
                  item.imgUrl ? (openBlock(), createElementBlock("div", _hoisted_68, [
                    createBaseVNode("img", {
                      class: "w-32 h-32",
                      src: item.imgUrl
                    }, null, 8, _hoisted_69)
                  ])) : item.svgcode ? (openBlock(), createElementBlock("div", _hoisted_70, [
                    createBaseVNode("span", {
                      innerHTML: item.svgcode
                    }, null, 8, _hoisted_71)
                  ])) : createCommentVNode("", true),
                  withDirectives((openBlock(), createElementBlock("div", _hoisted_72, [
          ...
          !symbologyStackLoaded.value ? (openBlock(), createElementBlock("div", _hoisted_73, [
            withDirectives((openBlock(), createElementBlock("div", _hoisted_74, [
              isAnimationEnabled.value ? (openBlock(), createElementBlock("div", _hoisted_75)) : createCommentVNode("", true),
        ...
        __props.legendItem.expanded ? (openBlock(), createElementBlock("div", _hoisted_77, [
...
const item_vue_vue_type_style_index_0_scoped_d86f40b5_lang = '';

const item = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d86f40b5"]]);
