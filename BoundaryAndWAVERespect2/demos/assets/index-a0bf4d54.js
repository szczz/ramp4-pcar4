import { iU as commonjsGlobal, iV as getDefaultExportFromCjs, bB as FixtureInstance, fF as useExportStore, he as markRaw, hf as useAppbarStore } from './main-a010f0a1.js';
import { f as fabric } from './fabric-833a342e.js';
import { _ as _sfc_main } from './screen.vue_vue_type_script_setup_true_lang-7530157f.js';
...
class ExportAPI extends FixtureInstance {
  ...
  async make(canvas, panelWidth) {
    ...
    if (this.customRendererFunc) {
      ...
      const fbGroup = new fabric.fabric.Group(
