import { bG as defineComponent, bH as useI18n, bI as inject, bO as resolveDirective, bP as openBlock, bX as createElementBlock, bW as withDirectives, fG as normalizeClass, bU as unref, fH as createBaseVNode, fL as createCommentVNode, bT as toDisplayString, ip as withModifiers, iq as withKeys, i7 as vShow, fP as Extent, i8 as pushScopeId, i9 as popScopeId, ia as _export_sfc, hd as useAreasOfInterestStore, bM as computed, bJ as ref, bK as onMounted, bN as resolveComponent, bQ as createBlock, bR as withCtx, bS as createTextVNode, bY as Fragment, bZ as renderList, bV as createVNode } from './main-a010f0a1.js';

const _withScopeId = (n) => (pushScopeId("data-v-6666d0e3"), n = n(), popScopeId(), n);
...
const item_vue_vue_type_style_index_0_scoped_6666d0e3_lang = '';

const AreaItem = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6666d0e3"]]);
