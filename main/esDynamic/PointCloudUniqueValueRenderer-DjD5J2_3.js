import { O as e, P as t, Q as r, bX as f, f9 as R, dY as m, m2 as D, aa as o, aM as N, g$ as O, m4 as z, m5 as K } from "./main-lm2DHsZh.js";
var w;
...
const k = c, v = new R({ pointCloudFixedSizeAlgorithm: "fixed-size", pointCloudSplatAlgorithm: "splat" });
...
const q = h, A = { key: "type", base: P, typeMap: { "fixed-size": B, splat: q } }, T = D()({ pointCloudClassBreaksRenderer: "point-cloud-class-breaks", pointCloudRGBRenderer: "point-cloud-rgb", pointCloudStretchRenderer: "point-cloud-stretch", pointCloudUniqueValueRenderer: "point-cloud-unique-value" });
let l = class extends f {
  constructor(I) {
    super(I), this.type = void 0, this.pointSizeAlgorithm = null, this.colorModulation = null, this.pointsPerInch = 10;
  }
  clone() {
...
e([t({ type: T.apiValues, readOnly: !0, nonNullable: !0, json: { type: T.jsonValues, read: !1, write: T.write } })], l.prototype, "type", void 0), e([t({ types: A, json: { write: !0 } })], l.prototype, "pointSizeAlgorithm", void 0), e([t({ type: k, json: { write: !0 } })], l.prototype, "colorModulation", void 0), e([t({ json: { write: !0 }, nonNullable: !0, type: Number })], l.prototype, "pointsPerInch", void 0), l = e([r("esri.renderers.PointCloudRenderer")], l), function(s) {
  s.fieldTransformTypeKebabDict = new R({ none: "none", lowFourBit: "low-four-bit", highFourBit: "high-four-bit", absoluteValue: "absolute-value", moduloTen: "modulo-ten" });
}(l || (l = {}));
const i = l;
var j;
...
let u = $ = class extends f {
  ...
  clone() {
    return new $({ description: this.description, label: this.label, values: o(this.values), color: o(this.color) });
  }
};
e([t({ type: String, json: { write: !0 } })], u.prototype, "description", void 0), e([t({ type: String, json: { write: !0 } })], u.prototype, "label", void 0), e([t({ type: [String], json: { write: !0 } })], u.prototype, "values", void 0), e([t({ type: N, json: { type: [O], write: !0 } })], u.prototype, "color", void 0), u = $ = e([r("esri.renderers.support.pointCloud.ColorUniqueValueInfo")], u);
const F = u;
var x;
let d = x = class extends i {
  constructor(s) {
  ...
  clone() {
    return new x({ ...this.cloneProperties(), field: o(this.field), fieldTransformType: o(this.fieldTransformType), colorUniqueValueInfos: o(this.colorUniqueValueInfos), legendOptions: o(this.legendOptions) });
  }
};
e([m({ pointCloudUniqueValueRenderer: "point-cloud-unique-value" })], d.prototype, "type", void 0), e([t({ json: { write: !0 }, type: String })], d.prototype, "field", void 0), e([t({ type: i.fieldTransformTypeKebabDict.apiValues, json: { type: i.fieldTransformTypeKebabDict.jsonValues, read: i.fieldTransformTypeKebabDict.read, write: i.fieldTransformTypeKebabDict.write } })], d.prototype, "fieldTransformType", void 0), e([t({ type: [F], json: { write: !0 } })], d.prototype, "colorUniqueValueInfos", void 0), e([t({ type: z, json: { write: !0 } })], d.prototype, "legendOptions", void 0), d = x = e([r("esri.renderers.PointCloudUniqueValueRenderer")], d);
const Y = d;
export {
  Y as a,
  X as b,
...
//# sourceMappingURL=PointCloudUniqueValueRenderer-DjD5J2_3.js.map
