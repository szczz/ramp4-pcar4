import { y as l, u as o, i as a, c as p, l as c, p as _, o as y, m as F, T as m, h as g, a as w, b, d as v, A as E, O as x, x as A, g as T, w as H, E as I, L as M, B as $, F as O, I as k, U as D, j as z, V as B, M as G, S as V, k as j, q as C, v as q, z as J, C as K, D as N, G as S, H as P } from "./BufferView-BrHhkajr.js";
import { e as f } from "./types-ChhhI6OU.js";
import { s as Q } from "./Util-DTOy4PKT.js";
class h {
  constructor(t, e) {
...
class et {
  constructor(t) {
    this.fields = new Array(), t.fields.forEach((e, s) => {
      const i = { ...e, constructor: L(e.constructor) };
      this.fields.push([s, i]);
    }), this.stride = t.stride;
  }
}
const R = [l, o, a, p, c, _, y, F, m, g, w, b, v, E, x, A, T, H, I, M, $, O, k, D, z, B, G, V, j, C, q, J, K, N, S, P];
function L(n) {
...
R.forEach((n) => U.set(L(n), n));
export {
  tt as H,
  et as I
};
//# sourceMappingURL=InterleavedLayout-BGws9r5x.js.map
