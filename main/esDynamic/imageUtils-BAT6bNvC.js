import { ag as m, aJ as d, $ as u, M as w, s as p } from "./main-lm2DHsZh.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-Cpwgj1u8.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-C3bvNDLr.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-BAT6bNvC.js.map
