import { fH as D, fL as G, as as _ } from "./main-lm2DHsZh.js";
let k = class {
  constructor(e, t, s = 0, r, i) {
    this.TypedArrayConstructor = e, this.elementCount = 9;
    const f = this.TypedArrayConstructor;
    r === void 0 && (r = 9 * f.BYTES_PER_ELEMENT);
    const u = t.byteLength === 0 ? 0 : s;
    this.typedBuffer = i == null ? new f(t, u) : new f(t, u, (i - s) / f.BYTES_PER_ELEMENT), this.typedBufferStride = r / f.BYTES_PER_ELEMENT, this.count = Math.ceil(this.typedBuffer.length / this.typedBufferStride), this.stride = this.typedBufferStride * this.TypedArrayConstructor.BYTES_PER_ELEMENT;
  }
  sliceBuffer(e, t, s = this.count - t) {
    const r = this.typedBuffer.byteOffset + t * this.stride;
    return new e(this.buffer, r, this.stride, r + s * this.stride);
  }
  getMat(e, t) {
    let s = e * this.typedBufferStride;
    for (let r = 0; r < 9; r++) t[r] = this.typedBuffer[s++];
    return t;
  }
  setMat(e, t) {
    let s = e * this.typedBufferStride;
    for (let r = 0; r < 9; r++) this.typedBuffer[s++] = t[r];
  }
  get(e, t) {
    return this.typedBuffer[e * this.typedBufferStride + t];
  }
  set(e, t, s) {
    this.typedBuffer[e * this.typedBufferStride + t] = s;
  }
  copyFrom(e, t, s) {
    const r = this.typedBuffer, i = t.typedBuffer;
    let f = e * this.typedBufferStride, u = s * t.typedBufferStride;
    for (let p = 0; p < 9; ++p) r[f++] = i[u++];
  }
  get buffer() {
...
let q = class {
  constructor(e, t, s = 0, r, i) {
    this.TypedArrayConstructor = e, this.elementCount = 16;
    const f = this.TypedArrayConstructor;
    r === void 0 && (r = 16 * f.BYTES_PER_ELEMENT);
    const u = t.byteLength === 0 ? 0 : s;
    this.typedBuffer = i == null ? new f(t, u) : new f(t, u, (i - s) / f.BYTES_PER_ELEMENT), this.typedBufferStride = r / f.BYTES_PER_ELEMENT, this.count = Math.ceil(this.typedBuffer.length / this.typedBufferStride), this.stride = this.typedBufferStride * this.TypedArrayConstructor.BYTES_PER_ELEMENT;
  }
  sliceBuffer(e, t, s = this.count - t) {
  ...
  getMat(e, t) {
    let s = e * this.typedBufferStride;
    for (let r = 0; r < 16; r++) t[r] = this.typedBuffer[s++];
    return t;
  }
  setMat(e, t) {
    let s = e * this.typedBufferStride;
    for (let r = 0; r < 16; r++) this.typedBuffer[s++] = t[r];
  }
  get(e, t) {
    return this.typedBuffer[e * this.typedBufferStride + t];
  }
...
class y {
  constructor(e, t, s = 0, r, i) {
    ...
    const f = this.TypedArrayConstructor;
    r === void 0 && (r = f.BYTES_PER_ELEMENT);
    const u = t.byteLength === 0 ? 0 : s;
    this.typedBuffer = i == null ? new f(t, u) : new f(t, u, (i - s) / f.BYTES_PER_ELEMENT), this.stride = r, this.typedBufferStride = r / f.BYTES_PER_ELEMENT, this.count = Math.ceil(this.typedBuffer.length / this.typedBufferStride);
  }
  sliceBuffer(e, t, s = this.count - t) {
    const r = this.typedBuffer.byteOffset + t * this.stride;
    return new e(this.buffer, r, this.stride, r + s * this.stride);
...
let n = class {
  constructor(e, t, s = 0, r, i) {
    this.TypedArrayConstructor = e, this.elementCount = 2;
    const f = this.TypedArrayConstructor;
    r === void 0 && (r = 2 * f.BYTES_PER_ELEMENT);
    const u = t.byteLength === 0 ? 0 : s;
    this.typedBuffer = i == null ? new f(t, u) : new f(t, u, (i - s) / f.BYTES_PER_ELEMENT), this.typedBufferStride = r / f.BYTES_PER_ELEMENT, this.count = Math.ceil(this.typedBuffer.length / this.typedBufferStride), this.stride = this.typedBufferStride * this.TypedArrayConstructor.BYTES_PER_ELEMENT;
  }
  sliceBuffer(e, t, s = this.count - t) {
  ...
  getVec(e, t) {
    return e *= this.typedBufferStride, D(t, this.typedBuffer[e], this.typedBuffer[e + 1]);
  }
  setVec(e, t) {
    e *= this.typedBufferStride, this.typedBuffer[e++] = t[0], this.typedBuffer[e] = t[1];
  }
  get(e, t) {
    return this.typedBuffer[e * this.typedBufferStride + t];
  }
  ...
  setValues(e, t, s) {
    e *= this.typedBufferStride, this.typedBuffer[e++] = t, this.typedBuffer[e] = s;
  }
  copyFrom(e, t, s) {
    const r = this.typedBuffer, i = t.typedBuffer;
    let f = e * this.typedBufferStride, u = s * t.typedBufferStride;
...
let h = class {
  constructor(e, t, s = 0, r, i) {
    this.TypedArrayConstructor = e, this.elementCount = 3;
    const f = this.TypedArrayConstructor;
    r === void 0 && (r = 3 * f.BYTES_PER_ELEMENT);
    const u = t.byteLength === 0 ? 0 : s;
    this.typedBuffer = i == null ? new f(t, u) : new f(t, u, (i - s) / f.BYTES_PER_ELEMENT), this.typedBufferStride = r / f.BYTES_PER_ELEMENT, this.count = Math.ceil(this.typedBuffer.length / this.typedBufferStride), this.stride = this.typedBufferStride * this.TypedArrayConstructor.BYTES_PER_ELEMENT;
  }
  sliceBuffer(e, t, s = this.count - t) {
  ...
  getVec(e, t) {
    return e *= this.typedBufferStride, G(t, this.typedBuffer[e], this.typedBuffer[e + 1], this.typedBuffer[e + 2]);
  }
  setVec(e, t) {
    e *= this.typedBufferStride, this.typedBuffer[e++] = t[0], this.typedBuffer[e++] = t[1], this.typedBuffer[e] = t[2];
  }
  get(e, t) {
    return this.typedBuffer[e * this.typedBufferStride + t];
  }
  ...
  setValues(e, t, s, r) {
    e *= this.typedBufferStride, this.typedBuffer[e++] = t, this.typedBuffer[e++] = s, this.typedBuffer[e] = r;
  }
  copyFrom(e, t, s) {
    const r = this.typedBuffer, i = t.typedBuffer;
    let f = e * this.typedBufferStride, u = s * t.typedBufferStride;
    r[f++] = i[u++], r[f++] = i[u++], r[f] = i[u];
  }
  get buffer() {
    return this.typedBuffer.buffer;
  }
...
class c {
  constructor(e, t, s = 0, r, i) {
    this.TypedArrayConstructor = e, this.start = s, this.elementCount = 4;
    const f = this.TypedArrayConstructor;
    r === void 0 && (r = 4 * f.BYTES_PER_ELEMENT);
    const u = t.byteLength === 0 ? 0 : s;
    this.typedBuffer = i == null ? new f(t, u) : new f(t, u, (i - s) / f.BYTES_PER_ELEMENT), this.typedBufferStride = r / f.BYTES_PER_ELEMENT, this.count = Math.ceil(this.typedBuffer.length / this.typedBufferStride), this.stride = this.typedBufferStride * this.TypedArrayConstructor.BYTES_PER_ELEMENT;
  }
  sliceBuffer(e, t, s = this.count - t) {
  ...
  getVec(e, t) {
    return e *= this.typedBufferStride, _(t, this.typedBuffer[e++], this.typedBuffer[e++], this.typedBuffer[e++], this.typedBuffer[e]);
  }
  setVec(e, t) {
    e *= this.typedBufferStride, this.typedBuffer[e++] = t[0], this.typedBuffer[e++] = t[1], this.typedBuffer[e++] = t[2], this.typedBuffer[e] = t[3];
  }
  get(e, t) {
    return this.typedBuffer[e * this.typedBufferStride + t];
  }
  ...
  setValues(e, t, s, r, i) {
    e *= this.typedBufferStride, this.typedBuffer[e++] = t, this.typedBuffer[e++] = s, this.typedBuffer[e++] = r, this.typedBuffer[e] = i;
  }
  copyFrom(e, t, s) {
    const r = this.typedBuffer, i = t.typedBuffer;
    let f = e * this.typedBufferStride, u = s * t.typedBufferStride;
    r[f++] = i[u++], r[f++] = i[u++], r[f++] = i[u++], r[f] = i[u];
  }
  get buffer() {
    return this.typedBuffer.buffer;
  }
...
class $ extends h {
  ...
  static fromTypedArray(e, t) {
    return new $(e.buffer, e.byteOffset, t, e.byteOffset + e.byteLength);
  }
}
$.ElementType = "i8";
class v extends c {
...
//# sourceMappingURL=BufferView-BrHhkajr.js.map
