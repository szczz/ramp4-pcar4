import { jr as pe, js as me, c1 as ht, c4 as Y, iP as nt, f_ as Ot, c6 as Dt, cc as et, ci as dt, fV as B, cd as Pt, ce as Z, cg as ct, cf as N, ix as Et, c2 as It, iK as ve, iJ as ye, a1 as ge, hG as xt, ca as Nt, kW as be, c3 as ke, c5 as xe, g1 as ut, c8 as Se, cb as zt, lW as St } from "./main-lm2DHsZh.js";
import { r as we } from "./vue.esm-bundler-B-5KkXVU.js";
import { T as Pe } from "./toggle-switch-control-Cp5KoPz3.js";
var Tt = { exports: {} };
(function(C, L) {
  (function(j, y) {
    C.exports = y(we);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        var Zt = (V = {}, P(V, E.VALUE, 'The type of the "value" is illegal'), P(V, E.INTERVAL, 'The prop "interval" is invalid, "(max - min)" must be divisible by "interval"'), P(V, E.MIN, 'The "value" must be greater than or equal to the "min".'), P(V, E.MAX, 'The "value" must be less than or equal to the "max".'), P(V, E.ORDER, 'When "order" is false, the parameters "minRange", "maxRange", "fixed", "enabled" are invalid.'), V), Xt = function() {
          ...
          return Yt(t, [{ key: "setValue", value: function(e) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        var z = { None: 0, Drag: 2, Focus: 4 }, bt = 4, se = (0, i.defineComponent)({ name: "VueSlider", components: { VueSliderDot: X, VueSliderMark: tt }, emits: ["change", "drag-start", "dragging", "drag-end", "error", "update:modelValue"], data: function() {
          ...
          return this.control.processArray.map(function(e, n) {
            ...
            return { start: a, end: u, index: n, style: lt(lt((r = {}, W(r, t.isHorizontal ? "height" : "width", "100%"), W(r, t.isHorizontal ? "top" : "left", 0), W(r, t.mainDirection, "".concat(a, "%")), W(r, M, "".concat(u - a, "%")), W(r, "transitionProperty", "".concat(M, ",").concat(t.mainDirection)), W(r, "transitionDuration", "".concat(t.animateTime, "s")), r), t.processStyle), I) };
          });
        }, dotBaseStyle: function() {
          var t, e = Array.isArray(this.dotSize) ? this.dotSize : [this.dotSize, this.dotSize], n = yt(e, 2), r = n[0], o = n[1];
          return t = this.isHorizontal ? W({ transform: "translate(".concat(this.isReverse ? "50%" : "-50%", ", -50%)"), WebkitTransform: "translate(".concat(this.isReverse ? "50%" : "-50%", ", -50%)"), top: "50%" }, this.direction === "ltr" ? "left" : "right", "0") : W({ transform: "translate(-50%, ".concat(this.isReverse ? "50%" : "-50%", ")"), WebkitTransform: "translate(-50%, ".concat(this.isReverse ? "50%" : "-50%", ")"), left: "50%" }, this.direction === "btt" ? "bottom" : "top", "0"), lt({ width: "".concat(r, "px"), height: "".concat(o, "px") }, t);
...
const De = /* @__PURE__ */ me(Oe), Ee = { class: "rv-label" }, Ae = ["innerHTML"], Re = { class: "flex flex-row pl-30" }, Ve = /* @__PURE__ */ ht({
  ...
  setup(C) {
    const L = C, j = Y(L.config.value), y = Y(!!L.config.disabled), U = nt([]);
    return U.push(
  ...
  setup(C) {
    const { t: L } = It(), j = C, y = Y(!!j.config.disabled), U = nt([]);
    return U.push(
      // watch the config for changes to the opacity value
      Ot(
        () => j.config,
  ...
  setup(C) {
    const { t: L } = It(), j = ke("iApi"), y = C, U = Y(""), g = Y(y.layer.uid), T = Y(y.layer.visibility), l = Y(y.layer.opacity * 100), d = Y(y.layer.identify), s = Y(!1), i = nt([]), c = nt([]);
...
//# sourceMappingURL=screen-CQtJ2vPk.js.map
