import { d8 as z, dK as W, bI as F, D as Y, gh as G, mr as mt, bO as j, bM as I, bP as tt, O as f, P as y, Q as et, e2 as at, M as pt, a3 as ft, b8 as _t, ms as B, S as O, aj as yt, mt as Z, mu as K, bK as gt, bN as E, fs as vt, bL as wt } from "./main-lm2DHsZh.js";
import { c as A } from "./Program-CfcTPgr7.js";
import { C as p, R as v, E as T, F as D, G as xt, D as St, O as st, I as L } from "./enums-DDkmfb-t.js";
import { e as bt, c as At } from "./Texture-DhDvGrgF.js";
import { o as k } from "./ProgramTemplate-C6PXKuso.js";
import { t as w } from "./VertexElementDescriptor-BAy1DPb3.js";
import { t as it, n as Dt } from "./WGLContainer-TDEKqET4.js";
import { E as Mt, s as rt } from "./Container-CkDvNCAj.js";
import { b as Rt } from "./LabelMetric-pj4SxS9Q.js";
function zt(s) {
...
function lt(s, t) {
  if (!Tt(s.simulationSettings, t.simulationSettings) || !nt(s.timeExtent, t.timeExtent)) return !1;
  let e = !0;
...
class It {
  ...
  attach(t) {
    ...
    const c = t.painter.materialManager.getProgram(Ut, n);
    let h = 1e6, m = -1e6;
    ...
    const P = new At(e, g, l);
    this.vertexArray = o, this.program = c, this.texture = P, this.min = h, this.max = m, this._flowData = null;
  }
  detach() {
...
V.set("a_positionAndSide", 0), V.set("a_timeInfo", 1), V.set("a_extrude", 2), V.set("a_speed", 3);
const qt = { geometry: [new w("a_positionAndSide", 3, p.FLOAT, 0, 36), new w("a_timeInfo", 3, p.FLOAT, 12, 36), new w("a_extrude", 2, p.FLOAT, 24, 36), new w("a_speed", 1, p.FLOAT, 32, 36)] }, Wt = { vsPath: "raster/flow/streamlines", fsPath: "raster/flow/streamlines", attributes: V };
let Ht = class {
  constructor(t, e, a) {
    this._vertexData = t, this._indexData = e, this._values = a;
  }
  attach(t) {
    const { context: e } = t, a = A.createVertex(e, D.STATIC_DRAW, this._vertexData), i = A.createIndex(e, D.STATIC_DRAW, this._indexData), r = new k(e, V, qt, { geometry: a }, i), o = [];
    this._values.color.kind === "ramp" && o.push("vvColor"), this._values.opacity.kind === "ramp" && o.push("vvOpacity"), this._values.size.kind === "ramp" && o.push("vvSize");
...
const jt = 4, Bt = 1, Zt = 0.5, Kt = !0, Qt = !0, Jt = 2.3;
function Xt(s, t) {
  const { flowSpeed: e, trailLength: a } = s, i = zt(s);
  let r = null;
  const o = { opacity: Pt(s), size: q(s) };
  let n = Vt(s);
  if (s.background === "none") o.color = n;
    ...
    r = new Ot(m), o.color = $t();
  }
  const c = { loadImagery: t.loadImagery, createFlowMesh: t.createFlowMesh, simulationSettings: i, timeExtent: t.timeExtent, trailLength: a, flowSpeed: e, featheringSize: Bt, featheringOffset: Zt, introFade: Kt, fadeToZero: Qt, decayRate: Jt, color: o.color, opacity: o.opacity, size: o.size }, h = s.trailCap === "butt" || ot(q(s)) <= jt ? new H(c) : new Ft(c);
...
class ae extends rt {
  ...
  setTransform(t) {
    ...
    mt(c, [-1, 1, 0]), j(c, c, [2 / (t.size[0] * t.pixelRatio), -2 / (t.size[1] * t.pixelRatio), 1]), I(c, c, [r[0], r[1], 0]), tt(c, c, n), j(c, c, [o * t.pixelRatio, o * t.pixelRatio, 1]);
  }
  _createTransforms() {
...
let _ = class extends at {
  constructor() {
    super(...arguments), this._loadImagery = (s, t, e, a, i) => B(this.layer, s, t, e, a, i), this._createFlowMesh = (s, t, e, a) => this.layer.createFlowMesh({ meshType: s, flowData: e, simulationSettings: t }, { signal: a }), this.attached = !1, this.type = "flow", this.timeExtent = null, this.redrawOrRefetch = async () => {
  ...
  attach() {
    const { layer: s } = this, t = () => {
      this._loadImagery = (e, a, i, r, o) => B(s, e, a, i, r, o), this._updateVisualization();
    };
    "multidimensionalDefinition" in s ? this.addHandles(O(() => s.multidimensionalDefinition, t)) : this.addHandles([O(() => s.mosaicRule, t), O(() => s.rasterFunction, t), O(() => s.definitionExpression, t)]), this.container = new te(), this._strategy = new ie({ flowContainer: this.container }), this._updateVisualization();
  }
  detach() {
...
class xe extends it {
  ...
  _drawTriangles(t, e, a, i) {
    ...
    r.useProgram(l);
    const { coordScale: g, opacity: P, transforms: d } = e;
    l.setUniform2fv("u_coordScale", g), l.setUniform1f("u_opacity", P), l.setUniformMatrix3fv("u_dvsMat3", d.displayViewScreenMat3);
    ...
    l.setUniform2fv("u_symbolSize", ut), r.bindVAO(a), r.drawElements(T.TRIANGLES, i, p.UNSIGNED_INT, 0);
  }
  _drawScalars(t, e, a, i) {
    ...
    l.setUniform2fv("u_symbolSize", S), r.bindVAO(a), r.drawElements(T.TRIANGLES, i, p.UNSIGNED_INT, 0);
  }
  _getSymbolSize(t, e) {
...
//# sourceMappingURL=RasterVFDisplayObject-zn3huqTd.js.map
