import { fq as q, bx as v, cy as K } from "./main-lm2DHsZh.js";
import { y as Q } from "./DoubleArray-_P_N9oOs.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-Dj055wa7.js";
import { f as Z, l as ee } from "./vec3-CNt5Ew5T.js";
import "./sphere-Ds8CiJPS.js";
import "./I3SUtil-Du9EM_pw.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-BETZanvS.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-lm2DHsZh.js").then((a) => a.r9), import("./main-lm2DHsZh.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-D1gdEtVj.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-BL4eCKvc.js.map
