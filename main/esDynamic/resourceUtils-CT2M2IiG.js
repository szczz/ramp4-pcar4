import { b1 as f, s as h, $ as v, b2 as R } from "./main-lm2DHsZh.js";
...
async function F(e, t, s, r) {
  ...
  for (const { prefix: n, compress: p, access: l, files: o } of a.values())
    for (let c = 0; c < o.length; c += 25) {
      ...
      let g = 0;
      for (const { fileName: y, content: b } of i) u.append("file" + ++g, b, y);
...
async function O(e) {
  return e.type === "blob" ? e.blob : e.type === "json" ? new Blob([e.jsonString], { type: "application/json" }) : (await v(e.url, { responseType: "blob" })).data;
}
function S(e, t) {
...
export {
  ...
  $ as removeAllResources,
  U as removeResource,
  x as splitPrefixFileNameAndExtension
};
//# sourceMappingURL=resourceUtils-CT2M2IiG.js.map
