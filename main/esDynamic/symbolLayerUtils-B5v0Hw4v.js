import { dK as d, s as n, dL as a, bl as m, dM as v, ci as c } from "./main-BVGiskS7.js";
let u = h();
function h() {
  return new d(50);
}
async function p(r, o = null) {
  if (!r.isPrimitive) {
    ...
    const { fetch: l } = await import("./objectResourceUtils-3s3aVC3C.js"), f = await l(e, { disableTextures: !0 }), s = a(f.referenceBoundingBox, c());
    return u.put(e, s), s;
  }
...
//# sourceMappingURL=symbolLayerUtils-B5v0Hw4v.js.map
