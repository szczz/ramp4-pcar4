import { kH as ie, dt as x, kI as v, kJ as se, kK as oe, kL as le, j_ as F, ji as ae, gk as ue, kM as ce, K as O, ad as fe, kN as K, ap as k, gl as B, bm as me, dR as pe, dy as _, f9 as he, kO as ye, ai as ge, eV as Ie, aK as $, aV as G, aW as Re, br as Se, kP as Ne, an as de, de as Y, kQ as $e, kR as xe, kS as Z, kT as Te, kU as be, s as w, cV as _e } from "./main-lm2DHsZh.js";
import { t as W } from "./json-BI97KiBB.js";
const z = new x(), Ge = new x(), A = new x(), M = { esriGeometryPoint: v, esriGeometryPolyline: se, esriGeometryPolygon: oe, esriGeometryMultipoint: le };
...
function b(e, t, n, r, i, s, o = t, l = n) {
  const a = t && o, u = n && l, f = r != null ? "coords" in r ? r : r.geometry : null;
  if (f == null) return null;
  if (i) {
    let c = ae(Ge, f, t, n, e, i, o, l);
    return s && (c = F(A, c, a, u, e, s)), M[e]?.(c, a, u) ?? null;
  }
  if (s) {
    const c = F(A, f, t, n, e, s, o, l);
    return M[e]?.(c, a, u) ?? null;
  }
  return ie(z, f, t, n, o, l), M[e]?.(z, a, u) ?? null;
}
function rt(e) {
  return e && D in e ? JSON.parse(JSON.stringify(e, we)) : e;
}
const D = "_geVersion", we = (e, t) => e !== D ? t : void 0;
function V(e, t) {
...
function it(e, t, n, r) {
  ...
  const i = e.coords, s = [], o = n ? [Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY] : [Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY], { lengths: l, coords: a } = t, u = V(n, r);
  let f = 0;
  for (const c of l) {
    const m = Me(o, a, f, c, n, r);
    m && s.push(m), f += c * u;
  }
  if (s.sort((c, m) => {
    let p = c[2] - m[2];
  ...
  if (!i.length) {
    const c = t.lengths[0] ? Ee(a, 0, l[0], n, r) : null;
    if (!c) return null;
...
function Me(e, t, n, r, i, s) {
  ...
  for (let N = 0, T = r - 1; N < T; N++, l += o, a += o) {
    const y = t[l], g = t[l + 1], R = t[l + 2], I = t[a], S = t[a + 1], q = t[a + 2];
    let d = y * S - I * g;
    m += d, u += (y + I) * d, f += (g + S) * d, i && (d = y * q - I * R, c += (R + q) * d, p += d), y < e[0] && (e[0] = y), y > e[1] && (e[1] = y), g < e[2] && (e[2] = g), g > e[3] && (e[3] = g), i && (R < e[4] && (e[4] = R), R > e[5] && (e[5] = R));
  }
...
function Ee(e, t, n, r, i) {
  ...
  for (let m = 0, p = n - 1; m < p; m++, o += s, l += s) {
    const h = e[o], N = e[o + 1], T = e[o + 2], y = e[l], g = e[l + 1], R = e[l + 2], I = r ? ve(h, N, T, y, g, R) : Pe(h, N, y, g);
    if (I) if (a += I, r) {
      const S = Ae(h, N, T, y, g, R);
...
function H(e, t) {
  ...
  if ("x" in t) {
    const n = { x: 0, y: 0 };
    return [n.x, n.y] = e(t.x, t.y, E), t.z != null && (n.z = t.z), t.m != null && (n.m = t.m), n;
  }
  if ("xmin" in t) {
    const n = { xmin: 0, ymin: 0, xmax: 0, ymax: 0 };
    return [n.xmin, n.ymin] = e(t.xmin, t.ymin, E), [n.xmax, n.ymax] = e(t.xmax, t.ymax, E), t.hasZ && (n.zmin = t.zmin, n.zmax = t.zmax, n.hasZ = !0), t.hasM && (n.mmin = t.mmin, n.mmax = t.mmax, n.hasM = !0), n;
  }
...
const Q = H.bind(null, ue), X = H.bind(null, ce);
function ee(e, t, n, r) {
  if (!e || (n || (n = t, t = e.spatialReference), !_(t) || !_(n) || O(t, n))) return e;
  if (K(t, n)) {
    const i = k(n) ? Q(e) : X(e);
    return i.spatialReference = n, i;
  }
  return B(W, [e], t, n, null, r)[0];
}
class Oe {
  constructor() {
  ...
  _process() {
    ...
    K(r, i) ? k(i) ? s(n.map(Q)) : s(n.map(X)) : s(B(W, n, r, i, o, null)), this._jobs.length > 0 && (this._timer = setTimeout(this._process, 10));
  }
}
const ke = new Oe();
function st(e, t, n, r) {
  return ke.push(e, t, n, r);
}
const Ve = new he({ esriSRUnit_Meter: "meters", esriSRUnit_Kilometer: "kilometers", esriSRUnit_Foot: "feet", esriSRUnit_StatuteMile: "miles", esriSRUnit_NauticalMile: "nautical-miles", esriSRUnit_USNauticalMile: "us-nautical-miles" }), J = Object.freeze({});
async function ot(e, t, n) {
  ...
  return e.geometry && !e.outSR && (e.outSR = e.geometry.spatialReference), je(e, t, n);
}
async function je(e, t, n) {
  ...
  if (i) {
    await j(i.spatialReference, n), i = Ue(i, n);
...
function te(e, t) {
  ...
  return ($(e) || G(e) || Re(e)) && !O(n, t) && !Se(n, t);
}
function Ue(e, t) {
  const n = e.spatialReference;
...
async function qe(e) {
  ...
  const i = r.spatialReference, s = n ? Ve.fromJSON(n) : Ne(i), o = i && (de(i) || k(i)) ? r : await j(i, Y).then(() => ee(r, Y));
  return (await Ye())(o.spatialReference, o, t, s);
}
async function Ye() {
  return (await import("./geometryEngineJSON-lkbMo_hW.js").then((e) => e.g)).geodesicBuffer;
}
function Ze(e) {
...
function re(e, t, n, r, i) {
  ...
  let a = !1, u = 0;
  for (const f of l) a = Je(a, o, s, u, f, r, i), u += f * s;
  return a;
}
...
const P = "unsupported-query", Ke = { esriSpatialRelIntersects: "intersects", esriSpatialRelContains: "contains", esriSpatialRelCrosses: "crosses", esriSpatialRelDisjoint: "disjoint", esriSpatialRelEnvelopeIntersects: "intersects", esriSpatialRelIndexIntersects: null, esriSpatialRelOverlaps: "overlaps", esriSpatialRelTouches: "touches", esriSpatialRelWithin: "within", esriSpatialRelRelation: null }, U = { spatialRelationship: { esriSpatialRelIntersects: !0, esriSpatialRelContains: !0, esriSpatialRelWithin: !0, esriSpatialRelCrosses: !0, esriSpatialRelDisjoint: !0, esriSpatialRelTouches: !0, esriSpatialRelOverlaps: !0, esriSpatialRelEnvelopeIntersects: !0, esriSpatialRelIndexIntersects: !1, esriSpatialRelRelation: !1 }, queryGeometry: { esriGeometryPoint: !0, esriGeometryMultipoint: !0, esriGeometryPolyline: !0, esriGeometryPolygon: !0, esriGeometryEnvelope: !0 }, layerGeometry: { esriGeometryPoint: !0, esriGeometryMultipoint: !0, esriGeometryPolyline: !0, esriGeometryPolygon: !0, esriGeometryEnvelope: !1 } };
function Be(e) {
  return e != null && U.spatialRelationship[e] === !0;
}
function We(e) {
  return e != null && U.queryGeometry[_e(e)] === !0;
}
function De(e) {
  return e != null && U.layerGeometry[e] === !0;
}
function He() {
  return import("./geometryEngineJSON-lkbMo_hW.js").then((e) => e.g);
}
function lt(e, t, n, r, i) {
  if (G(t) && n === "esriGeometryPoint" && (e === "esriSpatialRelIntersects" || e === "esriSpatialRelContains")) {
    const s = Z(new x(), t, !1, !1);
    return Promise.resolve((o) => ze(s, !1, !1, o));
  }
  if (G(t) && n === "esriGeometryMultipoint") {
    const s = Z(new x(), t, !1, !1);
    if (e === "esriSpatialRelContains") return Promise.resolve((o) => Ce(s, !1, !1, o, r, i));
  }
  if ($(t) && n === "esriGeometryPoint" && (e === "esriSpatialRelIntersects" || e === "esriSpatialRelContains")) return Promise.resolve((s) => Te(t, b(n, r, i, s)));
  if ($(t) && n === "esriGeometryMultipoint" && e === "esriSpatialRelContains") return Promise.resolve((s) => be(t, b(n, r, i, s)));
  if ($(t) && e === "esriSpatialRelIntersects") {
    const s = Ze(n);
    return Promise.resolve((o) => s(t, b(n, r, i, o)));
  }
  return He().then((s) => {
    const o = s[Ke[e]].bind(null, t.spatialReference, t);
    return (l) => o(b(n, r, i, l));
  });
}
async function at(e, t, n) {
  const { spatialRel: r, geometry: i } = e;
  if (i) {
    if (!Be(r)) throw new w(P, "Unsupported query spatial relationship", { query: e });
    if (_(i.spatialReference) && _(n)) {
      if (!We(i)) throw new w(P, "Unsupported query geometry type", { query: e });
      if (!De(t)) throw new w(P, "Unsupported layer geometry type", { query: e });
      if (e.outSR) return j(e.geometry?.spatialReference, e.outSR);
    }
  }
}
function ut(e) {
...
function ft(e, t, n) {
  ...
  if (s === void 0 && o === void 0) return Xe();
  const l = n.getAttributeAsTimestamp?.bind(n) ?? n.getAttribute.bind(n);
  return r && i ? Le(l, r, i, s, o) : Qe(l, r || i, s, o);
}
...
//# sourceMappingURL=timeSupport-BMgFmqzA.js.map
