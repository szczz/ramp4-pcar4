import { am as m, au as d, a2 as u, K as w, s as p } from "./main-BVGiskS7.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-5P54WhuM.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-C4Nom2Aq.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-IgQRpNae.js.map
