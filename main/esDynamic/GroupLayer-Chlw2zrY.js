import { e3 as u, e7 as v, e5 as c, e6 as m, gM as f, gN as g, e8 as w, bR as _, gO as I, f1 as L, S as y, eF as O, gP as S, Z as $, _ as A, gQ as V, gR as d, gS as M, O as r, P as l, eH as p, e9 as P, gT as C, bi as E, fw as b, Q as T, ei as x, D as R } from "./main-lm2DHsZh.js";
import { a as G } from "./fetchService-DHH3a12X.js";
import { r as H } from "./saveUtils-DGiWOint.js";
...
let s = class extends u(v(c(m(f(g(w(x))))))) {
  constructor(e) {
    super(e), this.allLayers = new _({ getCollections: () => [this.layers], getChildrenFunction: (i) => "layers" in i ? i.layers : null }), this.allTables = I(this), this.fullExtent = void 0, this.operationalLayerType = "GroupLayer", this.spatialReference = void 0, this.type = "group", this._debouncedSaveOperations = L(async (i, t, a) => {
      const { save: o, saveAs: n } = await import("./groupLayerUtils-BFvdjdPd.js");
      switch (i) {
        case d.SAVE:
          return o(this, t);
        case d.SAVE_AS:
...
//# sourceMappingURL=GroupLayer-Chlw2zrY.js.map
