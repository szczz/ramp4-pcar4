import { c1 as b, c2 as x, c3 as L, c4 as A, c5 as B, c6 as C, c7 as I, c8 as j, c9 as i, ca as l, cb as p, cc as n, cd as w, ce as D, cf as c, cg as N, ch as T, ci as u, cj as V, ck as q, cl as d } from "./main-lm2DHsZh.js";
const F = ["content"], M = /* @__PURE__ */ b({
  ...
  setup(v) {
    const m = d(() => import("./header-CDEYTXkJ.js")), _ = d(() => import("./item-BU-y3VVg.js")), { t: s } = x(), f = L("iApi"), e = A(), r = () => {
      e.value._tippy.hide();
    }, a = (t) => {
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-B3HIyyut.js.map
