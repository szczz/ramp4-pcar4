import { O as i, P as s, Q as _, e2 as L, bX as O, bx as z, a9 as Ue, fq as ge, s as d, eU as se, b7 as Ie, a3 as Re, b6 as pe, b5 as le, D as J, $ as N, a0 as qe } from "./main-lm2DHsZh.js";
import { m as Se, p as be, t as Ye, c as Qe } from "./GraphQueryStreaming-BJOL8AaN.js";
...
async function Be(e) {
  if (e) {
    const { default: t } = await import("./arcgis-knowledge-client-core-simd-BLSkO4VV.js").then((n) => n.a);
    return t({ locateFile: (n) => ge(_e + n) });
  }
  const { default: r } = await import("./arcgis-knowledge-client-core-BSG7Aeug.js").then((t) => t.a);
...
//# sourceMappingURL=knowledgeGraphService-CHPoIwzu.js.map
