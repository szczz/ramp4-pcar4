import { bC as Q, bD as ae, bF as V, bG as ce, bK as N, bN as l, bT as a, bS as w, fC as o, bQ as t, ii as x, ij as ie, fD as C, iz as Le, iy as u, ls as ke, bE as ge, fA as me, bI as U, lt as b, kM as M, bJ as ye, bR as xe, bM as de, bO as B, bP as p, fK as W, i4 as oe, bU as le, bV as ne, iG as we, fI as v, lu as pe, i2 as Ce, fH as Me, lv as f, lw as Z, lx as re, bL as G, ix as Se, ly as O, kF as Te, lz as ze, lA as ee } from "./main-BVGiskS7.js";
...
const Ee = ["type", "aria-label", "checked", "disabled", "content"], te = /* @__PURE__ */ Q({
  ...
  setup(e) {
    ...
    const I = (s) => !s.symbologyStack.some((d) => d.visibility), $ = () => {
    ...
    return (s, d) => {
      ...
      return l(), a("div", {
        ...
        w(o("input", {
          ...
          onClick: d[0] || (d[0] = x((D) => $(), ["stop"])),
          checked: e.checked && m.value,
          onKeypress: d[1] || (d[1] = ie(x(() => {
          }, ["prevent"]), ["enter"])),
          onKeyup: d[2] || (d[2] = ie(x((D) => $(), ["stop"]), ["enter"])),
          class: C([[
  ...
  setup(e) {
    const { t: y } = ae(), i = ge("iApi"), m = V(), I = V(!1), $ = me(), s = V($.mobileView), d = e, T = () => {
      d.legendItem.layerControlAvailable(b.Symbology) && d.legendItem.toggleSymbology();
    }, D = () => {
      d.legendItem.layerControlAvailable(b.Datatable) && A("grid") && i.event.emit(W.GRID_TOGGLE, d.legendItem.layer);
    }, q = () => {
      d.legendItem.layerControlAvailable(b.Settings) && A("settings") && i.event.emit(W.SETTINGS_TOGGLE, d.legendItem.layer);
    }, J = () => {
      if (d.legendItem.layerControlAvailable(b.Metadata) && A("metadata")) {
        ...
        if (z.url) {
          const R = z.url.split("."), E = R[R.length - 1], X = E === "xml" || E === "md" ? E : "html";
          i.event.emit(W.METADATA_TOGGLE, {
            type: X,
            layerName: c,
            url: z.url,
            catalogueUrl: L,
      ...
      j.value && (M(d.legendItem.layer).reload(), m.value.open = !1);
    }, j = U(() => d.legendItem.layerControlAvailable(b.Reload) && d.legendItem instanceof u && M(d.legendItem.layer)?.canReload), Y = (z) => {
    ...
    return (z, c) => {
      const L = ye("dropdown-menu"), R = N("tippy");
      return l(), a("div", {
        onClick: c[2] || (c[2] = x(() => {
        }, ["stop"])),
          ...
          default: de(() => [
            o("a", {
              ...
              class: C(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(b).Metadata) || !A("metadata")
              }]),
              onClick: J,
              role: "button",
              ...
              B(" " + p(t(y)("legend.layer.controls.metadata")), 1)
            ], 10, He),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(b).Settings) || !A("settings")
              }]),
              onClick: q,
              role: "button",
              ...
              B(" " + p(t(y)("legend.layer.controls.settings")), 1)
            ], 10, Ae),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
                disabled: !e.legendItem.layerControlAvailable(t(b).Datatable) || !A("grid")
              }]),
              onClick: D,
              role: "button",
              ...
              B(" " + p(t(y)("legend.layer.controls.datatable")), 1)
            ], 10, Be),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              B(" " + p(t(y)("legend.layer.controls.symbology")), 1)
            ], 10, $e),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              B(" " + p(t(y)("legend.layer.controls.boundaryzoom")), 1)
            ], 10, Ze),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              B(" " + p(t(y)("legend.layer.controls.remove")), 1)
            ], 10, Ge),
            w((l(), a("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              onMouseover: c[0] || (c[0] = x((E) => Y(E.currentTarget), ["stop"])),
              ...
              B(" " + p(t(y)("legend.layer.controls.reload")), 1)
            ], 42, Ue)), [
              [R, {
                placement: "top-start",
...
}), De = /* @__PURE__ */ oe(Re, [["__scopeId", "data-v-89260022"]]), Pe = { key: 0 }, je = {
  key: 0,
  class: "relative left-3"
}, Oe = ["innerHTML"], Ne = ["src"], qe = {
  key: 1,
  class: "symbologyIcon w-32 h-32"
}, Fe = ["innerHTML"], Ke = ["src"], We = {
  key: 1,
  ...
  setup(e) {
    ...
    return ce(() => {
    ...
    }), (m, I) => e.visible ? (l(), a("div", We, I[0] || (I[0] = [
      o("svg", {
      ...
      i.value.length > 1 ? (l(), a("div", je, [
        (l(!0), a(le, null, ne(i.value.slice(0, 3).reverse(), ($, s) => (l(), a("div", {
...
}), Je = /* @__PURE__ */ oe(Qe, [["__scopeId", "data-v-34dfeccd"]]), Ye = { class: "relative" }, Xe = ["content"], _e = {
  key: 0,
  ...
  key: 1,
  class: "symbologyIcon"
}, Zt = ["innerHTML"], Gt = { class: "flex-1 ml-15" }, Ut = { key: 1 }, Rt = { class: "flex p-5 ml-48" }, Dt = {
  key: 0,
  class: "relative animate-spin spinner h-20 w-20 mr-10 pt-2"
}, Pt = { class: "flex-1 text-gray-500" }, jt = {
  key: 1,
  ...
  setup(e) {
    const y = pe(), i = me(), { t: m } = ae(), I = ge("iApi"), $ = V(), s = e, d = Ce(), T = d.multilineItems, D = (s.legendItem instanceof u && s.legendItem.maxLines) ?? d.maxLines, q = V(i.mobileView), J = U(() => y.layerConfigs), H = V([]), F = V(!1), P = V(!1), j = U(() => s.legendItem instanceof u ? M(s.legendItem.layer)?.layerType : ""), Y = U(() => s.legendItem instanceof u && M(s.legendItem.layer)?.canModifyLayer), A = U(() => {
      if (s.legendItem instanceof u) {
        const r = M(s.legendItem.layer);
        return r ? r.canReload : !0;
      } else
        return !1;
    }), z = U(() => I.animate), c = U(() => s.legendItem.children.length > 0 || // TODO: Determine why Vue reactivity isn't picking updates to the children property of the parent.
    ...
    s.legendItem instanceof u && M(s.legendItem.layer)?.sublayers.length > 0), L = (r) => r === Z.Expand || r === Z.Visibility ? s.legendItem.controlAvailable(r) : s.legendItem.layerControlAvailable(r), R = (r) => Ve(r), E = () => {
      ...
      L(b.Datatable) && K() && I.event.emit(W.GRID_TOGGLE, s.legendItem.layer);
    }, ve = (r) => {
      ...
      s.legendItem.reload(), setTimeout(() => {
        ...
        if (n) {
          const h = r.isSublayer ? r.parentLayerId : r.layerId, k = J.value.find((S) => S.id === h);
          k !== void 0 && Ie(k);
        }
    ...
    return s.legendItem instanceof u && (se(), Me(
      ...
      const h = ye("item", !0), k = N("tippy"), S = N("truncate"), _ = N("focus-item");
      return e.legendItem.hidden ? v("", !0) : (l(), a("div", {
        ...
        o("div", Ye, [
          w((l(), a("div", {
            class: C(["flex items-center hover:bg-gray-200 default-focus-style !p-5", [
              ...
              c.value && L(t(Z).Expand) || !c.value && e.legendItem instanceof t(u) && L(t(b).Datatable) && K() && e.legendItem.type === t(f).Item ? "cursor-pointer" : "cursor-default",
              t(T) ? "multilined" : "singlelined"
            ]]),
            onMouseover: n[9] || (n[9] = x((g) => he(g.currentTarget), ["stop"])),
            onMouseout: n[10] || (n[10] = (g) => (
              //@ts-ignore
              (q.value || g.currentTarget?._tippy?.hide(), P.value = !1)
            )),
            onClick: n[11] || (n[11] = () => {
              !c.value && e.legendItem instanceof t(u) && L(t(b).Datatable) && K() && e.legendItem.type === t(f).Item ? ue() : c.value && E();
            }),
            content: c.value && L(t(Z).Expand) ? t(m)(e.legendItem.expanded ? "legend.group.collapse" : "legend.group.expand") : e.legendItem instanceof t(u) && e.legendItem.type === t(f).Item && L(t(b).Datatable) && K() ? t(m)("legend.layer.data") : "",
            "truncate-trigger": ""
          }, [
            ...
            e.legendItem instanceof t(u) && t(T) ? w((l(), a("div", {
              key: 3,
              class: C(["flex-1 pointer-events-none m-5", `line-clamp-${t(D)}`])
            }, [
              ...
              }, null, 8, gt)) : (l(), G(Te(`${e.legendItem.uid}-info-section`), { key: 5 }))
            ])) : v("", !0),
            ...
            (e.legendItem.type === t(f).Item || e.legendItem.type === t(f).Placeholder && t(T)) && e.legendItem instanceof t(u) ? (l(), G(De, {
              key: 7,
              class: C({
            ...
            ])) : e.legendItem.type === t(f).Item && L(t(Z).Visibility) ? (l(), G(te, {
              key: 12,
            ...
            (l(!0), a(le, null, ne(H.value, (g) => (l(), a("div", {
              ...
              g.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !g.imgUrl && j.value === "ogc-wms" ? (l(), a("div", St, [
                ...
                g.label ? w((l(), a("div", Et, [
                  ...
                  !g.imgUrl && H.value.length > 1 || g.imgUrl && g.definitionClause ? (l(), G(te, {
                    key: 0,
                    class: "float-right",
                    value: g,
                    legendItem: e.legendItem,
                ...
                Y.value && e.legendItem.layer.supportsFeatures && (!g.imgUrl && H.value.length > 1 || g.imgUrl && g.definitionClause) ? (l(), G(te, {
                  key: 2,
                  value: g,
                  legendItem: e.legendItem,
                  checked: g.visibility,
        ...
        e.legendItem.expanded ? (l(), a("div", jt, [
          (l(!0), a(le, null, ne(e.legendItem.children, (g) => (l(), G(h, {
            legendItem: g,
            key: g.uid
...
//# sourceMappingURL=item-9XMRbmUp.js.map
