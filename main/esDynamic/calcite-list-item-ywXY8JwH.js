import { c$ as k, d0 as E, e_ as c, cX as i, d1 as J } from "./main-lm2DHsZh.js";
import { t as b, l as m, v as L, g as N } from "./dom-BHTTQ4_z.js";
import { u as A, I as w } from "./interactive-wINwzqu-.js";
import { c as H, d as D } from "./locale-DlBi8777.js";
import { c as T, s as M, d as z, u as P } from "./t9n-BO4Ef3RJ.js";
import { s as B, a as F, c as O } from "./loadable-CsKbmXcU.js";
import { g as Q, a as V, b as Y, u as Z } from "./utils3-C1HEHusp.js";
import { a as x, I as g, C as s, S as p } from "./resources4-Bi43yZeq.js";
import { d as ee } from "./action-BJv-sdFl.js";
import { d as U } from "./icon-F11CuSC7.js";
import { d as te } from "./loader-BJcS0mbh.js";
const y = {
  handle: "handle",
  ...
  total: "{total}"
          ...
          );color:var(--calcite-handle-icon-color-hover, var(--calcite-color-text-1))}:host(:not([disabled])) .handle--selected{color:var(--calcite-handle-icon-color-selected, var(--calcite-color-text-1));background-color:var(--calcite-handle-background-color-selected, var(--calcite-color-foreground-3))}:host([disabled]) ::slotted([calcite-hydrated][disabled]),:host([disabled]) [calcite-hydrated][disabled]{opacity:1}.interaction-container{display:contents}:host([hidden]){display:none}[hidden]{display:none}`, se = ie, ae = /* @__PURE__ */ k(class extends E {
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.calciteHandleChange = c(this, "calciteHandleChange", 6), this.calciteHandleNudge = c(this, "calciteHandleNudge", 6), this.calciteInternalAssistiveTextChange = c(this, "calciteInternalAssistiveTextChange", 6), this.handleKeyDown = (e) => {
      if (!this.disabled)
        switch (e.key) {
          case " ":
  ...
  async setFocus() {
    await O(this), this.handleButton?.focus();
  }
  // --------------------------------------------------------------------------
  //
  //  Private Methods
  ...
  getTooltip() {
    ...
    return t ? e ? t.dragHandle.replace(C.itemLabel, e) : t.dragHandleUntitled : "";
  }
  getAriaText(e) {
    const { setPosition: t, setSize: n, label: a, messages: l, selected: o } = this;
    return !l || !a || typeof n != "number" || typeof t != "number" ? null : (e === "label" ? o ? l.dragHandleChange : l.dragHandleIdle : o ? l.dragHandleActive : l.dragHandleCommit).replace(C.position, t.toString()).replace(C.itemLabel, a).replace(C.total, n.toString());
  }
  // --------------------------------------------------------------------------
  //
  //  Render Methods
  ...
  // --------------------------------------------------------------------------
  render() {
    return i(w, { key: "1a694de393421691c83e7265850275c217ef7ffe", disabled: this.disabled }, i("span", {
      key: "82ff692c15c2d9294ceb814b3f7f06bb4d8ff0e0",
      "aria-checked": this.disabled ? null : b(this.selected),
      "aria-disabled": this.disabled ? b(this.disabled) : null,
      "aria-label": this.disabled ? null : this.getAriaText("label"),
      class: { [y.handle]: !0, [y.handleSelected]: !this.disabled && this.selected },
    ...
    }, i("calcite-icon", { key: "25862a953826aea2d594507157aaffc21d07001c", icon: ne.drag, scale: "s" })));
  }
...
const le = `:host([disabled]){cursor:default;-webkit-user-select:none;user-select:none;opacity:var(--calcite-opacity-disabled)}:host([disabled]) *,:host([disabled]) ::slotted(*){pointer-events:none}:host{display:flex;flex-direction:column;background-color:var(--calcite-color-foreground-1);--calcite-list-item-icon-color:var(--calcite-color-brand)}:host([filter-hidden]),:host([closed]){display:none}.wrapper--bordered{border-block-end:1px solid var(--calcite-color-border-3)}:host([disabled]) ::slotted([calcite-hydrated][disabled]),:host([disabled]) [calcite-hydrated][disabled]{opacity:1}.interaction-container{display:contents}.container{box-sizing:border-box;display:flex;flex:1 1 0%;overflow:hidden;background-color:var(--calcite-color-foreground-1)}.container *{box-sizing:border-box}.container--hover:hover{cursor:pointer;background-color:var(--calcite-color-foreground-2)}.container:active{background-color:var(--calcite-color-foreground-1)}.container--border{border-inline-start-width:4px;border-inline-start-style:solid}.container--border-selected{border-inline-start-color:var(--calcite-color-brand)}.container--border-unselected{border-inline-start-color:transparent}.container:hover.container--border-unselected{border-color:var(--calcite-color-border-1)}.nested-container{display:none;flex-direction:column;border-width:0px;border-style:solid;border-color:var(--calcite-color-border-3);margin-inline-start:var(--calcite-list-item-spacing-indent, 1.5rem)}.nested-container--open{display:flex}.content-container{display:flex;flex:1 1 auto;-webkit-user-select:none;user-select:none;align-items:stretch;padding:0px;font-weight:var(--calcite-font-weight-normal);color:var(--calcite-color-text-2)}.content-container--unavailable{opacity:var(--calcite-opacity-disabled)}tr,td{outline-color:transparent}tr{position:relative}tr:focus,td:focus{outline:2px solid var(--calcite-ui-focus-color, var(--calcite-color-brand));outline-offset:calc(
  ...
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.calciteListItemSelect = c(this, "calciteListItemSelect", 6), this.calciteListItemClose = c(this, "calciteListItemClose", 6), this.calciteListItemDragHandleChange = c(this, "calciteListItemDragHandleChange", 6), this.calciteListItemToggle = c(this, "calciteListItemToggle", 6), this.calciteInternalListItemSelect = c(this, "calciteInternalListItemSelect", 6), this.calciteInternalListItemSelectMultiple = c(this, "calciteInternalListItemSelectMultiple", 6), this.calciteInternalListItemActive = c(this, "calciteInternalListItemActive", 6), this.calciteInternalFocusPreviousItem = c(this, "calciteInternalFocusPreviousItem", 6), this.calciteInternalListItemChange = c(this, "calciteInternalListItemChange", 6), this.calciteInternalListItemToggle = c(this, "calciteInternalListItemToggle", 6), this.dragHandleSelectedChangeHandler = (e) => {
      ...
      if (e.defaultPrevented)
        return;
      const { key: t } = e, n = e.composedPath(), { containerEl: a, actionsStartEl: l, actionsEndEl: o, open: d, openable: h } = this, r = this.getGridCells(), u = r.findIndex((f) => n.includes(f));
      if (t === "Enter" && !n.includes(l) && !n.includes(o))
        e.preventDefault(), this.toggleSelected(e.shiftKey);
      else if (t === "ArrowRight") {
        e.preventDefault();
        const f = u + 1;
        u === -1 ? !d && h ? (this.toggle(!0), this.focusCell(null)) : r[0] && this.focusCell(r[0]) : r[u] && r[f] && this.focusCell(r[f]);
      } else if (t === "ArrowLeft") {
        e.preventDefault();
        const f = u - 1;
        u === -1 ? (this.focusCell(null), d && h ? this.toggle(!1) : this.calciteInternalFocusPreviousItem.emit()) : u === 0 ? (this.focusCell(null), a.focus()) : r[u] && r[f] && this.focusCell(r[f]);
      }
    }, this.focusCellNull = () => {
      this.focusCell(null);
      ...
      const { parentListEl: a } = this;
      n && I.set(a, null);
      const l = this.getGridCells();
      l.forEach((o) => {
        o.tabIndex = -1, o.removeAttribute(x);
      }), e && (e.tabIndex = e === t ? 0 : -1, e.setAttribute(x, ""), n && I.set(a, l.indexOf(e)));
    }, this.focusCell = (e, t = !0) => {
      const n = L(e);
      this.setFocusCell(e, n, t), n?.focus();
    }, this.active = !1, this.bordered = !1, this.closable = !1, this.closed = !1, this.description = void 0, this.disabled = !1, this.dragDisabled = !1, this.dragHandle = !1, this.dragSelected = !1, this.filterHidden = !1, this.label = void 0, this.metadata = void 0, this.open = !1, this.setSize = null, this.setPosition = null, this.selected = !1, this.unavailable = !1, this.value = void 0, this.selectionMode = null, this.selectionAppearance = null, this.messageOverrides = void 0, this.messages = void 0, this.effectiveLocale = "", this.defaultMessages = void 0, this.level = null, this.parentListEl = void 0, this.openable = !1, this.hasActionsStart = !1, this.hasActionsEnd = !1, this.hasCustomContent = !1, this.hasContentStart = !1, this.hasContentEnd = !1, this.hasContentBottom = !1;
  }
  activeHandler(e) {
  ...
  connectedCallback() {
    H(this), T(this);
    const { el: e } = this;
    this.parentListEl = e.closest(ce), this.level = Q(e) + 1, this.setSelectionDefaults();
  }
  async componentWillLoad() {
    B(this), await M(this);
  }
  ...
  async setFocus() {
    ...
    if (typeof n == "number") {
      ...
      a[n] ? this.focusCell(a[n]) : e?.focus();
      return;
    }
    e?.focus();
  }
  ...
  renderSelected() {
    ...
    return t === "none" || n === "border" ? null : i("td", { class: {
      [s.selectionContainer]: !0,
      [s.selectionContainerSingle]: t === "single" || t === "single-persist"
    }, key: "selection-container", onClick: this.handleItemClick }, i("calcite-icon", { icon: e ? t === "multiple" ? g.selectedMultiple : g.selectedSingle : t === "multiple" ? g.unselectedMultiple : g.unselectedSingle, scale: "s" }));
  }
  renderDragHandle() {
    const { label: e, dragHandle: t, dragSelected: n, dragDisabled: a, setPosition: l, setSize: o } = this;
    return t ? i("td", { "aria-label": e, class: s.dragContainer, key: "drag-handle-container", onFocusin: this.focusCellHandle, ref: (d) => this.handleGridEl = d, role: "gridcell" }, i("calcite-handle", { disabled: a, label: e, onCalciteHandleChange: this.dragHandleSelectedChangeHandler, selected: n, setPosition: l, setSize: o })) : null;
  }
  renderOpen() {
    const { el: e, open: t, openable: n, messages: a } = this, l = N(e), o = t ? g.open : l === "rtl" ? g.closedRTL : g.closedLTR, d = t ? a.collapse : a.expand;
    return n ? i("td", { class: s.openContainer, key: "open-container", onClick: this.handleToggleClick, title: d }, i("calcite-icon", { icon: o, key: o, scale: "s" })) : null;
  }
  renderActionsStart() {
    const { label: e, hasActionsStart: t } = this;
    return i("td", { "aria-label": e, class: s.actionsStart, hidden: !t, key: "actions-start-container", onFocusin: this.focusCellActionsStart, ref: (n) => this.actionsStartEl = n, role: "gridcell" }, i("slot", { name: p.actionsStart, onSlotchange: this.handleActionsStartSlotChange }));
  }
  renderActionsEnd() {
    const { label: e, hasActionsEnd: t, closable: n, messages: a } = this;
    return i("td", { "aria-label": e, class: s.actionsEnd, hidden: !(t || n), key: "actions-end-container", onFocusin: this.focusCellActionsEnd, ref: (l) => this.actionsEndEl = l, role: "gridcell" }, i("slot", { name: p.actionsEnd, onSlotchange: this.handleActionsEndSlotChange }), n ? i("calcite-action", { appearance: "transparent", class: s.close, icon: g.close, key: "close-action", label: a.close, onClick: this.handleCloseClick, text: a.close }) : null);
  }
  renderContentStart() {
    const { hasContentStart: e } = this;
    return i("div", { class: s.contentStart, hidden: !e }, i("slot", { name: p.contentStart, onSlotchange: this.handleContentStartSlotChange }));
  }
  renderCustomContent() {
    const { hasCustomContent: e } = this;
    return i("div", { class: s.customContent, hidden: !e }, i("slot", { name: p.content, onSlotchange: this.handleContentSlotChange }));
  }
  renderContentEnd() {
    const { hasContentEnd: e } = this;
    return i("div", { class: s.contentEnd, hidden: !e }, i("slot", { name: p.contentEnd, onSlotchange: this.handleContentEndSlotChange }));
  }
  renderContentBottom() {
    const { hasContentBottom: e } = this;
    return i("div", { class: s.contentBottom, hidden: !e }, i("slot", { name: p.contentBottom, onSlotchange: this.handleContentBottomSlotChange }));
  }
  renderDefaultContainer() {
    return i("div", { class: {
      [s.nestedContainer]: !0,
      [s.nestedContainerOpen]: this.openable && this.open
    } }, i("slot", { onSlotchange: this.handleDefaultSlotChange, ref: (e) => this.defaultSlotEl = e }));
  }
  renderContentProperties() {
    const { label: e, description: t, hasCustomContent: n } = this;
    return !n && (e || t) ? i("div", { class: s.content, key: "content" }, e ? i("div", { class: s.label, key: "label" }, e) : null, t ? i("div", { class: s.description, key: "description" }, t) : null) : null;
  }
  renderContentContainer() {
    const { description: e, label: t, selectionMode: n, hasCustomContent: a, unavailable: l } = this, o = a || !!t || !!e, d = [
      this.renderContentStart(),
      this.renderCustomContent(),
      this.renderContentProperties(),
      this.renderContentEnd()
    ];
    return i("td", { "aria-label": t, class: {
      [s.contentContainer]: !0,
      [s.contentContainerUnavailable]: l,
      [s.contentContainerSelectable]: n !== "none",
      [s.contentContainerHasCenterContent]: o
    }, key: "content-container", onClick: this.handleItemClick, onFocusin: this.focusCellContent, ref: (h) => this.contentEl = h, role: "gridcell" }, d);
  }
  render() {
    const { openable: e, open: t, level: n, setPosition: a, setSize: l, active: o, label: d, selected: h, selectionAppearance: r, selectionMode: u, closed: f, filterHidden: $, bordered: R, disabled: j } = this, S = u !== "none" && r === "border", W = S && h, X = S && !h;
    return i(J, { key: "a610ab740c82b6088400839884d58d4d867829db" }, i(w, { key: "f05bf10e82fab03ddfdaf3ab2e100dcbd6d69c63", disabled: j }, i("div", { key: "4bf63ed08d2a4a049e060d26d3699656558d495e", class: { [s.wrapper]: !0, [s.wrapperBordered]: R } }, i("tr", { key: "d231a113c3bd8ee7f67c2ffb0cf804c142a95fb9", "aria-expanded": e ? b(t) : null, "aria-label": d, "aria-level": n, "aria-posinset": a, "aria-selected": b(h), "aria-setsize": l, class: {
      [s.container]: !0,
      [s.containerHover]: !0,
      [s.containerBorder]: S,
      [s.containerBorderSelected]: W,
      [s.containerBorderUnselected]: X
...
const Le = G, xe = K;
export {
  Le as CalciteListItem,
  xe as defineCustomElement
};
//# sourceMappingURL=calcite-list-item-ywXY8JwH.js.map
