import { d as p, s as c, Z as w, C as j, _ as u, $ as y, a0 as D } from "./main-lm2DHsZh.js";
async function q(e, n) {
  ...
  if (r.sceneLayerItem ??= await A(r), r.sceneLayerItem == null) return v(r.sceneServerUrl.replace("/SceneServer", "/FeatureServer"), r);
  const a = await $(r);
...
//# sourceMappingURL=associatedFeatureServiceUtils-CG_WlYZR.js.map
