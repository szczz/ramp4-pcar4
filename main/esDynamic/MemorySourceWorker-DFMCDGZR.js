import { df as O, s as I, dg as Q, di as Z, dh as A, bg as $, cV as b, dm as w, dn as k, dp as C, de as S, aT as v } from "./main-lm2DHsZh.js";
import { t as P, n as G } from "./objectIdUtils-EszJVKSV.js";
import { m as L } from "./FeatureStore-kbC0mBT0.js";
import { x as E, j as T } from "./timeSupport-BMgFmqzA.js";
import { $ as z } from "./QueryEngine-cqgD_odw.js";
import { i as W, o as B, c as H } from "./clientSideDefaults-BkFQkY5x.js";
import { j as N, f as g, p as _, d as j, y as D } from "./sourceUtils-VS0hDVPC.js";
...
class ae {
  ...
  async load(e) {
    ...
    for (const i of o) {
      ...
      if (i.name === t && (i.type = "esriFieldTypeOID"), !Q.jsonValues.includes(i.type)) throw new I("feature-layer:invalid-field-type", `invalid type for field "${i.name}"`, { field: i });
      i.length == null && (i.length = Z(i));
    }
    const F = {};
    ...
    this._createDefaultAttributes = W(F, t);
    ...
    if (this._queryEngine = new z({ fieldsIndex: O.fromLayerJSON({ fields: o, timeInfo: n, dateFieldsTimeReference: x }), geometryType: y, hasM: u, hasZ: f, objectIdField: t, spatialReference: d, featureStore: new L({ geometryType: y, hasM: u, hasZ: f }), timeInfo: n, cacheSpatialQueries: !0 }), !a?.length) return this._nextObjectId = P, R;
    const M = G(t, a);
    return this._nextObjectId = M + 1, await E(a, d), this._loadInitialFeatures(R, a);
  }
  async applyEdits(e) {
  ...
  async _loadInitialFeatures(e, s) {
    ...
    for (const t of s) {
      ...
      const n = this._createDefaultAttributes(), c = _(d, n, t.attributes, !0);
      c ? e.featureErrors.push(c) : (this._assignObjectId(n, t.attributes, !0), t.attributes = n, t.uid != null && (e.assignedObjectIds[t.uid] = t.attributes[u]), t.geometry != null && (t.geometry = T(t.geometry, t.geometry.spatialReference, f)), m.push(t));
    }
  ...
  _applyAddEdits(e, s) {
    ...
    for (const l of s) {
      ...
      const t = this._createDefaultAttributes(), n = _(m, t, l.attributes);
      if (n) a.push(n);
      else {
        ...
        if (l.geometry != null) {
          ...
          l.geometry = T(D(l.geometry, c), c, p);
        }
  ...
  _applyUpdateEdits({ updateResults: e }, s) {
    ...
    for (const m of s) {
      ...
      if (l != null) {
        ...
        n.geometry = T(D(l, c), c, f);
      }
      if (y) {
        const c = _(d, n.attributes, y);
        if (c) {
          e.push(c);
          continue;
        }
...
//# sourceMappingURL=MemorySourceWorker-DFMCDGZR.js.map
