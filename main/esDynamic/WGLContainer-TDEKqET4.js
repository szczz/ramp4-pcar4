import { N as dt, fO as $e, bL as pe, bI as ne, oK as _t, jk as ge, oL as vt, lK as mt, fL as pt, cA as gt, a9 as j, iB as he, bl as Ee, D as be, a$ as Oe, lb as ht, bN as xt, oM as yt, dt as Ae, s as Te, kS as St, fH as bt, fD as Pe, S as Tt, oN as It } from "./main-lm2DHsZh.js";
import { j as ce, a as ue, x as Ct, f as Et, g as Ot, h as At, Y as B, $ as Ze, Z as De } from "./definitions-Doe0g1C2.js";
import { a as Pt, b as Ke, h as qe, f as z, n as re, s as le, r as Dt } from "./LabelMetric-pj4SxS9Q.js";
import { c as k } from "./Program-CfcTPgr7.js";
import { C as E, F as $, E as A, L as U, R as L, O as w, I as Q, N as Lt, D as Rt } from "./enums-DDkmfb-t.js";
import { o as Z, a as zt, e as fe } from "./ProgramTemplate-C6PXKuso.js";
import { t as ie } from "./VertexElementDescriptor-BAy1DPb3.js";
import { n as Mt } from "./vec3f32-BS0cezmI.js";
import { s as je, N as xe, S as Le, p as Nt, h as Vt, E as ee } from "./Container-CkDvNCAj.js";
import { e as wt, c as Ft } from "./Texture-DhDvGrgF.js";
import { r as J, l as G, n as Re } from "./StyleDefinition-Dfu7Kx8O.js";
import { e as ze } from "./config-nuMERBvb.js";
import { i as Bt } from "./earcut-D5euH4Nc.js";
let Ut = class {
  constructor(e, t) {
    this._rctx = e, this._attributes = [{ name: "position", offset: 0, type: E.SHORT, count: 2 }], this.layout = { hash: Pt(this._attributes), attributes: this._attributes, stride: 4 }, this._vertexBuffer = k.createVertex(e, $.STATIC_DRAW, new Uint16Array(t)), this._vao = new Z(e, /* @__PURE__ */ new Map([["a_position", 0]]), { geometry: [new ie("a_position", 2, E.SHORT, 0, 4)] }, { geometry: this._vertexBuffer }), this._count = t.length / 2;
  }
  bind() {
...
const _e = { nearest: { defines: [], samplingMode: U.NEAREST, mips: !1 }, bilinear: { defines: [], samplingMode: U.LINEAR, mips: !1 }, bicubic: { defines: ["bicubic"], samplingMode: U.LINEAR, mips: !1 }, trilinear: { defines: [], samplingMode: U.LINEAR_MIPMAP_LINEAR, mips: !0 } }, Gt = (u, e, t) => {
  if (t.samplingMode === "dynamic") {
    const { state: n } = u, i = e.resolution / e.pixelRatio / n.resolution, o = Math.round(u.pixelRatio) !== u.pixelRatio, a = i > 1.05 || i < 0.95;
    return n.rotation || a || o || e.isSourceScaled || e.rotation ? _e.bilinear : _e.nearest;
  }
  return _e[t.samplingMode];
};
let Yt = class extends H {
  ...
  draw(e, t) {
    ...
    const l = Gt(e, t, i), s = o.materialManager.getProgram(this._desc, l.defines);
    if (r && a != null && !s.compiled) return void a();
    e.timeline.begin(this.name), t.blendFunction === "additive" ? n.setBlendFunctionSeparate(L.ONE, L.ONE, L.ONE, L.ONE) : n.setBlendFunctionSeparate(L.ONE, L.ONE_MINUS_SRC_ALPHA, L.ONE, L.ONE_MINUS_SRC_ALPHA), n.setStencilFunction(w.EQUAL, t.stencilRef, 255), this._quad || (this._quad = new Ut(n, [0, 0, 1, 0, 0, 1, 1, 1]));
    const { coordScale: c, computedOpacity: _, transforms: f } = t;
    t.setSamplingProfile(l), t.bind(e.context, ce), n.useProgram(s), s.setUniformMatrix3fv("u_dvsMat3", f.displayViewScreenMat3), s.setUniform1i("u_texture", ce), s.setUniform2fv("u_coordScale", c), s.setUniform1f("u_opacity", _), this._quad.draw(), e.timeline.end(this.name);
  }
};
function Xe() {
...
function kt(u) {
  ...
  return e[0] = u[0], e[1] = u[1], e[2] = u[2], e[3] = u[3], e;
}
function W(u, e, t, n) {
  const i = new Float32Array(4);
  return i[0] = u, i[1] = e, i[2] = t, i[3] = n, i;
}
function Ht(u, e) {
  return new Float32Array(u, e, 4);
}
function Qe() {
  return Xe();
}
...
const Wt = Qe(), $t = Je(), Zt = et(), Kt = tt(), qt = nt(), jt = it();
Object.freeze(Object.defineProperty({ __proto__: null, ONES: $t, UNIT_W: jt, UNIT_X: Zt, UNIT_Y: Kt, UNIT_Z: qt, ZEROS: Wt, clone: kt, create: Xe, createView: Ht, fromValues: W, ones: Je, unitW: it, unitX: et, unitY: tt, unitZ: nt, zeros: Qe }, Symbol.toStringTag, { value: "Module" }));
const Xt = { background: { "background.frag": `uniform lowp vec4 u_color;
void main() {
...
const Jt = new zt(Qt(Xt));
function de(u) {
  return Jt.resolveIncludes(u);
}
const oe = { shaders: { vertexShader: de("background/background.vert"), fragmentShader: de("background/background.frag") }, attributes: /* @__PURE__ */ new Map([["a_pos", 0]]) }, en = () => Ke("clip", { geometry: [{ location: 0, name: "a_pos", count: 2, type: E.SHORT }] });
let tn = class extends H {
  ...
  prepareState({ context: e }) {
    e.setStencilTestEnabled(!0), e.setBlendingEnabled(!1), e.setFaceCullingEnabled(!1), e.setColorMask(!1, !1, !1, !1), e.setStencilOp(Q.KEEP, Q.KEEP, Q.REPLACE), e.setStencilWriteMask(255), e.setStencilFunction(w.ALWAYS, 0, 255);
  }
  draw(e, t) {
    const { context: n, state: i, requestRender: o, allowDelayedRender: a } = e, r = en(), l = t.getVAO(n, i, r.attributes, r.bufferLayouts);
    l.indexBuffer != null && (this._program || (this._program = fe(n, oe)), !a || o == null || this._program.compiled ? (n.useProgram(this._program), this._program.setUniform2fv("u_coord_range", [1, 1]), this._program.setUniform4fv("u_color", this._color), this._program.setUniformMatrix3fv("u_dvsMat3", i.displayMat3), n.bindVAO(l), n.drawElements(A.TRIANGLES, l.indexBuffer.size, E.UNSIGNED_INT, 0), n.bindVAO()) : o());
  }
};
const nn = () => Ke("overlay", { geometry: [{ location: 0, name: "a_pos", count: 2, type: E.FLOAT }], tex: [{ location: 1, name: "a_uv", count: 2, type: E.UNSIGNED_SHORT }] });
let on = class extends H {
  ...
  prepareState({ context: e }) {
    e.setBlendingEnabled(!0), e.setColorMask(!0, !0, !0, !0), e.setBlendFunctionSeparate(L.ONE, L.ONE_MINUS_SRC_ALPHA, L.ONE, L.ONE_MINUS_SRC_ALPHA), e.setStencilWriteMask(0), e.setStencilTestEnabled(!0), e.setStencilFunction(w.GREATER, 255, 255);
  }
  draw(e, t) {
    const { context: n, painter: i, requestRender: o, allowDelayedRender: a } = e;
    if (!t.isReady) return;
    const { computedOpacity: r, dvsMat3: l, isWrapAround: s, perspectiveTransform: c, texture: _, wrapAroundShift: f } = t;
    e.timeline.begin(this.name);
    const g = i.materialManager.getProgram(this._desc);
    if (a && o != null && !g.compiled) return void o();
    const d = nn(), h = t.getVAO(n, d.bufferLayouts, d.attributes);
    h && (n.bindVAO(h), n.useProgram(g), n.bindTexture(_, ce), g.setUniformMatrix3fv("u_dvsMat3", l), g.setUniform1i("u_texture", ce), g.setUniform1f("u_opacity", r), g.setUniform2fv("u_perspective", c), g.setUniform2fv("u_texSize", t.textureSize), g.setUniform1f("u_wrapAroundShift", 0), t.draw(e.context), s && (g.setUniform1f("u_wrapAroundShift", f), t.draw(e.context)), n.bindVAO(), e.timeline.end(this.name));
  }
};
const ye = { geometry: [new ie("a_pos", 2, E.BYTE, 0, 2)] }, Jn = { geometry: [new ie("a_pos", 2, E.BYTE, 0, 4), new ie("a_tex", 2, E.BYTE, 2, 4)] }, ei = { geometry: [new ie("a_pos", 2, E.UNSIGNED_SHORT, 0, 4)] };
let an = class extends H {
  ...
  draw(e, t) {
    ...
    this._initialized || this._initialize(n), !o || i == null || this._solidProgram.compiled ? (n.setStencilFunctionSeparate(Lt.FRONT_AND_BACK, w.GREATER, t.stencilRef, 255), n.bindVAO(this._solidVertexArrayObject), n.useProgram(this._solidProgram), this._solidProgram.setUniformMatrix3fv("u_dvsMat3", t.transforms.displayViewScreenMat3), this._solidProgram.setUniform2fv("u_coord_range", [t.rangeX, t.rangeY]), this._solidProgram.setUniform1f("u_depth", 0), this._solidProgram.setUniform4fv("u_color", this._color), n.drawArrays(A.TRIANGLE_STRIP, 0, 4), n.bindVAO()) : i();
  }
  _initialize(e) {
    if (this._initialized) return !0;
    const t = fe(e, oe);
    if (!t) return !1;
    const n = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), i = k.createVertex(e, $.STATIC_DRAW, n), o = new Z(e, oe.attributes, ye, { geometry: i });
  ...
  setTransform(e) {
    ...
    $e(n, a, 0, 0, 0, r, 0, i, o, 1), pe(this.transforms.displayViewScreenMat3, e.displayViewMat3, n);
  }
  get destroyed() {
...
let ln = class extends rn {
  ...
  _createTransforms() {
    return { labelMat2d: ge(), tileMat3: ne(), displayViewScreenMat3: ne() };
  }
  containsScreenPoint(e, t, n) {
    const i = pe(Me, e.viewMat3, this.transforms.tileMat3), o = mt(Me, i);
    if (o == null) return !0;
    pt(ve, ...t, 1);
    const a = gt(ve, ve, o), r = n * (this.resolution / e.resolution);
    return a[0] >= -r && a[0] < this.width + r && a[1] >= -r && a[1] < this.height + r;
  }
}, Y = class ot {
  constructor(e) {
...
let te = class {
  ...
  getAttributePrecisionPackFactors() {
    const e = this.instance.instanceId;
    return this.target.getMesh(e).getAttributePrecisionPackFactors();
  }
  draw(e, t) {
    Nt(e) ? this.drawCompute(e.context, t) : this.drawGeometry(e.context, t);
  }
  drawCompute(e, t) {
    const n = this.instance.instanceId, i = this.target.getMesh(n).getComputeVAO(e, t), o = this.start * Uint32Array.BYTES_PER_ELEMENT / 3;
    e.bindVAO(i), e.drawElements(A.POINTS, this.count / 3, E.UNSIGNED_INT, o), e.bindVAO(null);
  }
  drawGeometry(e, t) {
    const n = this.instance.instanceId, i = this.target.getMesh(n).getGeometryVAO(e, t), o = this.start * Uint32Array.BYTES_PER_ELEMENT;
    e.bindVAO(i), e.drawElements(A.TRIANGLES, this.count, E.UNSIGNED_INT, o), e.bindVAO(null);
  }
}, un = class rt {
  constructor() {
  ...
  static fromDisplayEntities(e, t, n, i) {
    ...
    for (const a of e.values()) for (const r of a.records) {
      const l = n.getInstance(r.instanceId), s = sn(l.instanceId, r.textureKey);
  ...
  addRecord(e, t, n, i, o, a, r, l) {
    ...
    if (this._head == null) {
      const h = new te(e, t, r, s, c);
      return this._head = new Y(h), this._tail = this._head, this._length++, void this._minOrderedLength++;
    }
    if (l === xe.STRICT_ORDER) return this._insert(e, t, r, s, c, this._tail, null);
    let _ = null, f = this._head;
    const g = e.instanceId, d = e.techniqueRef.symbologyPlane;
    if (l === xe.STRICT_MARKERS_AND_TEXT && (d === Le.MARKER || d === Le.TEXT)) return this._insert(e, t, r, s, c, this._tail, null);
    for (; f; ) {
      const h = f.data.instance, S = h.instanceId, O = h.techniqueRef.symbologyPlane, I = _?.data.instance.instanceId;
      if (d < O || g === I && g !== S) return this._insert(e, t, r, s, c, _, f);
      _ = f, f = f.next;
    }
...
const Ne = j("esri-2d-log-allocations");
let Ve = class lt {
  static create(e, t) {
...
class li {
  ...
  get _bytesTotal() {
    return this._pages.length * me.BYTE_LENGTH;
  }
  acquireUint32Array(e) {
    if (this._bytesAllocated += e, Ne && console.log(`Allocating ${e}, (${this._bytesAllocated} / ${this._bytesTotal})`), e >= me.BYTE_LENGTH) return new Uint32Array(e / Uint32Array.BYTES_PER_ELEMENT);
  ...
  releaseUint32Array(e) {
    this._bytesAllocated -= e.byteLength, Ne && console.log(`Freeing ${e.byteLength}, (${this._bytesAllocated} / ${this._bytesTotal})`);
...
const dn = 1.25, we = 32767, _n = we << 16 | we;
let Fe = class {
  constructor(e, t, n, i) {
    this._pool = i;
    const o = Ve.create(t * n * Uint32Array.BYTES_PER_ELEMENT, this._pool);
  ...
  clear() {
    ...
    if (!(this.maxAvailableSpace() >= e) && e * this.strideInt > this._cpu.length - this.fillPointer) {
      this.invalidate();
      const t = this._cpu.length / this.strideInt, n = Math.round((t + e) * dn), i = n * this.strideInt;
  ...
  copyFrom(e, t, n, i, o) {
    ...
    if (this._cpu.array.set(l, c), i !== 0) for (let f = 0; f < a; f++) this._cpu.array[c + f * this.strideInt + o] += i;
  ...
  free(e, t, n) {
    ...
    if (n === !0) for (let a = e; a !== e + t; a++) this._cpu.array[a * this.strideInt] = _n;
  ...
  reshuffle(e, t) {
    ...
    const n = this.byteSize, i = e * this.strideInt * Uint32Array.BYTES_PER_ELEMENT, o = n > i, a = this._cpu, r = Ve.create(i, this._pool);
    ...
    for (const l of t) if (o || l.srcFrom !== l.dstFrom || l.mutate !== 0) {
      ...
      for (let s = 0; s < l.count; s++) {
        ...
        for (let f = 0; f < this.strideInt; f++) r.array[c + f] = a.array[_ + f] + l.mutate;
      }
    }
...
const Be = 1e3;
function vn(u, e) {
  const t = [], n = u.attributes.filter((i) => e.locations.has(i.name));
  for (const i of n) t.push({ name: i.name, type: i.type, count: i.count, divisor: 0, normalized: i.normalized ?? !1, offset: i.offset, stride: u.stride });
  return { geometry: t };
}
function mn(u, e) {
  const t = [], n = u.attributes.filter((i) => e.locations.has(i.name));
  for (const i of n) {
    t.push({ name: i.name, type: i.type, count: i.count, divisor: 0, normalized: i.normalized ?? !1, offset: i.offset, stride: u.stride });
    const o = e.computeAttributeMap[i.name];
    o != null && o.length === 2 && (t.push({ name: o[0], count: i.count, divisor: 0, type: i.type, normalized: i.normalized ?? !1, offset: i.offset + u.stride, stride: u.stride }), t.push({ name: o[1], count: i.count, divisor: 0, type: i.type, normalized: i.normalized ?? !1, offset: i.offset + 2 * u.stride, stride: u.stride }));
  }
  return { geometry: t };
}
let pn = class {
  constructor(e, t) {
    if (this._bufferPool = e, this._layout = t, this._invalidated = !1, this._position = this._layout.attributes.find((n) => n.name === "pos" || n.name === "position"), !this._position) throw new Error("InternalError: Unable to find position attribute");
  }
  destroy() {
    this._indexBuffer = Ee(this._indexBuffer), this._vertexBuffer = Ee(this._vertexBuffer), this._computeVAO?.disposeVAOOnly(), this._geometryVAO?.disposeVAOOnly();
  }
  get layout() {
    return this._layout;
  }
  ...
  getDebugVertexInfo(e = !1) {
    ...
    const t = this._layout, n = t.stride, i = this._vertexBuffer.getView(0, this._vertexBuffer.byteSize), o = new DataView(i.slice().buffer);
    let a = i.byteLength / n;
    e && (a = this._indexBuffer.fillPointer / 3);
    ...
    for (let c = 0; c < a; c++) {
      ...
      for (const f of t.attributes) {
        let g = `${f.offset} ${f.name}`, d = qe(o, f, l);
        if (f.packPrecisionFactor) if (g += ` (precision: ${f.packPrecisionFactor})`, typeof d == "number") d /= f.packPrecisionFactor;
        else for (let h = 0; h < d.length; h++) d[h] /= f.packPrecisionFactor;
        _[g] = d;
      }
      l += n, s.push(_);
    }
  ...
  _ensure(e, t) {
    if (this._vertexBuffer && this._indexBuffer) this._indexBuffer.ensure(Math.max(e, 1e3)), this._vertexBuffer.ensure(Math.max(t, 1e3));
    else {
      const n = this._layout.stride / Uint32Array.BYTES_PER_ELEMENT;
      this._indexBuffer = new Fe("index", Math.max(e, Be), 1, this._bufferPool), this._vertexBuffer = new Fe("vertex", Math.max(t, Be), n, this._bufferPool);
    }
  }
  append(e) {
  ...
  copyRecordFrom(e, t, n, i) {
    ...
    this._ensure(a, l);
    const s = e._position, c = n * (s.packPrecisionFactor ?? 1), _ = i * (s.packPrecisionFactor ?? 1), f = s.offset, g = z(c, _), d = this._vertexBuffer.copyFrom(e._vertexBuffer, r, l, g, f), h = this._indexBuffer.copyFrom(e._indexBuffer, o, a, d - r, 0), S = t.clone();
    return S.vertexStart = d, S.indexStart = h, S.overlaps = 0, S;
  }
  remove(e, t, n, i) {
  ...
  getGeometryVAO(e, t) {
    ...
    if (this._invalidated) {
      ...
      const n = this._indexBuffer.getGPUBuffer(e, !1), i = this._vertexBuffer.getGPUBuffer(e);
      this._geometryVAO || (this._geometryVAO = new Z(e, t.locations, vn(this.layout, t), { geometry: i }, n)), this._invalidated = !1;
    }
  ...
  getComputeVAO(e, t) {
    ...
    const n = this._indexBuffer.getGPUBuffer(e, !0), i = this._vertexBuffer.getGPUBuffer(e);
    return this._computeVAO || (this._computeVAO = new Z(e, t.locations, mn(this.layout, t), { geometry: i }, n), this._invalidated = !1), this._computeVAO;
  }
  get memoryStats() {
...
function Ue(u) {
  return u ? { entities: re(new se(u.entities), le), vertexData: u.data.map(gn) } : null;
}
function gn(u) {
  const e = u.layout.stride, t = new DataView(u.vertices), n = [], i = u.vertices.byteLength / e;
  let o = 0;
  for (let a = 0; a < i; a++) {
    const r = {};
    for (const l of u.layout.attributes) {
  ...
  return { vertices: n, layout: u.layout };
}
const hn = () => be.getLogger("esri.views.2d.engine.webgl.FeatureTile");
let xn = 0, yn = class extends ln {
  constructor(e, t, n, i, o = !1) {
    super(e, t, n, i), this._meshes = /* @__PURE__ */ new Map(), this._entities = [], this._invalidated = !1, this._nextUploadAllowed = !1, this.tileAge = xn++, this._metrics = [], this._entityIds = /* @__PURE__ */ new Set(), this._entityIdsFromBuffer = /* @__PURE__ */ new Set(), this._attributeEpoch = 0, this._encounteredEnd = !1, this.visible = !0, this.transforms.labelMat2d = ge(), this.enableDeferredUploads = o;
  }
  destroy() {
  ...
  tryReady(e) {
    ...
    return !(this._isReady || t || !this._encounteredEnd || !(e >= this._attributeEpoch)) && (j("esri-2d-update-debug") && console.debug(`Tile[${this.key.id}] FeatureTile.ready [epoch=${e}]`), this.ready(), this.requestRender(), !0);
  }
  get labelMetrics() {
  ...
  getDisplayList(e, t) {
    if (this._uploadAllowed && this._invalidated) {
      this._entities.sort((n, i) => {
        const o = i.sortKey, a = n.sortKey;
        return a === o ? n.id - i.id : a - o;
      }), t === xe.BATCHING && this.reshuffle(!0), this._displayList = un.fromDisplayEntities(this._entities, this, e, t);
      for (const n of this._meshes.values()) n.upload();
  ...
  onMessage(e) {
    ...
    if (this._aggregateMemoryStats(), this.requestRender(), e.end) {
      if (j("esri-2d-update-debug") && console.debug(`Tile[${this.key.id}] FeatureTile.end [epoch=${e.attributeEpoch}]`), !e.attributeEpoch) throw new Error("InternalError: Attribute epoch not defined.");
      this._attributeEpoch = e.attributeEpoch, this._encounteredEnd = !0;
    }
  }
  _onAppendMessage(e) {
    if (j("esri-2d-update-debug") && console.debug(`Tile[${this.key.id}] FeatureTile.append`, { append: Ue(e?.append) }), e.clear && this.clear(), !e.append) return;
    const t = re(new se(e.append.entities), le);
    this._insert(t, e.append.data, !1);
  }
  _onUpdateMessage(e) {
    j("esri-2d-update-debug") && console.debug(`Tile[${this.key.id}] FeatureTile.update`, { isPixelBuffer: e.isPixelBuffer, modify: Ue(e.modify), remove: e.remove });
  ...
  reshuffle(e = !1) {
    ...
    for (const n of this._entities) for (const i of n.records) {
      ...
      let a = t.get(o);
      a || (a = new fn(e), t.set(o, a)), a.copyRecord(i);
    }
    for (const [n, i] of t) n.reshuffle(i);
    this._invalidated = !0, this._aggregateMemoryStats(), j("esri-2d-update-debug") && hn().info(`Tile ${this.key.id} was reshuffled.`);
  }
  copyPixelBufferedEntitesFrom(e, t, n, i) {
    ...
    for (const r of e._entities) {
      ...
      for (const s of r.records) if (s.overlaps & t) {
        const c = e.getMesh(s.instanceId), _ = this._ensureMesh(s.instanceId, c.layout).copyRecordFrom(c, s, o, a);
        l || (l = new le(r.id, r.sortKey), this._entityIdsFromBuffer.add(r.id), this._entities.push(l)), l.records.push(_);
      }
    }
    this._invalidated = !0;
  }
  _ensureMesh(e, t) {
    return this._meshes.has(e) || this._meshes.set(e, new pn(this._stage.bufferPool, t)), this._meshes.get(e);
  }
  _insert(e, t, n) {
    if (!e.length) return;
  ...
  _insertVertexData(e) {
    const t = /* @__PURE__ */ new Map();
    for (const n of e) {
      const { instanceId: i, layout: o } = n, a = this._ensureMesh(i, o).append(n);
      if (n.metrics) {
        const r = re(new se(n.metrics), Dt) ?? [];
        this._metrics.push(...r);
      }
      t.set(i, a);
    }
    return t;
  ...
  _insertEntity(e) {
    j("esri-2d-update-debug") && this._entityIds.has(e.id) && console.error(`Tile ${this.key.id} insertEnitty: Already have entityId ${e.id}`), this._entityIds.add(e.id), this._entities.push(e);
  }
  ...
  get _needsReshuffle() {
    ...
    return t > Ct && n < Et || o > Ot && i / o < At;
  }
};
const Ge = { shaders: { vertexShader: de("tileInfo/tileInfo.vert"), fragmentShader: de("tileInfo/tileInfo.frag") }, attributes: /* @__PURE__ */ new Map([["a_pos", 0]]) }, Ye = 512, Se = 512, q = 16, N = 8, Sn = (Se - 2 * N) / 5;
let bn = class extends H {
  ...
  draw(e, t) {
    const { context: n, requestRender: i, allowDelayedRender: o } = e;
    if (!t.isReady && t instanceof yn && t.hasData) return;
  ...
  _loadWGLResources(e) {
    ...
    const t = fe(e, oe), n = fe(e, Ge), i = new Int8Array([0, 0, 1, 0, 1, 1, 0, 1]), o = k.createVertex(e, $.STATIC_DRAW, i), a = new Z(e, oe.attributes, ye, { geometry: o }), r = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), l = k.createVertex(e, $.STATIC_DRAW, r), s = new Z(e, Ge.attributes, ye, { geometry: l });
    this._outlineProgram = t, this._tileInfoProgram = n, this._outlineVertexArrayObject = a, this._tileInfoVertexArrayObject = s;
  }
  _getTexture(e, t) {
    if (!this._ctx) {
      const l = document.createElement("canvas");
      l.width = Ye, l.height = Se, this._ctx = l.getContext("2d");
    }
    if (!t.tileDebugInfoTexture) {
      const l = new wt();
      l.wrapMode = Rt.CLAMP_TO_EDGE, l.samplingMode = U.LINEAR, l.isImmutable = !0, l.width = Ye, l.height = Se, t.tileDebugInfoTexture = new Ft(e, l);
    }
    const n = this._ctx;
    n.clearRect(0, 0, n.canvas.width, n.canvas.height), n.textAlign = "left", n.textBaseline = "top", n.font = q - 2 + "px sans-serif", n.lineWidth = 2, n.fillStyle = "white", n.strokeStyle = "black";
    const { debugSlot: i } = t;
    let o = N + Sn * i;
    const a = `${i}) ${t.key.id} (${t.constructor.name})`;
    n.strokeText(a, N, o), n.fillText(a, N, o), o += q;
    const { debugInfo: r } = t;
    if (r) {
      const { length: l, minOrderedLength: s, minUnorderedLength: c, triangleCount: _ } = r.display;
      if (l > 0) {
        const d = `Length: ${l}`;
        n.strokeText(d, N, o), n.fillText(d, N, o), o += q;
      }
      if (s) {
      ...
      const { bytesUsed: f, bytesReserved: g } = r.memory;
      if (n.fillStyle = "white", n.strokeStyle = "black", f > 0 || g > 0) {
        const d = `Memory usage: ${f} of ${g} bytes`;
        n.strokeText(d, N, o), n.fillText(d, N, o), o += q;
      }
    }
  ...
  constructor() {
    super(...arguments), this._color = W(1, 0, 0, 1), this._patternMatrix = ne(), this._programOptions = { id: !1, pattern: !1 };
  }
  dispose() {
  ...
  drawMany(e, t) {
    ...
    const r = e.displayLevel, l = e.styleLayer, s = l.backgroundMaterial, c = i.vectorTilesMaterialManager, _ = l.getPaintValue("background-color", r), f = l.getPaintValue("background-opacity", r), g = l.getPaintValue("background-pattern", r), d = g !== void 0, h = 1 | window.devicePixelRatio, S = e.spriteMosaic;
    let O, I;
    const x = h > Ze ? 2 : 1, T = this._programOptions;
    T.pattern = d;
    const m = c.getMaterialProgram(n, s, T);
    if (!a || o == null || m.compiled) {
      if (n.bindVAO(this._vao), n.useProgram(m), d) {
        const v = S.getMosaicItemPosition(g, !0);
        if (v != null) {
          const { tl: y, br: b, page: p } = v;
          O = b[0] - y[0], I = b[1] - y[1];
          const D = S.getPageSize(p);
          D != null && (S.bind(n, U.LINEAR, p, B), m.setUniform4f("u_tlbr", y[0], y[1], b[0], b[1]), m.setUniform2fv("u_mosaicSize", D), m.setUniform1i("u_texture", B));
        }
        m.setUniform1f("u_opacity", f);
      } else {
        const v = _[3] * f;
      ...
      for (const v of t) {
        if (m.setUniform1f("u_coord_range", v.rangeX), m.setUniformMatrix3fv("u_dvsMat3", v.transforms.displayViewScreenMat3), d) {
          const y = Math.max(2 ** (Math.round(r) - v.key.level), 1), b = x * v.width * y, p = b / Oe(O), D = b / Oe(I);
          this._patternMatrix[0] = p, this._patternMatrix[4] = D, m.setUniformMatrix3fv("u_pattern_matrix", this._patternMatrix);
        }
        n.setStencilFunction(w.EQUAL, 0, 255), n.drawArrays(A.TRIANGLE_STRIP, 0, 4);
      }
    } else o();
  }
  _loadWGLResources(e) {
    if (this._vao) return;
    const { context: t, styleLayer: n } = e, i = n.backgroundMaterial, o = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), a = k.createVertex(t, $.STATIC_DRAW, o), r = new Z(t, i.getAttributeLocations(), i.getLayoutInfo(), { geometry: a });
    this._vao = r;
  }
}, In = class extends H {
  constructor() {
  ...
  drawMany(e, t) {
    ...
    const f = e.styleLayer, g = f.circleMaterial, d = r.vectorTilesMaterialManager, h = 1.2, S = f.getPaintValue("circle-translate", i), O = f.getPaintValue("circle-translate-anchor", i), I = this._programOptions, x = d.getMaterialProgram(n, g, I);
    if (_ && c != null && !x.compiled) return void c();
    n.useProgram(x), x.setUniformMatrix3fv("u_displayMat3", O === J.VIEWPORT ? a.displayMat3 : a.displayViewMat3), x.setUniform2fv("u_circleTranslation", S), x.setUniform1f("u_depth", f.z), x.setUniform1f("u_antialiasingWidth", h);
    let T = -1;
    for (const m of t) {
      if (!m.layerData.has(s)) continue;
      m.key.level !== T && (T = m.key.level, g.setDataUniforms(x, i, f, T, l));
      const v = m.layerData.get(s);
      if (!v.circleIndexCount) continue;
      v.prepareForRendering(n);
      const y = v.vao;
      y != null && (n.bindVAO(y), x.setUniformMatrix3fv("u_dvsMat3", m.transforms.displayViewScreenMat3), o !== m.key.level ? n.setStencilFunction(w.EQUAL, m.stencilRef, 255) : n.setStencilFunction(w.GREATER, 255, 255), n.drawElements(A.TRIANGLES, v.circleIndexCount, E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * v.circleIndexStart), m.triangleCount += v.circleIndexCount / 3);
    }
  }
};
const ke = 1 / 65536;
class Cn extends H {
  ...
  drawMany(e, t) {
    ...
    let r = !1;
    for (const x of t) if (x.layerData.has(a)) {
      const T = x.layerData.get(a);
    ...
    let f;
    if (c && !_) {
      const x = s.getValue(n);
      f = o.getMosaicItemPosition(x, !0);
    }
    const g = !c && l.getPaintValue("fill-antialias", n);
    let d = !0, h = 1;
    if (!c) {
      const x = l.getPaintProperty("fill-color"), T = l.getPaintProperty("fill-opacity");
      if (!x?.isDataDriven && !T?.isDataDriven) {
        const m = l.getPaintValue("fill-color", n);
        h = l.getPaintValue("fill-opacity", n) * m[3], h >= 1 && (d = !1);
      }
    }
    if (d && i === "opaque") return;
    const S = l.getPaintValue("fill-translate", n), O = l.getPaintValue("fill-translate-anchor", n);
    (d || i !== "translucent") && this._drawFill(e, a, l, t, S, O, c, f, _);
    const I = !l.hasDataDrivenOutlineColor && l.outlineUsesFillColor && h < 1;
    g && i !== "opaque" && !I && this._drawOutline(e, a, l, t, S, O);
  }
  _drawFill(e, t, n, i, o, a, r, l, s) {
    if (r && !s && l == null) return;
    const { context: c, displayLevel: _, state: f, painter: g, pixelRatio: d, spriteMosaic: h, requestRender: S, allowDelayedRender: O } = e, I = n.fillMaterial, x = g.vectorTilesMaterialManager, T = d > Ze ? 2 : 1, m = this._fillProgramOptions;
    m.pattern = r;
    const v = x.getMaterialProgram(c, I, m);
    if (O && S != null && !v.compiled) return void S();
    if (c.useProgram(v), l != null) {
      const { page: b } = l, p = h.getPageSize(b);
      p != null && (h.bind(c, U.LINEAR, b, B), v.setUniform2fv("u_mosaicSize", p), v.setUniform1i("u_texture", B));
    }
    v.setUniformMatrix3fv("u_displayMat3", a === J.VIEWPORT ? f.displayMat3 : f.displayViewMat3), v.setUniform2fv("u_fillTranslation", o), v.setUniform1f("u_depth", n.z + ke);
    let y = -1;
    for (const b of i) {
      if (!b.layerData.has(t)) continue;
      b.key.level !== y && (y = b.key.level, I.setDataUniforms(v, _, n, y, h));
      const p = b.layerData.get(t);
      if (!p.fillIndexCount) continue;
      p.prepareForRendering(c);
      const D = p.fillVAO;
      if (D != null) {
        if (c.bindVAO(D), v.setUniformMatrix3fv("u_dvsMat3", b.transforms.displayViewScreenMat3), c.setStencilFunction(w.EQUAL, b.stencilRef, 255), r) {
          const C = Math.max(2 ** (Math.round(_) - b.key.level), 1), R = b.rangeX / (T * b.width * C);
          v.setUniform1f("u_patternFactor", R);
        }
        if (s) {
          const C = p.patternMap;
          if (!C) continue;
          for (const [R, M] of C) {
            const K = h.getPageSize(R);
            K != null && (h.bind(c, U.LINEAR, R, B), v.setUniform2fv("u_mosaicSize", K), v.setUniform1i("u_texture", B), c.drawElements(A.TRIANGLES, M[1], E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * M[0]));
          }
        } else c.drawElements(A.TRIANGLES, p.fillIndexCount, E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * p.fillIndexStart);
        b.triangleCount += p.fillIndexCount / 3;
      }
    }
  }
  _drawOutline(e, t, n, i, o, a) {
    const { context: r, displayLevel: l, state: s, painter: c, pixelRatio: _, spriteMosaic: f, requestRender: g, allowDelayedRender: d } = e, h = n.outlineMaterial, S = c.vectorTilesMaterialManager, O = 0.75 / _, I = this._outlineProgramOptions, x = S.getMaterialProgram(r, h, I);
    if (d && g != null && !x.compiled) return void g();
    r.useProgram(x), x.setUniformMatrix3fv("u_displayMat3", a === J.VIEWPORT ? s.displayMat3 : s.displayViewMat3), x.setUniform2fv("u_fillTranslation", o), x.setUniform1f("u_depth", n.z + ke), x.setUniform1f("u_outline_width", O);
    let T = -1;
    for (const m of i) {
      if (!m.layerData.has(t)) continue;
      m.key.level !== T && (T = m.key.level, h.setDataUniforms(x, l, n, T, f));
      const v = m.layerData.get(t);
      if (v.prepareForRendering(r), !v.outlineIndexCount) continue;
      const y = v.outlineVAO;
      y != null && (r.bindVAO(y), x.setUniformMatrix3fv("u_dvsMat3", m.transforms.displayViewScreenMat3), r.setStencilFunction(w.EQUAL, m.stencilRef, 255), r.drawElements(A.TRIANGLES, v.outlineIndexCount, E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * v.outlineIndexStart), m.triangleCount += v.outlineIndexCount / 3);
    }
  }
}
class En extends H {
  ...
  drawMany(e, t) {
    ...
    if (!t.some((C) => C.layerData.get(s)?.lineIndexCount ?? !1)) return;
    const f = e.styleLayer, g = f.lineMaterial, d = a.vectorTilesMaterialManager, h = f.getPaintValue("line-translate", i), S = f.getPaintValue("line-translate-anchor", i), O = f.getPaintProperty("line-pattern"), I = O !== void 0, x = I && O.isDataDriven;
    let T, m;
    if (I && !x) {
      const C = O.getValue(i);
      T = l.getMosaicItemPosition(C);
    }
    let v = !1;
    if (!I) {
      const C = f.getPaintProperty("line-dasharray");
      if (m = C !== void 0, v = m && C.isDataDriven, m && !v) {
        const R = C.getValue(i), M = f.getDashKey(R, f.getLayoutValue("line-cap", i));
        T = l.getMosaicItemPosition(M);
      }
    }
    const y = 1 / r, b = this._programOptions;
    b.pattern = I, b.sdf = m;
    const p = d.getMaterialProgram(n, g, b);
    if (_ && c != null && !p.compiled) return void c();
    if (n.useProgram(p), p.setUniformMatrix3fv("u_displayViewMat3", o.displayViewMat3), p.setUniformMatrix3fv("u_displayMat3", S === J.VIEWPORT ? o.displayMat3 : o.displayViewMat3), p.setUniform2fv("u_lineTranslation", h), p.setUniform1f("u_depth", f.z), p.setUniform1f("u_antialiasing", y), T && T != null) {
      const { page: C } = T, R = l.getPageSize(C);
      R != null && (l.bind(n, U.LINEAR, C, B), p.setUniform2fv("u_mosaicSize", R), p.setUniform1i("u_texture", B));
    }
    let D = -1;
    for (const C of t) {
      if (!C.layerData.has(s)) continue;
      C.key.level !== D && (D = C.key.level, g.setDataUniforms(p, i, f, D, l));
      const R = 2 ** (i - D) / r;
      p.setUniform1f("u_zoomFactor", R);
      const M = C.layerData.get(s);
      if (!M.lineIndexCount) continue;
      M.prepareForRendering(n);
      const K = M.vao;
      if (K != null) {
        if (n.bindVAO(K), p.setUniformMatrix3fv("u_dvsMat3", C.transforms.displayViewScreenMat3), n.setStencilFunction(w.EQUAL, C.stencilRef, 255), x || v) {
          const ae = M.patternMap;
          if (!ae) continue;
          for (const [P, X] of ae) {
            const V = l.getPageSize(P);
            V != null && (l.bind(n, U.LINEAR, P, B), p.setUniform2fv("u_mosaicSize", V), p.setUniform1i("u_texture", B), n.drawElements(A.TRIANGLES, X[1], E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * X[0]));
          }
        } else n.drawElements(A.TRIANGLES, M.lineIndexCount, E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * M.lineIndexStart);
        C.triangleCount += M.lineIndexCount / 3;
      }
    }
  }
}
const On = 256 / 360, An = 1 / Math.LN2;
function Pn(u, e) {
  return (u %= e) >= 0 ? u : u + e;
}
function He(u) {
...
function mi(u) {
  return Math.log(u) * An;
}
const Dn = 1 / 65536;
class Ln extends H {
  constructor() {
    super(...arguments), this._iconProgramOptions = { id: !1, sdf: !1 }, this._sdfProgramOptions = { id: !1 }, this._spritesTextureSize = ht();
  }
  dispose() {
  }
  drawMany(e, t) {
  ...
  _drawIcons(e, t, n) {
    const { context: i, displayLevel: o, painter: a, spriteMosaic: r, state: l, styleLayerUID: s, requestRender: c, allowDelayedRender: _ } = e, f = t.iconMaterial, g = a.vectorTilesMaterialManager;
    let d, h = !1;
    ...
    if (!h) return;
    const S = t.getPaintValue("icon-translate", o), O = t.getPaintValue("icon-translate-anchor", o);
    let I = t.getLayoutValue("icon-rotation-alignment", o);
    I === G.AUTO && (I = t.getLayoutValue("symbol-placement", o) === Re.POINT ? G.VIEWPORT : G.MAP);
    const x = I === G.MAP, T = t.getLayoutValue("icon-keep-upright", o) && x, m = d.isIconSDF, v = this._iconProgramOptions;
    v.sdf = m;
    const y = g.getMaterialProgram(i, f, v);
    if (_ && c != null && !y.compiled) return void c();
    i.useProgram(y), y.setUniformMatrix3fv("u_displayViewMat3", I === G.MAP ? l.displayViewMat3 : l.displayMat3), y.setUniformMatrix3fv("u_displayMat3", O === J.VIEWPORT ? l.displayMat3 : l.displayViewMat3), y.setUniform2fv("u_iconTranslation", S), y.setUniform1f("u_depth", t.z), y.setUniform1f("u_mapRotation", He(l.rotation)), y.setUniform1f("u_keepUpright", T ? 1 : 0), y.setUniform1f("u_level", 10 * o), y.setUniform1i("u_texture", B), y.setUniform1f("u_fadeDuration", ze / 1e3);
    let b = -1;
    for (const p of n) {
      if (!p.layerData.has(s) || (p.key.level !== b && (b = p.key.level, f.setDataUniforms(y, o, t, b, r)), d = p.layerData.get(s), d.iconPerPageElementsMap.size === 0)) continue;
      d.prepareForRendering(i), d.updateOpacityInfo();
      const D = d.iconVAO;
      if (D != null) {
        i.bindVAO(D), y.setUniformMatrix3fv("u_dvsMat3", p.transforms.displayViewScreenMat3), y.setUniform1f("u_time", (performance.now() - d.lastOpacityUpdate) / 1e3);
        for (const [C, R] of d.iconPerPageElementsMap) this._renderIconRange(e, y, R, C, p);
      }
    }
  }
  _renderIconRange(e, t, n, i, o) {
    const { context: a, spriteMosaic: r } = e;
    this._spritesTextureSize[0] = r.getWidth(i) / 4, this._spritesTextureSize[1] = r.getHeight(i) / 4, t.setUniform2fv("u_mosaicSize", this._spritesTextureSize), r.bind(a, U.LINEAR, i, B), this._setStencilState(e, o), a.drawElements(A.TRIANGLES, n[1], E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * n[0]), o.triangleCount += n[1] / 3;
  }
  _drawText(e, t, n) {
    const { context: i, displayLevel: o, glyphMosaic: a, painter: r, pixelRatio: l, spriteMosaic: s, state: c, styleLayerUID: _, requestRender: f, allowDelayedRender: g } = e, d = t.textMaterial, h = r.vectorTilesMaterialManager;
    let S, O = !1;
    for (const V of n) if (V.layerData.has(_) && (S = V.layerData.get(_), S.glyphPerPageElementsMap.size > 0)) {
      O = !0;
      break;
    }
    if (!O) return;
    const I = t.getPaintProperty("text-opacity");
    if (I && !I.isDataDriven && I.getValue(o) === 0) return;
    const x = t.getPaintProperty("text-color"), T = !x || x.isDataDriven || x.getValue(o)[3] > 0, m = t.getPaintProperty("text-halo-width"), v = t.getPaintProperty("text-halo-color"), y = (!m || m.isDataDriven || m.getValue(o) > 0) && (!v || v.isDataDriven || v.getValue(o)[3] > 0);
    if (!T && !y) return;
    const b = 24 / 8;
    let p = t.getLayoutValue("text-rotation-alignment", o);
    p === G.AUTO && (p = t.getLayoutValue("symbol-placement", o) === Re.POINT ? G.VIEWPORT : G.MAP);
    const D = p === G.MAP, C = t.getLayoutValue("text-keep-upright", o) && D, R = 0.8 * b / l;
    this._glyphTextureSize || (this._glyphTextureSize = xt(a.width / 4, a.height / 4));
    const M = t.getPaintValue("text-translate", o), K = t.getPaintValue("text-translate-anchor", o), ae = this._sdfProgramOptions, P = h.getMaterialProgram(i, d, ae);
    if (g && f != null && !P.compiled) return void f();
    i.useProgram(P), P.setUniformMatrix3fv("u_displayViewMat3", p === G.MAP ? c.displayViewMat3 : c.displayMat3), P.setUniformMatrix3fv("u_displayMat3", K === J.VIEWPORT ? c.displayMat3 : c.displayViewMat3), P.setUniform2fv("u_textTranslation", M), P.setUniform1f("u_depth", t.z + Dn), P.setUniform2fv("u_mosaicSize", this._glyphTextureSize), P.setUniform1f("u_mapRotation", He(c.rotation)), P.setUniform1f("u_keepUpright", C ? 1 : 0), P.setUniform1f("u_level", 10 * o), P.setUniform1i("u_texture", De), P.setUniform1f("u_antialiasingWidth", R), P.setUniform1f("u_fadeDuration", ze / 1e3);
    let X = -1;
    for (const V of n) {
      if (!V.layerData.has(_) || (V.key.level !== X && (X = V.key.level, d.setDataUniforms(P, o, t, X, s)), S = V.layerData.get(_), S.glyphPerPageElementsMap.size === 0)) continue;
      S.prepareForRendering(i), S.updateOpacityInfo();
      const Ce = S.textVAO;
      if (Ce == null) continue;
      i.bindVAO(Ce), P.setUniformMatrix3fv("u_dvsMat3", V.transforms.displayViewScreenMat3), this._setStencilState(e, V);
      const ct = (performance.now() - S.lastOpacityUpdate) / 1e3;
      P.setUniform1f("u_time", ct), S.glyphPerPageElementsMap.forEach((ut, ft) => {
        this._renderGlyphRange(i, ut, ft, a, P, y, T, V);
      });
    }
  }
  _renderGlyphRange(e, t, n, i, o, a, r, l) {
    i.bind(e, U.LINEAR, n, De), a && (o.setUniform1f("u_halo", 1), e.drawElements(A.TRIANGLES, t[1], E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * t[0]), l.triangleCount += t[1] / 3), r && (o.setUniform1f("u_halo", 0), e.drawElements(A.TRIANGLES, t[1], E.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * t[0]), l.triangleCount += t[1] / 3);
  }
  _setStencilState(e, t) {
    const { context: n, is3D: i, stencilSymbols: o } = e;
    if (n.setStencilTestEnabled(!0), o) return n.setStencilWriteMask(255), void n.setStencilFunction(w.ALWAYS, t.stencilRef, 255);
    n.setStencilWriteMask(0), i ? n.setStencilFunction(w.EQUAL, t.stencilRef, 255) : n.setStencilFunction(w.GREATER, 255, 255);
  }
}
const Rn = { clip: tn, stencil: an, bitmap: Yt, overlay: on, tileDebugInfo: bn, vtlBackground: Tn, vtlFill: Cn, vtlLine: En, vtlCircle: In, vtlSymbol: Ln }, zn = (u) => {
  switch (u.BYTES_PER_ELEMENT) {
    case 1:
  ...
  let i = 0;
  for (let o = 1; o < t; o++) {
    const a = u[2 * (e + o - 1)], r = u[2 * (e + o - 1) + 1];
    i += (u[2 * (e + o)] - a) * (u[2 * (e + o) + 1] + r);
  }
  return n ? i > 0 : i < 0;
}, We = ({ coords: u, lengths: e }, t) => {
  const n = [];
  for (let i = 0, o = 0; i < e.length; o += e[i], i += 1) {
    const a = o, r = [];
    for (; i < e.length - 1 && Mn(u, o + e[i], e[i + 1], t); i += 1, o += e[i]) r.push(o + e[i] - a);
    const l = u.slice(2 * a, 2 * (o + e[i])), s = Bt(l, r, 2);
...
class F {
  ...
  static fromPath(e) {
    const t = yt(new Ae(), e.path, !1, !1), n = t.coords, i = new Uint32Array(We(t, !0)), o = new Uint32Array(n.length / 2);
    for (let a = 0; a < o.length; a++) o[a] = z(Math.floor(n[2 * a]), Math.floor(n[2 * a + 1]));
    return new F({ geometry: o }, i, A.TRIANGLES);
  }
  static fromGeometry(e, t) {
    const n = t.geometry?.type;
    switch (n) {
      case "polygon":
        return F.fromPolygon(e, t.geometry);
      case "extent":
        return F.fromMapExtent(e, t.geometry);
      default:
        return be.getLogger("esri.views.2d.engine.webgl.Mesh2D").error(new Te("mapview-bad-type", `Unable to create a mesh from type ${n}`, t)), F.fromScreenExtent({ xmin: 0, ymin: 0, xmax: 1, ymax: 1 });
    }
  }
  static fromPolygon(e, t) {
    const n = St(new Ae(), t, !1, !1), i = n.coords, o = new Uint32Array(We(n, !1)), a = new Uint32Array(i.length / 2), r = Pe(), l = Pe();
    for (let s = 0; s < a.length; s++) bt(r, i[2 * s], i[2 * s + 1]), e.toScreen(l, r), a[s] = z(Math.floor(l[0]), Math.floor(l[1]));
    return new F({ geometry: a }, o, A.TRIANGLES, !0);
  }
  static fromScreenExtent({ xmin: e, xmax: t, ymin: n, ymax: i }) {
    const o = { geometry: new Uint32Array([z(e, n), z(t, n), z(e, i), z(e, i), z(t, n), z(t, i)]) }, a = new Uint32Array([0, 1, 2, 3, 4, 5]);
    return new F(o, a, A.TRIANGLES);
  }
  static fromMapExtent(e, t) {
    const [n, i] = e.toScreen([0, 0], [t.xmin, t.ymin]), [o, a] = e.toScreen([0, 0], [t.xmax, t.ymax]), r = { geometry: new Uint32Array([z(n, i), z(o, i), z(n, a), z(n, a), z(o, i), z(o, a)]) }, l = new Uint32Array([0, 1, 2, 3, 4, 5]);
    return new F(r, l, A.TRIANGLES);
  }
  destroy() {
...
class Ie extends je {
  constructor(e, t) {
    super(), this._clip = t, this._cache = {}, this.stage = e, this._handle = Tt(() => t.version, () => this._invalidate()), this.ready();
  }
  ...
  getVAO(e, t, n, i) {
    ...
    if (this._clip.type !== "geometry" && this._lastWidth === o && this._lastHeight === a || (this._lastWidth = o, this._lastHeight = a, this._destroyGL()), this._cache.vao == null) {
      ...
      this._cache.mesh = r, this._cache.vao = new Z(e, n, i, s, l);
    }
    return this._cache.vao;
  }
  _createTransforms() {
    return { displayViewScreenMat3: ne() };
  }
  _invalidate() {
  ...
  _createMesh(e, t) {
    switch (t.type) {
      case "rect":
        return F.fromScreenExtent(It(t, e.size[0], e.size[1]));
      case "path":
        return F.fromPath(t);
      case "geometry":
        return F.fromGeometry(e, t);
      default:
        return be.getLogger("esri.views.2d.engine.webgl.ClippingInfo").error(new Te("mapview-bad-type", "Unable to create ClippingInfo mesh from clip of type: ${clip.type}")), F.fromScreenExtent({ xmin: 0, ymin: 0, xmax: 1, ymax: 1 });
    }
  }
}
class pi extends Vt {
  ...
  prepareRenderPasses(e) {
    return [e.registerRenderPass({ name: "clip", brushes: [Rn.clip], target: () => this._clippingInfos, drawPhase: ee.MAP | ee.LABEL | ee.LABEL_ALPHA | ee.DEBUG | ee.HIGHLIGHT })];
  }
  _updateClippingInfo(e) {
    this._clippingInfos != null && (this._clippingInfos.forEach((t) => t.destroy()), this._clippingInfos = null), e != null && e.length && (this._clippingInfos = e.items.map((t) => Ie.fromClipArea(this.stage, t))), this.requestRender();
  }
}
export {
  an as _,
...
//# sourceMappingURL=WGLContainer-TDEKqET4.js.map
