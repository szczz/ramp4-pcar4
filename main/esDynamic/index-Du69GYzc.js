import { bY as o, iS as a, c1 as c, c3 as h, c2 as r, c8 as u, ca as m, cb as f, cf as v, g1 as d, cc as g, fV as s, hG as x, hI as _ } from "./main-lm2DHsZh.js";
import { _ as A } from "./screen.vue_vue_type_script_setup_true_lang-BRhzq2jV.js";
class $ extends o {
  /**
   * Toggles help panel
   *
...
const w = /* @__PURE__ */ c({
  __name: "nav-button",
  setup(n) {
    const t = h("iApi"), { t: e } = r(), i = () => t.event.emit(d.HELP_TOGGLE);
    return (S, p) => {
...
//# sourceMappingURL=index-Du69GYzc.js.map
