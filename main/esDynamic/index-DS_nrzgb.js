import { bY as m, hJ as n, hG as u, hH as b } from "./main-lm2DHsZh.js";
import { T as o } from "./table-state-manager-CQv-OGS1.js";
class x extends m {
...
class S extends x {
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => u(import("./screen-B9nDYRTZ.js"))
          },
          style: {
            width: "450px"
          },
  ...
  removed() {
    this.$iApi.fixture.exists("appbar") && b(this.$vApp.$pinia).removeButton("grid"), n(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("grid");
  }
}
export {
  S as default
};
//# sourceMappingURL=index-DS_nrzgb.js.map
