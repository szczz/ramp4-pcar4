import { bx as f, iH as p, iB as a, iw as l, iI as y, ha as g, iJ as w } from "./main-BVGiskS7.js";
import h from "./screen-By-6sz2A.js";
class m extends f {
  /**
...
class z extends p {
  ...
  async getFeatureInfo(e) {
    ...
    return {
      config: {
        ...
        tooltipField: r.data.displayField,
        state: { opacity: 1, visibility: !0 }
      },
  ...
  async getWfsInfo(e) {
    const r = new y(e), { offset: i, limit: t } = r.queryMap, d = await this.$iApi.geo.layer.ogc.loadWfsData(
      e,
      -1,
      parseInt(i) || 0,
      parseInt(t) || 1e3
    );
    return this.getGeojsonInfo(e.match(/\/([^/]+)\/items/)?.[1] || "Layer", d);
  }
  /**
...
class S extends m {
  added() {
    ...
    let e = new z(this.$iApi);
    const r = w(this.$vApp.$pinia);
...
//# sourceMappingURL=index-BTIZrOGy.js.map
