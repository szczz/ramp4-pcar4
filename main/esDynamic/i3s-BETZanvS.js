import { u as un } from "./main-lm2DHsZh.js";
...
It = Ht, it = typeof document < "u" && document.currentScript ? document.currentScript.src : void 0, Ot = function(J = {}) {
  ...
  function Zt(t) {
    return U || !ut && !D || typeof fetch != "function" ? Promise.resolve().then(() => gt(t)) : fetch(t, { credentials: "same-origin" }).then((e) => {
      if (!e.ok) throw "failed to load wasm binary file at '" + t + "'";
      return e.arrayBuffer();
    }).catch(() => gt(t));
  }
  function yt(t, e, n) {
    return Zt(t).then((r) => WebAssembly.instantiate(r, e)).then((r) => r).then(n, (r) => {
      F("failed to asynchronously prepare wasm: " + r), B(r);
    });
  }
  function Jt(t, e, n, r) {
    return t || typeof WebAssembly.instantiateStreaming != "function" || mt(e) || typeof fetch != "function" ? yt(e, n, r) : fetch(e, { credentials: "same-origin" }).then((o) => WebAssembly.instantiateStreaming(o, n).then(r, function(u) {
      return F("wasm streaming compile failed: " + u), F("falling back to ArrayBuffer instantiation"), yt(e, n, r);
    }));
  }
  function Kt() {
  ...
  function Y(t) {
    var e = q[t];
    return e || (t >= q.length && (q.length = t + 1), q[t] = e = ft.get(t)), e;
  }
  function Qt(t, e) {
    Y(t)(e);
  }
  function Yt(t) {
    this.excPtr = t, this.ptr = t - 24, this.set_type = function(e) {
      ...
      e = e ? 1 : 0, E[this.ptr + 12 | 0] = e;
    }, this.get_caught = function() {
      return E[this.ptr + 12 | 0] != 0;
    }, this.set_rethrown = function(e) {
      e = e ? 1 : 0, E[this.ptr + 13 | 0] = e;
  ...
  function re(t) {
    ...
    return e >= ee && e <= ne ? "_" + t : t;
  }
  function ie(t, e) {
    return t = re(t), { [t]: function() {
      return e.apply(this, arguments);
    } }[t];
  }
  function tt(t, e) {
    var n = ie(e, function(r) {
...
` + o.replace(/^Error(:[^\n]*)?\n/, ""));
  ...
  function At(t, e, n) {
    ...
    var o = new Array(e.length), u = [], c = 0;
    e.forEach((a, s) => {
  ...
  function oe(t) {
    var e = N[t];
    delete N[t];
    var n = e.rawConstructor, r = e.rawDestructor, o = e.fields;
    At([t], o.map((u) => u.getterReturnType).concat(o.map((u) => u.setterArgumentType)), (u) => {
      ...
      }), [{ name: e.name, fromWireType: function(a) {
        var s = {};
  ...
  function A(t, e, n = {}) {
    ...
    if (j[t] = e, delete $[t], S.hasOwnProperty(t)) {
      var o = S[t];
  ...
  function ce(t, e, n, r, o) {
    var u = et(n);
    A(t, { name: e = h(e), fromWireType: function(c) {
      return !!c;
  ...
  function se() {
    this.allocated = [void 0], this.freelist = [], this.get = function(t) {
      ...
      let e = this.freelist.pop() || this.allocated.length;
  ...
  function fe() {
    for (var t = 0, e = g.reserved; e < g.allocated.length; ++e) g.allocated[e] !== void 0 && ++t;
    return t;
  }
  function le() {
    g.allocated.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), g.reserved = g.allocated.length, i.count_emval_handles = fe;
  }
  ...
  function de(t, e) {
    A(t, { name: e = h(e), fromWireType: function(n) {
      var r = G.toValue(n);
      return Pt(n), r;
  ...
  function pe(t, e) {
    switch (e) {
      case 2:
        return function(n) {
          return this.fromWireType(ct[n >> 2]);
        };
      case 3:
        return function(n) {
          return this.fromWireType(st[n >> 3]);
        };
      default:
  ...
  function ve(t, e, n) {
    var r = et(n);
    A(t, { name: e = h(e), fromWireType: function(o) {
      return o;
    }, toWireType: function(o, u) {
      return u;
    }, argPackAdvance: 8, readValueFromPointer: pe(e, r), destructorFunction: null });
  }
  function he(t, e, n, r, o, u) {
    var c = e.length;
    c < 2 && m("argTypes array size mismatch! Must at least get return value and 'this' types!");
    for (var a = e[1] !== null && n !== null, s = !1, f = 1; f < e.length; ++f) if (e[f] !== null && e[f].destructorFunction === void 0) {
      s = !0;
      break;
    }
    var l = e[0].name !== "void", d = c - 2, C = new Array(d), y = [], _ = [];
    return function() {
      var P;
      arguments.length !== d && m("function " + t + " called with " + arguments.length + " arguments, expected " + d + " args!"), _.length = 0, y.length = a ? 2 : 1, y[0] = o, a && (P = e[1].toWireType(_, this), y[1] = P);
      for (var w = 0; w < d; ++w) C[w] = e[w + 2].toWireType(_, arguments[w]), y.push(C[w]);
      function rt(Z) {
        if (s) _t(_);
        else for (var x = a ? 1 : 2; x < e.length; x++) {
          var an = x === 1 ? P : C[x - 2];
          e[x].destructorFunction !== null && e[x].destructorFunction(an);
        }
        if (l) return e[0].fromWireType(Z);
      }
  ...
  function me(t, e, n) {
    if (t[e].overloadTable === void 0) {
      var r = t[e];
      t[e] = function() {
        return t[e].overloadTable.hasOwnProperty(arguments.length) || m("Function '" + n + "' called with an invalid number of arguments (" + arguments.length + ") - expects one of (" + t[e].overloadTable + ")!"), t[e].overloadTable[arguments.length].apply(this, arguments);
      }, t[e].overloadTable = [], t[e].overloadTable[r.argCount] = r;
    }
  }
  function ge(t, e, n) {
    i.hasOwnProperty(t) ? ((n === void 0 || i[t].overloadTable !== void 0 && i[t].overloadTable[n] !== void 0) && m("Cannot register public name '" + t + "' twice"), me(i, t, t), i.hasOwnProperty(n) && m("Cannot register multiple overloads of a function with the same number of arguments (" + n + ")!"), i[t].overloadTable[n] = e) : (i[t] = e, n !== void 0 && (i[t].numArguments = n));
  }
  function ye(t, e) {
    for (var n = [], r = 0; r < t; r++) n.push(p[e + 4 * r >> 2]);
    return n;
  }
  function _e(t, e, n) {
    i.hasOwnProperty(t) || bt("Replacing nonexistant public symbol"), i[t].overloadTable !== void 0 && n !== void 0 ? i[t].overloadTable[n] = e : (i[t] = e, i[t].argCount = n);
  }
  function we(t, e, n) {
    var r = i["dynCall_" + t];
  ...
  function be(t, e, n) {
    return t.includes("j") ? we(t, e, n) : Y(e).apply(null, n);
  }
  function Ae(t, e) {
    var n = [];
    return function() {
      return n.length = 0, Object.assign(n, arguments), be(t, e, n);
    };
  }
  function H(t, e) {
    function n() {
      return t.includes("j") ? Ae(t, e) : Y(e);
    }
    t = h(t);
    var r = n();
    return typeof r != "function" && m("unknown function pointer with signature " + t + ": " + e), r;
  }
  var Et = void 0;
  function Wt(t) {
    var e = St(t), n = h(e);
  ...
  function Te(t, e) {
    var n = [], r = {};
    function o(u) {
      r[u] || j[u] || ($[u] ? $[u].forEach(o) : (n.push(u), r[u] = !0));
    }
    throw e.forEach(o), new Et(t + ": " + n.map(Wt).join([", "]));
  }
  function Ce(t, e, n, r, o, u, c) {
    var a = ye(e, n);
    t = h(t), o = H(r, o), ge(t, function() {
      Te("Cannot call " + t + " due to unbound types", a);
    }, e - 1), At([], a, function(s) {
      var f = [s[0], null].concat(s.slice(1));
      return _e(t, he(t, f, null, o, u), e - 1), [];
    });
  }
  function Pe(t, e, n) {
    switch (e) {
  ...
  function Ee(t, e, n, r, o) {
    ...
    var s = e.includes("unsigned"), f = (l, d) => {
    };
    A(t, { name: e, fromWireType: c, toWireType: s ? function(l, d) {
      return f(d, this.name), d >>> 0;
    } : function(l, d) {
      return f(d, this.name), d;
    }, argPackAdvance: 8, readValueFromPointer: Pe(e, u, r !== 0), destructorFunction: null });
  }
  function We(t, e, n) {
    ...
    A(t, { name: n = h(n), fromWireType: o, argPackAdvance: 8, readValueFromPointer: o }, { ignoreDuplicateRegistrations: !0 });
  }
  function ke(t, e, n, r) {
    if (!(r > 0)) return 0;
    for (var o = n, u = n + r - 1, c = 0; c < t.length; ++c) {
  ...
  function jt(t, e, n) {
    ...
    if (o - e > 16 && t.buffer && kt) return kt.decode(t.subarray(e, o));
    for (var u = ""; e < o; ) {
      var c = t[e++];
      if (128 & c) {
        var a = 63 & t[e++];
        if ((224 & c) != 192) {
          var s = 63 & t[e++];
          if ((c = (240 & c) == 224 ? (15 & c) << 12 | a << 6 | s : (7 & c) << 18 | a << 12 | s << 6 | 63 & t[e++]) < 65536) u += String.fromCharCode(c);
          else {
            var f = c - 65536;
  ...
  function Se(t, e) {
    var n = (e = h(e)) === "std::string";
    A(t, { name: e, fromWireType: function(r) {
      var o, u = p[r >> 2], c = r + 4;
      if (n) for (var a = c, s = 0; s <= u; ++s) {
        var f = c + s;
        if (s == u || v[f] == 0) {
          var l = Re(a, f - a);
      ...
      c || o instanceof Uint8Array || o instanceof Uint8ClampedArray || o instanceof Int8Array || m("Cannot pass non-string to std::string"), u = n && c ? Fe(o) : o.length;
      var a = nt(4 + u + 1), s = a + 4;
      if (p[a >> 2] = u, n && c) je(o, s, u + 1);
  ...
  function xe(t, e) {
    for (var n = t, r = n >> 1, o = r + e / 2; !(r >= o) && M[r]; ) ++r;
    if ((n = r << 1) - t > 32 && Ft) return Ft.decode(v.subarray(t, n));
    for (var u = "", c = 0; !(c >= e / 2); ++c) {
      var a = R[t + 2 * c >> 1];
      if (a == 0) break;
  ...
  function Ue(t, e, n) {
    ...
    for (var r = e, o = (n -= 2) < 2 * t.length ? n / 2 : t.length, u = 0; u < o; ++u) {
  ...
  function He(t, e, n) {
    ...
    for (var r = e, o = r + n - 4, u = 0; u < t.length; ++u) {
      var c = t.charCodeAt(u);
      if (c >= 55296 && c <= 57343 && (c = 65536 + ((1023 & c) << 10) | 1023 & t.charCodeAt(++u)), W[e >> 2] = c, (e += 4) + 4 > o) break;
    }
    return W[e >> 2] = 0, e - r;
  }
  function ze(t) {
  ...
  function De(t, e, n) {
    var r, o, u, c, a;
    n = h(n), e === 2 ? (r = xe, o = Ue, c = Ie, u = () => M, a = 1) : e === 4 && (r = Oe, o = He, c = ze, u = () => p, a = 2), A(t, { name: n, fromWireType: function(s) {
      for (var f, l = p[s >> 2], d = u(), C = s + 4, y = 0; y <= l; ++y) {
        var _ = s + 4 + y * e;
        if (y == l || d[_ >> a] == 0) {
          var P = r(C, _ - C);
          f === void 0 ? f = P : (f += "\0", f += P), C = _ + e;
        }
      }
      return T(s), f;
    }, toWireType: function(s, f) {
      typeof f != "string" && m("Cannot pass non-string to C++ string type " + n);
      var l = c(f), d = nt(4 + l + e);
      return p[d >> 2] = l >> a, o(f, d + 4, l + e), s !== null && s.push(T, d), d;
    }, argPackAdvance: 8, readValueFromPointer: L, destructorFunction: function(s) {
      T(s);
    } });
  }
  function Ve(t, e, n, r, o, u) {
    N[t] = { name: h(e), rawConstructor: H(n, r), rawDestructor: H(o, u), fields: [] };
  }
  function Me(t, e, n, r, o, u, c, a, s, f) {
    N[t].fields.push({ fieldName: h(e), getterReturnType: n, getter: H(r, o), getterContext: u, setterArgumentType: c, setter: H(a, s), setterContext: f });
  }
  function Be(t, e) {
    A(t, { isVoid: !0, name: e = h(e), argPackAdvance: 0, fromWireType: function() {
    }, toWireType: function(n, r) {
    } });
  }
  function qe(t) {
  ...
  function $e(t) {
    return G.toHandle(Le(t));
  }
  function Ge(t, e) {
    var n = j[t];
    return n === void 0 && m(e + " has unknown type " + Wt(t)), n;
  }
  function Xe(t, e) {
    var n = (t = Ge(t, "_emval_take_value")).readValueFromPointer(e);
    return G.toHandle(n);
  }
  function Ze() {
    B("");
  ...
  function Qe(t) {
    var e = V.buffer;
    try {
      return V.grow(t - e.byteLength + 65535 >>> 16), dt(), 1;
    } catch {
    }
  }
  function Ye(t) {
    ...
    for (var o = 1; o <= 4; o *= 2) {
      var u = e * (1 + 0.2 / o);
      if (u = Math.min(u, t + 100663296), Qe(Math.min(n, r(Math.max(t, u), 65536)))) return !0;
    }
    return !1;
  }
  function tn(t) {
  ...
  function rn(t, e) {
    var n = nn[t];
    e === 0 || e === 10 ? ((t === 1 ? Dt : F)(jt(n, 0)), n.length = 0) : n.push(e);
  }
  function on(t, e, n, r) {
    for (var o = 0, u = 0; u < n; u++) {
      var c = p[e >> 2], a = p[e + 4 >> 2];
      e += 8;
      for (var s = 0; s < a; s++) rn(t, v[c + s]);
      o += a;
    }
    return p[r >> 2] = o, 0;
  }
  wt = i.InternalError = tt(Error, "InternalError"), ue(), Ct = i.BindingError = tt(Error, "BindingError"), le(), Et = i.UnboundTypeError = tt(Error, "UnboundTypeError");
  var Rt = { __call_sighandler: Qt, __cxa_throw: te, _embind_finalize_value_object: oe, _embind_register_bigint: ae, _embind_register_bool: ce, _embind_register_emval: de, _embind_register_float: ve, _embind_register_function: Ce, _embind_register_integer: Ee, _embind_register_memory_view: We, _embind_register_std_string: Se, _embind_register_std_wstring: De, _embind_register_value_object: Ve, _embind_register_value_object_field: Me, _embind_register_void: Be, _emval_decref: Pt, _emval_incref: qe, _emval_new_cstring: $e, _emval_take_value: Xe, abort: Ze, emscripten_memcpy_big: Je, emscripten_resize_heap: Ye, fd_close: tn, fd_seek: en, fd_write: on };
  Kt();
  var nt = function() {
    return (nt = i.asm.malloc).apply(null, arguments);
  }, T = function() {
...
const cn = un(Ht.exports), fn = Object.freeze(Object.defineProperty({ __proto__: null, default: cn }, Symbol.toStringTag, { value: "Module" }));
export {
  fn as i
};
//# sourceMappingURL=i3s-BETZanvS.js.map
