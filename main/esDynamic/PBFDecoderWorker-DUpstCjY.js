import { hN as d, bx as c, dS as p, hO as f, dl as m, hP as y, hQ as _, hR as g } from "./main-lm2DHsZh.js";
let b = class {
  constructor(t, e, s) {
...
class R {
  ...
  _deriveApplyTransform(t) {
    ...
    return e && s ? v : e ? u : s ? A : l;
  }
}
class T {
  _parseFeatureQuery(t) {
    const e = new R(t.options), s = g(t.buffer, e), r = { ...s, spatialReference: s.spatialReference?.toJSON(), fields: s.fields ? s.fields.map((n) => n.toJSON()) : void 0, missingAttributes: e.missingAttributes };
...
//# sourceMappingURL=PBFDecoderWorker-DUpstCjY.js.map
