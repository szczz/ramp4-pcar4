import { a0 as S, a as F, m as p, B as i, b as o, r as l } from "./arcadeUtils-BPQamVKT.js";
import { s as w } from "./TimeOnly-CCn2Gvs1.js";
import { u as c, f as h } from "./SpatialFilter-CQ7CjOeG.js";
import { eU as u } from "./main-lm2DHsZh.js";
import { relate as I, crosses as A, touches as P, within as g, overlaps as C, contains as O, intersects as R } from "./geometryEngineAsync-nyTI7qeG.js";
function f(r) {
...
function a(r, t, s, d) {
  return d(r, t, async (y, e, n) => {
    ...
    if (n[0] === null) {
      if (i(n[1])) return new c({ parentfeatureset: n[1] });
      if (n[1] instanceof u || n[1] === null) return !1;
    }
    throw new o(r, l.InvalidParameter, t);
  });
}
function T(r) {
  r.mode === "async" && (r.functions.intersects = function(t, s) {
    ...
    return r.standardFunctionAsync(t, s, async (d, y, e) => {
...
//# sourceMappingURL=featuresetgeom-CwxLFCg1.js.map
