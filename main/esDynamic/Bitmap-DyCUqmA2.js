import { ad as p, fr as c, bK as x, bM as u, bN as a, bP as _, fs as g, bL as m, ft as f, bI as w } from "./main-lm2DHsZh.js";
import { s as B } from "./Container-CkDvNCAj.js";
import { P as k, G as b, D as R } from "./enums-DDkmfb-t.js";
import { e as S, c as v } from "./Texture-DhDvGrgF.js";
class y {
  constructor(t, e, i) {
...
function A(s) {
  return T(s) ? s instanceof y ? s.getRenderedRasterPixels()?.renderedRasterPixels : M(s) : s;
}
class G extends B {
  ...
  setTransform(t) {
    ...
    u(e, e, a(i, r)), u(e, e, a(o / 2, l / 2)), _(e, e, -n), u(e, e, a(-o / 2, -l / 2)), g(e, e, a(o, l)), m(this.transforms.displayViewScreenMat3, t.displayViewMat3, e);
  }
  ...
  _createTexture(t) {
    const e = this.immutable, i = new S();
    return i.internalFormat = e ? k.RGBA8 : b.RGBA, i.wrapMode = R.CLAMP_TO_EDGE, i.isImmutable = e, i.width = this._sourceWidth, i.height = this._sourceHeight, new v(t, i);
  }
}
export {
  G as b,
...
//# sourceMappingURL=Bitmap-DyCUqmA2.js.map
