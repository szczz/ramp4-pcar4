import { cF as v, cG as g, cE as f, cD as n } from "./main-BVGiskS7.js";
import { s as k, r as m, f as x } from "./form-D7modeeC.js";
import { c as w, d as y, u as C, I as z } from "./interactive-MFA4f6-y.js";
import { c as E, d as L, g as S } from "./label2-BaEz5e-W.js";
import { s as T, a as O, c as F } from "./loadable-1oO4BxTG.js";
import { c as I, a as M, d as R, b as A, s as H, u as j } from "./t9n-BNuTqDLk.js";
import { c as r } from "./observers-3PE_HtlV.js";
import { g as i } from "./component-CR3VB33V.js";
import { t as B } from "./dom-C63VhwMK.js";
import { d as D } from "./icon-DI4LdGPl.js";
import { d as G } from "./loader-CQj5sP7u.js";
/*!
...
const e = {
  ...
  loadingChanged(t, a) {
    t && !a && (this.hasLoader = !0), !t && a && window.setTimeout(() => {
      this.hasLoader = !1;
    }, 300);
  }
  onMessagesChange() {
  ...
  async connectedCallback() {
    w(this), I(this), M(this), this.hasLoader = this.loading, this.setupTextContentObserver(), E(this), this.formEl = x(this);
  }
  disconnectedCallback() {
    this.mutationObserver?.disconnect(), y(this), L(this), R(this), A(this), this.resizeObserver?.disconnect(), this.formEl = null;
  }
  async componentWillLoad() {
    T(this), this.updateHasContent(), await H(this);
  }
  componentDidLoad() {
    O(this), this.setTooltipText();
  }
  componentDidRender() {
    C(this);
  }
  render() {
    const t = this.href ? "a" : "button", a = t, d = this.hasLoader ? n("div", { class: e.buttonLoader }, n("calcite-loader", { class: this.loading ? e.loadingIn : e.loadingOut, inline: !0, label: this.messages.loading, scale: this.scale === "l" ? "m" : "s" })) : null, o = !this.iconStart && !this.iconEnd, h = n("calcite-icon", { class: { [e.icon]: !0, [e.iconStart]: !0 }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: i(this.scale) }), u = n("calcite-icon", { class: { [e.icon]: !0, [e.iconEnd]: !0 }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: i(this.scale) }), p = n("span", { class: e.content, ref: (b) => this.contentEl = b }, n("slot", null));
    return n(z, { disabled: this.disabled }, n(a, {
      "aria-disabled": t === "a" ? B(this.disabled || this.loading) : null,
      "aria-expanded": this.el.getAttribute("aria-expanded"),
      "aria-label": this.loading ? this.messages.loading : S(this),
      "aria-live": "polite",
      class: {
        [e.buttonPadding]: o,
        [e.buttonPaddingShrunk]: !o,
        [e.contentSlotted]: this.hasContent,
        [e.iconStartEmpty]: !this.iconStart,
        [e.iconEndEmpty]: !this.iconEnd
      },
      disabled: t === "button" ? this.disabled || this.loading : null,
      href: t === "a" && this.href,
      name: t === "button" && this.name,
      onClick: this.handleClick,
      rel: t === "a" && this.rel,
      tabIndex: this.disabled ? -1 : null,
      target: t === "a" && this.target,
      title: this.tooltipText,
      type: t === "button" && this.type,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setChildEl
    }, d, this.iconStart ? h : null, this.hasContent ? p : null, this.iconEnd ? u : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
  ...
  async setFocus() {
    await F(this), this.childEl?.focus();
  }
  effectiveLocaleChange() {
    j(this, this.effectiveLocale);
  }
  updateHasContent() {
...
//# sourceMappingURL=calcite-button-daROchj3.js.map
