import { bY as a, hG as l, hH as r } from "./main-lm2DHsZh.js";
import o from "./screen-CQtJ2vPk.js";
class g extends a {
  /**
  ...
  toggleSettings(e, s) {
    ...
    if (!t.isOpen && s !== !1)
      ...
      const n = t.route.props.layer.uid;
      s !== !0 && t.close(), n !== e.uid && setTimeout(() => {
        this.$iApi.panel.open({
          id: "settings",
          props: { layer: e }
        });
...
//# sourceMappingURL=index-CfbRTvvi.js.map
