import { m as A } from "./WGLContainer-TDEKqET4.js";
import { E as f, c as v } from "./Program-CfcTPgr7.js";
import { D as l, L as p, F as X, _ as I, E as Q, G as R, U } from "./enums-DDkmfb-t.js";
import { e as g, c as M } from "./Texture-DhDvGrgF.js";
import { o as P } from "./ProgramTemplate-C6PXKuso.js";
import { fE as S } from "./main-lm2DHsZh.js";
class c {
...
function F(t, s) {
  ...
  return e ? new c(() => t.createQuery(), (r) => {
    t.deleteQuery(r), i = !1;
  ...
  }, (r) => e.queryCounterEXT(r, e.TIMESTAMP_EXT), () => t.getQuery(e.TIMESTAMP_EXT, e.QUERY_COUNTER_BITS_EXT)) : (e = t.getExtension("EXT_disjoint_timer_query"), e ? new c(() => e.createQueryEXT(), (r) => {
...
class N extends x {
  ...
  _test(s) {
    ...
    const n = new f(e, r), u = v.createVertex(e, X.STATIC_DRAW, new Uint16Array([0, 0, 1, 0, 0, 1, 1, 1])), a = new P(e, /* @__PURE__ */ new Map([["a_pos", 0]]), A, { geometry: u }), o = new g();
    o.samplingMode = p.LINEAR, o.wrapMode = l.CLAMP_TO_EDGE;
    const _ = new M(e, o, E);
    e.useProgram(s), e.bindTexture(_, 0), s.setUniform1i("u_texture", 0);
    const T = e.getBoundFramebufferObject(), { x: d, y: h, width: y, height: w } = e.getViewport();
    e.bindFramebuffer(n), e.setViewport(0, 0, 1, 1), e.setClearColor(0, 0, 0, 0), e.setBlendingEnabled(!1), e.clear(I.COLOR_BUFFER_BIT), e.bindVAO(a), e.drawArrays(Q.TRIANGLE_STRIP, 0, 4);
    const m = new Uint8Array(4);
    return n.readPixels(0, 0, 1, 1, R.RGBA, U.UNSIGNED_BYTE, m), a.dispose(), n.dispose(), _.dispose(), e.setViewport(d, h, y, w), e.bindFramebuffer(T), m[0] !== 255;
  }
}
const E = new Image();
...
//# sourceMappingURL=testSVGPremultipliedAlpha-C5s8n9jz.js.map
