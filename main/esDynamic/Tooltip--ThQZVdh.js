import { a as M, s as N, am as F, an as R, b as x, x as S, a8 as E, a5 as j, af as B, ao as u } from "./Theme-DN_QqyRv.js";
class D extends M {
  _beforeChanged() {
  ...
  _changed() {
    if (super._changed(), this._clear) {
      ...
      if (t > 0 && i > 0) {
        ...
        let r = this.get("pointerX", 0), o = this.get("pointerY", 0), a = this.get("pointerBaseWidth", 15) / 2, T = 0, _ = 0, f = 0, b = (r - T) * (i - _) - (o - _) * (t - T), n = (r - f) * (0 - i) - (o - i) * (t - f);
        const s = this._display;
        if (s.moveTo(e, 0), b > 0 && n > 0) {
          let l = Math.round(u(r, e + a, t - a - e));
          o = u(o, -1 / 0, 0), s.lineTo(l - a, 0), s.lineTo(r, o), s.lineTo(l + a, 0);
        }
        if (s.lineTo(t - e, 0), s.arcTo(t, 0, t, e, e), b > 0 && n < 0) {
          let l = Math.round(u(o, e + a, i - a - e));
          r = u(r, t, 1 / 0), s.lineTo(t, e), s.lineTo(t, Math.max(l - a, e)), s.lineTo(r, o), s.lineTo(t, l + a);
        }
        if (s.lineTo(t, i - e), s.arcTo(t, i, t - e, i, e), b < 0 && n < 0) {
          let l = Math.round(u(r, e + a, t - a - e));
          o = u(o, i, 1 / 0), s.lineTo(t - e, i), s.lineTo(l + a, i), s.lineTo(r, o), s.lineTo(l - a, i);
        }
        if (s.lineTo(e, i), s.arcTo(0, i, 0, i - e, e), b < 0 && n > 0) {
          let l = Math.round(u(o, e + a, i - e - a));
          r = u(r, -1 / 0, 0), s.lineTo(0, i - e), s.lineTo(0, l + a), s.lineTo(r, o), s.lineTo(0, Math.max(l - a, e));
        }
...
class P extends N {
  constructor(t, i, e, r = []) {
    super(t, i, e, r), Object.defineProperty(this, "_fx", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_fy", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_label", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_fillDp", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_strokeDp", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_labelDp", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_w", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_h", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_keepHoverDp", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_htmlContentHovered", { enumerable: !0, configurable: !0, writable: !0, value: !1 });
  }
  _afterNew() {
    this._settings.themeTags = F(this._settings.themeTags, ["tooltip"]), super._afterNew(), this._setDefaultFn("background", () => D.new(this._root, {})).set("themeTags", ["tooltip", "background"]), this._label = this.children.push(R.new(this._root, {})), this._disposers.push(this._label.events.on("boundschanged", () => {
      ...
      t && (this._disposers.push(x(t, "pointerover", (i) => {
        this._htmlContentHovered = !0;
      })), this._disposers.push(x(t, "pointerout", (i) => {
        this._htmlContentHovered = !1;
      })));
    })), this.on("visible", (t) => {
      this._handleReaderAnnouncement();
    }), this.label.events.on("dataitemchanged", (t) => {
      this._handleReaderAnnouncement();
  ...
  dispose() {
    super.dispose(), S(this._root._tooltips, this);
  }
  _updateChildren() {
  ...
  _changed() {
    if (super._changed(), (this.isDirty("pointTo") || this.isDirty("pointerOrientation")) && this._updateBackground(), this.isDirty("tooltipTarget") && this.updateBackgroundColor(), this.isDirty("keepTargetHover"))
      if (this.get("keepTargetHover")) {
        ...
        this._keepHoverDp = new E([t.events.on("pointerover", (i) => {
          ...
          this._keepHoverDp && i && this._keepHoverDp.disposers.push(x(i, "pointerleave", (e) => {
            const r = this.root._renderer.getEvent(e);
            t.events.dispatch("pointerout", { type: "pointerout", originalEvent: r.event, point: r.point, simulated: !1, target: t });
          }));
        });
  ...
  updateBackgroundColor() {
    ...
    let e, r;
    t && i && (e = t.get("fill"), r = t.get("stroke"), e == null && (e = r), this.get("getFillFromSprite") && (this._fillDp && this._fillDp.dispose(), e != null && i.set("fill", e), this._fillDp = t.on("fill", (o) => {
  ...
  _updateBackground() {
    ...
    if (t) {
      let i = 0.5, e = 0.5, r = this.get("centerX");
      r instanceof B && (i = r.value);
      let o = this.get("centerY");
      o instanceof B && (e = o.value);
      let a = t.width(), T = t.height(), _ = this.parent, f = 0, b = 0;
      if (_) {
        f = _.x(), b = _.y();
        const g = _.get("layerMargin");
        g && (f += g.left || 0, b += g.top || 0, a += (g.left || 0) + (g.right || 0), T += (g.top || 0) + (g.bottom || 0));
      }
      const n = this.get("bounds", { left: -f, top: -b, right: a - f, bottom: T - b });
      this._updateBounds();
      let s = this.width(), l = this.height();
      s === 0 && (s = this._w), l === 0 && (l = this._h);
      let k = this.get("pointTo", { x: a / 2, y: T / 2 }), h = k.x, p = k.y, m = this.get("pointerOrientation"), c = this.get("background"), d = 0, v = 0, y = 0;
      c instanceof D && (d = c.get("pointerLength", 0), v = c.get("strokeWidth", 0) / 2, y = v, c.set("width", s), c.set("height", l));
      let C = 0, O = 0, H = n.right - n.left, L = n.bottom - n.top;
      m == "horizontal" || m == "left" || m == "right" ? (v = 0, m == "horizontal" ? h > n.left + H / 2 ? (h -= s * (1 - i) + d, y *= -1) : h += s * i + d : m == "left" ? h += s * (1 - i) + d : (h -= s * i + d, y *= -1)) : (y = 0, m == "vertical" ? p > n.top + l / 2 + d ? p -= l * (1 - e) + d : (p += l * e + d, v *= -1) : m == "down" ? p -= l * (1 - e) + d : (p += l * e + d, v *= -1)), h = u(h, n.left + s * i, n.left + H - s * (1 - i)) + y, p = u(p, n.top + l * e, n.top + L - l * (1 - e)) - v, C = k.x - h + s * i + y, O = k.y - p + l * e - v, this._fx = h, this._fy = p;
      const w = this.get("animationDuration", 0);
      if (w > 0 && this.get("visible") && this.get("opacity") > 0.1) {
        const g = this.get("animationEasing");
        this.animate({ key: "x", to: h, duration: w, easing: g }), this.animate({ key: "y", to: p, duration: w, easing: g });
      } else this.set("x", h), this.set("y", p);
      c instanceof D && (c.set("pointerX", C), c.set("pointerY", O)), s > 0 && (this._w = s), l > 0 && (this._h = l);
    }
  }
}
...
//# sourceMappingURL=Tooltip--ThQZVdh.js.map
