import { D as N, gj as k } from "./main-lm2DHsZh.js";
const q = () => N.getLogger("esri.rest.support.generateRendererUtils");
function g(t, e) {
...
function pt(t) {
  ...
  return t.supportsNullCount && (u.nullcount = e.length - n), t.percentileParams && (u.median = $(e, t.percentileParams)), u;
}
function W(t) {
  ...
  return n && (a.nullcount = e.length - s), t.percentileParams && (a.median = $(e, t.percentileParams)), a;
}
function $(t, e) {
...
function ot(t, e) {
  const l = st({ field: e.field, normalizationType: e.normalizationType, normalizationField: e.normalizationField, classificationMethod: e.classificationMethod, standardDeviationInterval: e.standardDeviationInterval, breakCount: e.numClasses || j });
...
function ct(t, e) {
  const { field: l, classificationMethod: n, standardDeviationInterval: u, normalizationType: i, normalizationField: c, normalizationTotal: o, minValue: f, maxValue: p } = e, s = e.numBins || Y;
...
//# sourceMappingURL=utils-C0Edlkdl.js.map
