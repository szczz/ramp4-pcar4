import { hX as K, bh as D } from "./main-BVGiskS7.js";
import { y as X } from "./DoubleArray-BS7gOzI9.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Cj-flGNw.js";
import { n as Z, s as ee } from "./vec3-By3e4mSV.js";
import "./sphere-B8ifWULU.js";
import "./I3SUtil-DzHRIkWm.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BrLDafas.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BVGiskS7.js").then((d) => d.qK), import("./main-BVGiskS7.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DOlFCuTe.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-BPSfXL_h.js.map
