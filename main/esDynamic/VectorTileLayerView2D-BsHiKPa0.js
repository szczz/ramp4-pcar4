import { $ as Ee, mA as j, fy as $e, bA as re, eW as Ve, ft as ze, _ as Fe, N as M, M as X, d$ as oe, dV as qe, o2 as Ce, mi as He, aP as F, k2 as Be, fE as U, o3 as ne, bK as Ne, bM as We, bP as Qe, bO as Je, bI as V, o4 as Ke, iq as Ge, fv as Re, aj as ae, cr as Ye, F as je, o5 as Xe, o6 as Ze, bl as $, K as et, D as le, G as he, aa as tt, a3 as st, O as ce, P as it, Q as rt } from "./main-lm2DHsZh.js";
import { E as L, I as v } from "./enums-qHpGJ28Q.js";
import { t as A } from "./Rect-DD6XS68q.js";
import { G as ot, D as Le, F as C, I as k, O as ue, R as B } from "./enums-DDkmfb-t.js";
import { e as Pe, c as Ae } from "./Texture-DhDvGrgF.js";
import { i as nt } from "./rasterizingUtils-CkVVpqYc.js";
import { w as at, d as lt } from "./GeometryUtils-CFDcE7Ev.js";
import { c as R } from "./Program-CfcTPgr7.js";
import { o as E } from "./ProgramTemplate-C6PXKuso.js";
import { e as Q, t as ht, c as ct } from "./config-nuMERBvb.js";
import { r as Me } from "./WGLContainer-TDEKqET4.js";
import { n as ut, l as O, r as yt, i as Z, a as D } from "./StyleDefinition-Dfu7Kx8O.js";
import { E as N } from "./Container-CkDvNCAj.js";
import { i as dt } from "./TileContainer-CEbFukYw.js";
import { h as _t } from "./PooledRBush-BFEVh9JL.js";
import { e as ye, s as de } from "./SourceLayerData-DDgucYFY.js";
import { L as ft, l as _e } from "./StyleRepository-BYhbefF3.js";
import { f as pt, y as gt } from "./LayerView-CpYEODlP.js";
let z = class {
  constructor(e, s) {
  ...
  constructor(e, s, t) {
    this.width = 0, this.height = 0, this._dirties = [], this._glyphData = [], this._currentPage = 0, this._glyphIndex = {}, this._textures = [], this._rangePromises = /* @__PURE__ */ new Map(), this.width = e, this.height = s, this._glyphSource = t, this._binPack = new z(e - 4, s - 4), this._glyphData.push(new Uint8Array(e * s)), this._dirties.push(!0), this._textures.push(void 0);
  }
  getGlyphItems(e, s) {
    ...
    return r.forEach((a) => {
      const l = e + a;
      if (this._rangePromises.has(l)) n.push(this._rangePromises.get(l));
      else {
        ...
        this._rangePromises.set(l, c), n.push(c);
      }
    }), Promise.all(n).then(() => {
      ...
      for (const l of s) {
        ...
        if (d.width === 0) u = new A(0, 0, 0, 0);
          ...
          p === 1 && (p = 5), m === 1 && (m = 5), u = this._binPack.allocate(f + p, g + m), u.isEmpty && (this._dirties[this._currentPage] || (this._glyphData[this._currentPage] = null), this._currentPage = this._glyphData.length, this._glyphData.push(new Uint8Array(this.width * this.height)), this._dirties.push(!0), this._textures.push(void 0), this._binPack = new z(this.width - 4, this.height - 4), u = this._binPack.allocate(f + p, g + m));
  ...
  removeGlyphs(e) {
    for (const s in this._glyphIndex) {
      ...
      for (const r in t) if (i = t[r], i.tileIDs.delete(e), i.tileIDs.size === 0) {
        ...
        let a, l;
        for (let c = 0; c < n.height; c++) for (a = this.width * (n.y + c) + n.x, l = 0; l < n.width; l++) o[a + l] = 0;
  ...
  bind(e, s, t, i = 0) {
    if (!this._textures[t]) {
      const o = new Pe();
      o.pixelFormat = ot.ALPHA, o.wrapMode = Le.CLAMP_TO_EDGE, o.width = this.width, o.height = this.height, this._textures[t] = new Ae(e, o, new Uint8Array(this.width * this.height));
    }
  ...
  constructor(e) {
    ...
    for (; e.next(); ) switch (e.tag()) {
      case 1: {
        const o = e.getMessage();
        for (; o.next(); ) switch (o.tag()) {
          case 3: {
            const n = o.getMessage();
            let a, l, c, y, d, u, _;
    ...
    for (const [o, n] of s) {
      const { startOffset: a, length: l } = r[o];
      if (n) for (let c = 0; c < l; ++c) i[a + c] = n[c];
    }
    this._allBitmaps = i;
  }
  getMetrics(e) {
  ...
  getRange(e, s) {
    ...
    if (this._baseURL) {
      const o = this._baseURL.replace("{fontstack}", e).replace("{range}", i + "-" + r);
      return Ee(o, { responseType: "array-buffer" }).then((n) => {
        t.addRange(s, new G(new j(new Uint8Array(n.data), new DataView(n.data))));
      }).catch(() => {
        t.addRange(s, new G());
      });
    }
...
let ge = class Oe {
  ...
  setSpriteSource(e) {
    if (this.dispose(), this.pixelRatio = e.devicePixelRatio, this._mosaicsData.length === 0) {
      this._binPack = new z(this._pageWidth - 4, this._pageHeight - 4);
  ...
  getSpriteItem(e, s = !1) {
    ...
    const o = t.width, n = t.height, [a, l, c] = this._allocateImage(o, n);
    return a.width <= 0 ? null : (this._copy(a, t, l, c, s, i), r = { type: "sprite", rect: a, width: o, height: n, sdf: t.sdf, simplePattern: !1, rasterizationScale: t.pixelRatio, page: l }, this._mosaicRects[e] = r, r);
  }
  getSpriteItems(e) {
    const s = {};
  ...
  getMosaicItemPosition(e, s) {
    const t = this.getSpriteItem(e, s), i = t?.rect;
    if (!i) return null;
  ...
  bind(e, s, t = 0, i = 0) {
    ...
    if (!this._textures[t]) {
      const o = new Pe();
      o.wrapMode = Le.CLAMP_TO_EDGE, o.width = this._size[t][0], o.height = this._size[t][1], this._textures[t] = new Ae(e, o, new Uint8Array(this._mosaicsData[t].buffer));
    }
    const r = this._textures[t];
  ...
  static _copyBits(e, s, t, i, r, o, n, a, l, c, y) {
    let d = i * s + t, u = a * o + n;
    if (y) {
      u -= o;
      for (let _ = -1; _ <= c; _++, d = ((_ + c) % c + i) * s + t, u += o) for (let f = -1; f <= l; f++) r[u + f] = e[d + (f + l) % l];
  ...
  _copy(e, s, t, i, r, o) {
    ...
    const n = new Uint32Array(o ? o.buffer : this._sprites.image.buffer), a = this._mosaicsData[t], l = 2, c = o ? s.width : this._sprites.width;
    Oe._copyBits(n, c, s.x, s.y, a, i[0], e.x + l, e.y + l, s.width, s.height, r), this._dirties[t] = !0;
  }
  _allocateImage(e, s) {
    e += 2, s += 2;
    ...
    return o.width <= 0 ? (this._dirties[this._currentPage] || (this._mosaicsData[this._currentPage] = null), this._currentPage = this._mosaicsData.length, this._mosaicsData.push(new Uint32Array(this._pageWidth * this._pageHeight)), this._dirties.push(!0), this._size.push([this._pageWidth, this._pageHeight]), this._textures.push(void 0), this._binPack = new z(this._pageWidth - 4, this._pageHeight - 4), this._allocateImage(e, s)) : [o, this._currentPage, [this._pageWidth, this._pageHeight]];
  }
  _rasterizeDash(e) {
    const s = /\[(.*?)\]/, t = e.match(s);
    if (!t) return null;
    const i = t[1].split(",").map(Number), r = e.slice(e.lastIndexOf("-") + 1), [o, n, a] = nt(i, r);
  ...
  async start(e) {
    ...
    this._glyphMosaic = new fe(1024, 1024, t), this._broadcastPromise = Ve("WorkerTileHandler", { client: this, schedule: e.schedule, signal: e.signal }).then((i) => {
  ...
  _requestSprite(e) {
    ...
    this._spriteSourcePromise = this._layer.loadSpriteSource(this.devicePixelRatio, r), this._spriteSourcePromise.then((o) => {
      Fe(i), this._spriteMosaic = new ge(1024, 1024, 250), this._spriteMosaic.setSpriteSource(o);
    });
  }
  async updateStyle(e) {
  ...
  async fetchTilePBFs(e) {
    const s = Object.keys(this._layer.sourceNameToSource), t = {}, i = await this._getRefKeys(e, t), r = [], o = [];
    for (let n = 0; n < i.length; n++) if (i[n].value == null || s[n] == null) o.push(null);
    else {
      const a = i[n].value, l = this._getTilePayload(a, s[n], t);
      l.then((c) => {
        r.push({ ...c, key: a });
      }), o.push(l);
    }
  ...
  async _getTilePayload(e, s, t) {
    const i = M.pool.acquire(e.id), r = this._layer.sourceNameToSource[s], { level: o, row: n, col: a } = i;
    M.pool.release(i);
    try {
  ...
  _getSourcesData(e, s, t) {
    ...
    for (let r = 0; r < s.length; r++) if (s[r].value == null || e[r] == null) i.push(null);
      ...
      const o = s[r].value, n = this._getTilePayload(o, e[r], t);
      i.push(n);
    }
    return oe(i).then((r) => {
      const o = {}, n = [];
      for (let a = 0; a < r.length; a++) {
        ...
        if (l && l.protobuff && l.protobuff.byteLength > 0) {
          ...
          o[l.sourceName] = { refKey: c, protobuff: l.protobuff }, n.push(l.protobuff);
        }
      }
...
let be = class {
  ...
  update(e) {
    ...
    if (!t) return !0;
    const { spans: i, lodInfo: r } = t, { level: o } = r, n = this._tiles, a = /* @__PURE__ */ new Set(), l = /* @__PURE__ */ new Set();
    for (const { row: y, colFrom: d, colTo: u } of i) for (let _ = d; _ <= u; _++) {
      const f = M.getId(o, y, r.normalizeCol(_), r.getWorldForColumn(_)), g = this._getOrAcquireTile(f);
      a.add(f), g.processed() ? this._addToContainer(g) : l.add(new M(f));
    }
    for (const [y, d] of n) d.isCoverage = a.has(y);
    for (const y of l) this._findPlaceholdersForMissingTiles(y, a);
    let c = !1;
    for (const [y, d] of n) d.neededForCoverage = a.has(y), d.neededForCoverage || d.isHoldingForFade && s.intersects(t, d.key) && a.add(y), d.isFading && (c = !0);
  ...
  getIntersectingTiles(e, s, t, i, r) {
    const o = [0, 0], n = [0, 0];
    i.toMap(o, e - t, s + t), i.toMap(n, e + t, s - t);
    const a = Math.min(o[0], n[0]), l = Math.min(o[1], n[1]), c = Math.max(o[0], n[0]), y = Math.max(o[1], n[1]), d = He(a, l, c, y), u = F(), _ = [];
  ...
  _findPlaceholdersForMissingTiles(e, s) {
    const t = [];
    for (const [r, o] of this._tiles) this._addPlaceholderChild(t, o, e, s);
  ...
  _addPlaceholderParent(e, s) {
    ...
    for (; ; ) {
      ...
      const r = t.get(i);
      if (r?.hasData()) return this._addToContainer(r), void s.add(r.id);
    }
  }
  _getOrAcquireTile(e) {
  ...
  _addToContainer(e) {
    ...
    for (const [o, n] of r) this._canConnectDirectly(e, n) && t.push(n), s == null && this._canConnectDirectly(n, e) && (s = n);
    if (s != null) {
      for (const o of t) s.childrenTiles.delete(o), e.childrenTiles.add(o), o.parentTile = e;
  ...
  _canConnectDirectly(e, s) {
    ...
    for (; i > 0; ) {
      if (i--, r >>= 1, o >>= 1, t.level === i && t.row === r && t.col === o && t.world === n) return !0;
      if (a.has(`${i}/${r}/${o}/${n}`)) return !1;
    }
    return !1;
  }
  _updateCacheSize(e) {
...
function we(h, e, s, t, i, r) {
  const o = s - i;
  if (o >= 0) return (e >> o) + (t - (r << o)) * (h >> o);
  const n = -o;
  return e - (r - (t << n)) * (h >> n) << n;
}
let ke = class {
  constructor(e, s, t) {
  ...
  if (r.type === L.SYMBOL) {
    for (const o of t) {
      ...
      if (o.selectedForRendering) {
        const l = n.parts[0], c = l.startOpacity, y = l.targetOpacity;
        h.allSymbolsFadingOut = h.allSymbolsFadingOut && y === 0;
        const d = Math.floor(127 * c) | y << 7;
        a = d << 24 | d << 16 | d << 8 | d;
      } else a = 0;
      for (const [l, c] of o.iconVertexRanges) for (let y = l; y < l + c; y += 4) r.iconOpacity[y / 4] = a;
      if (o.selectedForRendering) {
        const l = n.parts[1], c = l.startOpacity, y = l.targetOpacity;
        h.allSymbolsFadingOut = h.allSymbolsFadingOut && y === 0;
        const d = Math.floor(127 * c) | y << 7;
        a = d << 24 | d << 16 | d << 8 | d;
      } else a = 0;
      for (const [l, c] of o.textVertexRanges) for (let y = l; y < l + c; y += 4) r.textOpacity[y / 4] = a;
    }
...
function Mt(h, e, s, t) {
  ...
  let r, o, n, a;
  for (const l of i)
    if (h.unique.show && h.unique.parts[l.partIndex].show && (r = l.xScreen - t[0] + l.dxScreen, o = l.yScreen - t[1] + l.dyScreen, n = r + l.width, a = o + l.height, at(s, e.x, e.y, r, o, n, a))) return !0;
  return !1;
}
let K = class {
  constructor(e, s) {
    ...
    this.layerUIDs = [];
    const r = i[t++];
    for (let o = 0; o < r; o++) this.layerUIDs[o] = i[t++];
...
class Ot extends K {
  constructor(e, s) {
    ...
    if (r > 0) {
      ...
      for (let o = 0; o < r; o++) {
        const n = t[i++], a = t[i++], l = t[i++];
        this.patternMap.set(n, [a, l]);
      }
    }
  ...
  doPrepareForRendering(e, s, t) {
    const i = new Uint32Array(s), r = new Int32Array(i.buffer), o = i[t++], n = R.createVertex(e, C.STATIC_DRAW, new Int32Array(r.buffer, 4 * t, o));
    t += o;
    const a = i[t++], l = R.createIndex(e, C.STATIC_DRAW, new Uint32Array(i.buffer, 4 * t, a));
    t += a;
    const c = this.layer.lineMaterial;
    this.vao = new E(e, c.getAttributeLocations(), c.getLayoutInfo(), { geometry: n }, l);
  }
}
let kt = class extends K {
  ...
  doPrepareForRendering(e, s, t) {
    ...
    this.fillVAO = new E(e, f.getAttributeLocations(), f.getLayoutInfo(), { geometry: n }, l), this.outlineVAO = new E(e, g.getAttributeLocations(), g.getLayoutInfo(), { geometry: y }, u);
  }
}, Ut = class extends K {
  constructor(e, s, t) {
    ...
    this.isIconSDF = !!i[n++];
    const a = i[n++], l = i[n++], c = i[n++], y = new M(a, l, c, 0), d = i[n++];
    for (let g = 0; g < d; g++) {
      const p = i[n++], m = i[n++], b = i[n++];
    ...
    const _ = i[n++], f = i[n++];
    this.iconOpacity = new Int32Array(_), this.textOpacity = new Int32Array(f), n = Lt(i, r, o, n, this.symbols, t, y), this.bufferDataOffset = n;
  }
  get memoryUsed() {
  ...
  doPrepareForRendering(e, s, t) {
    ...
    this.iconVAO = new E(e, p.getAttributeLocations(), p.getLayoutInfo(), { geometry: n, opacity: _ }, l), this.textVAO = new E(e, m.getAttributeLocations(), m.getLayoutInfo(), { geometry: y, opacity: f }, u);
  }
}, Et = class extends K {
  constructor(e, s) {
  ...
  dispose() {
    this.status !== "unloaded" && (this.featureIndex = null, Vt.delete(this), Ue._destroyRenderBuckets(this.layerData), this.layerData.clear(), this._memoryUsedByLayerData = 0, this.destroy(), this.status = "unloaded");
  }
  release() {
  ...
  changeDataImpl(e) {
    ...
    if (e) {
      ...
      if (i && i.byteLength > 0) {
        ...
        for (const n of o) this._deleteLayerData(n);
      }
      for (const [o, n] of r) this._deleteLayerData(o), n.type === L.SYMBOL && (this.symbols.set(o, n.symbols), s = !0), this._memoryUsedByLayerData += n.memoryUsed, this.layerData.set(o, n);
  ...
  setTransform(e) {
    ...
    Ne(o), We(o, o, r), Qe(o, o, Math.PI * e.rotation / 180), Je(o, o, [t, i, 1]);
  }
  _createTransforms() {
    return { displayViewScreenMat3: V(), tileMat3: V(), tileUnitsToPixels: V() };
  }
  ...
  _createRenderBuckets(e) {
    ...
    for (const i of e) {
      ...
      for (const o of r.layerUIDs) s.set(o, r);
    }
    return s;
  }
...
function zt(h, e, s, t, i, r) {
  const { iconRotationAlignment: o, textRotationAlignment: n, iconTranslate: a, iconTranslateAnchor: l, textTranslate: c, textTranslateAnchor: y } = t;
  let d = 0;
  for (const u of h.colliders) {
    const [_, f] = u.partIndex === 0 ? a : c, g = u.partIndex === 0 ? l : y, p = u.minLod <= r && r <= u.maxLod;
    d += p ? 0 : 1, u.enabled = p, u.xScreen = u.xTile * i[0] + u.yTile * i[3] + i[6], u.yScreen = u.xTile * i[1] + u.yTile * i[4] + i[7], g === yt.MAP ? (u.xScreen += s * _ - e * f, u.yScreen += e * _ + s * f) : (u.xScreen += _, u.yScreen += f), O.VIEWPORT === (u.partIndex === 0 ? o : n) ? (u.dxScreen = u.dxPixels, u.dyScreen = u.dyPixels) : (u.dxScreen = s * (u.dxPixels + u.width / 2) - e * (u.dyPixels + u.height / 2) - u.width / 2, u.dyScreen = e * (u.dxPixels + u.width / 2) + s * (u.dyPixels + u.height / 2) - u.height / 2);
  }
  h.colliders.length > 0 && d === h.colliders.length && (h.unique.show = !1);
}
class Ft {
  constructor(e, s, t, i, r, o) {
    this._symbols = e, this._styleRepository = i, this._zoom = r, this._currentLayerCursor = 0, this._currentSymbolCursor = 0, this._styleProps = /* @__PURE__ */ new Map(), this._allNeededMatrices = /* @__PURE__ */ new Map(), this._gridIndex = new ke(s, t, ht), this._si = Math.sin(Math.PI * o / 180), this._co = Math.cos(Math.PI * o / 180);
    for (const n of e) for (const a of n.symbols) this._allNeededMatrices.has(a.tile) || this._allNeededMatrices.set(a.tile, Ke(a.tile.transforms.tileUnitsToPixels));
  }
  work(e) {
    const s = this._gridIndex;
    function t(r) {
      const o = r.xScreen + r.dxScreen, n = r.yScreen + r.dyScreen, a = o + r.width, l = n + r.height, [c, y, d, u] = s.getCellSpan(o, n, a, l);
      for (let _ = y; _ <= u; _++) for (let f = c; f <= d; f++) {
        const g = s.cells[_][f];
        for (const p of g) {
          const m = p.xScreen + p.dxScreen, b = p.yScreen + p.dyScreen, S = m + p.width, I = b + p.height;
          if (!(a < m || o > S || l < b || n > I)) return !0;
        }
      }
      return !1;
    }
    ...
    for (; this._currentLayerCursor < this._symbols.length; this._currentLayerCursor++, this._currentSymbolCursor = 0) {
      ...
      for (; this._currentSymbolCursor < r.symbols.length; this._currentSymbolCursor++) {
        ...
        if (!n.unique.show) continue;
        zt(n, this._si, this._co, o, this._allNeededMatrices.get(n.tile), this._zoom);
        const a = n.unique;
        if (!a.show) continue;
        const { iconAllowOverlap: l, iconIgnorePlacement: c, textAllowOverlap: y, textIgnorePlacement: d } = o;
        for (const u of n.colliders) {
          if (!u.enabled) continue;
          const _ = a.parts[u.partIndex];
          _.show && !(u.partIndex ? y : l) && t(u) && (u.hard ? a.show = !1 : _.show = !1);
        }
        if (a.show) for (const u of n.colliders) {
...
class Ht {
  ...
  _createOpacityJob() {
    ...
    function i(r, o) {
      const n = r.symbols;
      for (const [a, l] of n) Bt(l, o);
      e(r, o);
      for (const a of r.childrenTiles) i(a, o);
    }
    return { work(r) {
      const o = performance.now();
      for (; t < s.length; t++) {
        if (performance.now() - o > r) return !1;
        const n = s[t];
        n.parentTile == null && i(n, performance.now());
      }
      return !0;
    } };
  }
...
class Kt {
  ...
  add(e, s) {
    ...
    if (s) for (const n of s) t.symbols.has(n) && (i.set(n, t.symbols.get(n)), t.symbols.delete(n));
    else for (const [n, a] of e.layerData) t.symbols.has(n) && (i.set(n, t.symbols.get(n)), t.symbols.delete(n));
    ...
    for (const [n, a] of r) {
      ...
      } else o.set(n, { flat: a }), t.symbols.set(n, { flat: a });
    }
  ...
  querySymbols(e, s, t, i) {
    const r = [], o = this.uniqueSymbols;
    for (const n of o) {
      const a = n.styleLayerUID, l = n.uniqueSymbols;
      for (const c of l) {
  ...
  _addSymbols(e, s) {
    ...
    for (const [i, r] of s) for (const o of r) if (o.unique == null) {
  ...
  _matchSymbols(e, s, t) {
    ...
    for (const [r, o] of t) {
      ...
      for (const y of o) {
        ...
        d >= 0 && d < this.tileCoordRange && u >= 0 && u < this.tileCoordRange && n.push({ symbol: y, xTransformed: d, yTransformed: u });
      }
      const a = [], l = (e.key.level < s.level ? 1 : 1 << e.key.level - s.level) + Jt, c = this._tiles.get(e.id).symbols.get(r);
      if (c) {
        const y = c.flat;
        for (const d of n) {
          let u, _ = !1;
...
let jt = class extends Me {
  _createTransforms() {
    return { displayViewScreenMat3: V(), tileMat3: V() };
  }
};
const J = 1e-6;
function xe(h, e) {
...
let Xt = class extends dt {
  ...
  setStyleResources(e, s, t, i) {
    this._spriteMosaic = e, this._glyphMosaic = s, this._styleRepository = t, this._tileInfoView = i, this._computeDisplayInfoView(i), this._symbolFader == null && (this._symbolFader = new Yt(this._styleRepository, this.children)), this._symbolFader.styleRepository = t;
  }
  setSpriteMosaic(e) {
  ...
  _doRender(e) {
    ...
    if (!i) return;
    const r = i.layers, o = this._displayInfo.scaleToZoom(t.scale);
    i.backgroundBucketIds.length > 0 && (e.renderPass = "background", this._renderBackgroundLayers(e, i.backgroundBucketIds, o)), super.renderChildren(e), e.drawPhase === N.MAP && this._fade(o, t);
    const n = this.children.filter((a) => a.visible && a.hasData());
    if (!n || n.length === 0) return s.bindVAO(), s.setStencilTestEnabled(!0), void s.setBlendingEnabled(!0);
    for (const a of n) a.triangleCount = 0;
    ...
    for (let a = r.length - 1; a >= 0; a--) this._renderStyleLayer(r[a], e, n);
    ...
    for (let a = 0; a < r.length; a++) this._renderStyleLayer(r[a], e, n);
    s.bindVAO(), s.setStencilTestEnabled(!0), s.setBlendingEnabled(!0);
    for (const a of n) a.debugInfo.display.triangleCount = a.triangleCount;
  }
  _fade(e, s) {
    this._symbolFader != null && (this._symbolFader.update(e, s) || this.requestRender());
  }
  _renderStyleLayer(e, s, t) {
    const { displayLevel: i, painter: r, renderPass: o } = s;
    if (e === void 0) return;
    const n = e.getLayoutProperty("visibility");
    if (n && n.getValue() === Z.NONE) return;
    let a;
    switch (e.type) {
      case D.BACKGROUND:
        return;
      case D.FILL:
        if (o !== "opaque" && s.renderPass !== "translucent") return;
        a = "vtlFill";
        break;
      case D.LINE:
        if (o !== "translucent") return;
        a = "vtlLine";
        break;
      case D.CIRCLE:
        if (o !== "translucent") return;
  ...
  _renderBackgroundLayers(e, s, t) {
    const { context: i, painter: r, state: o } = e, n = this._styleRepository;
    let a = !1;
    for (const b of s)
      if (n.getLayerById(b).type === D.BACKGROUND && xe(n.getLayerById(b), t)) {
        a = !0;
        break;
      }
    if (!a) return;
    ...
    for (const { row: b, colFrom: S, colTo: I } of y) for (let w = S; w <= I; w++) {
      if (m < g.length) p = g[m], p.key.set(u, b, d.normalizeCol(w), d.getWorldForColumn(w)), l.getTileBounds(_, p.key, !1), p.x = _[0], p.y = _[3], p.resolution = l.getTileResolution(u);
        ...
        p = new jt(x, q, P[0], P[3], 512, 512, 4096, 4096), g.push(p);
      }
      p.setTransform(o), f.push(p), m++;
    }
...
const Zt = 8, es = 512, Ie = 4096, ts = (h, e) => {
...
class ee {
  ...
  async queryAttributes(e, s, t, i, r) {
    ...
    const o = [];
    return this._queryIndex(o, e, s, t, this.tileKey.level, i), r && r?.length > 0 && await this._getSymbolsAttributes(o, r), o;
  }
  async _indexLayers() {
    const e = this.tileKey, s = this._styleRepository.layers, t = await this._getTilePayload(e);
    for (const [i, r] of this._tileLayerData) {
      const o = s[i], n = t.find((c) => c.sourceName === o.source);
      if (!n) continue;
      const { protobuff: a, key: l } = n;
      if (r.type !== L.SYMBOL) {
        const c = 1 << e.level - l.level, y = e.row - l.row * c, d = e.col - l.col * c;
        this._indexLayer(o, a, e.level, c, y, d);
      }
    }
  }
  _indexLayer(e, s, t, i, r, o) {
    const n = e.sourceLayer, a = e.getFeatureFilter(), l = t, c = t + 1, y = lt(l), d = new j(new Uint8Array(s), new DataView(s));
    for (; d.next(); ) switch (d.tag()) {
      case 3: {
        const u = d.getMessage(), _ = new ye(u);
        if (u.release(), _.name !== n) continue;
        const f = _.getData(), g = _.extent / i, p = g * o - y, m = g * r - y, b = p + g + 2 * y, S = m + g + 2 * y, I = g / es, w = Ie / g, x = g * o, P = g * r;
        for (; f.nextTag(2); ) {
  ...
  async _getSymbolsAttributes(e, s) {
    ...
    for (const l of t) {
      ...
      n = o[l.styleLayerUID], a = !!n && c.find((y) => y.sourceName === n.source), a && this._addSymbolsAttributes(e, s.slice(l.from, l.to).map((y) => y.vtlSymbol), i, a);
    }
    return e;
  }
  _addSymbolsAttributes(e, s, t, i) {
    const r = this._styleRepository.layers, o = i.key, n = this.tileKey, a = 1 << n.level - o.level, l = n.row - o.row * a, c = n.col - o.col * a;
  ...
  _getSymbolAttributes(e, s, t, i, r, o) {
    const n = [], a = this._styleRepository.layers;
    let l = 0;
    ...
    for (; c.next(); ) switch (c.tag()) {
      case 3: {
        ...
        const u = d.getData(), _ = d.extent / i, f = Ie / _, g = _ * o, p = _ * r;
        let m = 0;
        for (; u.nextTag(2); ) {
          ...
          if (m++ === s[l].featureIndex) {
            ...
            n.push({ attributes: I, tilePoint: x }), l++;
          }
          if (b.release(), l === s.length) return n;
        }
        break;
      }
      default:
  ...
  _queryIndex(e, s, t, i, r, o) {
    const n = Zt * i * (window.devicePixelRatio || 1);
    return this._index?.search({ minX: s - n, minY: t - n, maxX: s + n, maxY: t + n }, (a) => {
      const { layer: l, feature: c } = a;
      l.isIntersectingFeature(s, t, i, c, r, o, a) && e.push({ layerId: l.id, layerIndex: l.uid, tilePoint: null, graphic: new ae({ attributes: c.values, origin: { type: "vector-tile", layerId: a.layer.id, layerIndex: a.layer.uid, layer: this._parentLayer } }) });
    }), e;
  }
...
class Te extends je {
  ...
  getTileCoverage(e, s, t = !0, i) {
    ...
    if (!r) return r;
    const o = 1 << r.lodInfo.level;
    return r.spans = r.spans.filter((n) => n.row >= 0 && n.row < o), r;
  }
  scaleToLevel(e) {
...
let W = class extends pt(gt) {
  ...
  async hitTest(h, e) {
    ...
    const o = this.view.state, n = this._tileManager.getIntersectingTiles(e.x, e.y, Y, o, i);
    if ((!n || n.length === 0) && i?.length === 0) return null;
    h = h.clone().normalize();
    const a = [], l = [];
    for (const c of n) a.push(this._queryTile(l, h, Y, this.view.state.rotation, c, i?.filter((y) => y.tileKey.id === c.id)));
  ...
  attach() {
    ...
    this._styleRepository = new _e(h), this._tileInfoView = new Te(this.layer.tileInfo, this.layer.fullExtent), this._vectorTileContainer = new Xt(this._tileInfoView), this._tileHandler = new St(this.layer, this._styleRepository, window.devicePixelRatio || 1, this.layer.tileInfo.lods.length - 1), this.container.addChild(this._vectorTileContainer), this._start(), this.addAttachHandles([this.layer.on("paint-change", (e) => {
      ...
      if (i != null) {
        if (Ze(i, "visibility") && is(i) === 1) return s.setLayoutProperties(e.layer, e.layout), t.type === D.SYMBOL && this._vectorTileContainer?.restartDeclutter(), void this._vectorTileContainer?.requestRender();
  ...
  detach() {
    this._stop(), this.container.removeAllChildren(), this._vectorTileContainer = $(this._vectorTileContainer), this._tileHandler = $(this._tileHandler);
  }
  viewChange() {
    this.requestUpdate();
  }
  ...
  _stop() {
    ...
    h && h.abort(), this._tileHandlerPromise = null, this._isTileHandlerReady = !1, this._fetchQueue = $(this._fetchQueue), this._parseQueue = $(this._parseQueue), this._tileManager = $(this._tileManager), this._vectorTileContainer.removeAllChildren();
  }
  ...
  async _applyStyleChanges() {
    ...
    h.forEach((r) => {
      ...
      const o = r.data, n = e.getLayerById(o.layer);
      n && s.add(n.uid);
    });
    ...
    if (s.size > 0) {
      ...
      for (const o of i) o.deleteLayerData(r);
    }
    if (this._fetchQueue.resume(), this._parseQueue.resume(), t.size > 0) {
      const r = Array.from(t), o = [];
      for (const n of i) {
        const a = this._updatingHandles.addPromise(this._fetchQueue.push(n.key).then((l) => this._parseQueue.push({ key: n.key, data: l, styleLayerUIDs: r })).then((l) => n.setData(l)));
        o.push(a);
      }
      await Promise.all(o);
    }
  ...
  _createVectorTile(h) {
    ...
    return new $t(h, s, e[0], e[3], 512, 512, this._styleRepository);
  }
  async _queryTile(h, e, s, t, i, r) {
    if (i.layerData.size === 0) return;
    const o = this._ensureTileIndex(i), n = this._tileInfoView.getTileBounds(F(), i.key, !0), a = ve * De * ((e.x - n[0]) / (n[2] - n[0])), l = ve * De * (1 - (e.y - n[1]) / (n[3] - n[1])), c = await o.queryAttributes(a, l, s, t, r);
...
//# sourceMappingURL=VectorTileLayerView2D-BsHiKPa0.js.map
