import { G as f, s as R, E as _, at as b, am as T, ao as g } from "./Theme-DN_QqyRv.js";
class p extends f {
  _beforeChanged() {
  ...
  _draw() {
    ...
    if (_(t) && _(i)) {
      let u = Math.min(t, i) / 2, r = b(this.get("cornerRadiusTL", 8), u), n = b(this.get("cornerRadiusTR", 8), u), o = b(this.get("cornerRadiusBR", 8), u), h = b(this.get("cornerRadiusBL", 8), u), d = Math.min(Math.abs(t / 2), Math.abs(i / 2));
      r = g(r, 0, d), n = g(n, 0, d), o = g(o, 0, d), h = g(h, 0, d);
...
//# sourceMappingURL=Button-D_BDO3Do.js.map
