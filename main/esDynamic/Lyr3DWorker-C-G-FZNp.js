import { fq as T } from "./main-lm2DHsZh.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-Tg2zww5D.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-C-G-FZNp.js.map
