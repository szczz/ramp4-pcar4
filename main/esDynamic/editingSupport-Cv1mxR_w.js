import { ab as I, ac as $, ad as v, aa as E, s as n, ae as S, af as w, D as R, ag as O, ah as k, ai as L, aj as U, ak as j, al as G, am as T, an as B, K as V, ao as y, ap as D, V as W } from "./main-lm2DHsZh.js";
function F(e) {
...
async function x(e, t, r, a) {
  ...
  const { edits: s, options: o } = await C(e, r, a);
...
async function C(e, t, r) {
  ...
  if (J(t, a, r, !!s, !!o, `${e.type}-layer`), !a.data.isVersioned && r?.gdbVersion) throw new n(`${e.type}-layer:invalid-parameter`, "'gdbVersion' is applicable only if the layer supports versioned data. See: 'capabilities.data.isVersioned'");
  ...
  return d.addFeatures.forEach((l) => q(l, e, u, c)), d.updateFeatures.forEach((l) => Z(l, e, u, c)), d.deleteFeatures.forEach((l) => N(l, e, u, c)), d.addAttachments.forEach((l) => m(l, e)), d.updateAttachments.forEach((l) => m(l, e)), p && await P(d, e), { edits: await K(d), options: i };
}
function f(e, t, r, a) {
  if (r) {
...
export {
  ...
  H as normalizeEdits,
  K as normalizeGeometries,
  g as shallowCloneFeature,
  ae as uploadAssets
};
//# sourceMappingURL=editingSupport-Cv1mxR_w.js.map
