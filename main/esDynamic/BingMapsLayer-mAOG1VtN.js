import { e3 as M, e7 as x, e4 as j, fv as b, bx as h, b8 as U, aP as B, $ as c, gq as f, s as u, O as r, P as s, Q as T, gr as P, ei as R, f9 as k, e5 as _, e8 as I, a3 as L, gs as a } from "./main-lm2DHsZh.js";
var m;
const y = new P("0/0/0", 0, 0, 0, void 0);
let g = m = class extends M(x(j(R))) {
  constructor() {
    super(...arguments), this.tileInfo = b.create({ spatialReference: h.WebMercator, size: 256 }), this.type = "base-tile", this.fullExtent = new U(-20037508342787e-6, -2003750834278e-5, 2003750834278e-5, 20037508342787e-6, h.WebMercator), this.spatialReference = h.WebMercator;
  }
  ...
  fetchTile(e, t, i, l = {}) {
    const { signal: n } = l, p = this.getTileUrl(e, t, i), d = { responseType: "image", signal: n, query: { ...this.refreshParameters } };
    return c(p ?? "", d).then((v) => v.data);
  }
  async fetchImageBitmapTile(e, t, i, l = {}) {
    const { signal: n } = l;
    if (this.fetchTile !== m.prototype.fetchTile) {
      const S = await this.fetchTile(e, t, i, l);
      return f(S, e, t, i, n);
    }
    const p = this.getTileUrl(e, t, i) ?? "", d = { responseType: "blob", signal: n, query: { ...this.refreshParameters } }, { data: v } = await c(p, d);
    return f(v, e, t, i, n);
  }
  getTileUrl() {
...
let o = class extends M(_(I(O))) {
  ...
  _getMetadata() {
    ...
    return c(`${$}/REST/v1/Imagery/Metadata/${e}`, { responseType: "json", query: { include: "ImageryProviders", uriScheme: "https", key: this.key, suppressStatus: !0, output: "json", culture: this.culture, userRegion: this.region } }).then((t) => {
      const i = t.data;
...
//# sourceMappingURL=BingMapsLayer-mAOG1VtN.js.map
