...
let W = class extends ee {
  ...
  loadDependencies() {
    return Le({ icon: () => import("./calcite-icon-CiF5pGWc.js") });
  }
  get capabilities() {
...
async function mr(t, e, i) {
  ...
  const c = s ? null : pr(n);
  return (await Promise.all(n.map(async (h, p) => ({ value: h, color: t.type === "opacity" ? await fr(h, t) : (await import("./main-lm2DHsZh.js").then((m) => m.r8)).getColor(t, h), label: s ? r[p] : c?.[p] ?? "" })))).reverse();
}
async function fr(t, e, i) {
  const s = new Zi(hr), n = (await import("./main-lm2DHsZh.js").then((r) => r.r8)).getOpacity(e, t);
...
let U = class extends ee {
  constructor(e, i) {
    super(e, i), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new Ie(), this.messages = null, this._disposeChart = (s) => {
      ...
      if (n || !r || !s) return;
      const { createRoot: a } = await import("./chartUtilsAm5-DEyyGTqj.js"), d = await a(s);
  ...
  async _getSeriesColors(e) {
    const { colorAm5: i } = await import("./chartCommon-DvKq-4xl.js"), s = /* @__PURE__ */ new Map();
    return e.forEach((n) => {
      n.color && s.set(n, i(n.color.toCss(!0)));
    }), s;
  }
  async _getRendererColors() {
    const { colorAm5: e } = await import("./chartCommon-DvKq-4xl.js"), i = /* @__PURE__ */ new Map(), s = this._getRenderer(), n = "default";
    if (!s) return i;
    const r = await yr(s);
  ...
  async _renderChart(e) {
    const { root: i, mediaInfo: s } = e, { value: n, type: r } = s, { ResponsiveThemeAm5: a, DarkThemeAm5: d, AnimatedThemeAm5: c, ColorSetAm5: h, ThemeAm5: p, esriChartColorSet: m } = await import("./chartCommon-DvKq-4xl.js"), f = p.new(i);
  ...
  async _customizeChartTooltip(e, i = "horizontal") {
    const { colorAm5: s } = await import("./chartCommon-DvKq-4xl.js");
  ...
  async _createPieChart(e, i) {
    const { TooltipAm5: s } = await import("./chartCommon-DvKq-4xl.js"), { PieChartAm5: n, PieSeriesAm5: r } = await import("./pieChart-g1vUtDX-.js"), { mediaInfo: a, root: d } = e, { title: c } = a, h = 5, p = a?.altText || a?.title || "", m = d.container.children.push(n.new(d, { ariaLabel: p, focusable: !0, paddingBottom: h, paddingTop: h, paddingLeft: h, paddingRight: h })), f = `{category}: {valuePercentTotal.formatNumber('0.00')}%
 ({value})`, y = s.new(d, { labelText: f }), v = m.series.push(r.new(d, { name: c, valueField: We, categoryField: pe, tooltip: y }));
  ...
  async _createColumnChart(e, i, s) {
    const { TooltipAm5: n, ScrollbarAm5: r } = await import("./chartCommon-DvKq-4xl.js"), { CategoryAxisAm5: a, AxisRendererXAm5: d, ValueAxisAm5: c, AxisRendererYAm5: h, ColumnSeriesAm5: p } = await import("./xyChart-CYzeqCpe.js"), { mediaInfo: m, root: f } = i, { value: y, title: v } = m;
  ...
  async _createLineChart(e, i, s) {
    const { TooltipAm5: n, ScrollbarAm5: r } = await import("./chartCommon-DvKq-4xl.js"), { CategoryAxisAm5: a, AxisRendererXAm5: d, ValueAxisAm5: c, AxisRendererYAm5: h, LineSeriesAm5: p } = await import("./xyChart-CYzeqCpe.js"), { root: m, mediaInfo: f } = i, { value: y, title: v } = f;
    e.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e, i) {
    const { XYChartAm5: s, XYCursorAm5: n } = await import("./xyChart-CYzeqCpe.js"), { root: r, mediaInfo: a } = e, { type: d } = a, c = a?.altText || a?.title || "", h = r.container.children.push(s.new(r, { ariaLabel: c, focusable: !0, panX: !0, panY: !0 }));
...
function gs() {
  return import("./arcade-CGmnjsQi.js");
}
function zr(t) {
...
let rt = class extends ee {
  ...
  loadDependencies() {
    return Le({ loader: () => import("./calcite-loader-Dvzo5OoK.js") });
  }
  destroy() {
...
let Q = class extends ee {
  ...
  loadDependencies() {
    return Le({ icon: () => import("./calcite-icon-CiF5pGWc.js"), list: () => import("./calcite-list-DmpjkY3P.js"), "list-item": () => import("./calcite-list-item-ywXY8JwH.js"), loader: () => import("./calcite-loader-Dvzo5OoK.js"), notice: () => import("./calcite-notice-CJfM9q_f.js") });
  }
  destroy() {
...
let q = Bt = class extends vs(ee) {
  ...
  loadDependencies() {
    return Le({ notice: () => import("./calcite-notice-CJfM9q_f.js"), loader: () => import("./calcite-loader-Dvzo5OoK.js") });
  }
  destroy() {
...
let be = class extends ee {
  ...
  loadDependencies() {
    return Le({ action: () => import("./calcite-action-WmPj-hmq.js"), "flow-item": () => import("./calcite-flow-item-0-YwKh59.js") });
  }
  render() {
...
async function Ni(t, e) {
  ...
  const { getColor: d, getOpacity: c, getAllSizes: h, getRotationAngle: p } = await import("./main-lm2DHsZh.js").then((w) => w.r8), m = [], f = [], y = [], v = [];
  ...
  constructor(t) {
    super(t), this._pendingPromises = new eo(), this._fetchFeaturesController = null, this._highlightSelectedFeaturePromise = null, this._highlightActiveFeaturePromise = null, this._selectedClusterFeature = null, this.actions = new Ae(), this.activeFeature = null, this.autoCloseEnabled = !1, this.browseClusterEnabled = !1, this.content = null, this.defaultPopupTemplateEnabled = !1, this.featurePage = null, this.featuresPerPage = 20, this.featureMenuOpen = !1, this.featureViewModelAbilities = null, this.featureViewModels = [], this.highlightEnabled = !0, this.includeDefaultActions = !0, this.selectedClusterBoundaryFeature = new De({ symbol: new ln({ outline: { width: 1.5, color: "cyan" }, style: "none" }) }), this.title = null, this.updateLocationEnabled = !1, this.view = null, this.visible = !1, this.zoomFactor = 4, this.zoomToLocation = null, this._debouncedLocationUpdate = it(async (e) => {
      ...
      if (s && s !== "mesh" && i && n && this.selectedFeature) if (s !== "point") try {
        ...
        if (a = dn(a, i), tt || (tt = await import("./geometryEngineAsync-nyTI7qeG.js")), !await tt.intersects(a, n)) {
...
let A = class extends vs(ee) {
  ...
  loadDependencies() {
    return Le({ action: () => import("./calcite-action-WmPj-hmq.js"), "action-bar": () => import("./calcite-action-bar-BBgDaBfY.js"), "action-group": () => import("./calcite-action-group-CzHCixs1.js"), button: () => import("./calcite-button-DFMPmuDm.js"), flow: () => import("./calcite-flow-PI6AOZCu.js"), "flow-item": () => import("./calcite-flow-item-0-YwKh59.js"), list: () => import("./calcite-list-DmpjkY3P.js"), "list-item": () => import("./calcite-list-item-ywXY8JwH.js"), "list-item-group": () => import("./calcite-list-item-group-DBwSUk_N.js"), loader: () => import("./calcite-loader-Dvzo5OoK.js") });
  }
  destroy() {
...
//# sourceMappingURL=Popup-BphBMTTV.js.map
