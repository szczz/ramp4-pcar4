import { O as t, P as a, bH as o, Q as d, V, S as l, fw as y, bG as w } from "./main-lm2DHsZh.js";
import { y as p, f as v } from "./LayerView-CpYEODlP.js";
let s = class extends p {
  ...
  _layerViewsChangeHandler(i) {
    this.removeHandles("grouplayerview:visible"), this.addHandles(this.layerViews.map((r) => l(() => r.visible, (n) => this._applyVisibility(() => {
...
t([a({ readOnly: !0 })], s.prototype, "creatingLayerViews", null), t([a({ cast: o })], s.prototype, "layerViews", null), t([a({ readOnly: !0 })], s.prototype, "updatingProgress", null), t([a()], s.prototype, "view", void 0), s = t([d("esri.views.layers.GroupLayerView")], s);
const u = s;
...
//# sourceMappingURL=GroupLayerView2D-DPZglPq6.js.map
