import { iM as k, c7 as m, cc as x, ci as L, ch as j, iw as B, fV as b, fW as q, iN as T, f$ as N, iO as K, iK as V, iJ as D, c1 as M, c4 as O, iP as H, f_ as _, iQ as W, c6 as z, cd as A, ce as E, ca as I, cf as P, ix as R } from "./main-lm2DHsZh.js";
var C = { name: "Toggle", emits: ["input", "update:modelValue", "change"], props: { value: { validator: function(l) {
  ...
  const t = function(i, c, o) {
    const { value: r, modelValue: d, falseValue: a, trueValue: e, disabled: f } = k(i), u = d && d.value !== void 0 ? d : r, h = m(() => u.value === e.value), y = (p) => {
    ...
    return [null, void 0, !1, 0, "0", "off"].indexOf(u.value) !== -1 && [a.value, e.value].indexOf(u.value) === -1 && S(), [!0, 1, "1", "on"].indexOf(u.value) !== -1 && [a.value, e.value].indexOf(u.value) === -1 && w(), { externalValue: u, checked: h, update: y, check: w, uncheck: S, handleInput: (p) => {
      y(p.target.checked ? e.value : a.value);
    }, handleClick: () => {
      f.value || (h.value ? S() : w());
    } };
  }(l, n), g = function(i, c, o) {
    const { trueValue: r, falseValue: d, onLabel: a, offLabel: e } = k(i), f = o.checked, u = o.update;
    return { label: m(() => {
    ...
    const { disabled: r } = k(i), d = o.check, a = o.uncheck, e = o.checked;
    return { handleSpace: () => {
      r.value || (e.value ? a() : d());
    } };
...
const U = ["tabindex", "aria-checked", "aria-describedby", "aria-labelledby"], $ = ["id", "name", "value", "checked", "disabled"], J = ["innerHTML"], Q = ["checked"];
C.render = function(l, n, t, g, s, v) {
  return x(), L("div", K({ class: l.classList.container, tabindex: t.disabled ? void 0 : 0, "aria-checked": l.checked, "aria-describedby": t.describedby, "aria-labelledby": t.labelledby, role: "switch" }, t.aria, { onKeypress: n[1] || (n[1] = V(D((...i) => l.handleSpace && l.handleSpace(...i), ["prevent"]), ["space"])) }), [j(b("input", { type: "checkbox", id: t.id, name: t.name, value: t.trueValue, checked: l.checked, disabled: t.disabled }, null, 8, $), [[B, !1]]), b("div", { class: q(l.classList.toggle), onClick: n[0] || (n[0] = (...i) => l.handleClick && l.handleClick(...i)) }, [b("span", { class: q(l.classList.handle) }, null, 2), T(l.$slots, "label", { checked: l.checked, classList: l.classList }, () => [b("span", { class: q(l.classList.label), innerHTML: l.label }, null, 10, J)]), t.required ? (x(), L("input", { key: 0, type: "checkbox", style: { appearance: "none", height: "1px", margin: "0", padding: "0", fontSize: "0", background: "transparent", position: "absolute", width: "100%", bottom: "0", outline: "none" }, checked: l.checked, "aria-hidden": "true", tabindex: "-1", required: "" }, null, 8, Q)) : N("v-if", !0)], 2)], 16, U);
}, C.__file = "src/Toggle.vue";
const F = { class: "flex flex-row rv-label" }, G = { class: "flex items-center" }, X = ["innerHTML"], Y = /* @__PURE__ */ M({
  ...
  emits: ["toggled"],
  setup(l, { emit: n }) {
    const t = n, g = l, s = O(g.config.value), v = O(!!g.config.disabled), i = O(0), c = H([]), o = O(null);
    c.push(
      _(
        W(g, "config"),
        (a, e) => {
...
}), ee = /* @__PURE__ */ R(Y, [["__scopeId", "data-v-188debd2"]]);
export {
  ee as T
};
//# sourceMappingURL=toggle-switch-control-Cp5KoPz3.js.map
