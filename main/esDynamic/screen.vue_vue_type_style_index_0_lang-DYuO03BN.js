import { c1 as A, hK as H, c2 as j, c3 as R, c4 as O, c7 as T, iP as C, c5 as V, g1 as X, f_ as B, c6 as F, c8 as D, ca as q, cb as k, cc as o, cd as U, ce as m, cf as p, ci as d, fV as h } from "./main-lm2DHsZh.js";
import { m as G } from "./marked.esm-DgqJBp_S.js";
...
`, z = { key: 0 }, J = { class: "flex justify-center" }, Q = {
  key: 0,
  ...
  setup(r) {
    const s = H(), { t: l } = j(), f = R("iApi"), M = O(), a = r, u = T(() => s.status), b = T(() => s.response), v = O(!1), x = C({}), y = C([]), S = C([]);
    V(() => {
      _(), y.push(
        f.event.on(X.LAYER_REMOVE, (e) => {
    ...
    const _ = () => {
      v.value = a.payload.layer !== void 0 && !a.payload.layer.isRemoved, a.payload.type === "xml" ? I(a.payload.url, []).then((e) => {
        ...
        s.status = e.status, s.response = G(e.response);
      });
    }, I = (e, t) => {
      let n = f.language === "en" ? K : Y;
    ...
    return (e, t) => {
      ...
      return o(), q(n, {
        ...
        header: k(() => [
          U(m(p(l)("metadata.title")) + ": " + m(r.payload.layerName), 1)
        ]),
        content: k(() => [
          v.value ? (o(), d("div", z, [
            h("div", J, [
              u.value == "loading" ? (o(), d("div", Q, m(p(l)("metadata.loading")), 1)) : r.payload.type === "xml" && u.value == "success" ? (o(), d("div", {
                key: 1,
                innerHTML: b.value,
...
//# sourceMappingURL=screen.vue_vue_type_style_index_0_lang-DYuO03BN.js.map
