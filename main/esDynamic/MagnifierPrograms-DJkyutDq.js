import { c as b } from "./WGLContainer-TDEKqET4.js";
import { t as wt } from "./CircularArray-DaQg3PQl.js";
import { a9 as B, da as yt, aN as x, e2 as E, O as _, P as g, Q as R, nT as ht, fR as Mt, b0 as _t, aG as pt, fL as bt, h$ as xt, dI as gt, nU as Q, a3 as W, fF as vt, nV as H, nW as Tt, aH as $t, fH as nt, nX as St, jo as Ct, nY as Dt, fD as k, nZ as Vt, n_ as ot, n$ as zt, o0 as Et, bl as O, o1 as lt } from "./main-lm2DHsZh.js";
import { a as Rt } from "./testSVGPremultipliedAlpha-C5s8n9jz.js";
import { U, N as Lt, O as It } from "./definitions-Doe0g1C2.js";
import { t as Ft } from "./AttributeStore-BjcxQwrX.js";
import { e as At } from "./ProgramTemplate-C6PXKuso.js";
const se = { shaders: { vertexShader: b("bitBlit/bitBlit.vert"), fragmentShader: b("bitBlit/bitBlit.frag") }, attributes: /* @__PURE__ */ new Map([["a_pos", 0], ["a_tex", 1]]) }, ne = { shaders: { vertexShader: b("stencil/stencil.vert"), fragmentShader: b("stencil/stencil.frag") }, attributes: /* @__PURE__ */ new Map([["a_pos", 0]]) }, oe = { shaders: { vertexShader: b("highlight/textured.vert"), fragmentShader: b("highlight/highlight.frag") }, attributes: /* @__PURE__ */ new Map([["a_position", 0], ["a_texcoord", 1]]) }, ae = { shaders: { vertexShader: b("highlight/textured.vert"), fragmentShader: b("highlight/blur.frag") }, attributes: /* @__PURE__ */ new Map([["a_position", 0], ["a_texcoord", 1]]) }, w = B("esri-2d-profiler");
let re = class {
  constructor(t, e) {
    if (this._events = new yt(), this._entries = /* @__PURE__ */ new Map(), this._timings = new wt(10), this._currentContainer = null, this._currentPass = null, this._currentBrush = null, this._currentSummary = null, !w) return;
    this._ext = Rt(t.gl, {}), this._debugOutput = e;
    const i = t.gl;
...
let Pt = class {
  ...
  hasCollision(t) {
    ...
    for (const { computedX: i, computedY: s, width: n, height: a } of t.bounds) {
      const h = (n + U) * this._pixelRatio, o = (a + U) * this._pixelRatio;
  ...
  _collide(t, e, i, s) {
    ...
    if (h < 0 || o < 0 || n > this._width || a > this._height) return Z;
  ...
  _markMetrics(t) {
    for (const { computedX: e, computedY: i, width: s, height: n } of t.bounds) {
      const a = (s + U) * this._pixelRatio, h = (n + U) * this._pixelRatio;
      this._mark(e, i, a, h, t.entityTexel);
    }
  }
};
const L = 254, G = 255, I = 0;
function C(r, t) {
...
let Zt = class {
  run(t, e, i, s) {
    ...
    B("esri-2d-update-debug") && n.length && console.debug("CollisionEngine.run"), this._transformMetrics(n), this._runCollision(n, e, i, s);
    for (const a of n) a.container.requestRender();
  }
  _runCollision(t, e, i, s) {
    const [n, a] = e.state.size, h = new Pt(n, a, e.pixelRatio);
    for (const { container: o, deconflictionEnabled: u, visible: l } of t) {
      ...
      u ? l ? (this._prepare(o), this._collideVisible(h, o, i, s), this._collideInvisible(h, o)) : C(o, (c, m) => {
        for (const d of m) p.setLabelMinZoom(d.entityTexel, G);
      }) : C(o, (c, m) => {
        for (const d of m) ut(d, i) ? (p.setLabelMinZoom(d.entityTexel, I), l && h.insertMetrics(d)) : p.setLabelMinZoom(d.entityTexel, L);
      });
    }
  }
  _isFiltered(t, e, i) {
    const s = e.getFilterFlags(t), n = !i.hasFilter || !!(s & Lt), a = i.featureEffect == null || i.featureEffect.excludedLabelsVisible || !!(s & It);
    return !(n && a);
  }
  _prepare(t) {
      ...
      for (const a of n) {
        ...
        if (!i.has(h)) {
          if (i.add(h), this._isFiltered(h, e, t.layerView)) {
            e.setLabelMinZoom(h, L);
            continue;
          }
          e.getLabelMinZoom(h) !== I ? e.setLabelMinZoom(h, G) : e.setLabelMinZoom(h, I);
        }
      }
    });
  }
  _collideVisible(t, e, i, s) {
    ...
    C(e, (h, o) => {
      for (let u = 0; u < o.length; u++) {
        ...
        u = d - 1, c || (a.add(l), n.setLabelMinZoom(l, p ? L : I));
      }
    });
  }
  _collideInvisible(t, e) {
    ...
    C(e, (n, a) => {
      for (let h = 0; h < a.length; h++) {
        ...
        h = c - 1, l || (s.add(o), i.setLabelMinZoom(o, u ? G : I));
      }
    });
  }
  _transformMetrics(t) {
...
let F = class extends E {
  constructor(t) {
    super(t), this._lastUpdate = 0, this.collisionEngine = new Zt(), this.lastUpdateId = -1, this.updateRequested = !1, this.view = null;
  }
  get updating() {
    return B("esri-2d-log-updating") && console.log(`Updating LabelManager ${this.updateRequested}:
-> updateRequested: ${this.updateRequested}`), this.updateRequested;
  }
  update(t) {
    const e = performance.now();
    e - this._lastUpdate >= Nt ? (this._lastUpdate = e, this.doUpdate(t)) : this.requestUpdate();
  }
  viewChange() {
    this.requestUpdate();
  }
...
const X = "esri-zoom-box", Y = { container: `${X}__container`, overlay: `${X}__overlay`, background: `${X}__overlay-background`, box: `${X}__outline` }, tt = { zoom: "Shift", counter: "Control" };
let A = class extends E {
  ...
  set view(t) {
    this.removeAllHandles(), this._destroyOverlay(), this._set("view", t), t && this.addHandles([t.on("drag", [tt.zoom], (e) => this._handleDrag(e, 1), ht.INTERNAL), t.on("drag", [tt.zoom, tt.counter], (e) => this._handleDrag(e, -1), ht.INTERNAL)]);
  }
  _start() {
  ...
  _end(t, e, i, s, n) {
    const a = this.view, h = a.toMap(Mt(t + 0.5 * i, e + 0.5 * s));
    let o = Math.max(i / a.width, s / a.height);
    n === -1 && (o = 1 / o), this._destroyOverlay(), this.navigation.end(), a.goTo({ center: h, scale: a.scale * o }, { animationMode: "always", duration: _t(B("mapview-essential-goto-duration")) });
  }
  _updateBox(t, e, i, s) {
    const n = this._boxShape;
    n.setAttributeNS(null, "x", "" + t), n.setAttributeNS(null, "y", "" + e), n.setAttributeNS(null, "width", "" + i), n.setAttributeNS(null, "height", "" + s), n.setAttributeNS(null, "class", Y.box);
  }
  ...
  _createContainer() {
    ...
    t.className = Y.container, this.view.root.appendChild(t), this._container = t;
  }
  _createOverlay() {
    const t = this.view.width, e = this.view.height, i = document.createElementNS("http://www.w3.org/2000/svg", "path");
    i.setAttributeNS(null, "d", "M 0 0 L " + t + " 0 L " + t + " " + e + " L 0 " + e + " Z"), i.setAttributeNS(null, "class", Y.background);
    const s = document.createElementNS("http://www.w3.org/2000/svg", "rect"), n = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    n.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xlink", "http://www.w3.org/1999/xlink"), n.setAttributeNS(null, "class", Y.overlay), n.appendChild(i), n.appendChild(s), this._container.appendChild(n), this._backgroundShape = i, this._boxShape = s, this._overlay = n;
  }
  _destroyOverlay() {
...
_([g()], A.prototype, "navigation", void 0), _([g()], A.prototype, "view", null), A = _([R("esri.views.2d.navigation.ZoomBox")], A);
const kt = A;
let T = class {
  constructor(t) {
...
class qt {
  constructor(t = 300, e = 12, i = 0.84) {
    this._minimumInitialVelocity = t, this._stopVelocity = e, this._friction = i, this.enabled = !0, this._time = new T(0.6), this._screen = [new T(0.4), new T(0.4)], this._scene = [new T(0.6), new T(0.6), new T(0.6)], this._tmpDirection = pt();
  }
  add(t, e, i) {
    if (this.enabled) {
  ...
  createMomentum(t, e, i) {
    bt(this._tmpDirection, this._scene[0].filteredDelta ?? 0, this._scene[1].filteredDelta ?? 0, this._scene[2].filteredDelta ?? 0);
    const s = xt(this._tmpDirection);
    s > 0 && gt(this._tmpDirection, this._tmpDirection, 1 / s);
    const n = this._time.filteredDelta;
    return new Bt(t, e, i, n == null ? 0 : s / n, this._tmpDirection);
  }
}
let V = class extends E {
  constructor(t) {
    super(t), this.animationTime = 0, this.momentumEstimator = new qt(500, 6, 0.92), this.momentum = null, this.tmpMomentum = pt(), this.momentumFinished = !1, this.viewpoint = new Q({ targetGeometry: new W(), scale: 0, rotation: 0 }), this._previousDrag = null, vt(() => this.momentumFinished, () => this.navigation.stop());
  }
  begin(t, e) {
  ...
  update(t, e) {
    ...
    i = n ? n.center.x - i : -i, s = n ? s - n.center.y : s, t.viewpoint = H(this.viewpoint, t.viewpoint, [i || 0, s || 0]), this._previousDrag = e;
  }
  end(t, e) {
    this.addToEstimator(e);
  ...
  addToEstimator(t) {
    const e = t.center.x, i = t.center.y, s = Tt(-e, i), n = $t(-e, i, 0);
    this.momentumEstimator.add(s, n, 1e-3 * t.timestamp);
  }
  onAnimationUpdate(t) {
    this.navigation.animationManager?.animateContinuous(t.viewpoint, (e, i) => {
      ...
      if (!(this.momentumFinished = !s || s.isFinished(n))) {
        ...
        gt(a, s.direction, o), H(e, e, a), t.constraints.constrainByGeometry(e);
      }
...
let z = class extends E {
  constructor(t) {
    super(t), this._animationTime = 0, this._momentumFinished = !1, this._previousAngle = 0, this._previousRadius = 0, this._previousCenter = null, this._rotationMomentumEstimator = new Ut(0.6, 0.15, 0.95), this._rotationDirection = 1, this._startAngle = 0, this._startRadius = 0, this._updateTimestamp = null, this._zoomDirection = 1, this._zoomMomentumEstimator = new Xt(), this._zoomOnly = null, this.viewpoint = new Q({ targetGeometry: new W(), scale: 0, rotation: 0 }), this.zoomMomentum = null, this.rotateMomentum = null, this.addHandles(vt(() => this._momentumFinished, () => this.navigation.stop()));
  }
  begin(t, e) {
    ...
    this.navigation.animationManager?.animateContinuous(t.viewpoint, (e, i) => {
      ...
      if (this._momentumFinished = n && a, !this._momentumFinished) {
        ...
        if (this._previousCenter) {
          nt(l, this._previousCenter.x, this._previousCenter.y), St(p, t.size, t.padding), Ct(l, l, p);
          const { constraints: c, scale: m } = t, d = m * u;
          u < 1 && !c.canZoomInTo(d) ? (u = m / c.effectiveMaxScale, this.zoomMomentum = null, this.rotateMomentum = null) : u > 1 && !c.canZoomOutTo(d) && (u = m / c.effectiveMinScale, this.zoomMomentum = null, this.rotateMomentum = null), Dt(e, t.viewpoint, u, o, l, t.size), t.constraints.constrainByGeometry(e);
        }
      }
...
const Yt = z, et = k(), mt = k();
let P = class extends E {
  constructor(r) {
    super(r), this._previousCenter = k(), this.viewpoint = new Q({ targetGeometry: new W(), scale: 0, rotation: 0 });
  }
  begin(r, t) {
    this.navigation.begin(), nt(this._previousCenter, t.center.x, t.center.y);
  }
  update(r, t) {
    const { state: { size: e, padding: i } } = r;
    nt(et, t.center.x, t.center.y), Vt(mt, e, i), r.viewpoint = ot(this.viewpoint, r.state.paddedViewState.viewpoint, zt(mt, this._previousCenter, et)), Et(this._previousCenter, et);
  }
  end() {
    this.navigation.end();
  }
};
_([g()], P.prototype, "viewpoint", void 0), _([g()], P.prototype, "navigation", void 0), P = _([R("esri.views.2d.navigation.actions.Rotate")], P);
const Ht = P, D = 10, ct = 1, it = new Q({ targetGeometry: new W() }), st = [0, 0], dt = 250;
let M = class extends E {
  ...
  initialize() {
    this.pan = new Ot({ navigation: this }), this.rotate = new Ht({ navigation: this }), this.pinch = new Yt({ navigation: this }), this.zoomBox = new kt({ view: this.view, navigation: this });
  }
  destroy() {
    this.pan = O(this.pan), this.rotate = O(this.rotate), this.pinch = O(this.pinch), this.zoomBox = O(this.zoomBox), this.animationManager = null;
  }
  begin() {
  ...
  continuousRotateClockwise() {
    ...
    this.animationManager?.animateContinuous(r, (t) => {
      ot(t, t, -ct);
    });
  }
  ...
  _continuousPan(r) {
    ...
    this.animationManager?.animateContinuous(t, (e) => {
      H(e, e, r), this.view.constraints.constrainByGeometry(e);
    });
  }
  _startTimer(r) {
  ...
  _getDefaultAnchor() {
    ...
    return st[0] = 0.5 * (r[0] - e + t), st[1] = 0.5 * (r[1] - s + i), st;
  }
  async _zoomToScale(r, t = this._getDefaultAnchor()) {
    ...
    if (!(r < s && !o || r > s && !u)) return lt(it, n, r / s, 0, t, a, h), i.constrainByGeometry(it), e.goTo(it, { animate: !0, animationMode: "always", duration: _t(B("mapview-essential-goto-duration")), pickClosestTarget: !1 });
  }
  _scaleRotateTranslateViewpoint(r, t, e, i, s) {
    ...
    return (e < 1 && !c || e > 1 && !m) && (e = 1), H(l, l, s), lt(r, l, e, i, t, a, h), o.constrainByGeometry(r);
  }
};
...
const we = M, jt = { shaders: { vertexShader: b("magnifier/magnifier.vert"), fragmentShader: b("magnifier/magnifier.frag") }, attributes: /* @__PURE__ */ new Map([["a_pos", 0]]) };
function ye(r) {
  return At(r, jt);
}
export {
...
//# sourceMappingURL=MagnifierPrograms-DJkyutDq.js.map
