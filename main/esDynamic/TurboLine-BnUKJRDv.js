import { a9 as Et, fq as bt } from "./main-lm2DHsZh.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-B8DJ44UR.js").then((i) => i.l) : await import("./libtess-Cr2MZt4Z.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-BnUKJRDv.js.map
