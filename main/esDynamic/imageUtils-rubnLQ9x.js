import { bI as m, aP as I, O as M, Q as V } from "./main-lm2DHsZh.js";
import { b as y } from "./Bitmap-DyCUqmA2.js";
import { r as T, h as _ } from "./WGLContainer-TDEKqET4.js";
import { E as c } from "./Container-CkDvNCAj.js";
import { i as P } from "./TileContainer-CEbFukYw.js";
let A = class extends T {
  constructor(e, i, r, s, n, o, a = null) {
    super(e, i, r, s, n, o), this.bitmap = new y(a), this.bitmap.coordScale = [n, o], this.bitmap.once("isReady", () => this.ready());
  }
  destroy() {
  ...
  createTile(e) {
    const i = this._tileInfoView.getTileBounds(I(), e), r = this._tileInfoView.getTileResolution(e.level), [s, n] = this._tileInfoView.tileInfo.size;
...
const z = (t) => {
  ...
  return e = M([V("esri.views.2d.layers.BitmapTileLayerView2D")], e), e;
};
function L(t) {
...
//# sourceMappingURL=imageUtils-rubnLQ9x.js.map
