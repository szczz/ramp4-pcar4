...
const t = {
  ...
  render() {
    const { el: e, inline: v, label: h, scale: l, text: s, type: u, value: c } = this, g = e.id || C(), p = 0.45, i = v ? this.getInlineSize(l) : this.getSize(l), d = i * p, k = `0 0 ${i} ${i}`, r = u.startsWith("determinate"), m = 2 * d * Math.PI, f = c / 100 * m, y = m - f, z = Math.floor(c), b = { "stroke-dasharray": `${f} ${y}` };
    return a(w, { key: "8272bdfae9fff51b19ed8fa66197eb93b53feb4c", "aria-label": h, "aria-valuemax": r ? "100" : void 0, "aria-valuemin": r ? "0" : void 0, "aria-valuenow": r ? z.toString() : void 0, id: g, role: "progressbar" }, a("div", { key: "3d410c178af39bb57cc478bdd06c0392f6ba71a3", class: t.loaderParts }, [1, 2, 3].map((o) => a("svg", { "aria-hidden": "true", class: {
      [t.loaderPart]: !0,
      [t.loaderPartId(o)]: !0
    }, key: o, style: r && o === 3 ? b : void 0, viewBox: k }, a("circle", { cx: i / 2, cy: i / 2, r: d }))), r && a("div", { key: "4ccc633930dee031bf769908d712df39e0677bbb", class: t.loaderPercentage }, this.formatValue())), s && a("div", { key: "6d0d51988bdfafee2a19faed9e14d3bda06d79b5", class: t.loaderText }, s));
  }
  ...
  updateFormatter() {
    this.type !== "determinate-value" || this.formatter?.resolvedOptions().locale === this.effectiveLocale || (this.formatter = new Intl.NumberFormat(this.effectiveLocale, {
      style: "percent"
    }));
  }
  get el() {
...
//# sourceMappingURL=loader-BJcS0mbh.js.map
