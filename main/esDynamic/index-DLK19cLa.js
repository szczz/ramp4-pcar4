import { jr as A, js as y, bY as M, fU as $, hG as O, g1 as D, hH as j } from "./main-lm2DHsZh.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DME-xJyK.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-Yk5c5EFe.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-Ubj5dqs7.js")).default, n = (await import("./index-3tnTStq5.js")).default, a = (await import("./index-DmNcj-xt.js")).default, w = (await import("./index-NthhV6lY.js")).default, p = (await import("./index-6q6ska79.js")).default, r = (await import("./index-Dt95pYna.js")).default, b = (await import("./index-BXaw-Ymg.js")).default;
  ...
  added() {
    ...
    this.removed = () => {
      n(), this.$iApi.fixture.get("export-title")?.remove(), this.$iApi.fixture.get("export-map")?.remove(), this.$iApi.fixture.get("export-legend")?.remove(), this.$iApi.fixture.get("export-northarrow")?.remove(), this.$iApi.fixture.get("export-scalebar")?.remove(), this.$iApi.fixture.get("export-timestamp")?.remove(), this.$iApi.fixture.get("export-footnote")?.remove(), this.$iApi.fixture.exists("appbar") && j(this.$vApp.$pinia).removeButton("export"), $(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("export");
    };
  }
}
export {
...
//# sourceMappingURL=index-DLK19cLa.js.map
