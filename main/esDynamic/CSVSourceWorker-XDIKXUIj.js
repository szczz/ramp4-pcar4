import { dq as I, di as D, s as F, dj as j, M as P, D as R, I as V, $ as L, df as _, bg as b, dh as A, K as G, ap as M, gk as Q, gl as Z, bx as Y, ds as J, dt as U, de as B, o as K } from "./main-lm2DHsZh.js";
import { e as H, n as W } from "./date-CID61X27.js";
import { t as z } from "./json-BI97KiBB.js";
import { m as X } from "./FeatureStore-kbC0mBT0.js";
import { x as ee } from "./timeSupport-BMgFmqzA.js";
import { $ as te } from "./QueryEngine-cqgD_odw.js";
import { c as ie } from "./number-crCb3SnJ.js";
import { i as ne, o as se } from "./clientSideDefaults-BkFQkY5x.js";
...
function* C(r, i, e, t = () => /* @__PURE__ */ Object.create(null)) {
  const n = $(r);
  n.next();
  let a = "", o = "", l = 0, c = t(), u = 0;
  e: for (const y of n) {
...
class Te {
  ...
  async refresh(i) {
    this._loadOptions.customParameters = i, this._snapshotTask?.abort(), this._snapshotTask = j(this._snapshotFeatures), this._snapshotTask.promise.then((n) => {
      this._queryEngine.featureStore.clear(), n && this._queryEngine.featureStore.addMany(n);
    }, (n) => {
      this._queryEngine.featureStore.clear(), P(n) || R.getLogger("esri.layers.CSVLayer").error(new F("csv-layer:refresh", "An error occurred during refresh", { error: n }));
  ...
  async _createFeatures(i) {
    ...
    const p = C(i, u, this._delimiter, ne(f, n));
    for (const s of p) {
    ...
    if (!G({ wkid: 4326 }, o)) if (M(o)) for (const s of l) [s.x, s.y] = Q(s.x, s.y, pe);
...
//# sourceMappingURL=CSVSourceWorker-XDIKXUIj.js.map
