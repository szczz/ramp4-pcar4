import { c$ as p, d0 as u, e_ as n, cX as t } from "./main-lm2DHsZh.js";
import { c as b, d as k } from "./conditionalSlot-Bi5pMQuY.js";
import { r as c, n as v } from "./dom-BHTTQ4_z.js";
import { s as x, a as w, c as y } from "./loadable-CsKbmXcU.js";
import { c as z, d as C } from "./locale-DlBi8777.js";
import { c as E, d as L, s as O, u as B } from "./t9n-BO4Ef3RJ.js";
import { o as s } from "./openCloseComponent-CWMeR7bs.js";
import { g as a } from "./component-CWGf1hug.js";
import { d as N } from "./icon-F11CuSC7.js";
const l = {
  brand: "lightbulb",
...
const o = {
  ...
  updateRequestedIcon() {
    this.requestedIcon = c(l, this.icon, this.kind);
  }
  //--------------------------------------------------------------------------
  //
  //  Lifecycle
  ...
  //--------------------------------------------------------------------------
  connectedCallback() {
    b(this), z(this), E(this);
  }
  disconnectedCallback() {
    k(this), C(this), L(this);
  }
  async componentWillLoad() {
    x(this), this.requestedIcon = c(l, this.icon, this.kind), await O(this), this.open && s(this);
  }
  componentDidLoad() {
    w(this);
  }
  render() {
    const { el: e } = this, f = t("button", { key: "52f9306ebe945398929f68fe66615359836ba2d8", "aria-label": this.messages.close, class: i.close, onClick: this.close, ref: (g) => this.closeButton = g }, t("calcite-icon", { key: "f3601ac9547c73219661eebc7e7470db5dee7b52", icon: "x", scale: a(this.scale) })), m = v(e, o.actionsEnd);
    return t("div", { key: "3f8117ff7cdd08c92ce804ef4ac8af83003156a4", class: i.container, ref: this.setTransitionEl }, this.requestedIcon ? t("div", { class: i.icon }, t("calcite-icon", { flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: a(this.scale) })) : null, t("div", { key: "1b614ee86618bd5ce6e8834b466baf7d2564b5a1", class: i.content }, t("slot", { key: "19467ed9718a78c7530c2a08c727028d565dee7b", name: o.title }), t("slot", { key: "191e71caf2f2147c62fd6b73602e41d95dc27558", name: o.message }), t("slot", { key: "d4fbf2b8aaa980cd24c5be89c6c8a36d091658f3", name: o.link })), m ? t("div", { class: i.actionsEnd }, t("slot", { name: o.actionsEnd })) : null, this.closable ? f : null);
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
//# sourceMappingURL=calcite-notice-CJfM9q_f.js.map
