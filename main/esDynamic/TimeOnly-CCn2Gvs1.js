import { iE as i, iF as l, iG as Z, iH as g, iI as b, v as M, b3 as U, b8 as q } from "./main-lm2DHsZh.js";
var y;
(function(r) {
...
class w extends Error {
  constructor(e, t) {
    super(M(N[e], t)), this.declaredRootClass = "esri.arcade.arcadedate.dateerror", Error.captureStackTrace && Error.captureStackTrace(this, w);
  }
}
function h(r, e, t) {
...
function k(r) {
  r = r.replaceAll(/LTS|LT|L{1,4}|l{1,4}/g, "[$&]");
  let e = "";
  const t = /(\[[^[]*\])|(\\)?([Hh]mm(ss)?|Mo|M{1,4}|Do|DDDo|D{1,4}|d{2,4}|do?|w[o|w]?|W[o|W]?|Qo?|N{1,5}|YYYYYY|YYYYY|YYYY|YY|y{2,4}|yo?|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g;
...
function I(r) {
  ...
  switch (r.type) {
    ...
    case "polyline":
      return r.extent;
    case "point":
      return new q({ xmin: r.x, ymin: r.y, xmax: r.x, ymax: r.y, spatialReference: r.spatialReference });
    case "extent":
      return r;
  }
  return null;
...
//# sourceMappingURL=TimeOnly-CCn2Gvs1.js.map
