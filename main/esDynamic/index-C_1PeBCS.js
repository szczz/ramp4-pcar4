import { bY as u, iv as a, iX as y, iY as g, iZ as m, i_ as c, i$ as f, c1 as L, c2 as v, c3 as b, c8 as I, ca as x, cb as A, cf as $, cc as w, fV as h, hG as _, hH as S, hI as E } from "./main-lm2DHsZh.js";
import { _ as M } from "./screen.vue_vue_type_script_setup_true_lang-B3HIyyut.js";
class T extends u {
  /**
  ...
  updateLegend(e) {
    const t = (l, n) => {
      ...
      n ? (r && l instanceof c && (r.layer = l), r?.error()) : r?.load(l instanceof c ? l : void 0);
    };
    e.loadPromise().then(() => {
      ...
      return w(), x(i, {
        ...
        default: A(() => r[0] || (r[0] = [
          h("svg", {
            ...
            h("path", { d: "M11.99 18.54l-7.37-5.73L3 14.07l9 7 9-7-1.63-1.27-7.38 5.74zM12 16l7.36-5.73L21 9l-9-7-9 7 1.63 1.27L12 16z" })
          ], -1)
        ])),
        _: 1
      }, 8, ["tooltip"]);
...
//# sourceMappingURL=index-C_1PeBCS.js.map
