import { C as x, a1 as C, bn as J, bo as K, bp as E, bx as I, Z as M, eU as W, eY as Q, eZ as U } from "./main-lm2DHsZh.js";
import { a as G, b as u, r as c, I as j, m as P, G as w, ab as V, P as Z, N as T, U as v, A as H, E as D, X as k, w as X, v as Y, ac as _, ad as F, ae as z } from "./arcadeUtils-BPQamVKT.js";
import { l as B } from "./portalUtils-Bm5jKn1-.js";
import { p as L, n as O } from "./project-C4kbUCPI.js";
import { s as $, m as nn, t as tn, p as en, c as an } from "./GraphQueryStreaming-BJOL8AaN.js";
let f = null;
async function rn(n) {
...
async function q(n, t) {
  ...
  return await a.load(), f === null && (f = await import("./knowledgeGraphService-CHPoIwzu.js").then((i) => i.k)), await f.fetchKnowledgeGraph(a.url);
}
...
function pn(n) {
  n.mode === "async" && (n.functions.knowledgegraphbyportalitem = function(t, a) {
    ...
    return n.standardFunctionAsync(t, a, async (i, s, e) => {
      ...
      f === null && (f = await import("./knowledgeGraphService-CHPoIwzu.js").then((o) => o.k));
      let p = null;
      const m = Z(e[2], null);
...
//# sourceMappingURL=knowledgegraph-DAM0Bvot.js.map
