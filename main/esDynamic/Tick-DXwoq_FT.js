import { e$ as j } from "./main-lm2DHsZh.js";
import { s as C, a as K, aB as Z, w, N as J, aC as X, r as k, aD as Q, E as O, a5 as H, af as W, aE as ee, an as z, aF as te, a2 as G } from "./Theme-DN_QqyRv.js";
class ie extends X {
  constructor() {
...
class S extends C {
  ...
  _afterNew() {
    super._afterNew(), this._data.incrementRef(), this._updateFields(), this._disposers.push(this.data.events.onAll((e) => {
      ...
      if (this.markDirtyValues(), this._markDirtyGroup(), this._dataChanged = !0, e.type === "clear") w(t, (i) => {
        i.dispose();
        ...
        i.bullets && i.bullets.length == 0 && (i.bullets = void 0), J(s).forEach((l) => {
...
function $(r, e, t, i, s, l, o) {
    ...
    switch (s || e == "millisecond" || (h = r.getTimezoneOffset(), r.setUTCMinutes(r.getUTCMinutes() - h)), e) {
      case "day":
        ...
        if (t > 1) {
          if (l) {
            l = $(l, "day", 1);
            let D = r.getTime() - l.getTime(), b = Math.floor(D / P("day") / t), x = P("day", b * t);
            r.setTime(l.getTime() + x - h * P("minute"));
          }
        } else r.setUTCDate(d);
      ...
      case "hour":
        let f = r.getUTCHours();
        t > 1 && (f = Math.floor(f / t) * t), r.setUTCHours(f, 0, 0, 0);
        break;
      case "minute":
      ...
      case "year":
        ...
        t > 1 && (g = Math.floor(g / t) * t), r.setUTCFullYear(g, 0, 1), r.setUTCHours(0, 0, 0, 0);
        break;
      case "week":
        if (t > 1 && l) {
          l = $(l, "week", 1);
          let D = r.getTime() - l.getTime(), b = Math.floor(D / P("week") / t), x = P("week", b * t);
          r.setTime(l.getTime() + x - h * P("minute"));
        }
        let y = r.getUTCDate(), _ = r.getUTCDay();
        O(i) || (i = 1), y = _ >= i ? y - _ + i : y - (7 + _) + i, r.setUTCDate(y), r.setUTCHours(0, 0, 0, 0);
    }
  ...
  }
  {
    ...
    let h = o.offsetUTC(r), d = r.getTimezoneOffset(), n = o.parseDate(r), m = n.year, f = n.month, u = n.day, a = n.hour, g = n.minute, y = n.second, _ = n.millisecond, D = n.weekday, b = h - d;
    switch (e) {
      case "day":
        if (t > 1 && l) {
          l = $(l, "day", 1, i, s, void 0, o);
          let T = r.getTime() - l.getTime(), N = Math.floor(T / P("day") / t), I = P("day", N * t);
          r.setTime(l.getTime() + I), n = o.parseDate(r), m = n.year, f = n.month, u = n.day;
        }
        a = 0, g = b, y = 0, _ = 0;
        break;
      case "second":
        g += b, t > 1 && (y = Math.floor(y / t) * t), _ = 0;
        break;
      case "millisecond":
        g += b, t > 1 && (_ = Math.floor(_ / t) * t);
        break;
      case "hour":
        t > 1 && (a = Math.floor(a / t) * t), g = b, y = 0, _ = 0;
        break;
      case "minute":
        t > 1 && (g = Math.floor(g / t) * t), g += b, y = 0, _ = 0;
        break;
      case "month":
        t > 1 && (f = Math.floor(f / t) * t), u = 1, a = 0, g = b, y = 0, _ = 0;
        break;
      case "year":
        t > 1 && (m = Math.floor(m / t) * t), f = 0, u = 1, a = 0, g = b, y = 0, _ = 0;
        break;
      case "week":
        O(i) || (i = 1), u = D >= i ? u - D + i : u - (7 + D) + i, a = 0, g = b, y = 0, _ = 0;
    }
    let x = (r = new Date(m, f, u, a, g, y, _)).getTimezoneOffset(), c = o.offsetUTC(r) - x;
    return c != b && r.setTime(r.getTime() + 6e4 * (c - b)), r;
  }
}
class U extends S {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_aggregatesCalculated", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_selectionAggregatesCalculated", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_dataProcessed", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_psi", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_pei", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "chart", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "bullets", { enumerable: !0, configurable: !0, writable: !0, value: new X() }), Object.defineProperty(this, "bulletsContainer", { enumerable: !0, configurable: !0, writable: !0, value: C.new(this._root, { width: k, height: k, position: "absolute" }) });
  }
  _afterNew() {
  ...
  getDataItemById(e) {
    return Q(this.dataItems, (t) => t.get("id") == e);
  }
  _makeBullets(e) {
  ...
  _calculateAggregates(e, t) {
    ...
    const s = {}, l = {}, o = {}, h = {}, d = {}, n = {}, m = {}, f = {}, u = {};
    w(i, (a) => {
      s[a] = 0, l[a] = 0, o[a] = 0;
    }), w(i, (a) => {
      let g = a + "Change", y = a + "ChangePercent", _ = a + "ChangePrevious", D = a + "ChangePreviousPercent", b = a + "ChangeSelection", x = a + "ChangeSelectionPercent", c = "valueY";
      a != "valueX" && a != "openValueX" && a != "lowValueX" && a != "highValueX" || (c = "valueX");
      const T = this.getPrivate("baseValueSeries"), N = this.getPrivate("adjustedStartIndex", e);
      for (let I = N; I < t; I++) {
        const v = this.dataItems[I];
        if (v) {
          let p = v.get(a);
          p != null && (o[a]++, s[a] += p, l[a] += Math.abs(p), f[a] = s[a] / o[a], (h[a] > p || h[a] == null) && (h[a] = p), (d[a] < p || d[a] == null) && (d[a] = p), m[a] = p, n[a] == null && (n[a] = p, u[a] = p, T && (n[c] = T._getBase(c))), e === 0 && (v.setRaw(g, p - n[c]), v.setRaw(y, (p - n[c]) / n[c] * 100)), v.setRaw(_, p - u[c]), v.setRaw(D, (p - u[c]) / u[c] * 100), v.setRaw(b, p - n[c]), v.setRaw(x, (p - n[c]) / n[c] * 100), u[a] = p);
        }
      }
      if (t < this.dataItems.length - 1) {
        ...
        if (I) {
          let v = I.get(a);
          I.setRaw(_, v - u[c]), I.setRaw(D, (v - u[c]) / u[c] * 100), I.setRaw(b, v - n[c]), I.setRaw(x, (v - n[c]) / n[c] * 100);
        }
      }
      e > 0 && e--, delete u[a];
      for (let I = e; I < N; I++) {
        ...
        if (v) {
          let p = v.get(a);
          u[a] == null && (u[a] = p), p != null && (v.setRaw(_, p - u[c]), v.setRaw(D, (p - u[c]) / u[c] * 100), v.setRaw(b, p - n[c]), v.setRaw(x, (p - n[c]) / n[c] * 100), u[a] = p);
        }
      }
    }), w(i, (a) => {
      this.setPrivate(a + "AverageSelection", f[a]), this.setPrivate(a + "CountSelection", o[a]), this.setPrivate(a + "SumSelection", s[a]), this.setPrivate(a + "AbsoluteSumSelection", l[a]), this.setPrivate(a + "LowSelection", h[a]), this.setPrivate(a + "HighSelection", d[a]), this.setPrivate(a + "OpenSelection", n[a]), this.setPrivate(a + "CloseSelection", m[a]);
    }), e === 0 && t === this.dataItems.length && w(i, (a) => {
      this.setPrivate(a + "Average", f[a]), this.setPrivate(a + "Count", o[a]), this.setPrivate(a + "Sum", s[a]), this.setPrivate(a + "AbsoluteSum", l[a]), this.setPrivate(a + "Low", h[a]), this.setPrivate(a + "High", d[a]), this.setPrivate(a + "Open", n[a]), this.setPrivate(a + "Close", m[a]);
    });
  }
  _updateChildren() {
      ...
      w(t.target._entities, (l) => {
        ...
        if (!O(o)) {
          ...
          if (h) {
            ...
            d && t.neutral && d.set(t.key, t.neutral);
          }
          if (!t.customFunction) return;
        }
        if (t.customFunction) t.customFunction.call(this, l, i, s, o);
        else {
          let h, d;
          h = t.logarithmic ? (Math.log(o) * Math.LOG10E - Math.log(i) * Math.LOG10E) / (Math.log(s) * Math.LOG10E - Math.log(i) * Math.LOG10E) : (o - i) / (s - i), !O(o) || O(h) && Math.abs(h) != 1 / 0 || (h = 0.5), O(t.min) ? d = t.min + (t.max - t.min) * h : t.min instanceof H ? d = H.interpolate(h, t.min, t.max) : t.min instanceof W && (d = ee(h, t.min, t.max)), l.set(t.key, d);
          const n = l.states;
          if (n) {
  ...
  _positionBullets(e) {
    e.bullets && w(e.bullets, (t) => {
      ...
      t.get("dynamic") && (i && (i._markDirtyKey("fill"), i.markDirtySize()), i instanceof C && i.walkChildren((s) => {
        s._markDirtyKey("fill"), s.markDirtySize(), s instanceof z && s.text.markDirtyText();
      })), i instanceof z && i.get("populateText") && i.text.markDirtyText();
    });
  }
  _hideBullets(e) {
    e.bullets && w(e.bullets, (t) => {
  ...
  _sequencedShowHide(e, t) {
    return j(this, void 0, void 0, function* () {
      if (this.get("sequencedInterpolation")) if (O(t) || (t = this.get("interpolationDuration", 0)), t > 0) {
        const i = this.startIndex(), s = this.endIndex();
        yield Promise.all(G(this.dataItems, (l, o) => j(this, void 0, void 0, function* () {
          let h = t || 0;
          (o < i - 10 || o > s + 10) && (h = 0);
          let d = this.get("sequencedDelay", 0) + h / (s - i);
          yield se(d * (o - i)), e ? yield this.showDataItem(l, h) : yield this.hideDataItem(l, h);
        })));
      } else yield Promise.all(G(this.dataItems, (i) => e ? this.showDataItem(i, 0) : this.hideDataItem(i, 0)));
    });
  }
  updateLegendValue(e) {
    if (e) {
...
Object.defineProperty(U, "className", { enumerable: !0, configurable: !0, writable: !0, value: "Series" }), Object.defineProperty(U, "classNames", { enumerable: !0, configurable: !0, writable: !0, value: S.classNames.concat([U.className]) });
class F extends K {
  _beforeChanged() {
  ...
  _changed() {
    if (super._changed(), this._clear) {
      ...
      if (e && e.length > 0) {
        let i = e[0];
        this._display.moveTo(i.x, i.y), q(this._display, [[e]]);
      } else if (t) q(this._display, t);
...
Object.defineProperty(F, "className", { enumerable: !0, configurable: !0, writable: !0, value: "Line" }), Object.defineProperty(F, "classNames", { enumerable: !0, configurable: !0, writable: !0, value: K.classNames.concat([F.className]) });
const L = Math.PI, E = 2 * L, M = 1e-6, re = E - M;
function Y(r) {
  this._ += r[0];
...
class oe {
  ...
  arcTo(e, t, i, s, l) {
    ...
    let o = this._x1, h = this._y1, d = i - e, n = s - t, m = o - e, f = h - t, u = m * m + f * f;
    if (this._x1 === null) this._append`M${this._x1 = e},${this._y1 = t}`;
    else if (u > M) if (Math.abs(f * d - n * m) > M && l) {
      let a = i - o, g = s - h, y = d * d + n * n, _ = a * a + g * g, D = Math.sqrt(y), b = Math.sqrt(u), x = l * Math.tan((L - Math.acos((y + u - _) / (2 * D * b))) / 2), c = x / b, T = x / D;
      Math.abs(c - 1) > M && this._append`L${e + c * m},${t + c * f}`, this._append`A${l},${l},0,0,${+(f * a > m * g)},${this._x1 = e + T * d},${this._y1 = t + T * n}`;
    } else this._append`L${this._x1 = e},${this._y1 = t}`;
  }
  arc(e, t, i, s, l, o) {
    if (e = +e, t = +t, o = !!o, (i = +i) < 0) throw new Error(`negative radius: ${i}`);
    let h = i * Math.cos(s), d = i * Math.sin(s), n = e + h, m = t + d, f = 1 ^ o, u = o ? s - l : l - s;
    this._x1 === null ? this._append`M${n},${m}` : (Math.abs(this._x1 - n) > M || Math.abs(this._y1 - m) > M) && this._append`L${n},${m}`, i && (u < 0 && (u = u % E + E), u > re ? this._append`A${i},${i},0,1,${f},${e - h},${t - d}A${i},${i},0,1,${f},${this._x1 = n},${this._y1 = m}` : u > M && this._append`A${i},${i},0,${+(u >= L)},${f},${this._x1 = e + i * Math.cos(l)},${this._y1 = t + i * Math.sin(l)}`);
  }
  rect(e, t, i, s) {
...
class V extends C {
  constructor() {
    super(...arguments), Object.defineProperty(this, "chartContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.children.push(C.new(this._root, { width: k, height: k, interactiveChildren: !1 })) }), Object.defineProperty(this, "bulletsContainer", { enumerable: !0, configurable: !0, writable: !0, value: C.new(this._root, { interactiveChildren: !1, isMeasured: !1, position: "absolute", width: k, height: k }) });
  }
}
...
class B extends V {
  constructor() {
    super(...arguments), Object.defineProperty(this, "seriesContainer", { enumerable: !0, configurable: !0, writable: !0, value: C.new(this._root, { width: k, height: k, isMeasured: !1 }) }), Object.defineProperty(this, "series", { enumerable: !0, configurable: !0, writable: !0, value: new te() });
  }
  _afterNew() {
...
Object.defineProperty(A, "className", { enumerable: !0, configurable: !0, writable: !0, value: "Tick" }), Object.defineProperty(A, "classNames", { enumerable: !0, configurable: !0, writable: !0, value: F.classNames.concat([A.className]) });
export {
  U as D,
  $ as I,
  B as R,
...
//# sourceMappingURL=Tick-DXwoq_FT.js.map
