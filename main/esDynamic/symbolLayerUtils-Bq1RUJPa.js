import { dV as d, s as n, dW as a, bB as m, dX as v, aG as c } from "./main-lm2DHsZh.js";
let u = h();
function h() {
  return new d(50);
}
async function p(r, i = null) {
  if (!r.isPrimitive) {
    ...
    const { fetch: l } = await import("./objectResourceUtils-DLw99BS4.js"), f = await l(e, { disableTextures: !0 }), s = a(f.referenceBoundingBox, c());
    return u.put(e, s), s;
  }
...
//# sourceMappingURL=symbolLayerUtils-Bq1RUJPa.js.map
