import { cS as j, $ as R, cW as m, gi as l, cm as y, U as p } from "./main-lm2DHsZh.js";
function F(r, t) {
  const e = r.toJSON();
  return e.objectIds && (e.objectIds = e.objectIds.join(",")), e.orderByFields && (e.orderByFields = e.orderByFields.join(",")), e.outFields && !t?.returnCountOnly ? e.outFields.includes("*") ? e.outFields = "*" : e.outFields = e.outFields.join(",") : delete e.outFields, e.outSR && (e.outSR = m(e.outSR)), e.dynamicDataSource && (e.layer = JSON.stringify({ source: e.dynamicDataSource }), delete e.dynamicDataSource), e;
}
...
async function f(r, t, e = {}, a) {
  const o = j({ ...r.query, f: "json", ...a, ...F(t, a) });
  return R(r.path + "/queryRelatedRecords", { ...e, query: { ...e.query, ...o } });
}
async function I(r, t, e) {
  t = l.from(t);
  const a = y(r);
  return b(a, t, e).then((o) => {
    const s = o.data, n = {};
    return Object.keys(s).forEach((c) => n[c] = p.fromJSON(s[c])), n;
  });
}
...
//# sourceMappingURL=executeRelationshipQuery-DHZIP5pw.js.map
