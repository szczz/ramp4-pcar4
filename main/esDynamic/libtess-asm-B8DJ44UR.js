import { u as P4 } from "./main-lm2DHsZh.js";
function U4(M2, W2) {
      ...
      function q1(K) {
          ...
          i: {
            f: {
                          ...
                          b: {
                            if ((n |= 0) >>> 0 <= 244) {
                              if (3 & (f = (o = i[854]) >>> (a = (k = n >>> 0 < 11 ? 16 : n + 11 & 504) >>> 3 | 0) | 0)) {
                                f = 3456 + (n = (a = a + (1 & ~f) | 0) << 3) | 0, e = i[n + 3464 >> 2], (0 | f) != (0 | (n = i[e + 8 >> 2])) ? (i[n + 12 >> 2] = f, i[f + 8 >> 2] = n) : (v = 3416, h = i2(a) & o, i[v >> 2] = h), n = e + 8 | 0, f = a << 3, i[e + 4 >> 2] = 3 | f, i[4 + (f = f + e | 0) >> 2] = 1 | i[f + 4 >> 2];
                                break i;
                              }
                            ...
                            if (k = -1, !(n >>> 0 > 4294967231) && (k = -8 & (n = n + 11 | 0), r = i[855])) {
                              ...
                              k: {
                                c: {
                                  if (f = i[3720 + (o << 2) >> 2]) for (n = 0, a = k << ((0 | o) != 31 ? 25 - (o >>> 1 | 0) : 0); ; ) {
                    ...
                    t: {
                      u: {
                        ...
                        if (n = 31, b >>> 0 <= 16777215 && (n = 62 + ((b >>> 38 - (n = s2(b >>> 8 | 0)) & 1) - (n << 1) | 0) | 0), i[t + 28 >> 2] = n, i[t + 16 >> 2] = 0, i[t + 20 >> 2] = 0, f = 3720 + (n << 2) | 0, (e = i[855]) & (a = 1 << n)) {
                          for (n = b << ((0 | n) != 31 ? 25 - (n >>> 1 | 0) : 0), e = i[f >> 2]; ; ) {
                      ...
                      u: if (i[860] != (0 | t)) if (i[859] != (0 | t)) {
                        ...
                        if (i[t + 4 >> 2] = -2 & a, i[s + 4 >> 2] = 1 | o, i[o + s >> 2] = o, o >>> 0 <= 255) f = 3456 + (-8 & o) | 0, (a = i[854]) & (n = 1 << (o >>> 3)) ? n = i[f + 8 >> 2] : (i[854] = n | a, n = f), i[f + 8 >> 2] = s, i[n + 12 >> 2] = s, i[s + 12 >> 2] = f, i[s + 8 >> 2] = n;
                          ...
                          o: {
                            if ((e = i[855]) & (n = 1 << a)) {
                              for (a = o << ((0 | a) != 31 ? 25 - (a >>> 1 | 0) : 0), n = i[f >> 2]; ; ) {
              ...
              a: if (t >>> 0 <= 15) n = t + k | 0, i[e + 4 >> 2] = 3 | n, i[4 + (n = n + e | 0) >> 2] = 1 | i[n + 4 >> 2];
                ...
                n: {
                  if ((a = 1 << n) & r) {
                    for (n = t << ((0 | n) != 31 ? 25 - (n >>> 1 | 0) : 0), k = i[f >> 2]; ; ) {
            ...
            f: {
              ...
              if ((0 | e) < 0) for (S = 1 + ((l + 25 >>> 0) / 9 | 0) | 0, g = (0 | T) == 102; ; ) {
                if (v = (0 | (e = 0 - e | 0)) >= 9 ? 9 : e, o >>> 0 <= s >>> 0) k = i[s >> 2];
                  ...
                  for (y = 1e9 >>> v | 0, r = ~(-1 << v), e = 0, k = s; G = e, e = i[k >> 2], i[k >> 2] = G + (e >>> v | 0), e = L(y, e & r), (k = k + 4 | 0) >>> 0 < o >>> 0; ) ;
              ...
              if ((0 | (k = (l - ((0 | T) != 102 ? e : 0) | 0) - ((0 | T) == 103 & !!(0 | l)) | 0)) < (L(o - m >> 2, 9) - 9 | 0)) {
              ...
              if ((0 | T) == 103) {
                if (l = ((o = (0 | (k = l || 1)) > (0 | e) & (0 | e) > -5) ? ~e : -1) + k | 0, b = (o ? -1 : -2) + b | 0, !(A = 8 & t)) {
                                      ...
                                      w: {
                                        y: {
                                          p: {
                                                ...
                                                l: {
                                                  d: {
                                                    m: {
                                                      ...
                                                      if (f = I, (r = i[s + 64 >> 2]) | (k = i[s + 68 >> 2])) for (E2 = 32 & o; d[0 | (f = f - 1 | 0)] = E2 | w[1600 + (15 & r) | 0], T = !k & r >>> 0 > 15 | !!(0 | k), h = k, k = k >>> 4 | 0, r = (15 & h) << 28 | r >>> 4, T; ) ;
                                                      if (r = f, !(i[s + 64 >> 2] | i[s + 68 >> 2]) | !(8 & v)) break s;
                                                      M = 1024 + (o >>> 4 | 0) | 0, m = 2;
                                                      break s;
                                                    }
                                                    if (f = I, k = o = i[s + 68 >> 2], o | (r = i[s + 64 >> 2])) for (; d[0 | (f = f - 1 | 0)] = 7 & r | 48, h = !k & r >>> 0 > 7 | !!(0 | k), k = (o = k) >>> 3 | 0, r = (7 & o) << 29 | r >>> 3, h; ) ;
                                                    if (r = f, !(8 & v)) break s;
                                                    A = (0 | (f = I - f | 0)) < (0 | A) ? A : f + 1 | 0;
                                                    break s;
                                                  }
                                                  r = i[s + 64 >> 2], k = f = i[s + 68 >> 2], (0 | f) < 0 ? (k = o = 0 - (f + !!(0 | r) | 0) | 0, r = 0 - r | 0, i[s + 64 >> 2] = r, i[s + 68 >> 2] = o, m = 1, M = 1024) : 2048 & v ? (m = 1, M = 1025) : M = (m = 1 & v) ? 1026 : 1024;
                                                }
                                                r = Q2(r, k, I);
                                              }
                                              if ((0 | A) < 0 & P) break n;
                                              if (v = P ? -65537 & v : v, !(A | !!((f = i[s + 64 >> 2]) | (o = i[s + 68 >> 2])))) {
                                                r = I, A = 0;
                                                break o;
                                              }
                                            ...
                                            h = l = A >>> 0 >= 2147483647 ? 2147483647 : A, v = !!(0 | l);
                                            v: {
                                              s: {
                                                l: {
                                                  d: if (!(!(3 & (f = r = (f = i[s + 64 >> 2]) || 1071)) | !l)) for (; ; ) {
                                                    if (!w[0 | f]) break l;
                                                    if (v = !!(0 | (h = h - 1 | 0)), !(3 & (f = f + 1 | 0))) break d;
                                                    if (!h) break;
                                                  }
                                                  if (!v) break s;
                                                  if (!(!w[0 | f] | h >>> 0 < 4)) for (; ; ) {
                                                    if (~(o = i[f >> 2]) & o - 16843009 & -2139062144) break l;
          ...
          i: if (n |= 0) {
            ...
            if (!(e >>> 0 >= b >>> 0) && 1 & (f = i[b + 4 >> 2])) {
              ...
              f: {
                a: {
                  if ((t = i[855]) & (o = 1 << a)) {
                    for (a = n << ((0 | a) != 31 ? 25 - (a >>> 1 | 0) : 0), f = i[f >> 2]; ; ) {
        ...
        function z0(n, f) {
          ...
          i: {
            ...
            f: {
              if ((t = i[855]) & (o = 1 << e)) {
                for (e = f << ((0 | e) != 31 ? 25 - (e >>> 1 | 0) : 0), a = i[a >> 2]; ; ) {
        ...
        function B2(n, f, a) {
          switch (f - 100100 | 0) {
            ...
            case 4:
              return d[n + 80 | 0] = !!(0 | a), void (i[n + 92 >> 2] = a || 14);
            case 10:
              return d[n + 80 | 0] = !!(0 | a), void (i[n + 1720 >> 2] = a || 4);
            case 1:
...
//# sourceMappingURL=libtess-asm-B8DJ44UR.js.map
