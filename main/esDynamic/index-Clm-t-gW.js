import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-BVGiskS7.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DXSmyMEu.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-CfFt04wi.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-D1_6M4x3.js")).default, n = (await import("./index-CrisM22g.js")).default, a = (await import("./index-DfXlzGut.js")).default, w = (await import("./index-C2hVF1iY.js")).default, p = (await import("./index-B9o85upD.js")).default, r = (await import("./index-5SrxorF8.js")).default, b = (await import("./index-CSLCLzty.js")).default;
...
//# sourceMappingURL=index-Clm-t-gW.js.map
