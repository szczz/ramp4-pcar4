import { K as L, f5 as U, br as j, f6 as Q, f7 as T, f8 as P, D as x, s as R, aj as G, eV as V, f9 as C, O as E, P as F, fa as H, f1 as z, S as W, a9 as M, fb as X, fc as A, $ as m, bm as v, fd as Y, fe as Z, ff as B, fg as K, fh as ee, b8 as te, fi as ae, fj as se, b1 as $, a1 as N, fk as re, fl as ne, eO as ie, _ as oe, ah as ue, bx as le, fm as de, fn as ce, fo as pe, Q as he } from "./main-lm2DHsZh.js";
import { i as ye } from "./MeshLocalVertexSpace-Dj055wa7.js";
import { a as fe } from "./meshVertexSpaceUtils-ByPU76Jh.js";
import { N as me, v as ge } from "./MeshTransform-Vd-J1X5A.js";
import { isFeatureIdentifierArrayWithGlobalId as we, isFeatureIdentifierArrayWithObjectId as be } from "./editingSupport-Cv1mxR_w.js";
import { o as Ie } from "./clientSideDefaults-BkFQkY5x.js";
...
let O = class extends H {
  ...
  async uploadAssets(t, e) {
    const { uploadAssets: a } = await import("./uploadAssets-B795ceBQ.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(t) {
    ...
    for (const n of e) {
      ...
      if (fe(o)) r.push(i);
        ...
        const u = i.anchor, { convertMeshVertexSpace: d } = await import("./convertMeshVertexSpace-CqLwJ-W7.js"), l = await d(i, new ye({ origin: [u.x, u.y, u.z ?? 0] }));
...
//# sourceMappingURL=FeatureLayerSource-QulVF4eL.js.map
