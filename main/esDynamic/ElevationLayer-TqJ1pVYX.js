import { eW as _, D as f, J as g, fk as w, dK as u, iy as b, ej as V, e5 as T, e6 as S, e8 as D, iz as $, s as L, _ as k, $ as c, fB as x, O as o, P as l, e9 as y, ii as I, ec as M, Q as N, ei as j } from "./main-lm2DHsZh.js";
class O {
  constructor(e, t, i, a) {
...
let r = class extends b(V(T(S(D(j))))) {
  constructor(...s) {
  ...
  load(s) {
    ...
    } }, s).catch(k).then(() => this._fetchImageService(e))), Promise.resolve(this);
  }
  fetchTile(s, e, t, i) {
    ...
    return this.load().then(() => this._fetchTileAvailability(s, e, t, i)).then(() => c(this.getTileUrl(s, e, t), h)).then((d) => this._lercDecoder.decode(d.data, n, a)).then((d) => new O(d));
  }
  getTileUrl(s, e, t) {
  ...
  async queryElevation(s, e) {
    const { ElevationQuery: t } = await import("./ElevationQuery-DKAotjBs.js");
...
//# sourceMappingURL=ElevationLayer-TqJ1pVYX.js.map
