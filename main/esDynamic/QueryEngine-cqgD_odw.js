import { n as ot, a as Z, h as H, j as V, y as re, P as Ze, x as Te, g as U, b as ut, c as ct, S as Se, v as j, t as ht, I as He, d as dt } from "./timeSupport-BMgFmqzA.js";
import { ds as mt, dt as ft, dV as Re, s as C, dg as we, ba as me, bb as fe, d6 as Ye, d7 as We, dy as ge, K as k, b9 as be, dw as ne, m7 as Ae, m8 as gt, kO as Ce, k0 as pt, m9 as _t, aa as ee, iq as pe, jT as Xe, ma as te, eX as yt, O as le, P as Ne, Q as Tt, e2 as Et, mb as oe, bS as ue, S as It, T as xt, mc as _e, b0 as O, D as Ft, fQ as St, fF as Rt, md as wt, me as bt, mf as At, aR as Ct, df as Nt, bl as vt, mg as v, ai as ve, eV as Oe, dK as Ot, mh as Pt, bB as $t, bE as kt, bq as ce, bT as Lt, by as Dt, dk as Qt, aK as Vt, mi as Pe, aV as Gt, aX as Mt, aP as Ut, bC as qt, bV as zt } from "./main-lm2DHsZh.js";
import { O as jt } from "./WhereClause-DvgTpwPM.js";
import { t as Bt } from "./QueryEngineCapabilities-Deb54eFC.js";
import { w as Zt } from "./utils-BXgDHfnG.js";
import { c as he, B as Ht, d as $e, p as ke, C as Yt, k as Wt, $ as Xt, E as Jt, P as Kt, U as es, T as ts, v as ss, f as is } from "./utils-C0Edlkdl.js";
...
class b {
  ...
  async _getAggregateGeometry(e, t) {
    const { convexHull: i, union: a } = await import("./geometryEngineJSON-lkbMo_hW.js").then((d) => d.g), { statisticType: s, outStatisticFieldName: r } = e, { featureAdapter: n, spatialReference: o, geometryType: u, hasZ: c, hasM: h } = this, m = t.map((d) => Z(u, c, h, n.getGeometry(d))), f = i(o, m, !0)[0], p = { aggregateGeometries: null, outStatisticFieldName: null };
...
//# sourceMappingURL=QueryEngine-cqgD_odw.js.map
