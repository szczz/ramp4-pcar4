import { af as o, cU as h } from "./main-BVGiskS7.js";
import { s as a } from "./PooledRBush-DvCYRZzQ.js";
const _ = 5e4, t = { minX: 0, minY: 0, maxX: 0, maxY: 0 };
function u(d) {
  t.minX = d[0], t.minY = d[1], t.maxX = d[2], t.maxY = d[3];
}
function l(d, s, i) {
  u(s), d.search(t, i);
}
class B {
  ...
  get fullBounds() {
    ...
    const s = h();
    for (const i of this._boundsById.values()) i && (s[0] = Math.min(i[0], s[0]), s[1] = Math.min(i[1], s[1]), s[2] = Math.max(i[2], s[2]), s[3] = Math.max(i[3], s[3]));
    return s;
  }
  get valid() {
  ...
  forEachInBounds(s, i) {
    this._loadIndex(), l(this._index, s, (n) => i(this._idByBounds.get(n)));
  }
  get(s) {
  ...
  set(s, i) {
    ...
    this._boundsById.set(s, i), i && (this._idByBounds.set(i, s), this._indexInvalid || (this._boundsToLoad.push(i), this._boundsToLoad.length > _ && this._loadIndex()));
  }
}
export {
  B as o
};
//# sourceMappingURL=BoundsStore-CzQA7x2K.js.map
