import { a as i } from "./fabric-CfFt04wi.js";
import { bx as P, bz as S, by as k } from "./main-BVGiskS7.js";
class z extends P {
  get config() {
  ...
  async make(s) {
    ...
    if (p.isWebMercator())
      ...
      const a = new S("pole", { x: -96, y: 90 }), w = await this.$iApi.geo.proj.projectGeometry(p, a), o = this.$iApi.geo.map.mapPointToScreenPoint(w), c = {
      ...
      h = Math.min(Math.max(x, 0), 100), l = (n) => {
        ...
        return Math.atan((o.screenX - b) / (50 / 2 - o.screenY)) * (180 / Math.PI);
      };
    }
    const g = {
      top: 0,
...
//# sourceMappingURL=index-C2hVF1iY.js.map
