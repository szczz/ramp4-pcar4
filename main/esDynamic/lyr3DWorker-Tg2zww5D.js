import { u as Qn, f0 as zr } from "./main-lm2DHsZh.js";
...
`), !r) return null;
    ...
    o.hashRemoveNode(r);
  }, isRoot: (r) => r === r.parent, isMountpoint: (r) => !!r.mounted, isFile: (r) => (61440 & r) == 32768, isDir: (r) => (61440 & r) == 16384, isLink: (r) => (61440 & r) == 40960, isChrdev: (r) => (61440 & r) == 8192, isBlkdev: (r) => (61440 & r) == 24576, isFIFO: (r) => (61440 & r) == 4096, isSocket: (r) => !(49152 & ~r), flagsToPermissionString(r) {
    var e = ["r", "w", "rw"][3 & r];
    return 512 & r && (e += "w"), e;
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
  ...
  var xt = (r, e, t) => Pr(r, C, e, t), Ot = (r, e) => {
    ...
    for (var t = 0; t < r.length; ++t) P[0 | e++] = r.charCodeAt(t);
    P[0 | e] = 0;
  }, vn = (r, e) => {
    var t = 0;
...
//# sourceMappingURL=lyr3DWorker-Tg2zww5D.js.map
