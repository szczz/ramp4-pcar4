import { defineComponent as x, defineAsyncComponent as u, inject as b, ref as C, onMounted as w, onBeforeUnmount as A, computed as B, resolveComponent as D, resolveDirective as p, openBlock as o, createBlock as a, withCtx as d, createTextVNode as F, toDisplayString as T, unref as r, createVNode as j, withDirectives as N, createElementBlock as m, Fragment as V, renderList as q } from "vue";
...
const M = ["content"], W = /* @__PURE__ */ x({
  ...
  setup(v) {
    const f = u(() => import("./header-Bfjhpwl8.js")), _ = u(() => import("./item-vcYUEeYa.js")), { t: s } = H(), g = b("iApi"), e = C(), c = () => {
      e.value._tippy.hide();
    }, l = (t) => {
      ...
      return o(), a(E, { panel: v.panel }, {
        ...
        content: d(() => [
          ...
          N((o(), m("div", {
            ...
            (o(!0), m(V, null, q(h.value, (i) => (o(), a(r(_), {
              legendItem: i,
              key: i.uid,
