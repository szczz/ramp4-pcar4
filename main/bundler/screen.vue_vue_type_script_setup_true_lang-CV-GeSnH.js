import { defineComponent as w, inject as C, resolveDirective as l, openBlock as i, createElementBlock as n, withDirectives as s, normalizeClass as f, unref as _, createElementVNode as o, createCommentVNode as g, toDisplayString as x, withModifiers as v, withKeys as T, vShow as z, computed as I, ref as j, onMounted as A, resolveComponent as B, createBlock as M, withCtx as b, createTextVNode as O, Fragment as S, renderList as V, createVNode as $ } from "vue";
import { E, _ as N, c as D } from "./main-CKWgYI6e.js";
  ...
  setup(e) {
    ...
    return A(() => {
      ...
      return i(), M(u, { panel: e.panel }, {
        header: b(() => [
          O(x(_(c)("areas-of-interest.title")), 1)
        ]),
        content: b(() => [
          o("div", U, [
            o("div", W, [
              r.value.length > 0 ? s((i(), n("ul", X, [
                (i(!0), n(S, null, V(r.value, (h, k) => (i(), n("li", { key: k }, [
                  $(R, {
                    area: h,
