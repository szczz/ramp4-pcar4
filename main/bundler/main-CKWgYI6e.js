...
class G extends Je {
  ...
  static fromArcServer(e, t) {
    return G.fromESRI(yi.fromJSON(e), t);
  }
  ...
  static fromGeoJSON(e, t) {
    ...
    }), new G(t, i, r, _.fromGeoJSON(e.crs));
  }
  toGeoJSON() {
...
class Vs {
  ...
  async projectExtent(e, t) {
    ...
    return G.fromParams(t.id + "_projected", p, g, d, h, l.sr);
  }
}
class zs {
  // useful functions
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return v(), W(l, { panel: s.panel }, {
        header: ie(() => [
          ot(U(I(t)("notifications.title")), 1)
        ]),
        content: ie(() => [
          m("div", rr, [
            m("div", ar, [
...
const cr = ["content"], ur = { class: "flex items-center text-left" }, pr = { class: "select-text cursor-text" }, dr = ["content"], hr = {
  ...
  setup(s) {
    ...
    return (n, c) => {
      ...
      return M((v(), A("li", {
        ...
        m("div", ur, [
          m("span", null, [
            ot(U(a[s.notification.type]) + " ", 1),
            m("span", pr, U(s.notification.message), 1)
          ]),
    ...
    return (l, n) => {
      ...
      return v(), A("div", null, [
        o.value.length > 0 ? M((v(), A("ul", {
          ...
          m("span", null, U(I(t)("notifications.empty")), 1),
      ...
      return v(), W(ii, {
        ...
        header: ie(() => [
          m("div", vr, [
            ...
            i.value && i.value > 0 ? (v(), A("span", wr, U(i.value), 1)) : B("", !0)
          ])
        ]),
        default: ie((c) => [
          m("div", Ar, [
            m("div", null, [
              m("h4", Er, U(I(t)("notifications.title")), 1),
              m("div", xr, [
                M((v(), A("button", {
                  type: "button",
                  onClick: r,
        ...
        default: ie((g) => [
          m("div", Rr, [
            m("div", null, [
              ...
              m("div", kr, [
                m("div", null, [
                  m("span", Mr, U(r.value), 1),
                  m("span", Pr, " [" + U(a.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Nr, U(o.value[0]), 1),
                  m("span", Fr, U(o.value[1]), 1)
                ]),
  ...
  setup(s) {
    ...
    return (w, b) => {
      const $ = Z("dropdown-menu"), T = k("truncate"), N = k("tippy");
      return v(), A("div", Ur, [
        ae(Gr, {
        ...
        o.value?.text.disabled ? B("", !0) : M((v(), A("span", qr, [
          ot(U(o.value?.text.value), 1)
        ])), [
          [T, {
            options: {
              placement: "top",
        ...
        m("div", jr, [
          l.value?.disabled ? B("", !0) : M((v(), A("div", Wr, [
            ot(U(l.value?.formattedString), 1)
          ])), [
            [T, {
              options: {
                hideOnClick: !1,
          ...
          a.value?.disabled ? B("", !0) : M((v(), A("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? B("", !0) : (v(), W($, {
            ...
            header: ie(() => [
              m("span", Jr, U(I(i)("map.language.short")), 1)
            ]),
            default: ie(() => [
              (v(!0), A(We, null, ht(u.value, (F, Q) => (v(), A("a", {
                key: `${F}-${Q}`,
                class: oe(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": F === I(r).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Xe) => g(F)
              }, [
                ot(U(I(i)("map.language." + F)) + " ", 1),
                F === I(r).$i18n.locale.value ? (v(), A("span", Zr, U(I(i)("map.language.curr")), 1)) : B("", !0)
              ], 10, Kr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return M((v(), A("button", {
        ...
        r.value && r.value > 0 ? (v(), A("span", ea, U(r.value), 1)) : B("", !0)
      ], 8, Qr)), [
        [l]
      ]);
    };
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), A("div", {
        ...
        m("div", {
          ...
          m("div", sa, [
            m("h2", ra, U(I(t)("keyboardInstructions.title")), 1),
            ae(p, {
              class: "ml-auto",
          ...
          (v(!0), A(We, null, ht(r.value, (d) => (v(), A("p", {
            ...
            key: d
          }, U(I(t)(`keyboardInstructions.${d}`)), 1))), 128)),
          m("button", {
            type: "button",
            ...
            ref_key: "lastEl",
            ref: l
          }, U(I(t)("keyboardInstructions.OK")), 513)
        ], 512)
      ], 32)) : B("", !0);
    };
  }
}), st = V("instance", () => ({ started: f(!1) })), oa = { class: "h-full relative" }, na = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, la = { class: "absolute top-8 w-full flex justify-center" }, ca = {
  key: 1,
  class: "w-full h-full"
}, ua = /* @__PURE__ */ O({
  __name: "shell",
      ...
      m("div", na, [
        ...
        m("div", la, [
          m("button", {
            ...
            onClick: l
          }, U(I(a)("keyboardInstructions.open")), 1)
        ]),
        ae(aa),
...
const $a = ["content"], Ca = {
  ...
  setup(s, { expose: e }) {
    ...
    return Ye(() => {
      ...
      const T = Z("back"), N = Z("panel-options-menu"), F = Z("left"), Q = Z("right"), Xe = Z("pin"), Nt = Z("expand"), Ft = Z("minimize"), Dt = Z("close"), Gt = k("truncate"), Ut = k("focus-item"), S = k("tippy");
      return M((v(), A("div", {
        ...
        s.header ? (v(), A("header", Ca, [
          ...
          M((v(), A("h2", Oa, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (v(), A("div", ka, U(I(t)(s.panel.alertName)), 1))
          ])), [
            [Gt]
          ]),
          b.$slots.controls ? (v(), W(N, { key: 0 }, {
            default: ie(() => [
              Me(b.$slots, "controls")
            ]),
            _: 3
          ...
          m("div", {
            ...
            s.panel.teleport ? B("", !0) : (v(), A("div", Ma, [
              d.value ? (v(), W(F, {
                key: 0,
...
}), Eo = /* @__PURE__ */ Ne(Ao, [["__scopeId", "data-v-1cb84ae1"]]), xo = V("areas-of-interest", () => ({ areas: f([]) })), So = V("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
const Uo = V("geosearch", () => {
  const s = f(new Ti("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), r = f(""), a = f(""), o = f([]), l = f([]), n = f(!1), c = f([]), u = P(
    () => s.value.fetchProvinces().then((T) => (T.sort((N, F) => N.name.localeCompare(F.name, void 0, { sensitivity: "case" })), T))
  ), p = P(
    () => new Promise((T) => {
      s.value.fetchTypes().then((N) => {
        N.sort(
          (F, Q) => F.name.localeCompare(Q.name, void 0, { sensitivity: "case" })
        ), T(N);
      });
    })
  );
  ...
  function g(T) {
    n.value = !0;
    const N = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim();
    if (!N)
      o.value = [], l.value = [], n.value = !1;
    else if (N && N !== a.value || T) {
      const F = setInterval(() => {
        s.value.config.provinces.listFetched && s.value.config.types.typesFetched && (clearInterval(F), s.value.query(`${N}*`).then((Q) => {
          c.value = Q.failedServs, a.value = N, l.value = Q.results;
          const Xe = Li(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
  ...
  function h(T) {
    e.value.province = typeof T.province > "u" ? "" : T.province, g(T.forceReRun);
  }
  function y(T) {
    e.value.type = typeof T.type > "u" ? "" : T.type, g(T.forceReRun);
  }
  function w(T) {
    a.value = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim(), i.value = T, g();
  }
  function b(T) {
    const N = {
    ...
    T = T.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), r.value = Array.from(T).map((F) => Object.keys(N).includes(F) ? "[" + F + N[F] + "]" : F.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function $(T) {
...
class Xo extends J {
  ...
  async zoomMapTo(e, t, i = !0, r = 200, a = "ease") {
    if (this.esriView) {
      ...
      o.type === L.POINT && (l.scale = t || this.pointZoomScale);
...
class tn extends Xo {
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, r) => {
      if (this.esriMap || (this.noMapErr(), r()), e.initiationState !== D.INITIATING && e.initiationState !== D.INITIATED && e.layerState !== q.ERROR && e.initiate(), e.mapLayer && t === void 0) {
      ...
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === q.ERROR ? (clearInterval(n), e.lastCancel < o && console.error(`Failed to add layer: ${e.id}.`), r()) : e.initiationState === D.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
...
class yn extends J {
  ...
  allActiveLayers() {
    return this.allLayers().filter(
      (e) => e.layerState !== q.ERROR && e.initiationState === D.INITIATED
    );
  }
  /**
  ...
  async loadLayerMetadata(e) {
    ...
    if (a.name = r.name || "", a.currentVersion = r.currentVersion || -1, a.minScale = r.effectiveMinScale || r.minScale || 0, a.maxScale = r.effectiveMaxScale || r.maxScale || 0, a.extent = r.extent ? G.fromArcServer(r.extent, "layer_extent") : void 0, a.defaultVisibility = r.defaultVisibility ?? !0, a.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
...
class li extends J {
   ...
   */
  constructor(e, t) {
    super(t), this.config = e, this.id = "", this.uid = "", this.name = "error", this.layerState = q.NEW, this.drawState = ue.NOT_LOADED, this.initiationState = D.NEW, this.layerIdx = -1, this.layerFormat = me.UNKNOWN, this.layerType = x.UNKNOWN, this.dataFormat = te.UNKNOWN, this.supportsIdentify = !1, this.identifyMode = X.NONE, this.supportsFeatures = !1, this.mapLayer = !0, this.featureCount = 0, this.fields = [], this.fieldList = "", this.nameField = "", this.tooltipField = "", this.oidField = "", this.supportsSublayers = !1, this.isSublayer = !1, this.isRemoved = !1, this.isFile = !1, this.isCosmetic = !1, this.isSystem = !1, this.userAdded = !1, this.identify = !1, this.hovertips = !1, this.geomType = L.UNKNOWN, this.legend = [], this._sublayers = [], this.expectedTime = { draw: 0, load: 0, fail: 0 }, this.lastCancel = 0, this.canModifyLayer = !0, this.canReload = !0, this.url = "";
  }
  /**
...
class ss extends li {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = L.NONE, this.dataFormat = te.UNKNOWN, this.layerType = x.UNKNOWN, this.layerFormat = me.UNKNOWN;
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = X.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = q.NEW, this.initiationState = D.NEW, this.drawState = ue.NOT_LOADED, this.loadDefProm = new H(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.tooltipArcadeFormula = "", this.layerTree = new Lt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async initiate() {
    ...
    clearTimeout(i), t > this.lastCancel && (this.drawState !== ue.UP_TO_DATE && this.startTimer(
      "draw"
      /* DRAW */
    ), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(D.INITIATED));
  }
  async onInitiate() {
    if (this.isSublayer)
  ...
  async terminate() {
    this.updateInitiationState(D.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new H(), this.loadPromDone = !1, this.updateLayerState(q.NEW), this.updateDrawState(ue.NOT_LOADED), this.updateInitiationState(D.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
  ...
  onError(e = !0) {
    this.layerState !== q.ERROR && (this.initiationState === D.INITIATING && this.updateInitiationState(D.NEW), this.loadPromDone && (this.loadDefProm = new H()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      fe.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
...
class Ke extends ss {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new qi(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? G.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new H(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
...
class ci extends Ke {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = L.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new ji(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new as();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Ze extends ci {
  ...
  runIdentify(e) {
    ...
    if (this.identifyMode === X.HYBRID || this.identifyMode === X.GEOMETRIC) {
      ...
      this.geomType !== L.POLYGON && e.geometry.type === L.POINT ? n.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : n.filterGeometry = e.geometry, n.filterSql = this.getCombinedSqlFilter(), a = this.queryFeatures(n).then((c) => {
        o = c;
      });
    }
...
class In extends ci {
  ...
  runIdentify(e) {
    ...
    if (this.identifyMode === X.HYBRID || this.identifyMode === X.GEOMETRIC) {
      ...
      this.geomType !== L.POLYGON && e.geometry.type === L.POINT ? l.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : l.filterGeometry = e.geometry, l.filterSql = this.getCombinedSqlFilter(), a = this.queryOIDs(l).then((n) => {
        o = n;
      });
    }
    return e.hitTest && (this.identifyMode === X.HYBRID || this.identifyMode === X.SYMBOLIC) && (r = a.then(async () => {
...
class _n extends Ke {
  ...
  runIdentify(e) {
    ...
    if (t.length === 0)
      return [];
    let i;
    return e.geometry.type === L.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((r) => {
      ...
      return r.geomType !== L.POLYGON && i ? o.filterGeometry = i : o.filterGeometry = e.geometry, o.filterSql = r.getCombinedSqlFilter(), o.sourceSR = r.sourceSR, r.queryOIDs(o).then((n) => {
        n.forEach((c) => {
...
class Cn extends Ke {
  ...
  getFeatureInfo(e, t, i) {
    ...
    return $ && Object.keys($).forEach((T) => {
      T.toLowerCase() !== "styles" && (b[T] = $[T]);
    }), Object.keys(b).forEach((T) => l[T] = b[T]), Ve(a.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
  ...
  async symbolToSvg(e) {
    ...
    const a = tt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((N) => {
          const F = a.pattern(
            y,
            w,
            (Q) => (
          ...
          a.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(F).stroke($);
        });
      },
      "picture-marker"() {
...
class zn extends J {
  ...
  async queryGeometryHelper(e, t, i, r) {
    return !t && e.type === L.EXTENT && r && !r.isEqual(e.sr) && !(i && i > 2e7 && e.sr.wkid === 3978 && r.wkid === 4326) ? (await this.$iApi.geo.proj.projectExtent(r, e)).toESRI() : e.toESRI();
  }
  /**
...
const jn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-2rAPkqcL.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-EbrduFJ9.js"), "../fixtures/basemap/index.ts": () => import("./index-HoxhpK39.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CbTVX80i.js"), "../fixtures/details/index.ts": () => import("./index-BaeoGBne.js"), "../fixtures/draw/index.ts": () => import("./index-Bf_TUoG0.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Dz9-U1sS.js"), "../fixtures/export-legend/index.ts": () => import("./index-DcI3Q38T.js"), "../fixtures/export-map/index.ts": () => import("./index-CB_UCbhZ.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-B-Am-kJi.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DaaQ00_6.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-XSoKhsWy.js"), "../fixtures/export-title/index.ts": () => import("./index-BmKD9yBg.js"), "../fixtures/export/index.ts": () => import("./index-WsHDr0d3.js"), "../fixtures/extentguard/index.ts": () => import("./index-BA6Jiu2c.js"), "../fixtures/gazebo/index.ts": () => import("./index-CBzTw-6H.js"), "../fixtures/geosearch/index.ts": () => import("./index-BuAOcpVX.js"), "../fixtures/grid/index.ts": () => import("./index-C5rpdYt8.js"), "../fixtures/help/index.ts": () => import("./index-DAsLKFjJ.js"), "../fixtures/hilight/index.ts": () => import("./index-CdeZDiqc.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CAjy0Gxk.js"), "../fixtures/legend/index.ts": () => import("./index-6LZv0rHh.js"), "../fixtures/mapnav/index.ts": () => import("./index-DYwMsgub.js"), "../fixtures/metadata/index.ts": () => import("./index-DUxsTgV_.js"), "../fixtures/northarrow/index.ts": () => import("./index-Bq7D4RNz.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BoAs2ESM.js"), "../fixtures/panguard/index.ts": () => import("./index-W4c1HYoc.js"), "../fixtures/scrollguard/index.ts": () => import("./index-dRdRKUDE.js"), "../fixtures/settings/index.ts": () => import("./index-BLisatXn.js"), "../fixtures/snowman/index.ts": () => import("./index-ByuQfxXn.js"), "../fixtures/swipe/index.ts": () => import("./index-vVOIXubf.js"), "../fixtures/wizard/index.ts": () => import("./index-pk_ouDUl.js") });
class Wn extends J {
  /**
...
const Zn = /* @__PURE__ */ Ne(Jn, [["render", Kn], ["__scopeId", "data-v-a3c61802"]]), Xn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-C3vtJyWe.js"), "../fixtures/basemap/screen.vue": () => import("./screen-lASZIQJe.js"), "../fixtures/export/screen.vue": () => import("./screen-r-bPQTvm.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CWpnLBLq.js"), "../fixtures/grid/screen.vue": () => import("./screen-CXQZwhNQ.js"), "../fixtures/help/screen.vue": () => import("./screen-Cj5xvjNm.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-D7gr1iAo.js"), "../fixtures/legend/screen.vue": () => import("./screen-qO49-_LN.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CHaGe5HK.js"), "../fixtures/settings/screen.vue": () => import("./screen-GxOu1_7H.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CMvVAmxt.js") });
class St extends J {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "13", patch: "0-beta", timestamp: "Mon Jun 23 17:10:05 2025 -0400", hash: "944ad2afbc915e55bc71939b245c85d165c47070" };
console.info(
