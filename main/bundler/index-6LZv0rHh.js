...
import "tiny-emitter";
import { F as x, n as a, S as A, o as g, p as w, q as h, L as $, b as S, d as _ } from "./main-CKWgYI6e.js";
...
class M extends x {
  ...
  createItem(e, t) {
    let r;
    e.layerId === void 0 ? r = new A(this.$iApi, e, t) : (e.sublayerIndex !== void 0 && (e.layerId = this.$iApi.geo.layer.sublayerId(e.layerId, e.sublayerIndex)), r = new g(this.$iApi, e, t));
    const i = e.children;
   ...
   */
  addItem(e, t) {
    const r = e instanceof w ? e : this.createItem(e, t);
  ...
  updateLegend(e) {
    ...
    e.loadPromise().then(() => {
      ...
      if (e.layerType === $.MAPIMAGE) {
        const i = (l) => {
          if (l.isLayerRoot && !l.isLogicalLayer)
            ...
            if (r = this.getLayerItem(this.$iApi.geo.layer.sublayerId(e.id, l.layerIdx)), r) {
              const n = r.getConfig();
      ...
      t(e, !0), e.supportsSublayers && e.config.sublayers.forEach((r) => {
        t(this.$iApi.geo.layer.sublayerId(e.id, r.index), !0);
      });
    });
  }
  /**
    ...
    this.$iApi.component("legend-nav-button", T), this.$iApi.panel.register(
      {
        legend: {
          screens: {
            "legend-screen": () => I(import("./screen-qO49-_LN.js"))
          },
          style: {
            width: "350px"
          },
