...
import "tiny-emitter";
import { F as f, k as y, L as a, U as m, I as g } from "./main-CKWgYI6e.js";
...
class h extends y {
  ...
  async getWfsInfo(e) {
    const r = new m(e), { offset: i, limit: t } = r.queryMap, d = await this.$iApi.geo.layer.ogc.loadWfsData(
      e,
      -1,
      parseInt(i) || 0,
      parseInt(t) || 1e3
    ...
    this.$iApi.panel.register(
      {
        wizard: {
          screens: {
            "wizard-screen": () => u(import("./screen-CMvVAmxt.js"))
          },
          button: {
