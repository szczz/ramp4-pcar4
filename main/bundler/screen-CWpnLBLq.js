import { defineComponent as T, computed as y, resolveDirective as C, openBlock as t, createElementBlock as s, createElementVNode as a, normalizeClass as F, unref as u, withKeys as A, withModifiers as q, withDirectives as L, createTextVNode as k, createCommentVNode as $, inject as j, ref as M, onBeforeMount as H, watch as O, onBeforeUnmount as I, toDisplayString as g, Fragment as P, renderList as N, onMounted as Z, renderSlot as J, resolveComponent as X, createBlock as z, withCtx as B, createVNode as V } from "vue";
import { h as E, a as Q, G as W, _ as Y, J as ee, K as te, M as G, N as K } from "./main-CKWgYI6e.js";
...
const se = { class: "rv-geosearch-bar relative h-26 mx-8 mb-8" }, re = ["placeholder", "value", "aria-label"], ne = { class: "absolute inset-y-0 right-8 grid w-10 place-content-center" }, ae = ["aria-label", "content"], ie = /* @__PURE__ */ T({
  __name: "search-bar",
  setup(S) {
    const { t: i } = R(), p = E(), l = Q(), _ = y(() => p.searchVal), m = y(
      ...
      if (o.flav === "fsa" && v.value) {
        ...
        if (!b) {
          const w = new G(
            ...
            K.fromConfig(n.spatialReference),
