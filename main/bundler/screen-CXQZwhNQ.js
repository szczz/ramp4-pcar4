import { defineComponent as D, inject as oe, resolveComponent as Pe, openBlock as E, createBlock as Xe, unref as h, withCtx as se, createElementVNode as o, createElementBlock as k, Fragment as Je, renderList as et, createTextVNode as H, toDisplayString as $, createCommentVNode as R, ref as C, onBeforeMount as ve, withDirectives as F, normalizeClass as z, withModifiers as V, withKeys as P, vModelText as ne, vModelSelect as kt, onMounted as X, nextTick as _e, onBeforeUnmount as J, resolveDirective as U, computed as O, useTemplateRef as Mt, watch as Ie, vShow as ae, createVNode as Ee, getCurrentInstance as At, markRaw as Ge } from "vue";
import "tiny-emitter";
import { a as fe, _ as ge, G as Q, O as Ft, Q as $t, L as Tt, V as Rt, W as tt, X as re, i as lt, Y as Ye, Z as Le, $ as St } from "./main-CKWgYI6e.js";
...
const zt = ["onClick"], Ot = { class: "md-icon-small inline" }, Ut = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24",
...
class Qe {
  ...
  scrollMouseDownHandler(n) {
    ...
    const s = (u) => {
      ...
      this.agGrid.style.cursor = "grab", this.agGrid.removeEventListener("mousemove", s), this.agGrid.removeEventListener("mouseup", i), this.agGrid.removeEventListener("mouseleave", i);
    };
    this.agGrid.addEventListener("mousemove", s), this.agGrid.addEventListener("mouseup", i), this.agGrid.addEventListener("mouseleave", i);
  }
}
function Wt(_) {
...
const Zt = { class: "h-full flex items-center justify-center" }, Qt = ["placeholder", "aria-label", "disabled"], Xt = ["placeholder", "aria-label", "disabled"], Jt = {
  ...
  props: ["params"],
  setup(_) {
    const n = fe(), { t: e } = N(), a = _, l = C(""), s = C(""), i = C(a.params.stateManager.columns[a.params.column.colDef.field].filter.static), u = () => {
    ...
    return ve(() => {
      l.value = a.params.stateManager.getColumnFilterValue(a.params.column.colDef.field, "min"), s.value = a.params.stateManager.getColumnFilterValue(a.params.column.colDef.field, "max"), u(), m();
    }), (w, y) => (E(), k("div", Zt, [
      F(o("input", {
  ...
  props: ["params"],
  setup(_) {
    const n = fe(), { t: e } = N(), a = _, l = C(""), s = C(a.params.stateManager.columns[a.params.column.colDef.field].filter.static), i = () => {
      a.params.parentFilterInstance((u) => {
        l.value = l.value ? l.value : "", u.setModel({
          filterType: "text",
          type: "contains",
          filter: l.value
  ...
  setup(_) {
    ...
    return ve(() => {
      ...
      i = i.map((u) => u[n.params.column.colId]), a.value = i.filter((u, m) => i.indexOf(u) === m), a.value.unshift("..."), s();
    }), (i, u) => (E(), k("div", nl, [
      F(o("select", {
        ...
        onChange: u[1] || (u[1] = (m) => s()),
        onMousedown: u[2] || (u[2] = V(() => {
        }, ["stop"])),
        "aria-label": e.value,
        disabled: l.value
      }, [
  ...
  setup(_) {
    ...
    return X(async () => {
      await _e();
      const s = a.value?.closest(".ag-header-cell"), i = s.closest(".ag-pinned-left-header");
      s.addEventListener("keydown", async (u) => {
        u.key === "Enter" && (u.stopPropagation(), l(), await _e(), i.querySelector(".ag-header-cell.ag-floating-filter").focus());
      ...
      const s = a.value?.closest(".ag-header-cell"), i = s.closest(".ag-pinned-left-header");
      s.removeEventListener("keydown", async (u) => {
        u.key === "Enter" && (u.stopPropagation(), l(), await _e(), i.querySelector(".ag-header-cell.ag-floating-filter").focus());
  ...
  props: ["params"],
  setup(_) {
    const { t: n } = N(), e = _, a = C(), l = C(0), s = C(!1), i = C(!1), u = C(!1), m = C(null), b = () => {
      const c = m.value.getAllDisplayedColumns(), M = c.indexOf(e.params.column);
      i.value = M > 3 && !c[M - 1].colDef.isStatic, u.value = M < c.length - 1 && !c[M + 1].colDef.isStatic;
    }, w = () => {
      const c = m.value.getAllDisplayedColumns(), M = m.value.getAllGridColumns(), A = M.indexOf(c[c.indexOf(e.params.column) - 1]);
      i.value && (m.value.moveColumn(e.params.column, A), e.params.api.ensureColumnVisible(M[A]), a.value?.closest(".ag-header-row")?.querySelector(`[col-id="${e.params.column.colId}"]`)?.querySelector(".move-left")?.focus());
    }, y = () => {
      const c = m.value.getAllDisplayedColumns(), M = m.value.getAllGridColumns(), A = M.indexOf(c[c.indexOf(e.params.column) + 1]);
      u.value && (m.value.moveColumn(e.params.column, A), e.params.api.ensureColumnVisible(M[A]));
    }, L = (c) => {
...
}), $l = ["content", "aria-label"], Tl = /* @__PURE__ */ D({
  __name: "details-button-renderer",
  props: ["params"],
  setup(_) {
    const n = _, { t: e } = N(), a = oe("iApi"), l = C(), s = async () => {
      const i = n.params.data, u = i.rvUid, m = a.geo.layer.getLayer(u), b = m.oidField, y = n.params.layerCols[m.id].find(
        (c) => c.origAttr === b
      )?.mappedAttr || b, L = await m.getGraphic(i[y], {
        getAttribs: !0
      });
      a.event.emit(
        Q.DETAILS_TOGGLE,
  ...
  props: ["params"],
  setup(_) {
    const n = C("none"), e = _, a = oe("iApi"), l = $t(), s = C(), { t: i } = N(), u = O(() => {
      ...
      w.layerType === Tt.FEATURE && w.geomType !== Rt.POINT ? w.getGraphicExtent(L).then((M) => {
    ...
    return X(() => {
      u.value && (e.params.eGridCell.addEventListener("keydown", (w) => {
      ...
      u.value && (e.params.eGridCell.removeEventListener("keydown", (w) => {
        w.key === "Enter" && m();
  ...
  setup(_) {
    const n = _, e = oe("iApi"), a = C(), l = O(() => {
      const i = Object.assign({}, n.params.data), u = e.geo.layer.getLayer(i.rvUid), m = n.params.config.displayOn;
      return !(!u || m === "geo" && !u.mapLayer || m === "data" && u.mapLayer);
    }), s = () => {
      const i = Object.assign({}, n.params.data), u = e.geo.layer.getLayer(i.rvUid), m = n.params.layerCols[u.id].find((w) => w.origAttr === u.oidField), b = m.mappedAttr ? i[m.mappedAttr] : i[m.origAttr];
      u.getGraphic(b, { getAttribs: !0 }).then((w) => {
  ...
  props: ["params"],
  setup(_) {
    const n = fe(), e = oe("iApi"), { t: a } = N(), l = C(), s = C(), i = C(!1), u = _, m = O(() => n.mobileView), b = () => {
      s.value?.textContent && (i.value = !0, l.value?._tippy.show(), navigator.clipboard.writeText(s.value?.textContent), setTimeout(() => {
        i.value = !1;
      }, 2e3));
    }, w = O(() => u.params.type === "number" ? u.params.value == null ? "" : e.ui.formatNumber(u.params.value) : u.params.type === "date" ? u.params.value == null ? "" : new Date(u.params.value).toISOString().slice(0, 10) : u.params.type === "string" ? !u.params.value || /<a[^>]*>[^<]+<\/a>/g.test(u.params.value) ? u.params.value : Dt(u.params.value, {
      target: "_blank",
      validate: {
        url: (L) => /^https?:\/\//.test(L)
        // only links that begin with a protocol will be hyperlinked
      }
    }) : ""), y = O(() => /<a[^>]*>[^<]+<\/a>/g.test(u.params.value) || /(http(s)?:\/\/.*)/g.test(u.params.value));
    return X(() => {
      u.params.eGridCell.addEventListener("dblclick", () => {
        b();
      }), u.params.eGridCell.addEventListener("keydown", (L) => {
      ...
      u.params.eGridCell.removeEventListener("dblclick", () => {
        b();
      }), u.params.eGridCell.removeEventListener("keydown", (L) => {
        L.ctrlKey && L.code === "KeyC" && b();
...
}), Ol = { class: "pl-8" }, Ul = { class: "flex flex-col justify-center items-center h-full" }, Kl = { class: "flex flex-row" }, jl = { class: "font-bold text-2xl" }, ql = { class: "mt-20 text-xl" }, Wl = { class: "my-20" }, Yl = { class: "text-sm" }, Zl = ["aria-label"], Ql = { class: "flex flex-wrap gap-y-8 items-center pl-8 pb-8" }, Xl = { class: "flex flex-1 flex-col max-w-full mr-8" }, Jl = { class: "w-full font-bold" }, ea = { class: "w-full text-sm" }, ta = { key: 0 }, la = { class: "flex flex-1 grow-[1.4] items-center max-w-full" }, aa = { class: "flex flex-1 min-w-0 items-center pb-4 mr-8" }, ra = ["aria-label", "placeholder"], sa = { class: "-ml-30" }, na = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  fit: "",
  preserveAspectRatio: "xMidYMid meet",
  ...
  setup(_) {
    const n = [re.OID, re.DOUBLE, re.SINGLE, re.INTEGER], e = oe("iApi"), a = lt(), l = fe(), s = O(() => l.mobileView), i = C(!s.value), u = C(), m = Mt("gridContainer"), { t: b, locale: w } = N(), y = () => At()?.proxy?.$forceUpdate(), L = _, c = C({
      id: "dummy",
      layerIds: [],
      state: new Gt(),
      fieldMap: {}
    }), M = C(!0), A = C(new Nt()), K = C(), ee = C(), j = C(!1), te = C(!1), ie = C([]), ke = C(0), W = C([]), he = C([]), Me = C(""), I = C(new Bt()), le = C([]), ue = C([]), ye = C("OBJECTID"), Ae = C(void 0), at = Qe.onCellKeyPress, q = C({ firstRow: 0, lastRow: 0, visibleRows: 0 }), be = C({}), rt = e.geo.layer.getLayer(L.gridId), de = C({}), st = C(a.grids[L.gridId].layerIds), G = O(() => a.grids[L.gridId] ? a.grids[L.gridId].layerIds.map((r) => e.geo.layer.getLayer(r)).filter((r) => r !== void 0) : []), Fe = C(/* @__PURE__ */ new Set()), we = C([]), xe = () => {
      ...
      A.value = r.api, I.value = r.columnApi, Me.value = c.value.state.title || rt?.name || L.gridId, Te(), ue.value.length > 0 && I.value.autoSizeAllColumns(), xe(), A.value.addEventListener("rowDataChanged", xe), W.value.push(
        e.event.on(Q.FILTER_CHANGE, ({ uid: t, filterKey: v }) => {
          v !== Le.GRID && t && G.value.map((p) => p.uid).includes(t) && Y();
        })
      ), W.value.push(
        e.event.on(
      ...
      A.value && !j.value && (c.value.state.searchFilter !== "" && $e(), c.value.state.applyToMap && Re(), _e(() => {
      ...
      i.value = !i.value;
      const r = i.value ? "left" : null, t = I.value.getAllDisplayedColumns();
      I.value.setColumnsPinned(t.slice(1, 3), r);
    }, ct = () => {
      const r = I.value.getAllDisplayedColumns().filter((t) => !t.getColDef().preventExport);
      A.value.exportDataAsCsv({
        columnKeys: r,
        suppressQuotes: !0,
        processCellCallback: (t) => {
          const v = t.column.getColDef().cellRendererParams;
          return !t.value || v && v.type === "number" ? t.value : v && v.type === "date" ? `"${new Date(t.value).toLocaleDateString("en-CA", {
            timeZone: "UTC",
            year: "numeric",
            month: "2-digit",
            day: "2-digit",
      ...
      r.floatingFilterComponent = "dateFloatingFilter", r.filterParams.comparator = function(v, p) {
        const d = new Date(p);
      ...
      r.floatingFilterComponent = "textFloatingFilter", r.floatingFilterComponentParams = {
        suppressFilterButton: !0,
        stateManager: t
      }, r.filterParams.textMatcher = function(p) {
      ...
      r.filterParams.textFormatter = function(p) {
        return v(p);
      };
    }, ht = (r, t, v) => {
      ...
      if (r.field === "rvInteractive") {
        const p = c.value.state.controls, d = {
          sortable: !1,
          pinned: s.value ? "" : "left",
          filter: !1,
          lockPosition: !0,
        ...
        if (p.includes("details") && t.push(d), Et.value) {
          const f = {
            sortable: !1,
            pinned: s.value ? "" : "left",
            filter: !1,
      ...
      const r = new St(), t = we.value.slice().map((p) => p.getPromise());
      ...
      if (Object.keys(t).forEach((p) => {
        const d = Se(r, p);
        d ? v.push(Ct(d.origAttr, t[p])) : v.push("1=2");
      ...
      switch (t.filterType) {
        ...
        case "text": {
          ...
          if (v !== "") {
            const p = /\\[(!"#$&'+,.\\/:;<=>?@[\]^`{|}~)]/g;
            let d = v, f = "", x = p.exec(v), S = 0;
            for (; x; )
              f = f + v.substr(S, x.index - S) + x[0].slice(-1), S = x.index + 2, d = v.substr(x.index + 2), x = p.exec(v);
        ...
        case "date": {
          const v = new Date(t.dateFrom ?? 0), p = new Date(t.dateTo ?? 864e13), d = v ? `${v.getMonth() + 1}/${v.getDate()}/${v.getFullYear()}` : void 0, f = p ? `${p.getMonth() + 1}/${p.getDate()}/${p.getFullYear()}` : void 0;
          switch (t.type) {
      ...
      const v = c.value.state.searchFilter.replace(/'/g, "''").split(" "), p = A.value.rowModel.rowsToDisplay, d = I.value.getAllDisplayedColumns().filter(
        (x) => (x.colDef.filter === "agTextColumnFilter" || x.colDef.filter === "agNumberColumnFilter") && Se(r, x.getColId())
      ), f = [];
      return p.forEach((x) => {
        let S = !0, g = "";
        for (const T of v) {
          const pe = new RegExp(`.*${T.split(" ").join(".*").toUpperCase()}`), qe = `%${T.replace(/\*/g, "%").split(" ").join("%").toUpperCase()}`;
          let ce = !1;
          for (const De of d) {
      ...
      Oe(), L.panel.isOpen && L.panel.close();
    }, Oe = () => {
      (j.value || te.value) && G.value.forEach((r) => {
        r.abortAttributeLoad(), r.clearFeatureCache();
      });
    }, B = O(() => {
      const r = G.value.map((p) => p.visibility && p.canModifyLayer && p.mapLayer), t = G.value.some(
    ...
    ), Se = (r, t) => de.value[r].find((v) => (v.mappedAttr ?? v.origAttr) === t), Ue = () => {
      ...
      r.length === 0 && ze(), ke.value = r.reduce((t, { featureCount: v }) => t + v, 0), ie.value = new Array(G.value.length).fill(0), r.forEach((t, v) => ie.value[v] += t.downloadedAttributes()), r.forEach((t, v) => {
        ...
        const t = r.map((v) => Ge(v).getTabularAttributes().then((p) => {
          ...
          v.forEach((d, f) => {
            ...
            d.columns.forEach((g) => {
              c.value.fieldMap && c.value.fieldMap[g.data] ? (x.push({
                ...
                origAttr: g.data,
                mappedAttr: void 0
              }), p.columns.map((T) => T.data).includes(g.data) || p.columns.push(g);
            }), p.rows = p.rows.concat(
              d.rows.map((g) => {
                if (c.value.fieldMap)
                  for (const [T, pe] of Object.entries(c.value.fieldMap))
                    g[T] !== void 0 && g[pe] === void 0 && (g[pe] = g[T], delete g[T]);
                return g;
              })
            );
            for (let g = 0; g < p.rows.length; g++)
              for (const [T] of Object.entries(p.rows[g]))
                e.ui.isPlainText(p.rows[g][T]) && (p.rows[g][T] = e.ui.escapeHtml(p.rows[g][T]));
            ...
            ), p.oidField = c.value.fieldMap && c.value.fieldMap[d.oidField] ? c.value.fieldMap[d.oidField] : d.oidField, de.value[S] = x;
          }), ye.value = p.oidField, ["rvRowIndex", "rvInteractive", "rvSymbol", ...p.columns].forEach((d) => {
            ...
            const f = c.value.state?.columns[d.data], x = {
              ...
              suppressHeaderKeyboardEvent: (g) => {
                const T = g.event;
                return g.headerRowIndex === 0 && (T.key === "Enter" || !T.target.classList.contains("ag-header-cell") && T.key === "Tab");
              }
            }, S = p.fields.find((g) => g.name === x.field);
            d === "rvRowIndex" || d === "rvSymbol" || d === "rvInteractive" ? ht(x, le.value, c.value.state) : (n.indexOf(S.type) > -1 ? (ft(x, c.value.state), x.filter = "agNumberColumnFilter", x.autoHeight = !0, x.cellRenderer = f.template === "" ? Ve : e.component(f.template), x.cellRendererParams = {
              ...
              type: "date"
            }) : S.type === re.STRING && (x.isSelector ? vt(x, p.rows, c.value.state) : gt(x, c.value.state), x.filter = "agTextColumnFilter", x.autoHeight = !0, x.cellRenderer = f.template === "" ? Ve : e.component(f.template), x.cellRendererParams = {
              type: "string"
            }), le.value.push(x));
          }), ue.value = Ge(p.rows), le.value = Ge(le.value), Te(), j.value = !1;
        }).catch((v) => {
    ...
    return X(() => {
      ...
      c.value = a.grids[L.gridId], j.value = !0, y(), q.value = {
        ...
        onBodyScroll: () => {
          [...e.$vApp.$el.querySelectorAll("[id^=tippy]")].forEach((r) => {
            r._tippy && u.value?.contains(r._tippy.reference) && r._tippy.hide();
          });
        },
        onBodyScrollEnd: () => {
          Ne();
      ...
      Oe(), W.value.forEach((r) => e.event.off(r)), he.value.forEach((r) => r()), Ae.value?.removeAccessibilityListeners(), Ae.value?.removeScrollListeners(), m.value?.removeEventListener("keyup", Ke), m.value?.removeEventListener("blur", je);
    }), (r, t) => {
      const v = Pe("dropdown-menu"), p = U("truncate"), d = U("tippy");
      return E(), k("div", {
        ...
        F(o("div", null, [
          o("p", Ol, $(h(b)("grid.splash.error")), 1)
        ], 512), [
          [ae, te.value]
        ]),
        F(o("div", Ul, [
          o("div", Kl, [
            o("span", jl, $(ie.value.reduce((f, x) => f + x, 0)), 1),
            t[12] || (t[12] = o("svg", {
            ...
            o("span", ql, $(ke.value), 1)
          ]),
          o("div", Wl, [
            o("span", Yl, $(ie.value.reduce((f, x) => f + x, 0) < ke.value ? h(b)("grid.splash.loading") : h(b)("grid.splash.building")), 1)
          ]),
          o("div", null, [
            o("button", {
              type: "button",
        ...
        F(o("div", Ql, [
          o("div", Xl, [
            ...
            F((E(), k("div", ea, [
              H($(h(b)("grid.filters.label.info", {
                range: q.value.visibleRows !== 0 ? `${q.value.firstRow} - ${q.value.lastRow}` : "0",
                total: q.value.visibleRows
              })) + " ", 1),
              q.value.visibleRows !== ue.value.length ? (E(), k("span", ta, $(h(b)("grid.filters.label.filtered", {
                max: ue.value.length
              })), 1)) : R("", !0)
            ])), [
              [p]
                ...
                default: se(() => [
                  o("a", {
                    ...
                    o("div", pa, [
                      ...
                      H(" " + $(h(b)("grid.label.filters.apply")) + " ", 1),
                  ...
                  o("a", {
                    ...
                    o("div", va, [
                      ...
                      H(" " + $(h(b)("grid.label.filters.show")) + " ", 1),
                  ...
                  o("a", {
                    ...
                    o("div", ha, [
                      ...
                      H(" " + $(h(b)("grid.filters.label.extent")) + " ", 1),
                  ...
                  o("a", {
                    ...
                    ]))) : i.value ? R("", !0) : (E(), k("svg", xa, t[24] || (t[24] = [
                    ...
                    H(" " + $(h(b)("grid.label.pinColumns")) + " ", 1),
                    i.value ? (E(), k("svg", Ca, t[25] || (t[25] = [
                      o("g", { id: "done" }, [
                        o("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                      ], -1)
                    ]))) : R("", !0)
...
}), ka = /* @__PURE__ */ ge(Ea, [["__scopeId", "data-v-d2b8a567"]]), Ma = /* @__PURE__ */ D({
  __name: "screen",
  props: {
    panel: {
      type: tt,
  ...
  setup(_) {
    const n = lt(), { t: e } = N(), a = O(() => n.currentId);
    return (l, s) => {
      const i = Pe("panel-screen");
      return E(), Xe(i, { panel: _.panel }, {
        header: se(() => [
          H($(h(e)("grid.title")), 1)
        ]),
        content: se(() => [
