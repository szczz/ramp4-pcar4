import { defineComponent as c, inject as n, resolveComponent as h, openBlock as l, createBlock as m, unref as g, withCtx as v, createElementVNode as o, markRaw as f } from "vue";
import "tiny-emitter";
import { F as u, h as i, b as d, d as S } from "./main-CKWgYI6e.js";
    ...
    i(this.$vApp.$pinia).initService(this.$iApi.language, this.config), this.$iApi.component("geosearch-nav-button", w), this.$iApi.panel.register(
      {
        ...
        config: {
          screens: {
            "geosearch-component": () => f(import("./screen-CWpnLBLq.js"))
          },
          button: {
