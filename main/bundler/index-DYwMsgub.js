...
import { _ as C, d as A, F as j, G } from "./main-CKWgYI6e.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-BqJVtDz2.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-CJTWWQE2.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-BqHy8sNn.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-DmAXJJ65.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-C0kIr6mp.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-BiZww--3.js")))
      }), a;
    }), n = (a) => {
