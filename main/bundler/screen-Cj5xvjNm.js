import { defineComponent as M, resolveDirective as H, openBlock as u, createElementBlock as x, createElementVNode as r, withDirectives as b, unref as s, toDisplayString as $, normalizeClass as I, createVNode as N, Transition as z, withCtx as k, vShow as A, createCommentVNode as R, inject as D, computed as q, ref as g, onBeforeMount as K, watch as U, onBeforeUnmount as F, resolveComponent as G, createBlock as L, createTextVNode as J, isRef as P, withKeys as Q, withModifiers as W, vModelText as X, Fragment as Y, renderList as Z } from "vue";
import { _ as ee, j as te } from "./main-CKWgYI6e.js";
      ...
      return a.helpSection.drawn ? (u(), x("div", oe, [
        r("div", null, [
          b((u(), x("button", {
            ...
            r("div", {
              class: I(["dropdown-icon", { "transform -rotate-180": a.helpSection.expanded }])
            }, i[1] || (i[1] = [
              r("svg", {
        ...
        content: k(() => [
          r("div", pe, [
            b(r("input", {
              ...
              "onUpdate:modelValue": o[0] || (o[0] = (n) => P(m) ? m.value = n : m = n),
              "aria-label": s(i)("help.search"),
              onInput: o[1] || (o[1] = (n) => O(s(m), p.value)),
              onKeypress: o[2] || (o[2] = Q(W(() => {
              }, ["prevent"]), ["enter"])),
              enterkeyhint: "done"
            }, null, 40, de), [
              [X, s(m)]
          ...
          (u(!0), x(Y, null, Z(p.value, (n, l) => (u(), L(se, {
            helpSection: n,
            key: l,
            onExpand: (v) => V(n)
