...
var nt = /* @__PURE__ */ function(e) {
	...
	id;
	constructor(e, t, n) {
		this.geometry = e, t ? this.id = t : this.id = Ls.sharedUtils.generateUUID(), n ? this.attributes = n : this.attributes = {};
	}
	_hover;
	get hover() {
		return this._hover;
	...
	async projectGeometry(e, t) {
		...
		let n = t.toGeoJSON(), r = await this.projectGeoJson(n, this.normalizeProj(t.sr), this.normalizeProj(e)), i = Ls.geom.geomGeoJsonToRamp(r, t.id);
...
var Ht = class {
	...
	function a(t) {
		e.value.text.value = t.text.value, e.value.text.disabled = t.text.disabled, e.value.logo.altText = t.logo.altText, e.value.logo.link = t.logo.link, e.value.logo.value = t.logo.value, e.value.logo.disabled = t.logo.disabled;
	}
	return {
		attribution: e,
		scale: t,
	...
	en: {
		...
		"caption.attributionLogoAltText": "Powered by ESRI",
		"caption.attributionLink": "https://www.esri.com/"
	},
	fr: {
		"lang-code": "fr",
		"lang-dir": "ltr",
		...
		"caption.attributionLogoAltText": "Propulsé par ESRI",
		"caption.attributionLink": "https://www.esri.com/fr-fr/home"
	}
}, Qt = "en", $t = ["en", "fr"], en = {
	en: { number: {
		style: "decimal",
...
var nn = v("maptip", () => {
...
}), [["__scopeId", "data-v-3623a7d2"]]), zn = { class: "flex hover:text-white" }, Bn = ["aria-label"], Vn = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Hn = ["aria-label", "content"], Un = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Wn = { class: "absolute right-5 top-5" }, Gn = { class: "select-text" }, Kn = { class: "font-bold cursor-text" }, qn = { class: "text-sm cursor-text" }, Jn = { class: "font-bold cursor-text" }, Yn = { class: "ml-5 cursor-text" }, Xn = /* @__PURE__ */ n(/* @__PURE__ */ T({
	...
	setup(e) {
		let { t } = I(), n = ye("iApi"), r = () => {
			n.reload();
		}, i = y(() => `${Ns.major}.${Ns.minor}.${Ns.patch}`), a = y(() => Ns.hash.slice(0, 9)), o = y(() => {
			let e = new Date(Ns.timestamp);
...
}), [["__scopeId", "data-v-e0d1ce9f"]]), Zn = "__HELP__", Qn = v("keyboardnav", () => {
	...
	return ae;
}), $n = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, er = {
	key: 0,
	class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, tr = ["href", "aria-label"], nr = ["src", "alt"], rr = {
	key: 1,
	class: "relative ml-10 top-2 text-sm sm:text-base font-mono flex items-center gap-2",
	"aria-live": "polite"
}, ir = { class: "chain-content" }, ar = { class: "chain-keys" }, or = {
	key: 0,
	class: "chain-cursor"
}, sr = {
	key: 1,
...
}, ur = { class: "flex min-w-fit justify-end" }, dr = {
	key: 0,
	...
	"aria-label",
	"content"
], pr = { class: "relative top-1 text-sm sm:text-base" }, mr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, hr = ["onClick"], gr = {
	key: 0,
	class: "sr-only"
}, _r = /* @__PURE__ */ T({
	__name: "map-caption",
	setup(e) {
		let n = Gt(), r = Qn(), i = t(), { t: a } = I(), o = ye("iApi"), s = y(() => n.scale), c = y(() => n.attribution), l = y(() => n.coords), u = y(() => n.langtoggle), d = y(() => i.config.map), { keyChain: f, lastAction: p, chainState: m, namespaces: h, activeNamespace: ee } = le(r), g = y(() => {
		...
		let re = () => c.value?.logo?.link && c.value?.logo?.value && !c.value?.logo?.disabled, ie = (e) => {
			o.$i18n.locale.value != e && o.setLanguage(e);
		}, ae = () => {
			n.toggleScale(), o.geo.map.caption.updateScale();
		}, oe = (e = !1) => a(e ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
		return (e, t) => {
			...
			return O(), S("div", $n, [
				...
				re() ? (O(), S("span", er, [C("a", {
					...
					href: c.value?.logo.link,
					target: "_blank",
					"aria-label": c.value?.logo.altText
				}, [C("img", {
					class: "object-contain h-18 sm:h-26",
					src: c.value?.logo.value,
					alt: c.value?.logo.altText
				}, null, 8, nr)], 8, tr)])) : x("", !0),
				g.value ? (O(), S("span", rr, [C("span", ir, [
					t[0] ||= C("span", { class: "chain-colon" }, ":", -1),
					C("span", ar, M(g.value.keys), 1),
					g.value.cursor ? (O(), S("span", or, "_")) : x("", !0),
					g.value.options ? (O(), S("span", sr, M(g.value.options), 1)) : x("", !0)
				]), g.value.description ? (O(), S("span", cr, "- " + M(g.value.description) + "...", 1)) : x("", !0)])) : c.value?.text.disabled ? x("", !0) : F((O(), S("span", lr, [he(M(c.value?.text.value), 1)])), [[r, { options: {
					placement: "top",
					hideOnClick: !1,
					theme: "ramp4",
					animation: "scale"
				...
				C("div", ur, [
					l.value?.disabled ? x("", !0) : F((O(), S("div", dr, [he(M(l.value?.formattedString), 1)])), [[r, { options: {
						hideOnClick: !1,
						theme: "ramp4",
						animation: "scale"
					} }]]),
					s.value?.disabled ? x("", !0) : F((O(), S("button", {
						...
						"aria-label": `
                    ${s.value?.label} - ${oe(s.value?.isImperialScale)}
                `,
						content: oe(s.value?.isImperialScale)
					}, [C("span", {
						class: "border-solid border-2 border-white border-t-0 h-5 mr-4 inline-block",
						style: Se({ width: s.value?.width })
					}, null, 4), C("span", pr, M(s.value?.label), 1)], 8, fr)), [[i, {
						delay: [300, 0],
						placement: "top",
						hideOnClick: !1,
						theme: "ramp4",
					...
					u.value?.disabled ? x("", !0) : (O(), b(n, {
						...
						header: P(() => [C("span", mr, M(N(a)("map.language.short")), 1)]),
						default: P(() => [(O(!0), S(ue, null, Oe(te.value, (e, t) => (O(), S("a", {
							...
							href: "javascript:;",
							onClick: (t) => ie(e)
						}, [he(M(N(a)("map.language." + e)) + " ", 1), e === N(o).$i18n.locale.value ? (O(), S("span", gr, M(N(a)("map.language.curr")), 1)) : x("", !0)], 10, hr))), 128))]),
						_: 1
					}, 8, ["tooltip", "ariaLabel"]))
				])
			]);
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return F((O(), S("button", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
			}, [C("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" })], -1), i.value && i.value > 0 ? (O(), S("span", yr, M(i.value), 1)) : x("", !0)], 8, vr)), [[a]]);
		};
	}
}), [["__scopeId", "data-v-a451db5c"]]), xr = { class: "flex items-center mb-20" }, Sr = { class: "text-xl" }, Cr = /* @__PURE__ */ T({
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return r.value ? (O(), S("div", {
				...
				C("div", xr, [C("h2", Sr, M(N(n)("keyboardInstructions.title")), 1), w(a, {
					class: "ml-auto",
...
}), wr = v("instance", () => ({ started: k(!1) })), Tr = { class: "h-full relative" }, Er = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Dr = { class: "absolute top-8 w-full flex justify-center" }, Or = {
	key: 1,
	class: "w-full h-full"
}, kr = T({
	name: "App",
	components: { Shell: /* @__PURE__ */ n(/* @__PURE__ */ T({
		__name: "shell",
		setup(e) {
			let t = ye("iApi"), n = wr(), r = Jt(), i = ln(), { t: a } = I(), o = y(() => r.items.appbar), s = () => {
				t.event.emit("openKeyboardInstructions");
			}, c = () => i.teleported;
			return (e, t) => (O(), S("div", Tr, [
				C("div", Er, [
					...
					w(Cr, { class: "keyboard-instructions-modal" }),
					...
					o.value ? x("", !0) : (O(), b(br, { key: 0 })),
					w(_r, { class: "z-30" })
				]),
				N(n).started ? (O(), b(rn, { key: 0 })) : (O(), S("div", Or, [...t[1] ||= [C("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)]])),
...
function Mr(e, t, n, r, i, a) {
	...
	return O(), S("div", {
		...
		lang: e.$i18n.locale
	}, [C("div", jr, [w(o)], 512)], 8, Ar);
}
var Nr = /* @__PURE__ */ n(kr, [["render", Mr]]), Pr = /* @__PURE__ */ function(e) {
...
}(Pr || {}), Fr = "focus-list", Ir = "focus-item", Lr = "focus-icon", Rr = `[${Fr}],[focus-container]`, zr = "truncate-text", Br = "show-truncate", Vr = "focused", Hr = `button,input,select,a,textarea,[contenteditable],[${Fr}],[${Lr}],[tabindex]`, Ur = {
	mounted(e, t) {
		+e.getAttribute("tabindex") <= 0 && e.setAttribute("tabindex", "0"), e.toggleAttribute(Fr, !0), new Gr(e, t.value);
	},
	updated(e) {
		Wr(e);
	}
...
function Wr(e) {
	e.querySelectorAll(Hr).forEach((t) => {
		if (t.closest(Rr) === e || t.closest(Rr) === t && t.parentElement.closest(Rr) === e) if (t.closest(`[${Fr}],.${Vr}`).classList.contains(Vr)) t.setAttribute("tabindex", "0");
		else {
...
var Gr = class {
	...
	setTabIndex(e, t = this.element) {
		t.querySelectorAll(Hr).forEach((t) => {
			(e === -1 || t.closest(Rr) === this.element || t.closest(Rr) === t && t.parentElement.closest(Rr) === this.element || t.closest(`[${Fr}],.${Vr}`).classList.contains(Vr)) && t.setAttribute("tabindex", e.toString());
		});
	}
	defocusItem(e) {
		e.classList.remove(Vr), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Ir) === Br && e.querySelector(`[${zr}]`)?._tippy?.hide();
	}
	focusItem(e) {
		e.classList.add(Vr), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Ir) === Br && e.querySelector(`[${zr}]`)?._tippy?.show(), this.isTapped = !1;
	}
	...
	onKeydown(e) {
		let t = this, n = Array.prototype.filter.call(this.element.querySelectorAll(`[${Ir}]`), (e) => e.closest(`[${Fr}]`) === t.element && !!e.offsetParent);
		if (n.length !== 0) switch (e.key) {
			...
			case Pr.Space:
				...
				break;
			case Pr.Tab:
				let t = this.highlightedItem.querySelectorAll(Hr).length === 0, r = this.element.isEqualNode(e.target);
	...
	onClick(e) {
		...
		let t = e.target;
		if (!t.hasAttribute(Fr)) for (; t.parentElement.closest(`[${Fr}]`) !== this.element;) t = t.parentElement.closest(`[${Fr}]`);
		this.highlightedItem = t.closest(`[${Ir}]`) || t.closest(`[${Fr}]`) || this.highlightedItem, t.hasAttribute(`${Ir}`) && this.element.focus(), this.highlightedItem === this.element ? this.element.removeAttribute("aria-activedescendant") : this.focusItem(this.highlightedItem);
	}
	onFocus() {
		if (this.highlightedItem === this.element) {
			let e = this.element.querySelectorAll(`[${Ir}]`);
			if (e.length === 1) {
				this.defocusItem(this.highlightedItem), this.highlightedItem = e[0], this.focusItem(e[0]);
				return;
			}
		}
		this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Ir) === Br && this.highlightedItem.querySelector(`[${zr}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Wr(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
	}
	onBlur() {
		this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(Ir) === Br && this.highlightedItem.querySelector(`[${zr}]`)?._tippy?.hide());
	}
	onMousedown() {
		this.isClicked = !0;
	}
...
}, Kr = "focus-item", qr = { beforeMount(e, t) {
	e.hasAttribute("id") || e.setAttribute("id", Jr()), t.value ? e.setAttribute(Kr, t.value) : e.toggleAttribute(Kr, !0);
} };
function Jr() {
	let e;
	do
...
var Yr = /* @__PURE__ */ function(e) {
...
}(Yr || {}), Xr = "focus-container", Zr = "focus-container-active", Qr = "focus-list", $r = "focus-icon", ei = `[${Qr}],[${Xr}]`, ti = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Qr}],[${Xr}],[${$r}],[tabindex]`, ni = {
	childList: !0,
	subtree: !0,
	attributes: !0,
	attributeFilter: [
	...
	mounted(e) {
		[...document.querySelectorAll(".inner-shell")].some((t) => t.contains(e)) && ri.push(new ai(e));
	},
	beforeUnmount(e) {
		ri = ri.filter((t) => t.element === e ? (t.removeEventListeners(), !1) : !0);
	}
}, ai = class {
	element;
	isTabbingEnabled;
	...
	focusHandler;
	constructor(e) {
		this.element = e, this.isTabbingEnabled = !1, this.element.toggleAttribute(Xr, !0), this.element.toggleAttribute(Zr, !1), this.element.tabIndex = 0, this.initialDisableTimeout = setTimeout(() => this.disableTabbing(), 600), this.keypressHandler = (e) => {
			this.onKeypress(e);
		}, this.clickHandler = () => {
			this.onClick();
	...
	onKeypress(e) {
		e.target === this.element && (e.key === Yr.Enter || e.key === Yr.Space) && this.enableTabbing()?.focus();
	}
	onClick() {
		this.enableTabbing();
	}
	...
	disableTabbing() {
		...
		let t = Array.prototype.filter.call(this.element.querySelectorAll(ti), () => !0);
	...
	enableTabbing() {
		...
		return this.withPausedObserver(() => {
			Array.prototype.map.call(this.element.querySelectorAll(ti), (t) => {
				(t.closest(ei) === this.element || t.closest(ei) === t && t.parentElement.closest(ei) === this.element) && t.offsetParent && (t.tabIndex !== 0 && (t.tabIndex = 0), e === void 0 && (e = t));
			});
		}), e;
	}
	setTabbingEnabled(e) {
		this.isTabbingEnabled = e, this.element.toggleAttribute(Zr, e);
	}
	observeMutations() {
		this.mutationObserver?.observe(this.element, ni);
	}
...
}, oi = "truncate-text", si = "truncate-trigger", ci = {
	beforeMount(e, t) {
		!e.classList.contains("truncate") && !t.value?.noTruncateClass && e.classList.add("truncate"), e.toggleAttribute(oi, !0);
	},
	mounted(e, t) {
		let n;
		t.value && t.value.externalTrigger && (n = e.closest(`[${si}]`)), Je(e, {
			content: di(e.textContent),
			onShow: li,
			allowHTML: !0,
			placement: "bottom-start",
			maxWidth: 320,
	...
	updated(e, t) {
		e._tippy && (e._tippy.setContent(di(e.textContent)), t.value && t.value.options && e._tippy.setProps(t.value.options));
	},
	unmounted(e) {
...
var fi = ["content"], pi = {
...
}, yi = "focus-container", bi = "focus-container-active", xi = /* @__PURE__ */ T({
	__name: "panel-screen",
	props: {
		header: {
			type: Boolean,
	...
	setup(e, { expose: t }) {
		...
		t({ el: s });
		let f = e, p = y(() => o.fixture.get("appbar") ? a.temporary : []), m = y(() => i.mobileView), h = y(() => i.reorderable), ee = `[focus-list], [${yi}]`, g = (e) => e.scrollHeight > e.clientHeight, te = (e) => e.querySelector(ee), ne = () => {
			if (!c.value) return "-1";
			let e = c.value.closest(`[${yi}]`);
			if (e && !e.hasAttribute(bi)) return "-1";
			let t = !!te(c.value);
		...
		return we(() => {
			...
			return F((O(), S("div", {
				...
				}, null, 8, _i)) : x("", !0)], 512)) : x("", !0),
				e.footer ? F((O(), S("div", vi, [ke(t.$slots, "footer")])), [[g]]) : x("", !0)
			], 8, fi)), [[te, {
				trigger: "manual",
				touch: !1,
				onShow: _,
...
}), Si = { class: "relative" }, Ci = ["content", "aria-label"], wi = ["transform"], Ti = /* @__PURE__ */ T({
	__name: "pin",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = j("tippy");
			return O(), S("div", Si, [F((O(), S("button", {
				type: "button",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = j("tippy");
			return O(), S("div", Ei, [F((O(), S("button", {
				type: "button",
				class: D(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 352 512"
			}, [C("path", { d: "M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" })], -1)]], 10, Di)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), ki = { class: "relative" }, Ai = ["content", "aria-label"], ji = /* @__PURE__ */ T({
	__name: "back",
	props: { active: Boolean },
	setup(e) {
		let { t } = I();
		return (n, r) => {
			let i = j("tippy");
			return O(), S("div", ki, [F((O(), S("button", {
				type: "button",
				class: D(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
...
}), Mi = { class: "w-32 h-32" }, Ni = ["content", "aria-label"], Pi = {
	key: 0,
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 24 24",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = j("tippy");
			return O(), S("div", Mi, [F((O(), S("button", {
				type: "button",
...
}), Li = { class: "relative" }, Ri = ["content", "aria-label"], zi = /* @__PURE__ */ T({
	__name: "minimize",
	props: { active: Boolean },
	setup(e) {
		let { t } = I();
		return (n, r) => {
			let i = j("tippy");
			return O(), S("div", Li, [F((O(), S("button", {
				type: "button",
				...
				d: "M0 0h24v24H0V0z",
				fill: "none"
			}), C("path", { d: "M6 19h12v2H6z" })], -1)]], 10, Ri)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
var Vi = { class: "relative" }, Hi = ["content", "aria-label"], Ui = /* @__PURE__ */ T({
	__name: "right",
	props: { active: Boolean },
	setup(e) {
		let { t } = I(), n = e, r = k(null), { syncTooltipAfterKeyboardMove: i } = Bi(r, () => !!n.active);
		return (n, a) => {
			let o = j("tippy");
			return O(), S("div", Vi, [F((O(), S("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				class: D(["p-8", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [C("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })], -1)]], 10, Hi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), Wi = { class: "relative" }, Gi = ["content", "aria-label"], Ki = /* @__PURE__ */ T({
	__name: "left",
	props: { active: Boolean },
	setup(e) {
		let t = e, { t: n } = I(), r = k(null), { syncTooltipAfterKeyboardMove: i } = Bi(r, () => !!t.active);
		return (t, a) => {
			let o = j("tippy");
			return O(), S("div", Wi, [F((O(), S("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [C("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })], -1)]], 10, Gi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (e, i) => {
			...
			return O(), b(a, {
				...
				default: P(() => [N(n).isFullscreen ? (O(), S("svg", Ji, [...i[0] ||= [C("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), C("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)]])) : (O(), S("svg", Yi, [...i[1] ||= [C("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
	...
	tabindex: "-1"
}, ea = ["content", "aria-label"], ta = /* @__PURE__ */ T({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		return (t, n) => {
			...
			}, [ke(t.$slots, "default")], 10, ea)), [[r], [i, { placement: "left" }]])]);
		};
	}
}), na = {
	class: "relative",
	tabindex: "-1"
}, ra = ["aria-label", "content"], ia = /* @__PURE__ */ n(/* @__PURE__ */ T({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		...
		return (t, n) => {
			...
			return O(), S("div", na, [F((O(), S("button", {
				type: "button",
			...
			}, [ke(t.$slots, "default", {}, void 0, !0)], 8, ra)), [[i], [a, {
				allowHTML: !0,
				placement: "right"
			}]])]);
		};
	}
}), [["__scopeId", "data-v-1cb84ae1"]]), aa = v("areas-of-interest", () => ({ areas: k([]) })), oa = v("export", () => {
	let e = k({
		title: !0,
		map: !0,
		mapElements: !0,
	...
	fsaToProvince(e) {
		...
		return t = r === "X" ? n === "X0A" || n === "X0B" || n === "X0C" ? 62 : 61 : ca[r], this.codeToProvince(t);
	}
};
function da(e) {
	return new ua(e);
	...
	constructor(e, t) {
		Xe.get(t).then((t) => {
			t.data.definitions.forEach((t) => {
				fa[e][t.code] = t.term.split(`${t.code}-`)[1];
			}), Object.keys(fa[e]).forEach((t) => {
				this.allTypes[t] = fa[e][t], this.validTypes[t] = fa[e][t];
			}), this.typesFetched = !0;
		});
	}
	filterValidTypes(e) {
...
async function ga(e, t) {
	let n, r;
	return /^[-+]?([1-8]?\d(\.\d+)?|90(\.0+)?)(\s*[,|;\s]\s*)[-+]?(180(\.0+)?|((1[0-7]\d)|([1-9]?\d))(\.\d+)?)[*]$/.test(t) && !e.disabledSearchTypes.includes("LAT/LNG") ? (r = t.slice(0, -1), n = new ha(e, r), await Ta(n)) : /^[ABCEGHJKLMNPRSTVXY]\d[A-Z]/.test(t) && !e.disabledSearchTypes.includes("FSA") ? (r = t.substring(0, 3).toUpperCase(), n = new ha(e, r), await Ea(n)) : /^\d{2,3}[A-P]/.test(t) && !e.disabledSearchTypes.includes("NTS") ? (r = t.substring(0, 6).toUpperCase(), n = new ha(e, r), await Da(n)) : (r = encodeURIComponent(t.trim()), n = new ha(e, r), await Oa(n)), e.customSources.length && await xa(n, e.customSources), n;
}
var _a = async (e) => {
...
}, ba = (e, t) => t.filter((t) => e.types.validTypes[t.concise.code]).map((t) => ({
	name: t.name,
	flav: "nme",
	bbox: t.bbox,
	...
	let [t, n] = await Ze(_a(ya(e, !0)));
	return t ? (console.error("Geolocation service failed"), e.failedServs.push("geolocation"), []) : n;
}, Ca = async (e) => {
	let [t, n] = await Ze(_a(ya(e, !1))), r;
	t ? (console.error("GeoName service targeting Name failed"), e.failedServs.push("geoname"), r = []) : r = n.items, e.addResult(ba(e.config, r));
}, wa = async (e, t, n) => {
	let [r, i] = await Ze(_a(ya(e, !1, t, n))), a;
	r ? (console.error("GeoName service targeting Lat Lon failed"), e.failedServs.push("geoname"), a = []) : a = i.items, e.addResult(ba(e.config, a));
}, Ta = async (e) => {
	...
	await wa(e, n, r), e.addResult(i);
}, Ea = async (e) => {
	let t = e.config, n = await Sa(e);
	if (n.length) {
	...
	let t = e.config;
	if (await Ca(e), t.categories.length === 0 || t.categories.includes("ADDR")) {
		let n = await Sa(e), r = t.sortOrder.indexOf("ADDR"), i = r >= 0 ? r : t.sortOrder.length, a = n.filter((e) => e.type?.includes("Street")).map((e) => {
...
}, ka = "~FSA~", Aa = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", ja = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ma = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Na = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Pa = class {
	config;
	constructor(e, t) {
		let n, r, i, a, o = t?.serviceUrls;
		o ? (n = o.geoLocation ? o.geoLocation : Aa, r = o.geoNames ? o.geoNames : ja, i = o.geoProvince ? o.geoProvince : Ma, a = o.geoTypes ? o.geoTypes : Na) : (n = Aa, r = ja, i = Ma, a = Na), n = n.replace("@{language}", e), r = r.replace("@{language}", e), i = i.replace("@{language}", e), a = a.replace("@{language}", e);
		let s = "", c = t?.fsaBoundaries;
		if (c && c.serviceUrl) {
			let e = c.keyField || "CFSAUID";
			s = `${c.serviceUrl}/query/?where=${e}%3D'${ka}'&outFields=${e}&returnGeometry=true&f=json`;
		}
		...
		l ? (u = l.categories ? l.categories : [], d = l.sortOrder ? l.sortOrder : [], f = l.disabledSearchTypes ? l.disabledSearchTypes : [], p = l.maxResults > 0 ? l.maxResults : 100, m = !!l.officialOnly) : (u = [], d = [], f = [], p = 100, m = !1), h = t?.customSources ?? [], h = h.map((e) => ({
			...e,
			onSearch: async (t) => {
				let n = e.data ?? [], r = Ia(), i = decodeURIComponent(r.cleanVal(t)).replace("*", "");
	...
	async query(e) {
		let t = await ga(this.config, e.toUpperCase()), n = this.config.sortOrder.length, r = t.results.filter((e) => e.order < n), i = t.results.filter((e) => e.order >= n);
...
var Ia = v("geosearch", () => {
		...
		if (!u) o.value = [], s.value = [], c.value = !1;
			...
			let r = setInterval(() => {
				e.value.config.provinces.listFetched && e.value.config.types.typesFetched && (clearInterval(r), e.value.query(`${u}*`).then((e) => {
					l.value = e.failedServs, a.value = u, s.value = e.results, o.value = Fa(n.value, t.value, s.value) || [], c.value = !1;
				}));
			}, 250);
		} else o.value = Fa(n.value, t.value, s.value) || [], c.value = !1;
	}
	function h(e) {
	...
	_visibleChildren;
	constructor(e, t, n) {
		super(e), this._uid = Ls.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? Ra.Placeholder, this._parent = n, this._children = [], this._loadPromise = new Y(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [La.Visibility, La.Expand], this._disabledControls = t.disabledControls?.slice(), this._visibleChildren = [];
	}
	get uid() {
		return this._uid;
	}
	...
	toggleVisibility(e, t = !0) {
		if (this.visibility !== e) {
			...
			else if (this.visibility) if (this._lastVisible && (!(this._lastVisible instanceof Ba) || this._lastVisible.layerControlAvailable(G.Visibility))) this._lastVisible.toggleVisibility(!0);
			else {
				let e = this.children.find((e) => !(e instanceof Ba) || e.layerControlAvailable(G.Visibility));
	...
	checkVisibilityRules() {
		(this.parent && !this.parent.visibility || this.parent?.exclusive && this.parent.children.some((e) => e.visibility && e !== this && e.type === Ra.Item)) && this.toggleVisibility(!1, !1);
	}
	checkVisibility(e) {
		this instanceof Ba && !this.layerControlAvailable(G.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
			t.uid !== e.uid && t.toggleVisibility(!1, !1);
		}), this._lastVisible = e, this._visibility = !0, this instanceof Ba && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this instanceof Ba && this.layer && this.layer.layerExists && (this.layer.visibility = !1), this._lastVisible = e) : this.children.some((e) => e.visibility) ? (this._visibility = !0, this._visibleChildren = this.children.filter((e) => e.visibility), this instanceof Ba && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this._visibleChildren = [], this instanceof Ba && this.layer && this.layer.layerExists && (this.layer.visibility = !1)), this.parent && this.parent.checkVisibility(this));
	}
	getConfig() {
		let e = {
			name: this._name,
	...
	load() {
		this._type = Ra.Item, this._loadPromise.resolveMe(), this.checkVisibilityRules();
	}
	reload() {
		this._type = Ra.Placeholder, this._loadPromise = new Y();
	}
	error() {
		this._type !== Ra.Error && (this._type = Ra.Error, this._loadPromise.getPromise().catch(() => {}), this._loadPromise.rejectMe(), this.checkVisibilityRules());
	}
}, Ba = class extends za {
	_layerId;
	_layerIdx;
	...
	load(e) {
		let t = e instanceof go ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
		t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== ut.UP_TO_DATE, t.loadPromise().then(() => {
			this._layerInitVis = this._layerInitVis === void 0 ? t.visibility : this._visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(this.$iApi.event.on(Z.LAYER_VISIBILITYCHANGE, (e) => {
				e.layer.uid === this.layer.uid && this._type === Ra.Item && this.toggleVisibility(e.visibility, !0, !0);
	...
	_content;
	constructor(e, t, n) {
		super(e, t, n), this._infoType = t.infoType ?? Va.Title, this._content = t.content ?? "", t.infoType === Va.Template && this.$element.component(`${this._uid}-info-section`, { template: this._content }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [La.Expand]), super.load();
	}
	get infoType() {
	...
	function a(e) {
		if (e.parent === void 0) t.value.push(e.item);
			...
			if (!(e.item instanceof Ha) && !(e.item instanceof Ba)) {
	...
	function o(e) {
		...
		}), t = t.filter((e) => !(e instanceof Ha && !e.children.length && e.content === "")), t);
		t.value = n(t.value);
	}
	function s(e) {
	...
	constructor(e, t, n) {
		...
		let r = Za(e, this);
		this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new ds(this), this.panel = new ps(this), this.geo = new ls(this), this.dev = new bs(this), this.ui = {
	...
	reloadWorker(n, r) {
		let i = wr(this.$vApp.$pinia), a = pn(this.$vApp.$pinia), o = t(this.$vApp.$pinia), s = Jt(this.$vApp.$pinia), c = e(this.$vApp.$pinia), l = Wt(this.$vApp.$pinia), u = !!n;
	...
	useStore(n) {
		if (!([
			...
			case "areas-of-interest": return aa(this.$vApp.$pinia);
			case "details": return qt(this.$vApp.$pinia);
			case "export": return oa(this.$vApp.$pinia);
			case "extentguard": return sa(this.$vApp.$pinia);
			case "geosearch": return Ia(this.$vApp.$pinia);
			case "grid": return Wt(this.$vApp.$pinia);
			case "help": return i(this.$vApp.$pinia);
			case "keyboardnav": return Qn(this.$vApp.$pinia);
			case "legend": return Ua(this.$vApp.$pinia);
			case "mapnav": return Wa(this.$vApp.$pinia);
			case "metadata": return Ga(this.$vApp.$pinia);
			case "northarrow": return Ka(this.$vApp.$pinia);
			case "overviewmap": return qa(this.$vApp.$pinia);
			case "scrollguard": return Ja(this.$vApp.$pinia);
			case "wizard": return Ya(this.$vApp.$pinia);
			case "config": return t(this.$vApp.$pinia);
			case "fixture": return Jt(this.$vApp.$pinia);
			case "instance": return wr(this.$vApp.$pinia);
	...
	get started() {
		return wr(this.$vApp.$pinia).started;
	}
	updateAlert(e) {
...
function Za(e, t) {
	...
	let r = tn(), i = me(Nr).use(r).use(Ke, {
		directive: "tippy",
		component: "tippy"
	}).use(n);
	return i.directive("focus-container", ii), i.directive("focus-list", Ur), i.directive("focus-item", qr), i.directive("truncate", ci), i.component("panel-screen", xi), i.component("pin", Ti), i.component("close", Oi), i.component("back", ji), i.component("expand", Ii), i.component("panel-options-menu", qi), i.component("dropdown-menu", fn), i.component("minimize", zi), i.component("right", Ui), i.component("left", Ki), i.component("fullscreen-nav-button", Xi), i.component("geolocator-nav-button", Zi), i.component("home-nav-button", Qi), i.component("mapnav-button", ta), i.component("appbar-button", ia), i.component("transition", fe), i.component("transition-group", pe), i.config.globalProperties.$iApi = t, i.config.globalProperties.$pinia = n, i.config.idPrefix = `ramp-${e.id || Ls.sharedUtils.generateUUID()}`, i.provide("iApi", t), {
		element: i,
		app: i.mount(e),
		i18n: r.global
	};
...
var Qa = class e {
	...
	async createMap(e, t) {
		...
		}, r = e.basemaps.map((e) => Qa.create(e)), i = (await Promise.all(r)).filter((e) => (e.createErr && n(e), e.esriBasemap.baseLayers.length > 0));
		i.forEach((e) => {
	...
	constructor(e) {
		super(e, "overview"), this.overviewGraphicLayer = this.$iApi.geo.layer.createLayer({
			...
			cosmetic: !0,
			system: !0
		}), this.overviewmapStore = qa(this.$vApp.$pinia);
	}
	async createMapView(e) {
		...
		if (e ? (e.logo ? e.logo.disabled ? r.logo.disabled = !0 : (r.logo.altText = e.logo.altText || n.altText, r.logo.link = e.logo.link || n.link, r.logo.value = e.logo.value || n.value) : (r.logo.altText = n.altText, r.logo.link = n.link, r.logo.value = n.value), e.text ? e.text.disabled ? r.text.disabled = !0 : r.text.value = e.text.value || t.value : r.text.value = t.value, Gt(this.$vApp.$pinia).setAttribution(r)) : (r.logo.altText = n.altText, r.logo.link = n.link, r.logo.value = n.value, r.text.value = t.value), !e || e.text?.disabled || !e.text) {
			...
			if (n) {
				...
				Promise.all(i).then((n) => {
					e = n.filter((e) => e?.copyright).map((e) => e.copyright).join(" | "), r.text.value = e || r.text.value || t.value, Gt(this.$vApp.$pinia).setAttribution(r);
				});
			}
		}
	}
	...
	constructor(e) {
		super(e, "main"), this.maptip = new eo(e), this.caption = new no(e), this.mapMouseThrottle = 0;
	}
	async createMap(e, t) {
	...
	removeLayer(t) {
		...
		let n;
		if (n = t instanceof go ? t : this.$iApi.geo.layer.getLayer(t), !n) throw Error("Layer could not be found for removal.");
		if (n.isSublayer) {
...
var uo = class extends X {
	...
	async geoJsonToEsriJson(e, t) {
		...
		oo(e);
		let o = e.features[0].geometry.type, s = ao[o], c = JSON.parse(JSON.stringify(io[s]));
		if (t) {
	...
	ogc;
	constructor(e) {
		super(e), this.files = new uo(e), this.ogc = new po(e);
	}
	createLayer(e) {
		let t;
		switch (e.layerType) {
	...
	updateDrawState(e) {
		this.drawState = e, e === ut.REFRESH ? this.startTimer(_o.DRAW) : e === ut.UP_TO_DATE && this.stopTimer(_o.DRAW), this.$iApi.event.emit(Z.LAYER_DRAWSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	async initiate() {
		this.updateInitiationState(H.INITIATING), this.startTimer(_o.LOAD);
		let e = (e) => {
		...
		clearTimeout(n), t > this.lastCancel && (this.drawState !== ut.UP_TO_DATE && this.startTimer(_o.DRAW), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(H.INITIATED));
	}
	async onInitiate() {
	...
	onLoad() {
		...
		try {
			...
			Promise.all(r).then(() => {
				clearTimeout(n), t ? this.visibility = !1 : (this.stopTimer(_o.LOAD), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new Y()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((e) => e.onLoad()), this.updateLayerState(U.LOADED)));
			}).catch(() => {
	...
	async loadLayerMetadata(e = {}) {
		...
		if (!(t < this.lastCancel)) if (this.geomType = n.geometryType, this.attribs.quickCache = new $o(this.geomType), this.scaleSet.minScale = n.minScale, this.scaleSet.maxScale = n.maxScale, this.dataFormat = n.dataFormat, this.extent = this.extent ?? n.extent, this._serverVisibility = n.defaultVisibility, this.origRampConfig.name || (this.name = n.name ?? this.id), this.dataFormat === z.ESRI_FEATURE) {
			...
			this.attribs.attLoader = new Xo(this.$iApi, r);
	...
	runIdentify(e) {
		...
		return e.hitTest && (this.identifyMode === V.HYBRID || this.identifyMode === V.SYMBOLIC) && (r = i.then(async () => {
			...
			a.forEach((e) => {
				n.items.push(mo.makeRawItem(dt.ESRI, e.attributes));
			}), o.forEach((e) => {
				n.items.push(mo.makeOidItem(e, this));
	...
	extractLayerMetadata() {
		...
		this.attribs.attLoader = new Zo(this.$iApi, t);
	}
	async getGraphic(e, t) {
		let n;
	...
	set visibility(e) {
		...
		if (e || Mo(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible) this.esriLayer.visible = !0;
		else if (!e && this.esriLayer.visible) {
			let e = "", t = setTimeout(() => {
				this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Mo(this, ""));
			}, 1600);
			e = this.$iApi.event.on(Z.LAYER_DRAWSTATECHANGE, (n) => {
				n.layer.id === this.id && n.state === ut.UP_TO_DATE && (clearTimeout(t), this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Mo(this, "")));
			});
		}
		e && Mo(this, "");
	}
	...
	onLoadActions() {
		...
		let i = [], a = (e, t) => {
			...
			if (e.sublayers && e.sublayers.length > 0) {
				...
				this._sublayers[n] || (this._sublayers[n] = new No({
	...
	runIdentify(e) {
		...
		return e.geometry.type === L.POINT && (n = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((t) => {
			...
			return t.geomType !== L.POLYGON && n ? i.filterGeometry = n : i.filterGeometry = e.geometry, i.filterSql = t.getCombinedSqlFilter(), i.sourceSR = t.sourceSR, t.queryOIDs(i).then((e) => {
				e.forEach((e) => {
					a.items.push(mo.makeOidItem(e, t));
	...
	runIdentify(e) {
		...
		return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((e) => {
			if (e) {
				let t = !0, r;
				typeof e == "string" ? e.indexOf("Search returned no results") === -1 && e !== "" ? r = dt.TEXT : (t = !1, r = dt.UNKNOWN) : r = dt.JSON, t && n.items.push(mo.makeRawItem(r, e));
			}
			n.loaded = !0, t.resolveMe();
		}).catch(() => {
			n.errored = !0, t.resolveMe();
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = z.ESRI_FEATURE, this.layerFormat = lt.NOLAYER, this.drawState = ut.NOT_VISUAL, this.attribs = new qo(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
			...
			this.attribs.attLoader = new Qo(this.$iApi, i), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
	...
	onLoadActions() {
		let e = super.onLoadActions(), t = Date.now(), n = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, r = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((e) => {
			...
			this.attribs.attLoader = new Xo(this.$iApi, n), this.attribs.quickCache = new $o(this.geomType);
	...
	constructor(e, t) {
		super(e), this.aac = new Jo(), this.details = t;
	}
	updateFieldList(e) {
	...
	getAttribs() {
		return this.loadPromise ||= (this.aac = new Jo(), this.loadPromiseGenerator()), this.loadPromise;
	}
	abortAttribLoad() {
	...
	constructor(e, t, n = !1) {
		if (super(e, t, n), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((e, t) => {
			let n = t === 0, r = new os(this, e.minValue, e.maxValue, n);
	...
	makeRenderer(e, t, n = !1) {
		switch (e.type) {
			case this.SIMPLE: return new ns(e, t);
			case this.CLASS_BREAKS: return new as(e, t, n);
			case this.UNIQUE_VALUE: return new rs(e, t, n);
	...
	symbology;
	constructor(e) {
		super(e), this.geom = Ls.geom, this.proj = Ls.proj, this.shared = Ls.sharedUtils, this.map = new ro(e), this.layer = new ho(e), this.attributes = new Ko(e), this.query = new cs(e), this.symbology = new ss(e), Array.isArray(o.request.interceptors) || (o.request.interceptors = []), o.request.interceptors.push({ before: (e) => {
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-BBLu_u0D.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-ClrI-nis.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-BF38XE2_.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-Cgsw8u0m.js"),
	"../fixtures/details/index.ts": () => import("./details-CEYMCrry.js"),
	"../fixtures/draw/index.ts": () => import("./draw-C19G2BrS.js"),
	"../fixtures/export/index.ts": () => import("./export-qQs5BgF1.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-BirOsUEz.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-DvcGwjdr.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-BftB3EA2.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-DOwdQJq1.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-BZm7TJpB.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-DuKH1gNn.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-Bz0h0KPb.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-Ge_kfrmW.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-CQqNBsLq.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-BxBPIjlv.js"),
	"../fixtures/grid/index.ts": () => import("./grid-HBI8Kjqr.js"),
	"../fixtures/help/index.ts": () => import("./help-D9NuN5sy.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-DNguC1E-.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-B5MFjKeH.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-Dt47Uhm-.js"),
	"../fixtures/legend/index.ts": () => import("./legend-tPaWD_qH.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-Cuyy7E40.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-1xF08lnU.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-CpxsL5n6.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-DbX0-QEH.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-BgJldu2x.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-kvevgsoK.js"),
	"../fixtures/settings/index.ts": () => import("./settings-6-7lEVkg.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-DGUNSzF7.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-rXaKH0fh.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-N1GQ7eFw.js")
}), ds = class extends X {
	constructor(e) {
		super(e);
	}
	...
	async add(e, t) {
		...
		if (t) {
			...
			n = fs.updateBaseToInstance(new t(), e, this.$iApi);
		} else {
			let t = (await us[`../fixtures/${e}/index.ts`]()).default;
			n = new t(e, this.$iApi);
		}
	...
	register(e, t) {
		...
		let r = Object.entries(n).reduce((e, [t, n]) => (e.push(new ys(this.$iApi, t, n)), e), []);
	...
	open(e) {
		let t, n, r;
		if (typeof e == "string" || e instanceof ys ? t = this.get(e) : (t = this.get(e.id), {screen: n, props: r} = e), !t) return t;
	...
	toggle(e, t) {
		let n;
		return n = typeof e == "string" || e instanceof ys ? this.get(e) : this.get(e.id), n && (t = t === void 0 ? !n.isVisible : t, t === n.isVisible ? n : t ? this.open(e) : this.close(n));
	}
	toggleMinimize(e, t) {
		let n;
		return n = typeof e == "string" || e instanceof ys ? this.get(e) : this.get(e.id), n && (t = t === void 0 ? !n.isVisible : t, t === n.isVisible ? n : t ? this.open(n) : this.minimize(n));
	}
	pin(e, t) {
		let n = this.get(e);
...
var _s = /* @__PURE__ */ n(hs, [["render", gs], ["__scopeId", "data-v-a3c61802"]]), vs = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-DC_JW8np.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-BX74V795.js"),
	"../fixtures/export/screen.vue": () => import("./screen-CYMRlJ34.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-CJoXzssh.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-e9sxrFws.js"),
	"../fixtures/help/screen.vue": () => import("./screen-6l0U8Ho8.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-CtFPGZoA.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-CAumL7aK.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-Cfrc7rIT.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-Dx1RkWab.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-DTV6YclX.js")
}), ys = class extends X {
	id;
	screens;
	loadedScreens = [];
	...
	registerScreen(e) {
		...
		if (zt(t) || Rt(t)) n = t, this.loadedScreens.push(e);
			...
			let r;
			r = typeof t == "string" ? vs[`../fixtures/${t}`]() : t();
...
function Ss(e) {
	...
	return ks(e.services, t), Cs(e.map, t), As(e.ui, t), e.plugins && js(e.plugins, t), t;
}
function Cs(e, t) {
	if (e.layers && e.layers.forEach((e) => {
		t.layers.unshift(Es(e));
	...
	})) : t.fixtures.legend = { root: ws(e.legend.root) });
}
function ws(e) {
	let t = {
		name: e.name,
	...
	return e.controls && e.controls.length > 0 && (t.controls = Os(e.controls, n), e.controls.includes("visibility") && t.controls.push("visibilityButton"), (e.controls.length !== 1 || e.controls[0] !== "visibility") && console.warn("Legend entry groups currently support only the visibility control. All other controls are currently not supported."), t.controls.push("expandButton")), e.disabledControls && e.disabledControls.length > 0 && (t.disabledControls = Os(e.disabledControls, n), e.disabledControls.includes("visibility") && t.disabledControls.push("visibilityButton"), (e.disabledControls.length !== 1 || e.disabledControls[0] !== "visibility") && console.warn("Legend entry groups currently support only the visibility control. All other controls are currently not supported.")), e.children.forEach((e) => {
		if (e.layerId) t.children.push(Ts(e));
			...
			e.collapse !== void 0 && console.warn(`collapse property in visibilitySet in children list of legend entry group ${t.name} cannot be mapped and will be skipped.`), e.exclusiveVisibility.forEach((e) => {
				e.layerId ? n.children.push(Ts(e)) : n.children.push(ws(e));
			}), t.children.push(n);
		} else t.children.push(ws(e));
	}), t;
}
function Ts(e) {
	let t = e, n = [
	...
	return e.controls && e.controls.length > 0 && (t.layerControls = Os(e.controls, n), t.layerControls.push("symbology")), e.disabledControls && e.disabledControls.length > 0 && (t.disabledLayerControls = Os(e.disabledControls, n)), e.controlledIds && (console.warn(`controlledIds property defined in legend entry ${e.layerId} cannot be mapped and will be skipped.`), delete t.controlledIds), e.entryIndex && (t.sublayerIndex = e.entryIndex, delete e.entryIndex), e.entryId && console.warn(`entryId property defined in legend entry ${e.layerId} cannot be mapped and will be skipped.`), t;
}
function Es(e) {
	let t = Ds(e);
...
console.info(`RAMP v${{
	...
	minor: "20",
	patch: "0-beta",
	timestamp: "Fri Apr 17 09:56:06 2026 -0400",
	hash: "fd0eec334bc33a3d1d9051222019945d10868fa5"
}.major}.${{
	major: "4",
	minor: "20",
	patch: "0-beta",
...
var Is = (e, t, n) => new Xa(e, t, n), Ls = new Lt();
//#endregion
export { q as $, _a as A, Z as B, Ha as C, Ra as D, za as E, Zn as F, Ht as G, Kt as H, Xn as I, Y as J, X as K, vn as L, oa as M, aa as N, Ia as O, Qn as P, J as Q, pn as R, Va as S, La as T, Wt as U, qt as V, Ut as W, St as X, Tt as Y, bt as Z, qa as _, Ns as a, ne as at, Wa as b, Ro as c, W as ct, go as d, H as dt, c as et, mo as f, G as ft, Ja as g, $ as h, rt as ht, Fs as i, te as it, sa as j, ka as k, So as l, nt as lt, Ya as m, R as mt, Is as n, f as nt, ys as o, re as ot, to as p, U as pt, Pt as q, Ls as r, p as rt, fs as s, ft as st, Ps as t, d as tt, xo as u, dt as ut, Ka as v, Ba as w, Ua as x, Ga as y, ln as z };
