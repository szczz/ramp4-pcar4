import "tiny-emitter";
import { x as I, L as O, y as d, z as P, v as R, B as z, l as G, D as F, F as T, G as v, _ as k } from "./main-CKWgYI6e.js";
...
import { markRaw as E, defineComponent as D, inject as W, ref as f, computed as l, reactive as x, onMounted as j, onBeforeUnmount as q, resolveDirective as U, openBlock as y, createElementBlock as g, createElementVNode as c, normalizeStyle as S, normalizeClass as X, withDirectives as Y, unref as L } from "vue";
import "pinia";
...
const Q = { class: "relative h-full w-full overflow-hidden" }, ee = { class: "absolute h-30 w-30 top-0 right-0" }, te = ["content", "aria-label"], ie = /* @__PURE__ */ D({
  __name: "overviewmap",
  setup(u) {
    const e = d(), { t: i } = Z(), a = W("iApi"), t = G(), o = f(), n = l(() => t.activeBasemapConfig), _ = l(() => e.mapConfig), b = l(() => e.basemaps), A = l(() => e.startMinimized), r = x(new J(a)), p = f(!0), M = f(!1), m = x([]);
    j(async () => {
    ...
    return (h, s) => {
      ...
      return y(), g("div", {
        ...
        c("div", {
          ...
          c("div", Q, [
            c("div", {
              class: X(["overviewmap absolute top-0 right-0 h-192 w-192", { "cursor-move": M.value }]),
              onMousemove: $
            }, null, 34)
          ]),
          c("div", ee, [
...
}), ae = /* @__PURE__ */ k(ie, [["__scopeId", "data-v-9f9aebec"]]), re = { en: { "overviewmap.expand": "Expand Overview", "overviewmap.minimize": "Minimize Overview" }, fr: { "overviewmap.expand": "Développer l'aperçu", "overviewmap.minimize": "Réduire l'aperçu" } };
class De extends K {
  added() {
