    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        ...
        createBaseVNode("button", {
          ...
          createBaseVNode("span", _hoisted_3$3, toDisplayString(unref(t)("wizard.step.continue")), 1)
        ], 8, _hoisted_2$3)
      ]);
    };
  }
...
const WizardFormFooter = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-0220ba8a"]]);
...
(function (module) {
	...
	*/
	...
	var warning =  /* istanbul ignore next */noop_default.a ;
	...
	// Other constants.
	var INPUT_DEBOUNCE_DELAY =  /* istanbul ignore next */200;
	  ...
	  methods: {
	    ...
	    handleLocalSearch: function handleLocalSearch() {
	      ...
	      this.traverseAllNodesDFS(function (node) {
	        if (node.isBranch) {
	          ...
	          _this11.localSearch.countMap[node.id] = _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, ALL_CHILDREN, 0), ALL_DESCENDANTS, 0), LEAF_CHILDREN, 0), LEAF_DESCENDANTS, 0);
	    ...
	    normalize: function normalize(parentNode, nodes, prevNodeMap) {
	      ...
	      var normalizedOptions = nodes.map(function (node) {
	        ...
	        var isLeaf = !isBranch;
	        var childrenIgnoreDisabled = node.childrenIgnoreDisabled;
	        var isDisabled = !!node.isDisabled || !_this16.flat && !isRootNode && parentNode.isDisabled && !parentNode.childrenIgnoreDisabled;
	        ...
	        if (isBranch) {
	          ...
	          normalized.count = _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, ALL_CHILDREN, 0), ALL_DESCENDANTS, 0), LEAF_CHILDREN, 0), LEAF_DESCENDANTS, 0);
	    ...
	    _selectNode: function _selectNode(node) {
	      ...
	      if (isFullyChecked) {
	        ...
	        while ((curr = curr.parentNode) !== NO_PARENT_NODE) {
	          if (curr.children.every(this.isSelected) && !curr.childrenIgnoreDisabled) this.addValue(curr);else break;
	        }
	      }
	    },
	    // This is meant to be called only by `select()`.
	...
	/* harmony default export */ var MultiValuevue_type_script_lang_js = ({
	  ...
	  render: function render() {
	    ...
	    return renderValueContainer(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", {
	      "class": "vue-treeselect__multi-value",
	      "tag": "div",
	      "name": "vue-treeselect__multi-value-item--transition",
	      "appear": true
	    }, [this.renderMultiValueItems(), this.renderExceedLimitTip(), Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])(Placeholder, {
	      "key": "placeholder"
...
const _hoisted_2$2 = { class: "text-base font-bold" };
const _hoisted_3$2 = {
  class: "relative py-8 mb-0.5 h-75",
  "data-type": "file"
};
const _hoisted_4$2 = ["aria-label"];
const _hoisted_5$2 = { class: "text-gray-500 text-xs mb-1" };
const _hoisted_6$2 = { key: 1 };
const _hoisted_7$2 = { class: "text-base font-bold" };
const _hoisted_8 = {
  class: "mb-0.5",
  "data-type": "url"
};
const _hoisted_9 = ["value", "aria-label"];
const _hoisted_10 = {
  key: 0,
...
const _hoisted_17 = ["size", "value", "aria-label"];
...
const _hoisted_23 = { class: "text-base font-bold" };
const _hoisted_24 = { key: 4 };
const _hoisted_25 = { class: "text-base font-bold" };
const _hoisted_26 = { class: "relative mb-0.5" };
const _hoisted_27 = ["value", "aria-label"];
const _hoisted_28 = {
  key: 0,
  class: "text-red-900 text-xs"
};
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const blurEvent = () => {
      wizardSelect.value._tippy.hide();
    };
    const keyupEvent = (e) => {
      const evt = e;
      if (evt.key === "Tab" && wizardSelect.value?.matches(":focus") && navigator.userAgent.includes("Firefox")) {
        wizardSelect.value._tippy.show();
      } else {
        wizardSelect.value._tippy.hide();
      }
    };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        __props.type === "file" ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
          createBaseVNode("label", _hoisted_2$2, toDisplayString(__props.label), 1),
          createBaseVNode("div", _hoisted_3$2, [
            ...
            _cache[11] || (_cache[11] = createBaseVNode("div", { class: "upload-mask absolute inset-0 flex border-dashed border-2 border-gray-400 pointer-events-none justify-center" }, [
              createBaseVNode("svg", {
                ...
                createBaseVNode("path", { d: "M29,58A29,29,0,1,0,0,29,29,29,0,0,0,29,58ZM29,4A25,25,0,1,1,4,29,25,25,0,0,1,29,4Z" }),
                createBaseVNode("polygon", { points: "27 22 27 44.4 31 44.4 31 22 41.7 31.1 44.3 28.1 29 15 13.7 28.1 16.3 31.1 27 22" })
              ])
            ], -1))
          ]),
          createBaseVNode("div", _hoisted_5$2, toDisplayString(__props.help), 1)
        ])) : __props.type === "url" ? (openBlock(), createElementBlock("div", _hoisted_6$2, [
          createBaseVNode("label", _hoisted_7$2, toDisplayString(__props.label), 1),
          ...
          urlError.value ? (openBlock(), createElementBlock("div", _hoisted_10, toDisplayString(__props.modelValue ? __props.validationMessages?.invalid : __props.validationMessages?.required), 1)) : createCommentVNode("", true)
        ])) : __props.type === "select" ? (openBlock(), createElementBlock("div", _hoisted_11, [
          createBaseVNode("label", _hoisted_12, toDisplayString(__props.label), 1),
          createBaseVNode("div", _hoisted_13, [
            __props.multiple ? (openBlock(), createElementBlock("div", _hoisted_14, [
              createBaseVNode("div", {
                ref_key: "treeWrapper",
                ref: treeWrapper
              }, [
                createVNode(unref(Treeselect), {
                  ...
                  [valueLabel.value]: withCtx(({ node }) => [
                    createBaseVNode("label", null, toDisplayString(truncateVal(node.label)), 1)
                  ]),
              ...
              __props.validation && sublayersError.value ? (openBlock(), createElementBlock("div", _hoisted_15, toDisplayString(__props.validationMessages?.required), 1)) : createCommentVNode("", true)
              ...
              withDirectives((openBlock(), createElementBlock("select", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(__props.options, (option) => {
                  return openBlock(), createElementBlock("option", {
                    ...
                    key: option.label,
                    value: option.value
                  }, toDisplayString(option.label), 9, _hoisted_18);
                }), 128))
              ], 42, _hoisted_17)), [
                [_directive_tippy, {
                  content: unref(t)("select.items"),
                  trigger: "manual",
                  placement: "top-start"
                }]
              ]),
              __props.validation && __props.formatError ? (openBlock(), createElementBlock("div", _hoisted_19, toDisplayString(__props.validationMessages?.invalid), 1)) : createCommentVNode("", true),
              __props.validation && __props.failureError ? (openBlock(), createElementBlock("div", _hoisted_20, toDisplayString(__props.validationMessages?.failure), 1)) : createCommentVNode("", true)
            ]))
          ])
        ])) : __props.type === "checkbox" ? (openBlock(), createElementBlock("div", _hoisted_21, [
          createBaseVNode("input", {
          ...
          createBaseVNode("label", _hoisted_23, toDisplayString(__props.label), 1)
        ])) : (openBlock(), createElementBlock("div", _hoisted_24, [
          createBaseVNode("label", _hoisted_25, toDisplayString(__props.label), 1),
          ...
          __props.validation && !__props.modelValue ? (openBlock(), createElementBlock("div", _hoisted_28, toDisplayString(__props.validationMessages?.required), 1)) : createCommentVNode("", true)
        ]))
      ], 512);
    };
  }
...
const WizardInput = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b1820c72"]]);

const _hoisted_1$2 = { class: "step relative flex flex-col px-12" };
const _hoisted_2$1 = { class: "stepper-header flex pb-24" };
const _hoisted_3$1 = {
  key: 1,
  class: "flex-none stepper-check w-24 h-24 text-gray-400"
};
const _hoisted_4$1 = { class: "flex flex-col overflow-hidden" };
const _hoisted_5$1 = { class: "pl-12 flex items-center text-md" };
const _hoisted_6$1 = { class: "pl-12 text-xs transition-opacity duration-1000 ease-out" };
const _hoisted_7$1 = { class: "pl-36" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          }, toDisplayString(index.value + 1), 3)) : (openBlock(), createElementBlock("div", _hoisted_3$1, _cache[0] || (_cache[0] = [
            createBaseVNode("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              height: "100%",
              width: "100%",
              ...
              createBaseVNode("g", { id: "check_circle" }, [
                createBaseVNode("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" })
              ])
            ], -1)
          ]))),
          createBaseVNode("div", _hoisted_4$1, [
            createBaseVNode("div", _hoisted_5$1, toDisplayString(__props.title), 1),
...
const StepperItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-47ff0eb8"]]);

const _hoisted_1$1 = { class: "py-12 h-auto stepper" };
...
const _hoisted_2 = { class: "px-5 text-xs" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_panel_screen, { panel: __props.panel }, {
        ...
        content: withCtx(() => [
          createVNode(_sfc_main$1, { activeStep: step.value }, {
            default: withCtx(() => [
              createVNode(StepperItem, {
                ...
                default: withCtx(() => [
                  createBaseVNode("form", {
                    ...
                    _cache[12] || (_cache[12] = createBaseVNode("span", { class: "block text-center mb-10" }, "or", -1)),
                    createVNode(WizardInput, {
                      type: "url",
                      name: "url",
              ...
              createVNode(StepperItem, {
                ...
                default: withCtx(() => [
                  createBaseVNode("form", {
                    ...
                    IsCorsRequired.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
                      ...
                      createBaseVNode("span", _hoisted_2, toDisplayString(unref(t)("wizard.format.info.cors")), 1)
              ...
              createVNode(StepperItem, {
                ...
                default: withCtx(() => [
                  createBaseVNode("form", {
                    ...
                    layerInfo.value?.configOptions.includes(`sublayers`) ? (openBlock(), createElementBlock("div", _hoisted_3, [
                      createVNode(WizardInput, {
                        type: "checkbox",
                        name: "nested",
                    ...
                    }, toDisplayString(unref(t)("wizard.configure.colour.hex")), 9, _hoisted_4),
                    layerInfo.value?.configOptions.includes("colour") ? (openBlock(), createElementBlock("label", _hoisted_5, toDisplayString(unref(t)("wizard.configure.colour.label")), 1)) : createCommentVNode("", true),
                    layerInfo.value?.configOptions.includes("colour") ? (openBlock(), createBlock(unref(se), {
                      key: 7,
                      "alpha-channel": "hide",
                      "visible-formats": ["hex"],
                      "default-format": "hex",
                      ...
                      "hue-range-input-label": withCtx(() => [
                        createBaseVNode("span", _hoisted_6, toDisplayString(unref(t)("wizard.configure.colour.hue")), 1)
                      ]),
                      "copy-button": withCtx(() => [
                        createBaseVNode("span", _hoisted_7, toDisplayString(unref(t)("wizard.configure.colour.copy")), 1),
...
const WizardScreenV = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c8a6a685"]]);

export { WizardScreenV as default };
