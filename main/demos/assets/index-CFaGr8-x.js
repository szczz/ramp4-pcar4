const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./p2-screen-1-BH-va8h2.js","./main-ZcwzHdcj.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { c4 as defineComponent, c6 as inject, cb as resolveComponent, cd as createBlock, ce as withCtx, cf as openBlock, fZ as createBaseVNode, j8 as normalizeStyle, cg as createTextVNode, c5 as useI18n, ch as toDisplayString, ci as unref, b$ as FixtureInstance, hK as markRaw } from './main-ZcwzHdcj.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-BH-va8h2.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url).then((data) => {
                    resolve(data);
                  }),
                  2e3
                )
