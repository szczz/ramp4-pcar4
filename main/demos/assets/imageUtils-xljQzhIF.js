import { bL as e$1, aD as u$1, bd as e$2, bf as a } from './main-ZcwzHdcj.js';
import { b } from './Bitmap-BzeLwQIh.js';
import { r as r$2, h } from './WGLContainer-BXJm6cE9.js';
import { E } from './Container-Bcfoftbj.js';
import { i } from './TileContainer-DoIGINYf.js';
...
See https://js.arcgis.com/4.30/esri/copyright.txt for details.
*/
const r=r=>{let s=class extends r{attach(){this.view.timeline.record(`${this.layer.title} (BitmapTileLayer) Attach`),this._bitmapView=new n$1(this._tileInfoView),this.container.addChild(this._bitmapView);}detach(){this.container.removeChild(this._bitmapView),this._bitmapView?.removeAllChildren(),this._bitmapView=null;}};return s=e$2([a("esri.views.2d.layers.BitmapTileLayerView2D")],s),s};
