import { d2 as proxyCustomElement, d3 as H, c_ as h, d4 as Host, f2 as createEvent, hA as DEBOUNCE } from './main-ZcwzHdcj.js';
import { l as slotChangeHasAssignedElement, t as toAriaBoolean } from './dom-BGy5LjKF.js';
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-COCDSB_g.js';
import { c as createObserver } from './observers-Ag7bAhVh.js';
import { M as MAX_COLUMNS } from './resources4-DVAnfH27.js';
import { u as updateListItemChildren, a as getListItemChildren } from './utils3-CbLt-tmu.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-DQJf3qKn.js';
import { u as updateMessages, s as setUpMessages, c as connectMessages, d as disconnectMessages } from './t9n-BBZBju0c.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter } from './locale-CzzRKlOK.js';
import { S as Symbol$1, i as isObjectLike, r as root$1, b as baseGetTag, f as freeGlobal$1, a as isSymbol, c as isObject, d as debounce } from './debounce-GuTLDsIU.js';
import { d as defineCustomElement$7 } from './icon-Me97CXX9.js';
import { a as defineCustomElement$4, b as defineCustomElement$5, d as defineCustomElement$6 } from './input2-CG8or89-.js';
import { d as defineCustomElement$9 } from './loader-B9T_wj4K.js';
import { d as defineCustomElement$8 } from './scrim-DYjM5A-a.js';
import './preload-helper-dJJaZANz.js';
import './form-C4OlF4lR.js';
import './label-CSNG04Df.js';
...
const Stack = /*@__PURE__*/ proxyCustomElement(class Stack extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    renderActionsStart() {
        ...
        return (h("div", { class: CSS$2.actionsStart, hidden: !hasActionsStart, key: "actions-start-container" }, h("slot", { name: SLOTS$1.actionsStart, onSlotchange: this.handleActionsStartSlotChange })));
    }
    renderActionsEnd() {
        const { hasActionsEnd } = this;
        return (h("div", { class: CSS$2.actionsEnd, hidden: !hasActionsEnd, key: "actions-end-container" }, h("slot", { name: SLOTS$1.actionsEnd, onSlotchange: this.handleActionsEndSlotChange })));
    }
    renderContentStart() {
    ...
    renderDefaultContent() {
        return (h("div", { class: CSS$2.content }, h("slot", null)));
    }
    renderContentEnd() {
    ...
    render() {
        return (h(Host, { key: '97f052828720d715fd3b11a4b0e77fa085127796' }, h("div", { key: '5351cc20a8a437763894fef35ecc7a7240cb7c46', class: CSS$2.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd())));
    }
...
const Filter = /*@__PURE__*/ proxyCustomElement(class Filter extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
