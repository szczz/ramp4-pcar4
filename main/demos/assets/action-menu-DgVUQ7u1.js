import { hA as DEBOUNCE, c$ as isBrowser, c_ as h, d2 as proxyCustomElement, d3 as H, f2 as createEvent, d0 as forceUpdate, d4 as Host, kn as Fragment } from './main-ZcwzHdcj.js';
import { g as getElementDir, a as guid, t as toAriaBoolean, o as focusFirstTabbable, q as queryElementRoots, y as isKeyboardTriggeredClick, f as focusElement } from './dom-BGy5LjKF.js';
import { c as connectLocalized, d as disconnectLocalized, e as isActivationKey } from './locale-CzzRKlOK.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-DQJf3qKn.js';
import { d as defineCustomElement$4 } from './action-D0slJpYv.js';
import { d as defineCustomElement$3 } from './icon-Me97CXX9.js';
import { d as defineCustomElement$2 } from './loader-B9T_wj4K.js';
import { d as debounce } from './debounce-GuTLDsIU.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap, u as updateFocusTrapElements } from './focusTrapComponent-CsRI5YPY.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-CaN5KpO2.js';
import { u as updateMessages, c as connectMessages, s as setUpMessages, d as disconnectMessages } from './t9n-BBZBju0c.js';
...
const FloatingArrow = ({ floatingLayout, key, ref, }) => {
    ...
    const dValue = "M0,0" +
        ...
        " Z";
    return (h("svg", { "aria-hidden": "true", class: CSS$3.arrow, height: width, key: key, ref: ref, viewBox: `0 0 ${width} ${width + (!isVertical ? strokeWidth : 0)}`, width: width + (isVertical ? strokeWidth : 0) },
...
const Popover = /*@__PURE__*/ proxyCustomElement(class Popover extends H {
    ...
    renderCloseButton() {
        ...
        return closable ? (h("div", { class: CSS$2.closeButtonContainer, key: CSS$2.closeButtonContainer }, h("calcite-action", { appearance: "transparent", class: CSS$2.closeButton, onClick: this.hide, ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), scale: this.scale, text: messages.close }, h("calcite-icon", { icon: "x", scale: getIconScale(this.scale) })))) : null;
    }
    renderHeader() {
    ...
    render() {
        ...
        return (h(Host, { key: 'a563d48090d6e6c0c138023e169667834f657c4c', "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", { key: '73053dbdce2cfc68fcd42667089d611e81010955', class: {
                ...
                [CSS$2.headerContainer]: true,
            } }, this.renderHeader(), h("div", { key: '522abe801b98787863aac14d990b948d2d286156', class: CSS$2.content }, h("slot", { key: '022a8f690288acdbac4ec1b3eccf807ffe382d5d' })), !heading ? this.renderCloseButton() : null))));
    }
...
const ActionMenu = /*@__PURE__*/ proxyCustomElement(class ActionMenu extends H {
    ...
    renderMenuButton() {
        ...
        const menuButtonSlot = (h("slot", { name: SLOTS.trigger, onSlotchange: this.setMenuButtonEl }, h("calcite-action", { appearance: appearance, class: CSS$1.defaultTrigger, icon: ICONS.menu, ref: this.setDefaultMenuButtonEl, scale: scale, text: label, textEnabled: expanded })));
...
export { Heading as H, SLOTS as S, defineCustomElement as a, defaultEndMenuPlacement as b, defineCustomElement$1 as d };
