const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-DCg6So25.js","./main-ZcwzHdcj.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./table-state-manager-BxhJ2X4c.js","./screen-BSf4PA1q.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { b$ as FixtureInstance, hN as useGridStore, hK as markRaw, hL as useAppbarStore } from './main-ZcwzHdcj.js';
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => markRaw(__vitePreload(() => import('./screen-DCg6So25.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            width: "450px"
          },
