import { c4 as defineComponent, c5 as useI18n, iV as useGeosearchStore, fX as usePanelStore, ca as computed, g0 as debounce, cc as resolveDirective, cf as openBlock, cl as createElementBlock, fZ as createBaseVNode, f_ as normalizeClass, ci as unref, iO as withKeys, iN as withModifiers, ck as withDirectives, cg as createTextVNode, g3 as createCommentVNode, c6 as inject, c7 as ref, g1 as onBeforeMount, g2 as watch, c8 as onMounted, c9 as onBeforeUnmount, ch as toDisplayString, cm as Fragment, cn as renderList, g5 as GlobalEvents, iB as _export_sfc, iR as renderSlot, cb as resolveComponent, cd as createBlock, ce as withCtx, cj as createVNode, kg as Polygon, kh as SpatialReference } from './main-ZcwzHdcj.js';
...
const _hoisted_1$3 = { class: "w-fit inline-block sm:w-1/2 h-26 mb-8 sm:mb-0 pr-16 sm:pr-0" };
const _hoisted_2$3 = ["value", "aria-label"];
const _hoisted_3$3 = {
  value: "",
  disabled: "",
  hidden: ""
};
const _hoisted_4$2 = { class: "sm:w-1/2 h-26 sm:mx-16 flex" };
const _hoisted_5$1 = ["value", "aria-label"];
const _hoisted_6$1 = {
  value: "",
  disabled: "",
  hidden: ""
};
const _hoisted_7$1 = ["disabled", "content", "aria-label"];
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const blurProvince = () => {
      selectProvince.value._tippy.hide();
    };
    const blurFilter = () => {
      selectFilter.value._tippy.hide();
    };
    const keyupProvince = (e) => {
      const evt = e;
      if (evt.key === "Tab" && selectProvince.value?.matches(":focus") && navigator.userAgent.includes("Firefox")) {
        selectProvince.value._tippy.show();
      } else {
        selectProvince.value._tippy.hide();
      }
    };
    const keyupFilter = (e) => {
      ...
      if (evt.key === "Tab" && selectFilter.value?.matches(":focus") && navigator.userAgent.includes("Firefox")) {
        selectFilter.value._tippy.show();
      } else {
        selectFilter.value._tippy.hide();
      }
    };
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$3, [
          withDirectives((openBlock(), createElementBlock("select", {
            ...
            withDirectives((openBlock(), createElementBlock("option", _hoisted_3$3, [
        ...
        createBaseVNode("div", _hoisted_4$2, [
          withDirectives((openBlock(), createElementBlock("select", {
            ...
            createBaseVNode("option", _hoisted_6$1, toDisplayString(unref(t)("geosearch.filters.type")), 1),
