const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./header-0LDpiSfk.js","./main-ZcwzHdcj.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./header-DCuaZtjJ.css","./item-B-tAq3oJ.js","./marked.esm-DcwJ8j7Z.js","./item-EOH1U8SX.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { c4 as defineComponent, c5 as useI18n, c6 as inject, c7 as ref, c8 as onMounted, c9 as onBeforeUnmount, ca as computed, cb as resolveComponent, cc as resolveDirective, cd as createBlock, ce as withCtx, cf as openBlock, cg as createTextVNode, ch as toDisplayString, ci as unref, cj as createVNode, ck as withDirectives, cl as createElementBlock, cm as Fragment, cn as renderList, co as defineAsyncComponent } from './main-ZcwzHdcj.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const legendHeader = defineAsyncComponent(() => __vitePreload(() => import('./header-0LDpiSfk.js'),true?__vite__mapDeps([0,1,2,3,4]):void 0,import.meta.url));
    const legendItem = defineAsyncComponent(() => __vitePreload(() => import('./item-B-tAq3oJ.js'),true?__vite__mapDeps([5,1,2,3,6,7]):void 0,import.meta.url));
    const { t } = useI18n();
