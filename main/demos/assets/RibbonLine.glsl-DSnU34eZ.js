import{ao as Me,ab as x,d7 as Mt,X as qe,fJ as Wt,d8 as Vt,v as S,br as Ie,n as bt,m1 as ae,eX as Bt,c5 as kt,U as Ht}from"./main-D07jEvGH.js";import{I as Jt,E as k,p as Ge,o as H,u as xe,H as Gt,s as X,c as he,P as Qe,g as Pe,r as Zt}from"./vec32-ChV6ma3n.js";import{s as Yt,n as Xt,N as qt,r as Qt}from"./vec4f64-o2zAXfmz.js";import{o as We}from"./projection-Dm4lMAiE.js";import{t as Kt}from"./orientedBoundingBox-DIPVNLvC.js";import{b1 as Ot,e as Ze,b2 as ei,b3 as ti,at as _,av as yt,R as Et,au as At,c as Y,ah as _e,b4 as Ke,J as ii,d as ri,g as Ye,w as Xe,K as ni,ae as Ve,r as ai,P as si,af as oi,b as li,aE as ci,a0 as di,o as pi,L as hi,ag as ui,a9 as fi,G as ue,Y as mi,Z as vi,ak as et,al as gi,am as Si,an as _i,ao as Ti,ap as tt,aq as it,ar as bi,b5 as Oi,b6 as rt,b7 as yi,b8 as Ei,b9 as Ai,ba as Ri,A as B,aw as xi,aj as ne,aD as Be,aM as Ci,aN as Di,f as Li}from"./VerticalOffset.glsl-BzQwDvp5.js";import{n as ke,c as nt,H as Ii}from"./mat4-C7DAevmu.js";import{o as Pi,e as Re}from"./mat4f64-Dk4dwAN8.js";import{U as at,E as $i}from"./sphere-B9x1M-Wp.js";import{m as wi,M as De,p as Te,V as W,O as st}from"./plane-BkV-UNWE.js";import{t as Ni,B as be,g as $e,c as ot}from"./renderState-fiZ8Gckm.js";import{s as Ui,m as zi,H as Fi}from"./InterleavedLayout-CFjbHKK4.js";import{E as ji,e as h}from"./VertexAttribute-Cq4MnHjR.js";import{t as Rt,f as Mi,r as Wi,d as Vi}from"./HUDVisibility.glsl-TjE5O9kV.js";import{b as Bi,j as Oe}from"./Octree-49a2XVHd.js";import{r as ki}from"./vec2-maR1OrZI.js";import{v as xt,M as Hi,b as we,B as Ji}from"./lineSegment-CN-wv7mQ.js";import{n as se,u as pe,i as Gi,S as Zi,C as lt,e as Yi}from"./ShaderOutput-DnYY5J1_.js";import{_ as Xi}from"./preload-helper-ExcqyqRp.js";import{E as ct,f as ye}from"./enums-Dk3osxpS.js";import{m as qi}from"./computeTranslationToOriginAndRotation-nctri4OY.js";import{n as Qi,e as Ki}from"./ElevationInfo-uHpSKEtB.js";import{u as er}from"./hydratedFeatures-BSeNdZa2.js";import{n as p,t as tr}from"./glsl-BH37Aalp.js";import"./BindType-BBwFZqyN.js";import"./floatRGBA-zmH_-k2V.js";import"./Texture-BwQ9ZIzr.js";import{s as ir}from"./vec42-CKs01hkn.js";import"./vec2f64-DohEyf3f.js";import{i as rr}from"./ShaderBuilder-OVBIQINA.js";class xn{constructor(e,i=null,r=0){this.array=e,this.spatialReference=i,this.offset=r}}function Ct(t){return"array"in t}function Ee(t,e,i="ground"){if(Rt(e))return t.getElevation(e.x,e.y,e.z||0,e.spatialReference,i);if(Ct(e)){let r=e.offset;return t.getElevation(e.array[r++],e.array[r++],e.array[r]||0,e.spatialReference??t.spatialReference,i)}return t.getElevation(e[0],e[1],e[2]||0,t.spatialReference,i)}let nr=class extends Ot{get geometries(){return this._geometries}get transformation(){return this._transformation??Pi}set transformation(e){this._transformation=ke(this._transformation??Re(),e),this._invalidateBoundingVolume(),this._emit("transformationChanged",this)}get shaderTransformation(){return this._shaderTransformation}set shaderTransformation(e){this._shaderTransformation=e?ke(this._shaderTransformation??Re(),e):null,this._invalidateBoundingVolume(),this._emit("shaderTransformationChanged",this)}get effectiveTransformation(){return this.shaderTransformation??this.transformation}constructor(e={}){super(),this.type=Ze.Object,this._shaderTransformation=null,this._parentLayer=null,this._visible=!0,this.castShadow=e.castShadow??!0,this.usesVerticalDistanceToGround=e.usesVerticalDistanceToGround??!1,this.graphicUid=e.graphicUid,this.layerUid=e.layerUid,e.isElevationSource&&(this.lastValidElevationBB=new Dt),this._geometries=e.geometries?Array.from(e.geometries):new Array}dispose(){this._geometries.length=0}get parentLayer(){return this._parentLayer}set parentLayer(e){Ui(this._parentLayer==null||e==null,"Object3D can only be added to a single Layer"),this._parentLayer=e}addGeometry(e){e.visible=this._visible,this._geometries.push(e),this._emit("geometryAdded",{object:this,geometry:e}),this._invalidateBoundingVolume()}removeGeometry(e){const i=this._geometries.splice(e,1)[0];i&&(this._emit("geometryRemoved",{object:this,geometry:i}),this._invalidateBoundingVolume())}removeAllGeometries(){for(;this._geometries.length>0;)this.removeGeometry(0)}geometryVertexAttributeUpdated(e,i,r=!1){this._emit("attributesChanged",{object:this,geometry:e,attribute:i,sync:r}),ji(i)&&this._invalidateBoundingVolume()}get visible(){return this._visible}set visible(e){if(this._visible!==e){this._visible=e;for(const i of this._geometries)i.visible=this._visible;this._emit("visibilityChanged",this)}}maskOccludee(){const e=new ei;for(const i of this._geometries)i.occludees=Mi(i.occludees,e);return this._emit("occlusionChanged",this),e}removeOcclude(e){for(const i of this._geometries)i.occludees=Wi(i.occludees,e);this._emit("occlusionChanged",this)}highlight(e){const i=new ti(e);for(const r of this._geometries)r.addHighlight(i);return this._emit("highlightChanged",this),i}removeHighlight(e){for(const i of this._geometries)i.removeHighlight(e);this._emit("highlightChanged",this)}removeStateID(e){e.channel===Ni.Highlight?this.removeHighlight(e):this.removeOcclude(e)}getCombinedStaticTransformation(e,i){return nt(i,this.transformation,e.transformation)}getCombinedShaderTransformation(e,i=Re()){return nt(i,this.effectiveTransformation,e.transformation)}get boundingVolumeWorldSpace(){return this._bvWorldSpace||(this._bvWorldSpace=this._bvWorldSpace||new dt,this._validateBoundingVolume(this._bvWorldSpace,fe.WorldSpace)),this._bvWorldSpace}get boundingVolumeObjectSpace(){return this._bvObjectSpace||(this._bvObjectSpace=this._bvObjectSpace||new dt,this._validateBoundingVolume(this._bvObjectSpace,fe.ObjectSpace)),this._bvObjectSpace}_validateBoundingVolume(e,i){const r=i===fe.ObjectSpace;for(const n of this._geometries){const a=n.boundingInfo;a&&ar(a,e,r?n.transformation:this.getCombinedShaderTransformation(n))}Jt(at(e.bounds),e.min,e.max,.5);for(const n of this._geometries){const a=n.boundingInfo;if(a==null)continue;const l=r?n.transformation:this.getCombinedShaderTransformation(n),o=wi(l);k(pt,a.center,l);const s=Ge(pt,at(e.bounds)),c=a.radius*o;e.bounds[3]=Math.max(e.bounds[3],s+c)}}_invalidateBoundingVolume(){const e=this._bvWorldSpace?.bounds;this._bvObjectSpace=this._bvWorldSpace=void 0,this._parentLayer&&e&&this._parentLayer.notifyObjectBBChanged(this,e)}_emit(e,i){this._parentLayer&&this._parentLayer.events.emit(e,i)}get test(){}};class Dt{constructor(){this.min=Me(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE),this.max=Me(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE)}isEmpty(){return this.max[0]<this.min[0]&&this.max[1]<this.min[1]&&this.max[2]<this.min[2]}}class dt extends Dt{constructor(){super(...arguments),this.bounds=$i()}}function ar(t,e,i){const r=t.bbMin,n=t.bbMax;if(Ii(i)){const a=H(sr,i[12],i[13],i[14]);xe(z,r,a),xe(j,n,a);for(let l=0;l<3;++l)e.min[l]=Math.min(e.min[l],z[l]),e.max[l]=Math.max(e.max[l],j[l])}else if(k(z,r,i),Gt(r,n))for(let a=0;a<3;++a)e.min[a]=Math.min(e.min[a],z[a]),e.max[a]=Math.max(e.max[a],z[a]);else{k(j,n,i);for(let a=0;a<3;++a)e.min[a]=Math.min(e.min[a],z[a],j[a]),e.max[a]=Math.max(e.max[a],z[a],j[a]);for(let a=0;a<3;++a){X(z,r),X(j,n),z[a]=n[a],j[a]=r[a],k(z,z,i),k(j,j,i);for(let l=0;l<3;++l)e.min[l]=Math.min(e.min[l],z[l],j[l]),e.max[l]=Math.max(e.max[l],z[l],j[l])}}}const sr=x(),z=x(),j=x(),pt=x();var fe;(function(t){t[t.WorldSpace=0]="WorldSpace",t[t.ObjectSpace=1]="ObjectSpace"})(fe||(fe={}));var Ce;(function(t){t[t.ASYNC=0]="ASYNC",t[t.SYNC=1]="SYNC"})(Ce||(Ce={}));const or=["layerObjectAdded","layerObjectRemoved","layerObjectsAdded","layerObjectsRemoved","transformationChanged","shaderTransformationChanged","visibilityChanged","occlusionChanged","highlightChanged","geometryAdded","geometryRemoved","attributesChanged"];let lr=class extends Ot{constructor(e,i,r=""){super(),this.stage=e,this.apiLayerUid=r,this.type=Ze.Layer,this.events=new Mt,this.visible=!0,this.sliceable=!1,this._objectsAdded=new qe,this._handles=new Wt,this._objects=new qe,this._pickable=!0,this.visible=i?.visible??!0,this._pickable=i?.pickable??!0,this.updatePolicy=i?.updatePolicy??Ce.ASYNC,this._disableOctree=i?.disableOctree??!1,e.add(this);for(const n of or)this._handles.add(this.events.on(n,a=>e.handleEvent(n,a)))}destroy(){this._handles.size&&(this._handles.destroy(),this.stage.remove(this),this.invalidateSpatialQueryAccelerator())}get objects(){return this._objects}set pickable(e){this._pickable=e}get pickable(){return this._pickable&&this.visible}add(e){this._objects.push(e),e.parentLayer=this,this.events.emit("layerObjectAdded",{layer:this,object:e}),this._octree!=null&&this._objectsAdded.push(e)}remove(e){this._objects.removeUnordered(e)&&(e.parentLayer=null,this.events.emit("layerObjectRemoved",{layer:this,object:e}),this._octree!=null&&(this._objectsAdded.removeUnordered(e)||this._octree.remove([e])))}addMany(e){this._objects.pushArray(e);for(const i of e)i.parentLayer=this;this.events.emit("layerObjectsAdded",{layer:this,objects:e}),this._octree!=null&&this._objectsAdded.pushArray(e)}removeMany(e){const i=new Array;if(this._objects.removeUnorderedMany(e,e.length,i),i.length!==0){for(const r of i)r.parentLayer=null;if(this.events.emit("layerObjectsRemoved",{layer:this,objects:i}),this._octree!=null){for(let r=0;r<i.length;)this._objectsAdded.removeUnordered(i[r])?(i[r]=i[i.length-1],i.length-=1):++r;this._octree.remove(i)}}}sync(){this.updatePolicy!==Ce.SYNC&&this.stage.syncLayer(this.id)}notifyObjectBBChanged(e,i){this._octree==null||this._objectsAdded.includes(e)||this._octree.update(e,i)}getSpatialQueryAccelerator(){return this._octree==null&&this._objects.length>50&&!this._disableOctree?(this._octree=new Bi(e=>e.boundingVolumeWorldSpace.bounds),this._octree.add(this._objects.data,this._objects.length)):this._octree!=null&&this._objectsAdded.length>0&&(this._octree.add(this._objectsAdded.data,this._objectsAdded.length),this._objectsAdded.clear()),this._octree}invalidateSpatialQueryAccelerator(){this._octree=Vt(this._octree),this._objectsAdded.clear()}};var te,me;(function(t){t[t.Draped=0]="Draped",t[t.Screen=1]="Screen",t[t.World=2]="World",t[t.COUNT=3]="COUNT"})(te||(te={})),function(t){t[t.Center=0]="Center",t[t.Tip=1]="Tip",t[t.COUNT=2]="COUNT"}(me||(me={}));let F=class extends yt{constructor(){super(...arguments),this.space=te.Screen,this.anchor=me.Center,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.vvSize=!1,this.vvColor=!1,this.vvOpacity=!1,this.hasOccludees=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.textureCoordinateType=Et.None,this.emissionSource=At.None,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVvInstancing=!0,this.hasSliceTranslatedView=!0,this.objectAndLayerIdColorInstanced=!1}get draped(){return this.space===te.Draped}};S([_({count:te.COUNT})],F.prototype,"space",void 0),S([_({count:me.COUNT})],F.prototype,"anchor",void 0),S([_()],F.prototype,"occluder",void 0),S([_()],F.prototype,"writeDepth",void 0),S([_()],F.prototype,"hideOnShortSegments",void 0),S([_()],F.prototype,"hasCap",void 0),S([_()],F.prototype,"hasTip",void 0),S([_()],F.prototype,"vvSize",void 0),S([_()],F.prototype,"vvColor",void 0),S([_()],F.prototype,"vvOpacity",void 0),S([_()],F.prototype,"hasOccludees",void 0),S([_()],F.prototype,"terrainDepthTest",void 0),S([_()],F.prototype,"cullAboveTerrain",void 0);const ht=8;function cr(t,e){const i=t.vertex;i.uniforms.add(new Y("intrinsicWidth",r=>r.width)),e.vvSize?(t.attributes.add(h.SIZEFEATUREATTRIBUTE,"float"),i.uniforms.add(new _e("vvSizeMinSize",r=>r.vvSize.minSize),new _e("vvSizeMaxSize",r=>r.vvSize.maxSize),new _e("vvSizeOffset",r=>r.vvSize.offset),new _e("vvSizeFactor",r=>r.vvSize.factor)),i.code.add(p`float getSize() {
return intrinsicWidth * clamp(vvSizeOffset + sizeFeatureAttribute * vvSizeFactor, vvSizeMinSize, vvSizeMaxSize).x;
}`)):(t.attributes.add(h.SIZE,"float"),i.code.add(p`float getSize(){
return intrinsicWidth * size;
}`)),e.vvOpacity?(t.attributes.add(h.OPACITYFEATUREATTRIBUTE,"float"),i.constants.add("vvOpacityNumber","int",8),i.uniforms.add(new Ke("vvOpacityValues",r=>r.vvOpacity.values,ht),new Ke("vvOpacityOpacities",r=>r.vvOpacity.opacityValues,ht)),i.code.add(p`float interpolateOpacity( float value ){
...
}`))}function Lt(t){return t.pattern.map(e=>Math.round(e*t.pixelRatio))}function dr(t){if(t==null)return 1;const e=Lt(t);return Math.floor(e.reduce((i,r)=>i+r))}function pr(t){return Lt(t).reduce((e,i)=>Math.max(e,i))}function hr(t){return t==null?Yt:t.length===4?t:ir(ur,t[0],t[1],t[2],1)}const ur=Xt();function fr(t,e){if(!e.stippleEnabled)return void t.fragment.code.add(p`float getStippleAlpha() { return 1.0; }
...
}`),n.uniforms.add(new ni("stipplePatternTexture",a=>a.stippleTexture),new Y("stipplePatternSDFNormalizer",a=>mr(a.stipplePattern)),new Y("stipplePatternPixelSizeInv",a=>1/It(a))),e.stippleOffColorEnabled&&n.uniforms.add(new Ve("stippleOffColor",a=>hr(a.stippleOffColor))),n.code.add(p`float getStippleSDF(out bool isClamped) {
...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function mr(t){return t?(Math.floor(.5*(pr(t)-1))+.5)/t.pixelRatio:1}function It(t){const e=t.stipplePattern;return e?dr(t.stipplePattern)/e.pixelRatio:1}const vr=.4,Pt=64,gr=Pt/2,Sr=gr/5,_r=Pt/Sr,In=.25;function Tr(t,e){const i=t.vertex;Xe(i),i.uniforms.get("markerScale")==null&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",_r).code.add(p`float getLineWidth() {
