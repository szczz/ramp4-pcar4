import { c4 as defineComponent, hO as useMetadataStore, c5 as useI18n, c6 as inject, c7 as ref, ca as computed, iT as reactive, c8 as onMounted, g5 as GlobalEvents, g2 as watch, c9 as onBeforeUnmount, cb as resolveComponent, cd as createBlock, ce as withCtx, cf as openBlock, cg as createTextVNode, ch as toDisplayString, ci as unref, cl as createElementBlock, fZ as createBaseVNode } from './main-ZcwzHdcj.js';
...
const _hoisted_7 = { class: "text-xl mt-20" };
const _hoisted_8 = {
  key: 1,
  class: "p-5"
};
          ...
          layerExists.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
            createBaseVNode("div", _hoisted_2, [
              status.value == "loading" ? (openBlock(), createElementBlock("div", _hoisted_3, toDisplayString(unref(t)("metadata.loading")), 1)) : __props.payload.type === "xml" && status.value == "success" ? (openBlock(), createElementBlock("div", {
                ...
                _cache[0] || (_cache[0] = createBaseVNode("img", { src: "https://i.imgur.com/fA5EqV6.png" }, null, -1)),
                createBaseVNode("span", _hoisted_7, toDisplayString(unref(t)("metadata.error")), 1)
              ]))
            ])
