import { c4 as defineComponent, c5 as useI18n, cc as resolveDirective, ck as withDirectives, cf as openBlock, cl as createElementBlock, fZ as createBaseVNode, f_ as normalizeClass, ci as unref, iB as _export_sfc, c2 as getAugmentedNamespace, jv as commonjsGlobal, jw as getDefaultExportFromCjs, c6 as inject, c7 as ref, ca as computed, c8 as onMounted, g5 as GlobalEvents, c9 as onBeforeUnmount, ch as toDisplayString, cd as createBlock, ce as withCtx, g3 as createCommentVNode, cj as createVNode, cm as Fragment, cn as renderList, cg as createTextVNode, li as toRaw, lj as LayerState, cb as resolveComponent } from './main-ZcwzHdcj.js';
import { r as require$$0 } from './vue.esm-bundler-CsGDRq6o.js';

const _hoisted_1$1 = ["content", "aria-label"];
const _hoisted_2$1 = ["disabled", "aria-label"];
...
const ReorderButton = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c8bd21b7"]]);
...
const _hoisted_4 = { class: "flex items-center p-5 h-44 cursor-pointer hover:bg-gray-200" };
const _hoisted_5 = ["onClick", "content", "aria-label"];
const _hoisted_6 = {
  key: 0,
...
const _hoisted_8 = { class: "flex-1 mx-10" };
const _hoisted_9 = {
  key: 0,
  class: "items-center p-5 pl-30 default-focus-style cursor-pointer"
};
const _hoisted_10 = ["content", "aria-label"];
const _hoisted_11 = ["content", "aria-label"];
const _hoisted_12 = { class: "flex-1 mx-10" };
        ...
        layersModel.value.length === 0 ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          item: withCtx(({ element }) => [
            element.isLoaded ? withDirectives((openBlock(), createElementBlock("div", {
              ...
              _cache[3] || (_cache[3] = createBaseVNode("div", { class: "display-none" }, null, -1)),
              createBaseVNode("div", _hoisted_4, [
                element.supportsSublayers ? withDirectives((openBlock(), createElementBlock("button", {
                  ...
                  element.isExpanded ? (openBlock(), createElementBlock("svg", _hoisted_6, _cache[1] || (_cache[1] = [
                    createBaseVNode("path", {
                      d: "M0 0h24v24H0z",
                      fill: "none"
                    }, null, -1),
                    createBaseVNode("path", { d: "M19 13H5v-2h14v2z" }, null, -1)
                  ]))) : (openBlock(), createElementBlock("svg", _hoisted_7, _cache[2] || (_cache[2] = [
                    createBaseVNode("path", { d: "M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" }, null, -1)
                  ])))
                ], 8, _hoisted_5)), [
                  [_directive_focus_item],
                  [_directive_tippy, {
              ...
              element.isExpanded && element.sublayers.length > 0 ? withDirectives((openBlock(), createElementBlock("div", _hoisted_9, [
              ...
              _cache[4] || (_cache[4] = createBaseVNode("div", { class: "animate-spin spinner h-20 w-20 px-5" }, null, -1)),
