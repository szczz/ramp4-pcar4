import { hz as logLevel, d2 as proxyCustomElement, d3 as H, f2 as createEvent, c_ as h, d4 as Host } from './main-ZcwzHdcj.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-BqzIWwZT.js';
import { n as getSlotted, l as slotChangeHasAssignedElement, o as focusFirstTabbable, p as ensureId } from './dom-BGy5LjKF.js';
...
import { c as connectLocalized, d as disconnectLocalized } from './locale-CzzRKlOK.js';
import { s as setUpMessages, c as connectMessages, d as disconnectMessages, u as updateMessages } from './t9n-BBZBju0c.js';
import { g as getIconScale, c as componentOnReady } from './component-Dp1lfHT8.js';
import { d as defineCustomElement$4 } from './icon-Me97CXX9.js';
import { d as defineCustomElement$3 } from './loader-B9T_wj4K.js';
import { d as defineCustomElement$2 } from './scrim-DYjM5A-a.js';
...
const Modal = /*@__PURE__*/ proxyCustomElement(class Modal extends H {
    ...
    render() {
        return (h(Host, { key: 'f92cd77f4a5ad4a245ca50fe2b2bfcf9966d4ca8', "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, h("div", { key: 'a9d348a67842162f1bc17ec8422c07963aed412d', class: {
                [CSS.container]: true,
                [CSS.containerOpen]: this.opened,
                [CSS.containerEmbedded]: this.embedded,
            } }, h("calcite-scrim", { key: '7dc3bc9220fc375522a6d390b633f9573bfa6c67', class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), h("div", { key: '40782ba2b6d3f086c884ace3529110e873009504', class: {
                [CSS.modal]: true,
            }, ref: this.setTransitionEl }, h("div", { key: 'ea3a72ab0a0e5abae6e766d0b7b2cfce54667e86', class: CSS.header }, this.renderCloseButton(), h("header", { key: 'abe5c28d11fc6241cd6ac40adef4d94529eb9d5c', class: CSS.title }, h("slot", { key: '3d1d6ed6c0249472a00fba4128a861e6a6eae4dd', name: CSS.header }))), this.renderContentTop(), h("div", { key: '0e65dfbd175e490586518d1a4c34b9eb1dde1f01', class: {
                [CSS.content]: true,
                [CSS.contentNoFooter]: !this.hasFooter,
            }, ref: (el) => (this.modalContent = el) }, h("slot", { key: 'd5f3b08e61e8e47f64fd13bc6eb7f7ed6a07b7c8', name: SLOTS.content })), this.renderContentBottom(), this.renderFooter()))));
    }
    renderFooter() {
