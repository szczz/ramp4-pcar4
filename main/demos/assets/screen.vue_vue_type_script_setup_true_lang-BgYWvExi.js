import { c4 as defineComponent, c5 as useI18n, fX as usePanelStore, fY as useExportStore, ca as computed, cb as resolveComponent, cc as resolveDirective, ck as withDirectives, cf as openBlock, cd as createBlock, ce as withCtx, fZ as createBaseVNode, cl as createElementBlock, cn as renderList, f_ as normalizeClass, ch as toDisplayString, ci as unref, cm as Fragment, c6 as inject, c7 as ref, f$ as useTemplateRef, g0 as debounce, g1 as onBeforeMount, g2 as watch, c8 as onMounted, c9 as onBeforeUnmount, cj as createVNode, cg as createTextVNode, g3 as createCommentVNode } from './main-ZcwzHdcj.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const exportStore = useExportStore();
    const fixture = ref();
    const rootResizeObserver = ref(void 0);
    const panelResizeObserver = ref(void 0);
    const watchers = ref([]);
