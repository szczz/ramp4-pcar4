import { bG as defineComponent, bH as useI18n, bO as resolveDirective, bW as withDirectives, bP as openBlock, bX as createElementBlock, fG as normalizeClass, bU as unref, i8 as pushScopeId, i9 as popScopeId, fH as createBaseVNode, ia as _export_sfc, bE as getAugmentedNamespace, iV as getDefaultExportFromCjs, iU as commonjsGlobal, bI as inject, bJ as ref, bM as computed, bK as onMounted, fO as GlobalEvents, bL as onBeforeUnmount, bT as toDisplayString, bQ as createBlock, bR as withCtx, fL as createCommentVNode, bV as createVNode, bY as Fragment, bZ as renderList, bS as createTextVNode, kU as toRaw, kV as LayerState, bN as resolveComponent } from './main-75ed2508.js';
import { r as require$$0 } from './vue.esm-bundler-38a02c2f.js';

const _withScopeId = (n) => (pushScopeId("data-v-761f9dab"), n = n(), popScopeId(), n);
const _hoisted_1$1 = ["content", "aria-label"];
...
const _hoisted_5$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("svg", {
  class: "fill-current w-20 h-20",
  viewBox: "0 0 23 21"
}, [
  /* @__PURE__ */ createBaseVNode("path", { d: "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z" })
...
const reorderButton_vue_vue_type_style_index_0_scoped_761f9dab_lang = '';

const ReorderButton = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-761f9dab"]]);
...
const _hoisted_3 = ["aria-label", "content"];
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("div", { class: "display-none" }, null, -1);
const _hoisted_5 = { class: "flex items-center p-5 ms-5 h-44 cursor-pointer hover:bg-gray-200" };
const _hoisted_6 = ["onClick", "content", "aria-label"];
const _hoisted_7 = {
  key: 0,
...
const _hoisted_9 = /* @__PURE__ */ createBaseVNode("path", { d: "M19 13H5v-2h14v2z" }, null, -1);
const _hoisted_10 = [
  _hoisted_8,
  _hoisted_9
];
...
const _hoisted_12 = /* @__PURE__ */ createBaseVNode("path", { d: "M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" }, null, -1);
const _hoisted_13 = [
  _hoisted_12
];
const _hoisted_14 = { class: "flex-1 mx-10" };
const _hoisted_15 = {
  key: 0,
  class: "items-center bg-gray-200 p-5 pl-30 default-focus-style cursor-pointer"
};
const _hoisted_16 = ["content", "aria-label"];
const _hoisted_17 = ["content", "aria-label"];
const _hoisted_18 = /* @__PURE__ */ createBaseVNode("div", { class: "animate-spin spinner h-20 w-20 px-5" }, null, -1);
const _hoisted_19 = { class: "flex-1 mx-10" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const loadLayerData = (layer) => {
      let model = layersModel.value.find(
        (layerModel) => layerModel.id === layer.id
      );
      if (!model) {
        return;
      }
      model.name = layer.name;
      model.sublayers = layer.sublayers.filter(
        (sublayer) => sublayer !== void 0 && !sublayer.isRemoved
      ).map((sublayer) => {
        return {
          id: sublayer.id,
          name: sublayer.name
    ...
    const toggleExpand = (layerModel) => {
      ...
      iApi.updateAlert(
        t(
          layerModel.isExpanded ? "layer-reorder.expanded" : "layer-reorder.collapsed",
          {
    ...
    const onMoveLayerDragStart = () => {
      oldOrder.value = layersModel.value.map(
        (layerModel) => layerModel.orderIdx
      );
    };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        layersModel.value.length === 0 ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1, [
          createBaseVNode("span", _hoisted_2, toDisplayString(unref(t)("layer-reorder.nolayers")), 1)
        ])), [
          [_directive_truncate]
            ...
            element.isLoaded ? withDirectives((openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_5, [
                element.supportsSublayers ? withDirectives((openBlock(), createElementBlock("button", {
                  ...
                  content: unref(t)(
                    `layer-reorder.${!element.isExpanded ? "expand" : "collapse"}`
                  ),
                  "aria-label": unref(t)(
                    `layer-reorder.${!element.isExpanded ? "expand" : "collapse"}`
                  )
                }, [
                  element.isExpanded ? (openBlock(), createElementBlock("svg", _hoisted_7, _hoisted_10)) : (openBlock(), createElementBlock("svg", _hoisted_11, _hoisted_13))
                ], 8, _hoisted_6)), [
                  [_directive_focus_item],
                  [_directive_tippy, {
                    placement: "right",
                ...
                withDirectives((openBlock(), createElementBlock("div", _hoisted_14, [
                  createBaseVNode("span", null, toDisplayString(element.name), 1)
                ])), [
                  [_directive_truncate]
                ]),
              ...
              element.isExpanded && element.sublayers.length > 0 ? withDirectives((openBlock(), createElementBlock("div", _hoisted_15, [
              ...
              createBaseVNode("div", _hoisted_19, [
                createBaseVNode("span", null, toDisplayString(unref(t)("layer-reorder.loading")), 1)
              ])
            ], 8, _hoisted_17)), [
              [_directive_tippy, {
                placement: "top-start",
