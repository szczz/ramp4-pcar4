import { is as toRefs, bM as computed, bP as openBlock, bX as createElementBlock, bW as withDirectives, fH as createBaseVNode, fG as normalizeClass, it as renderSlot, fL as createCommentVNode, iu as mergeProps, iq as withKeys, ip as withModifiers, i7 as vShow, bG as defineComponent, bJ as ref, iv as reactive, fK as watch, iw as toRef, bL as onBeforeUnmount, bS as createTextVNode, bT as toDisplayString, bQ as createBlock, bU as unref, i8 as pushScopeId, i9 as popScopeId, ia as _export_sfc } from './main-75ed2508.js';
...
const _withScopeId = (n) => (pushScopeId("data-v-3b7ee75b"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "flex flex-row rv-label" };
const _hoisted_2 = { class: "flex items-center" };
const _hoisted_3 = ["innerHTML"];
const _hoisted_4 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "flex-1" }, null, -1));
...
const toggleSwitchControl_vue_vue_type_style_index_0_scoped_3b7ee75b_lang = '';

const ToggleSwitchControl = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3b7ee75b"]]);
