...
import { g as geo, c as createInstance } from './main-75ed2508.js';
            ...
            async function loadScript(scriptName) {
                                ...
                                lodSets: [
                                    {
                                        ...
                                        lods: geo.defaultLODs(
                                            geo.defaultTileSchemas()[0]
                                        )
                                    },
                                    {
                                        id: 'LOD_ESRI_World_AuxMerc_3857',
                                        lods: geo.defaultLODs(
                                            geo.defaultTileSchemas()[1]
                                        )
                                    }
                                ],
                                tileSchemas: [
                                ...
                                basemaps: [
                                    {
                                        ...
                                        altText:
                                            'The Canada Base Map - Transportation (CBMT)',
                                        layers: [
                                            {
                                                id: 'CBMT',
                                                layerType: 'esri-tile',
                                    ...
                                    },
                                    {
                                        ...
                                        name: 'OpenStreetMap',
                                        description:
                                            'Open sourced topographical map.',
                            ...
                            map: {
                                ...
                                basemaps: [
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            'La carte de base du Canada - simple',
                                        altText:
                                            'La carte de base du Canada - simple',
                                        layers: [
                                            {
                                    ...
                                    },
                                    {
                                        ...
                                        altText:
                                            'La carte du monde en relief ombragé',
                                        layers: [
                                            {
                                                id: 'World_Shaded_Relief',
                                                layerType: 'esri-tile',
                                    ...
                                    },
                                    {
                                        ...
                                        altText:
                                            'La carte du monde topographique',
                                        layers: [
                                            {
                                                id: 'World_Topo_Map',
                                                layerType: 'esri-tile',
                                    ...
                                    },
                                    {
                                        ...
                                        name: 'OpenStreetMap',
                                        description:
                                            'Carte topographique open source.',
                                        altText: 'OpenStreetMap',
                                        layers: [
                                            {
                                                id: 'Open_Street_Map',
                ...
                const utils = {
                    ...
                    addLayerLang: (layerConfig, langKey) => {
                        ...
                        langConfig.fixtures.legend.root.children.push(
                            structuredClone({ layerId: layerConfig.id })
                        );
                    },
                    ...
                    addLayerLegend: layerConfig => {
                        ...
                        langConfigs.forEach(lang => {
                            lang.layers.push(structuredClone(layerConfig));
                            lang.fixtures.legend.root.children.push(
                                structuredClone(legendConfig)
                            );
                        });
                    },
                    ...
                    addLegendLang: (legendConfig, langKey) => {
                        config.configs[
                            langKey
                        ].fixtures.legend.root.children.push(
                            structuredClone(legendConfig)
                        );
                    }
                };
                ...
                const testRunner = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"./enhanced-scripts/000-template.js": () => __vitePreload(() => import('./000-template-9d696790.js'),true?[]:void 0,import.meta.url),"./enhanced-scripts/001-happy.js": () => __vitePreload(() => import('./001-happy-4bb5b9cd.js'),true?[]:void 0,import.meta.url),"./enhanced-scripts/002-simple-empty.js": () => __vitePreload(() => import('./002-simple-empty-095d9ea2.js'),true?[]:void 0,import.meta.url),"./enhanced-scripts/003-simple-feature.js": () => __vitePreload(() => import('./003-simple-feature-a7d471f1.js'),true?[]:void 0,import.meta.url),"./enhanced-scripts/004-simple-mil.js": () => __vitePreload(() => import('./004-simple-mil-47db4703.js'),true?[]:void 0,import.meta.url),"./enhanced-scripts/005-simple-file.js": () => __vitePreload(() => import('./005-simple-file-185deb9d.js'),true?[]:void 0,import.meta.url),"./enhanced-scripts/006-simple-data.js": () => __vitePreload(() => import('./006-simple-data-84fcc2da.js'),true?[]:void 0,import.meta.url),"./enhanced-scripts/007-main-classic.js": () => __vitePreload(() => import('./007-main-classic-8560071d.js'),true?[]:void 0,import.meta.url)})), `./enhanced-scripts/${scriptName}.js`);
