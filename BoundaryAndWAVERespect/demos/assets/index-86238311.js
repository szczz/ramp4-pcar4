...
import { bG as defineComponent, bI as inject, bN as resolveComponent, bP as openBlock, bQ as createBlock, bR as withCtx, fH as createBaseVNode, iM as normalizeStyle, bS as createTextVNode, bH as useI18n, bT as toDisplayString, bU as unref, bB as FixtureInstance, he as markRaw } from './main-75ed2508.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-66080442.js'),true?["./p2-screen-1-66080442.js","./main-75ed2508.js","./preload-helper-a4975f27.js","./main-5c005d17.css"]:void 0,import.meta.url).then(
                    (data) => {
                      resolve(data);
                    }
                  ),
