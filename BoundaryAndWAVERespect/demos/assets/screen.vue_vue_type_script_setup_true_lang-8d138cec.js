import { bG as defineComponent, bH as useI18n, ix as useGeosearchStore, fE as usePanelStore, bM as computed, fI as debounce, bO as resolveDirective, bP as openBlock, bX as createElementBlock, fH as createBaseVNode, fG as normalizeClass, bU as unref, iq as withKeys, ip as withModifiers, bW as withDirectives, bS as createTextVNode, fL as createCommentVNode, bI as inject, bJ as ref, fJ as onBeforeMount, fK as watch, bL as onBeforeUnmount, bT as toDisplayString, bY as Fragment, bZ as renderList, bK as onMounted, fO as GlobalEvents, ia as _export_sfc, it as renderSlot, bN as resolveComponent, bQ as createBlock, bR as withCtx, bV as createVNode, jZ as Polygon, j_ as SpatialReference } from './main-75ed2508.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const iApi = inject("iApi");
    const geosearchStore = useGeosearchStore();
    const cleanedSearchVal = computed(
